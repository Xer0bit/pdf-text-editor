  ...
  (window.wpCoreControlsBundle = window.wpCoreControlsBundle || []).push([
    [6],
    {
      578: function (xa, ta, h) {
        ...
        var na = (function (ja) {
          function ka(fa, x) {
            var z = ja.call(this, fa, x) || this;
            z.url = fa;
            z.range = x;
            z.status = oa.a.NOT_STARTED;
            return z;
          }
          Object(qa.c)(ka, ja);
          ka.prototype.start = function () {
            ...
            this.status = oa.a.STARTED;
            this.GK();
          };
          return ka;
        })(xa.ByteRangeRequest);
        xa = (function (ja) {
          function ka(fa, x, z, r) {
            fa = ja.call(this, fa, x, z, r) || this;
            fa.VE = na;
            return fa;
          }
          Object(qa.c)(ka, ja);
          ka.prototype.fC = function (fa, x) {
            return ""
              .concat(fa, "#")
              .concat(x.start, "&")
