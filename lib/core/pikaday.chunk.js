        ...
        !(function (h, qa) {
          ...
          function qa(ma) {
            ...
            la._onChange = function (ra) {
              var pa = (ra = ra || window.event).target || ra.srcElement;
              pa &&
                (e(pa, "pika-select-month")
                  ? la.gotoMonth(pa.value)
                  : e(pa, "pika-select-year") && la.gotoYear(pa.value));
            };
            ...
            la._parseFieldValue = function () {
              if (ia.parse) return ia.parse(ia.field.value, ia.format);
              if (ba) {
                var ra = h(ia.field.value, ia.format, ia.formatStrict);
                return ra && ra.isValid() ? ra.toDate() : null;
              }
              return new Date(Date.parse(ia.field.value));
            };
            la._onInputChange = function (ra) {
              var pa;
              ra.firedBy !== la &&
                ((pa = la._parseFieldValue()),
                n(pa) && la.setDate(pa),
                la._v || la.show());
            };
              ...
              if ((ra = pa)) {
                !ha &&
                  ...
                  (pa.onchange ||
                    ...
                    y(pa, "change", la._onChange)));
                do if (e(ra, "pika-single") || ra === ia.trigger) return;
                while ((ra = ra.parentNode));
                la._v && pa !== ia.trigger && ra !== ia.trigger && la.hide();
              }
            };
            ...
            la.el.className =
              ...
              (ia.isRTL ? " is-rtl" : "") +
              (ia.theme ? " " + ia.theme : "");
            y(la.el, "mousedown", la._onMouseDown, !0);
            y(la.el, "touchend", la._onMouseDown, !0);
            y(la.el, "change", la._onChange);
            ia.keyboardInput && y(aa, "keydown", la._onKeyChange);
            ia.field &&
              (ia.container
                ? ia.container.appendChild(la.el)
                : ia.bound
                ? aa.body.appendChild(la.el)
                : ia.field.parentNode.insertBefore(la.el, ia.field.nextSibling),
              y(ia.field, "change", la._onInputChange),
              ia.defaultDate ||
                ((ia.defaultDate = la._parseFieldValue()),
                (ia.setDefaultDate = !0)));
            ma = ia.defaultDate;
            n(ma)
              ? ia.setDefaultDate
            ...
            ia.bound
              ? (this.hide(),
                ...
                y(ia.trigger, "click", la._onInputClick),
                y(ia.trigger, "focus", la._onInputFocus),
                y(ia.trigger, "blur", la._onInputBlur))
              : this.show();
          }
          function oa(ma, la, ia) {
            return (
          ...
          function na(ma, la, ia, ra, pa, sa) {
            ...
            for (sa = 0; 12 > sa; sa++)
              Na.push(
                '<option value="' +
                  (ia === pa ? sa - la : 12 + sa - la) +
                  '"' +
                  (sa === ra ? ' selected="selected"' : "") +
                  ((Ca && sa < Ba.minMonth) || (Aa && sa > Ba.maxMonth)
                    ? ' disabled="disabled"'
                    : "") +
                  ">" +
                  Ba.i18n.months[sa] +
            ...
            pa =
              ...
              "</select></div>";
            f(Ba.yearRange)
              ? ((sa = Ba.yearRange[0]), (ua = Ba.yearRange[1] + 1))
              : ((sa = ia - Ba.yearRange), (ua = 1 + ia + Ba.yearRange));
            for (Na = []; sa < ua && sa <= Ba.maxYear; sa++)
              sa >= Ba.minYear &&
                Na.push(
                  '<option value="' +
                    sa +
                    '"' +
                    (sa === ia ? ' selected="selected"' : "") +
                    ">" +
                    sa +
                    "</option>"
                );
            return (
              (wa =
                ...
                Na.join("") +
                "</select></div>"),
              Ba.showMonthAfterYear ? (Ja += wa + pa) : (Ja += pa + wa),
              Ca && (0 === ra || Ba.minMonth >= ra) && (Ea = !1),
              Aa && (11 === ra || Ba.maxMonth <= ra) && (La = !1),
              0 === la &&
                (Ja +=
          ...
          function ja(ma, la, ia) {
            for (la += ma.firstDay; 7 <= la; ) la -= 7;
            return ia ? ma.i18n.weekdaysShort[la] : ma.i18n.weekdays[la];
          }
          function ka(ma) {
            return (
              0 > ma.month &&
          ...
          function x(ma, la, ia) {
            ...
            for (ra in la)
              ...
              void 0 === la[ra].nodeName
                ? n(la[ra])
                  ? ia && (ma[ra] = new Date(la[ra].getTime()))
                  : f(la[ra])
                  ? ia && (ma[ra] = la[ra].slice(0))
                  : (ma[ra] = x({}, la[ra], ia))
                : (!ia && pa) || (ma[ra] = la[ra]);
            return ma;
          }
          function z(ma) {
            n(ma) && ma.setHours(0, 0, 0, 0);
          }
          function r(ma, la) {
            return [
              31,
          ...
          function b(ma, la) {
            var ia;
            ma.className = (ia = (" " + ma.className + " ").replace(
              " " + la + " ",
              " "
            )).trim
              ? ia.trim()
          ...
          function w(ma, la, ia, ra) {
            ha
              ? ma.removeEventListener(la, ia, !!ra)
              : ma.detachEvent("on" + la, ia);
          }
          function y(ma, la, ia, ra) {
            ha
              ? ma.addEventListener(la, ia, !!ra)
              : ma.attachEvent("on" + la, ia);
          }
          ...
          return (
            (qa.prototype = {
              config: function (ma) {
                ...
                n(ma.minDate) || (ma.minDate = !1),
                n(ma.maxDate) || (ma.maxDate = !1),
                ma.minDate &&
                  ma.maxDate &&
              ...
              setMoment: function (ma, la) {
                ba && h.isMoment(ma) && this.setDate(ma.toDate(), la);
              },
              getDate: function () {
              ...
              setDate: function (ma, la) {
                ...
                if (
                  ...
                  var ia = this._o.minDate,
                    ra = this._o.maxDate;
                  n(ia) && ma < ia ? (ma = ia) : n(ra) && ma > ra && (ma = ra);
                ...
                if (n(ma)) {
                  if (this.calendars) {
                    ...
                    var ia = new Date(
                      ...
                      ra = ma.getTime();
                    ia.setMonth(ia.getMonth() + 1);
                    ia.setDate(ia.getDate() - 1);
                    la = ra < la.getTime() || ia.getTime() < ra;
                  }
                  la &&
                    ((this.calendars = [
              ...
              adjustDate: function (ma, la) {
                ...
                "add" === ma
                  ? (ia = new Date(ra.valueOf() + la))
                  : "subtract" === ma && (ia = new Date(ra.valueOf() - la));
                this.setDate(ia);
              },
              adjustCalendars: function () {
                this.calendars[0] = ka(this.calendars[0]);
                for (var ma = 1; ma < this._o.numberOfMonths; ma++)
                  this.calendars[ma] = ka({
              ...
              adjustPosition: function () {
                var ma, la, ia, ra, pa, sa, ua, wa, Ba;
                if (!this._o.container) {
                  if (
                    ((this.el.style.position = "absolute"),
                    (la = ma = this._o.trigger),
                    (ia = this.el.offsetWidth),
                    (ra = this.el.offsetHeight),
                    (pa = window.innerWidth || aa.documentElement.clientWidth),
                    (sa =
                  ...
                  ((this._o.reposition && Ca + ia > pa) ||
                    (-1 < this._o.position.indexOf("right") &&
                      0 < Ca - ia + ma.offsetWidth)) &&
                    ((Ca = Ca - ia + ma.offsetWidth), (wa = !1));
                  ((this._o.reposition && Aa + ra > sa + ua) ||
                    (-1 < this._o.position.indexOf("top") &&
                      0 < Aa - ra - ma.offsetHeight)) &&
                    ((Aa = Aa - ra - ma.offsetHeight), (Ba = !1));
                  0 > Ca && (Ca = 0);
                  0 > Aa && (Aa = 0);
                  this.el.style.left = Ca + "px";
                  this.el.style.top = Aa + "px";
                  a(this.el, wa ? "left-aligned" : "right-aligned");
                  a(this.el, Ba ? "bottom-aligned" : "top-aligned");
                  b(this.el, wa ? "right-aligned" : "left-aligned");
                  b(this.el, Ba ? "top-aligned" : "bottom-aligned");
                }
              },
              render: function (ma, la, ia) {
                var ra = this._o,
                  pa = new Date(),
                  sa = r(ma, la),
                ...
                for (
                  ...
                  Oa -= 7;
                Na += 7 - Oa;
                for (var Sa = !1, Ta = (Oa = 0); Oa < Na; Oa++) {
                  var Ia = new Date(ma, la, Oa - ua + 1),
                    bb = !!n(this._d) && Ia.getTime() === this._d.getTime(),
                    Ma = Ia.getTime() === pa.getTime(),
                    Wa = -1 !== ra.events.indexOf(Ia.toDateString()),
                    Qa = Oa < ua || Oa >= sa + ua,
                    Ka = Oa - ua + 1,
                    $a = la,
                    Ga = ma,
                    Ra =
                      ra.startRange && ra.startRange.getTime() === Ia.getTime(),
                    ab = ra.endRange && ra.endRange.getTime() === Ia.getTime(),
                    cb =
                      ra.startRange &&
                      ra.endRange &&
                      ra.startRange < Ia &&
                  ...
                  var Za = bb,
                    Fa;
                  !(Fa =
                    (ra.minDate && Ia < ra.minDate) ||
                    (ra.maxDate && Ia > ra.maxDate)) &&
                    (Fa = ra.disableWeekends) &&
                    ((Fa = Ia.getDay()), (Fa = 0 === Fa || 6 === Fa));
                  Qa = {
                    day: Ka,
                    month: $a,
                    year: Ga,
                    ...
                    isSelected: Za,
                    isToday: Ma,
                    isDisabled: Fa || (ra.disableDayFn && ra.disableDayFn(Ia)),
                    isEmpty: Qa,
                    isStartRange: Ra,
                    isEndRange: ab,
                    isInRange: cb,
                  ...
                  a: {
                    ...
                    cb = "false";
                    if (Ra.isEmpty) {
                      if (!Ra.showDaysInNextAndPreviousMonths) {
                        Qa = '<td class="is-empty"></td>';
                        break a;
                      }
                      ab.push("is-outside-current-month");
                      Ra.enableSelectionDaysInNextAndPreviousMonths ||
                        ab.push("is-selection-disabled");
                    }
                    Qa =
                      (Ra.isDisabled && ab.push("is-disabled"),
                      Ra.isToday && ab.push("is-today"),
                      Ra.isSelected && (ab.push("is-selected"), (cb = "true")),
                      Ra.hasEvent && ab.push("has-event"),
                      Ra.isInRange && ab.push("is-inrange"),
                      Ra.isStartRange && ab.push("is-startrange"),
                      Ra.isEndRange && ab.push("is-endrange"),
                      '<td data-day="' +
                        Ra.day +
                        '" class="' +
                        ab.join(" ") +
                  ...
                  7 == ++Ta &&
                    (ra.showWeekNumber &&
                      ((Ta = Ba),
                      (bb = Ta.unshift),
                      (Ra = ra.firstWeekOfYearMinDays),
                      (Ia = new Date(ma, la, Oa - ua)),
                      ba
                        ? (Ia = h(Ia).isoWeek())
                        : (Ia.setHours(0, 0, 0, 0),
                          (ab = Ia.getDate()),
                          (Qa = Ra - 1),
                          Ia.setDate(ab + Qa - ((Ia.getDay() + 7 - 1) % 7)),
                          (Ra = new Date(Ia.getFullYear(), 0, Ra)),
                          (Ia =
                            1 +
                            Math.round(
                              ((Ia.getTime() - Ra.getTime()) / 864e5 -
                                Qa +
                                ((Ra.getDay() + 7 - 1) % 7)) /
                                7
                            ))),
                      bb.call(Ta, '<td class="pika-week">' + Ia + "</td>")),
                    (Ta = wa),
                    (bb = Ta.push),
                    (Ba =
                      '<tr class="pika-row' +
              ...
              show: function () {
                this.isVisible() ||
                  ...
                  b(this.el, "is-hidden"),
                  this._o.bound &&
                    (y(aa, "click", this._onClick), this.adjustPosition()),
              ...
              hide: function () {
                var ma = this._v;
                !1 !== ma &&
                  (this._o.bound && w(aa, "click", this._onClick),
                  this._o.container ||
              ...
              destroy: function () {
                ...
                ma.keyboardInput && w(aa, "keydown", this._onKeyChange);
                ma.field &&
