      ...
      573: function (xa, ta, h) {
        ...
        h = (function () {
          function fa(x) {
            ...
            this.file = x;
            this.dAa = new Promise(function (r) {
              return Object(qa.b)(z, void 0, void 0, function () {
                var n;
                return Object(qa.d)(this, function (f) {
                  switch (f.label) {
                    case 0:
                      return this.Qza(this.file)
                        ? [4, Object(na.b)(x)]
                        : [3, 2];
                    case 1:
                      (n = f.aa()),
                        (this.file = ja.q
                          ? new Blob([n], { type: x.type })
                          : new File(
                              [n],
          ...
          fa.prototype.getFileData = function (x) {
            ...
            r.onload = function (n) {
              ...
              x(new Uint8Array(n.target.result));
            };
              ...
              return Object(qa.d)(this, function (x) {
                switch (x.label) {
                  ...
                  case 1:
                    return (
                      x.aa(),
                      ka.da.isJSWorker ? [2, this.file.path] : [2, this.file]
                    );
                }
              });
            });
