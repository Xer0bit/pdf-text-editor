...
*****************************************************************************/
  ...
  $jscomp.defineProperty = $jscomp.ASSUME_ES5 || "function" == typeof Object.defineProperties ? Object.defineProperty : function(v, z, u) {
  ...
  $jscomp.polyfill = function(v, z, u, q) {
      z && ($jscomp.ISOLATE_POLYFILLS ? $jscomp.polyfillIsolated(v, z, u, q) : $jscomp.polyfillUnisolated(v, z, u, q))
  }
  ;
  $jscomp.polyfillUnisolated = function(v, z, u, q) {
      u = $jscomp.global;
      v = v.split(".");
      ...
      q = u[v];
      z = z(q);
      z != q && null != z && $jscomp.defineProperty(u, v, {
          configurable: !0,
          writable: !0,
          value: z
      })
  ...
  ;
  $jscomp.polyfillIsolated = function(v, z, u, q) {
      var t = v.split(".");
      v = 1 === t.length;
      q = t[0];
      q = !v && q in $jscomp.polyfills ? $jscomp.polyfills : $jscomp.global;
      ...
      t = t[t.length - 1];
      u = $jscomp.IS_SYMBOL_NATIVE && "es6" === u ? q[t] : null;
      z = z(u);
      null != z && (v ? $jscomp.defineProperty($jscomp.polyfills, t, {
          configurable: !0,
          writable: !0,
          value: z
      }) : z !== u && (void 0 === $jscomp.propertyToPolyfillSymbol[t] && (u = 1E9 * Math.random() >>> 0,
      $jscomp.propertyToPolyfillSymbol[t] = $jscomp.IS_SYMBOL_NATIVE ? $jscomp.global.Symbol(t) : $jscomp.POLYFILL_PREFIX + u + "$" + t),
      $jscomp.defineProperty(q, $jscomp.propertyToPolyfillSymbol[t], {
          configurable: !0,
          writable: !0,
          value: z
      })))
  ...
  ;
  $jscomp.polyfill("Symbol", function(v) {
      if (v)
          return v;
      var z = function(B, m) {
      ...
      var u = "jscomp_symbol_" + (1E9 * Math.random() >>> 0) + "_"
        ...
        , t = function(B) {
          ...
          return new z(u + (B || "") + "_" + q++,B)
      };
      return t
  }, "es6", "es3");
  $jscomp.polyfill("Symbol.iterator", function(v) {
      if (v)
          return v;
      v = Symbol("Symbol.iterator");
      for (var z = "Array Int8Array Uint8Array Uint8ClampedArray Int16Array Uint16Array Int32Array Uint32Array Float32Array Float64Array".split(" "), u = 0; u < z.length; u++) {
          var q = $jscomp.global[z[u]];
          "function" === typeof q && "function" != typeof q.prototype[v] && $jscomp.defineProperty(q.prototype, v, {
              configurable: !0,
              writable: !0,
              value: function() {
  ...
  $jscomp.checkEs6ConformanceViaProxy = function() {
      try {
          var v = {}
            , z = Object.create(new $jscomp.global.Proxy(v,{
              get: function(u, q, t) {
                  return u == v && "q" == q && t == z
              }
          }));
  ...
  $jscomp.makeIterator = function(v) {
      var z = "undefined" != typeof Symbol && Symbol.iterator && v[Symbol.iterator];
      if (z)
          return z.call(v);
      if ("number" == typeof v.length)
          return $jscomp.arrayIterator(v);
  ...
  ;
  $jscomp.polyfill("WeakMap", function(v) {
      function z() {
          if (!v || !Object.seal)
              return !1;
          try {
              var p = Object.seal({})
                , f = Object.seal({})
                , l = new v([[p, 2], [f, 3]]);
              if (2 != l.get(p) || 3 != l.get(f))
                  return !1;
              l.delete(p);
              l.set(f, 4);
              return !l.has(p) && 4 == l.get(f)
          } catch (g) {
              return !1
          }
      }
      ...
      function q(p) {
          var f = typeof p;
          return "object" === f && null !== p || "function" === f
      }
      function t(p) {
          if (!$jscomp.owns(p, m)) {
              var f = new u;
              $jscomp.defineProperty(p, m, {
                  value: f
              })
          }
      }
      function B(p) {
          if (!$jscomp.ISOLATE_POLYFILLS) {
              var f = Object[p];
              f && (Object[p] = function(l) {
                  if (l instanceof u)
                      return l;
                  Object.isExtensible(l) && t(l);
                  return f(l)
              }
              )
          }
      ...
      var d = 0
        , k = function(p) {
          ...
          if (p) {
              ...
              for (var f; !(f = p.next()).done; )
                  f = f.value,
                  this.set(f[0], f[1])
          }
      };
      k.prototype.set = function(p, f) {
          if (!q(p))
      ...
      k.prototype.get = function(p) {
          return q(p) && $jscomp.owns(p, m) ? p[m][this.id_] : void 0
      }
      ;
      k.prototype.has = function(p) {
          return q(p) && $jscomp.owns(p, m) && $jscomp.owns(p[m], this.id_)
      }
      ;
      k.prototype.delete = function(p) {
          return q(p) && $jscomp.owns(p, m) && $jscomp.owns(p[m], this.id_) ? delete p[m][this.id_] : !1
      }
      ;
      return k
  }, "es6", "es3");
  ...
  ;
  $jscomp.polyfill("Map", function(v) {
      function z() {
          if ($jscomp.ASSUME_NO_NATIVE_MAP || !v || "function" != typeof v || !v.prototype.entries || "function" != typeof Object.seal)
              return !1;
          try {
              var k = Object.seal({
                  x: 4
              })
                , p = new v($jscomp.makeIterator([[k, "s"]]));
              if ("s" != p.get(k) || 1 != p.size || p.get({
                  x: 4
              }) || p.set({
                  x: 4
              }, "t") != p || 2 != p.size)
              ...
              var f = p.entries()
                , l = f.next();
              if (l.done || l.value[0] != k || "s" != l.value[1])
                  return !1;
              l = f.next();
      ...
      var u = new WeakMap
        , q = function(k) {
          ...
          if (k) {
              ...
              for (var p; !(p = k.next()).done; )
                  p = p.value,
                  this.set(p[0], p[1])
          }
      };
      q.prototype.set = function(k, p) {
          k = 0 === k ? 0 : k;
          var f = t(this, k);
          f.list || (f.list = this.data_[f.id] = []);
          f.entry ? f.entry.value = p : (f.entry = {
              next: this.head_,
      ...
      ;
      q.prototype.has = function(k) {
          return !!t(this, k).entry
      }
      ;
      q.prototype.get = function(k) {
          return (k = t(this, k).entry) && k.value
      }
      ;
      ...
      ;
      q.prototype.forEach = function(k, p) {
          for (var f = this.entries(), l; !(l = f.next()).done; )
              l = l.value,
              k.call(p, l[1], l[0], this)
      }
      ;
      q.prototype[Symbol.iterator] = q.prototype.entries;
      var t = function(k, p) {
          var f = p && typeof p;
          "object" == f || "function" == f ? u.has(p) ? f = u.get(p) : (f = "" + ++d,
          u.set(p, f)) : f = "p_" + p;
          var l = k.data_[f];
          if (l && $jscomp.owns(k.data_, f))
              for (k = 0; k < l.length; k++) {
                  var g = l[k];
                  if (p !== p && g.key !== g.key || p === g.key)
                      return {
                          id: f,
                          list: l,
                          index: k,
  ...
  $jscomp.polyfill("Promise", function(v) {
      function z() {
          this.batch_ = null
      }
      function u(m) {
          return m instanceof t ? m : new t(function(d, k) {
              d(m)
          }
          )
      }
      if (v && (!($jscomp.FORCE_POLYFILL_PROMISE || $jscomp.FORCE_POLYFILL_PROMISE_WHEN_NO_UNHANDLED_REJECTION && "undefined" === typeof $jscomp.global.PromiseRejectionEvent) || !$jscomp.global.Promise || -1 === $jscomp.global.Promise.toString().indexOf("[native code]")))
          return v;
      ...
      t.prototype.createResolveAndReject_ = function() {
          ...
          return {
              ...
              reject: m(this.reject_)
          }
      }
      ;
      t.prototype.resolveTo_ = function(m) {
          if (m === this)
              this.reject_(new TypeError("A Promise cannot resolve to itself"));
          else if (m instanceof t)
              this.settleSameAsPromise_(m);
          else {
              a: switch (typeof m) {
              case "object":
                  var d = null != m;
      ...
      ;
      t.prototype.resolveToNonPromiseObj_ = function(m) {
          var d = void 0;
          try {
              d = m.then
          } catch (k) {
          ...
          "function" == typeof d ? this.settleSameAsThenable_(d, m) : this.fulfill_(m)
      }
      ;
      t.prototype.reject_ = function(m) {
          this.settle_(2, m)
      }
      ;
      t.prototype.fulfill_ = function(m) {
          this.settle_(1, m)
      }
      ;
      t.prototype.settle_ = function(m, d) {
          if (0 != this.state_)
              throw Error("Cannot settle(" + m + ", " + d + "): Promise already settled in state" + this.state_);
          this.state_ = m;
          this.result_ = d;
      ...
      ;
      var B = new z;
      t.prototype.settleSameAsPromise_ = function(m) {
          var d = this.createResolveAndReject_();
          m.callWhenSettled_(d.resolve, d.reject)
      }
      ;
      t.prototype.settleSameAsThenable_ = function(m, d) {
      ...
      ;
      t.prototype.then = function(m, d) {
          function k(g, x) {
              return "function" == typeof g ? function(n) {
                  try {
                      p(g(n))
                  } catch (r) {
                      f(r)
          ...
          var p, f, l = new t(function(g, x) {
              p = g;
              f = x
          }
          );
          this.callWhenSettled_(k(m, p), k(d, f));
          return l
      }
      ;
      t.prototype.catch = function(m) {
          return this.then(void 0, m)
      }
      ;
      t.prototype.callWhenSettled_ = function(m, d) {
          function k() {
              switch (p.state_) {
              case 1:
                  m(p.result_);
          ...
          var p = this;
          null == this.onSettledCallbacks_ ? B.asyncExecute(k) : this.onSettledCallbacks_.push(k);
      ...
      t.race = function(m) {
          return new t(function(d, k) {
              for (var p = $jscomp.makeIterator(m), f = p.next(); !f.done; f = p.next())
      ...
      t.all = function(m) {
          var d = $jscomp.makeIterator(m)
            , k = d.next();
          return k.done ? u([]) : new t(function(p, f) {
              function l(n) {
                  return function(r) {
                      g[n] = r;
                      x--;
  ...
  $jscomp.polyfill("String.prototype.endsWith", function(v) {
      return v ? v : function(z, u) {
          var q = $jscomp.checkStringArgs(this, z, "endsWith");
          z += "";
          void 0 === u && (u = q.length);
          u = Math.max(0, Math.min(u | 0, q.length));
          for (var t = z.length; 0 < t && 0 < u; )
              if (q[--u] != z[--t])
                  return !1;
          return 0 >= t
      }
  ...
  $jscomp.underscoreProtoCanBeSet = function() {
      var v = {
        ...
        , z = {};
      try {
          return z.__proto__ = v,
          z.a
      } catch (u) {}
      return !1
  }
  ;
  $jscomp.setPrototypeOf = $jscomp.TRUST_ES6_POLYFILLS && "function" == typeof Object.setPrototypeOf ? Object.setPrototypeOf : $jscomp.underscoreProtoCanBeSet() ? function(v, z) {
      v.__proto__ = z;
      if (v.__proto__ !== z)
  ...
  : null;
  $jscomp.assign = $jscomp.TRUST_ES6_POLYFILLS && "function" == typeof Object.assign ? Object.assign : function(v, z) {
      for (var u = 1; u < arguments.length; u++) {
          var q = arguments[u];
          if (q)
              for (var t in q)
                  $jscomp.owns(q, t) && (v[t] = q[t])
      }
      return v
  }
  ;
  $jscomp.polyfill("Set", function(v) {
      function z() {
          if ($jscomp.ASSUME_NO_NATIVE_SET || !v || "function" != typeof v || !v.prototype.entries || "function" != typeof Object.seal)
              return !1;
          try {
              var q = Object.seal({
                  x: 4
              })
                , t = new v($jscomp.makeIterator([q]));
              if (!t.has(q) || 1 != t.size || t.add(q) != t || 1 != t.size || t.add({
                  x: 4
              }) != t || 2 != t.size)
                  return !1;
              var B = t.entries()
                , m = B.next();
              if (m.done || m.value[0] != q || m.value[1] != q)
                  return !1;
              m = B.next();
              return m.done || m.value[0] == q || 4 != m.value[0].x || m.value[1] != m.value[0] ? !1 : B.next().done
          } catch (d) {
              return !1
          }
      }
      ...
      ;
      u.prototype.has = function(q) {
          return this.map_.has(q)
      }
      ;
      ...
      u.prototype.forEach = function(q, t) {
          var B = this;
          this.map_.forEach(function(m) {
              return q.call(t, m, m, B)
          })
      }
      ;
      return u
  ...
  (function(v) {
      function z(q) {
          ...
          v[q].call(t.exports, t, t.exports, z);
          t.l = !0;
          return t.exports
      }
      var u = {};
      ...
      z.c = u;
      z.d = function(q, t, B) {
          z.o(q, t) || Object.defineProperty(q, t, {
              enumerable: !0,
              get: B
          })
      }
      ...
      z.t = function(q, t) {
          t & 1 && (q = z(q));
          if (t & 8 || t & 4 && "object" === typeof q && q && q.__esModule)
              return q;
      ...
      var q = u(2)
        , t = function(p, f) {
          Object(q.a)("disableLogs") || (f ? console.warn(p + ": " + f) : console.warn(p))
      }
        , B = function(p, f) {
          Object(q.a)("disableLogs") || (f ? console.log(p + ": " + f) : console.log(p))
      }
        , m = function(p) {
          if (!Object(q.a)("disableLogs"))
              throw console.error(p),
              Error(p);
      }
        , d = function(p, f) {}
        , k = function(p, f) {}
  ...
  , function(v, z, u) {
      ...
      var q = u(14)
        ...
        , k = function() {
          var g = Object(q.a)(location.search);
          d("1" === g.disableLogs)
      }
        , p = function(g) {
        ...
        , l = function(g, x) {
          x ? console.warn(g + ": " + x) : console.warn(g)
      }
  }
  , function(v, z, u) {
      u.d(z, "a", function() {
      ...
      var q = {}
        ...
        , m = function(d, k) {
          var p;
          t[d] = k;
          null === (p = q[d]) || void 0 === p ? void 0 : p.forEach(function(f) {
              f(k)
          })
      }
  }
  , function(v, z, u) {
      ...
      var q = u(11)
        ...
        , p = !1
        , f = function(c, h) {
          p || (k(d.basePath + "decode.min.js"),
          p = !0);
          c = self.BrotliDecode(Object(m.b)(c));
          return h ? c : Object(m.a)(c)
      }
        , l = function(c, h) {
          return Object(q.a)(void 0, void 0, Promise, function() {
              var e;
              return Object(q.b)(this, function(w) {
                  switch (w.label) {
                  case 0:
                      return p ? [3, 2] : [4, Object(B.a)(self.Core.getWorkerPath() + "external/decode.min.js", "Failed to download decode.min.js", window)];
                  case 1:
                      w.sent(),
                      p = !0,
                      w.label = 2;
                  case 2:
                      return e = self.BrotliDecode(Object(m.b)(c)),
                      [2, h ? e : Object(m.a)(e)]
                  }
              })
          })
      ...
      (function() {
          ...
          c.prototype.GetNextChunk = function(h) {
              this.decodeFunction || (this.decodeFunction = 0 === h[0] && 97 === h[1] && 115 === h[2] && 109 === h[3] ? this.processRaw : this.processBrotli);
      ...
      var g = !1
        , x = function(c) {
          g || (k(d.basePath + "pako_inflate.min.js"),
          g = !0);
          var h = 10;
          if ("string" === typeof c) {
              if (c.charCodeAt(3) & 8) {
        ...
        , r = function(c) {
          ...
          var D = function() {
              ...
              Object(t.a)("worker", "Result length is " + J.length);
              J.length < c.compressedMaximum ? (J = c.decompressFunction(J, c.shouldOutputArray),
              Object(t.e)("There may be some degradation of performance. Your server has not been configured to serve .gz. and .br. files with the expected Content-Encoding. See https://docs.apryse.com/documentation/web/faq/content-encoding/ for instructions on how to resolve this."),
              k && Object(t.a)("worker", "Decompressed length is " + J.length)) : h && (J = Object(m.a)(J));
              k && Object(t.a)("worker", c.url + " Decompression took " + (Date.now() - F));
              return J
          };
          if (c.isAsync)
              var A = new Promise(function(F, J) {
                  e.onload = function() {
                      200 === this.status || 0 === this.status ? F(D()) : J("Download Failed " + c.url)
                  }
                  ;
                  e.onerror = function() {
        ...
        , y = function(c) {
          ...
          k || (e.endsWith(".js.mem") ? e = e.replace(".js.mem", ".mem") : e.endsWith(".js") && (e = e.concat(".mem")));
        ...
        , H = function(c, h) {
          c.endsWith(".js.mem") ? c = c.slice(0, -4) : c.endsWith(".mem") && (c = c.slice(0, -4) + ".js.mem");
          h.url = c;
          h.decompressFunction = n;
          return r(h)
      }
        , G = function(c, h, e, w) {
  ...
  , function(v, z, u) {
      ...
      var q = function(B) {
          if ("string" === typeof B) {
              for (var m = new Uint8Array(B.length), d = B.length, k = 0; k < d; k++)
                  m[k] = B.charCodeAt(k);
              return m
          }
          return B
        ...
        , t = function(B) {
          if ("string" !== typeof B) {
              for (var m = "", d = 0, k = B.length, p; d < k; )
                  p = B.subarray(d, d + 1024),
                  d += 1024,
                  m += String.fromCharCode.apply(null, p);
              return m
          }
          return B
      }
  ...
  , function(v, z, u) {
      ...
      var q = "undefined" === typeof window ? self : window;
      v = function() {
          var n = navigator.userAgent.toLowerCase();
          return (n = /(msie) ([\w.]+)/.exec(n) || /(trident)(?:.*? rv:([\w.]+)|)/.exec(n)) ? parseInt(n[2], 10) : n
      }();
      var t = function() {
          var n = q.navigator.userAgent.match(/OPR/)
            , r = q.navigator.userAgent.match(/Maxthon/)
            , y = q.navigator.userAgent.match(/Edge/);
          return q.navigator.userAgent.match(/Chrome\/(.*?) /) && !n && !r && !y
      }();
      (function() {
          if (!t)
              return null;
          var n = q.navigator.userAgent.match(/Chrome\/([0-9]+)\./);
          return n ? parseInt(n[1], 10) : n
      }
      )();
      var B = !!navigator.userAgent.match(/Edge/i) || navigator.userAgent.match(/Edg\/(.*?)/) && q.navigator.userAgent.match(/Chrome\/(.*?) /);
      (function() {
          if (!B)
              return null;
          var n = q.navigator.userAgent.match(/Edg\/([0-9]+)\./);
          return n ? parseInt(n[1], 10) : n
      }
      )();
      z = /iPad|iPhone|iPod/.test(q.navigator.platform) || "MacIntel" === navigator.platform && 1 < navigator.maxTouchPoints || /iPad|iPhone|iPod/.test(q.navigator.userAgent);
      var m = function() {
          var n = q.navigator.userAgent.match(/.*\/([0-9\.]+)\s(Safari|Mobile).*/i);
          return n ? parseFloat(n[1]) : n
      }()
        , d = /^((?!chrome|android).)*safari/i.test(q.navigator.userAgent) || /^((?!chrome|android).)*$/.test(q.navigator.userAgent) && z
        , k = q.navigator.userAgent.match(/Firefox/);
      (function() {
          if (!k)
              return null;
          var n = q.navigator.userAgent.match(/Firefox\/([0-9]+)\./);
          return n ? parseInt(n[1], 10) : n
      }
      )();
      v || /Android|webOS|Touch|IEMobile|Silk/i.test(navigator.userAgent);
      navigator.userAgent.match(/(iPad|iPhone|iPod)/i);
      q.navigator.userAgent.indexOf("Android");
      var p = /Mac OS X 10_13_6.*\(KHTML, like Gecko\)$/.test(q.navigator.userAgent)
        , f = q.navigator.userAgent.match(/(iPad|iPhone).+\sOS\s((\d+)(_\d)*)/i) ? 14 <= parseInt(q.navigator.userAgent.match(/(iPad|iPhone).+\sOS\s((\d+)(_\d)*)/i)[3], 10) : !1
        , l = !(!self.WebAssembly || !self.WebAssembly.validate)
        , g = -1 < q.navigator.userAgent.indexOf("Edge/16") || -1 < q.navigator.userAgent.indexOf("MSAppHost")
        , x = function() {
          return l && !g && !(!f && (d && 14 > m || p))
      }
  }
  , function(v, z, u) {
      function q(d) {
          "@babel/helpers - typeof";
          return q = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function(k) {
              return typeof k
          }
          : function(k) {
      ...
      var t, B, m;
      !function(d) {
          "object" === q(z) && "undefined" !== typeof v ? v.exports = d() : !(B = [],
          t = d,
          m = "function" === typeof t ? t.apply(z, B) : t,
          void 0 !== m && (v.exports = m))
      }(function() {
          return function l(k, p, f) {
              function g(r, y) {
                  if (!p[r]) {
                      if (!k[r]) {
                          if (x)
                              return x(r, !0);
                          y = Error("Cannot find module '".concat(r, "'"));
                      ...
                      k[r][0].call(y.exports, function(E) {
                          return g(k[r][1][E] || E)
                      }, y, y.exports, l, k, p, f)
                  }
                  return p[r].exports
              }
              for (var x = !1, n = 0; n < f.length; n++)
                  g(f[n]);
              return g
          }({
              1: [function(k, p, f) {
                  ...
                  f = function(x) {
                      function n(r) {
                          r || (r = {});
                          r.strategy || (r.strategy = BinaryHeapStrategy);
                          r.comparator || (r.comparator = function(y, E) {
                              return (y || 0) - (E || 0)
                          }
                          );
                          n.__super__.constructor.call(this, r)
                      }
                      g(n, x);
                      return n
                  }(f);
              ...
              3: [function(k, p, f) {
                  ...
                  p.exports = function() {
                      function g(x) {
                          ...
                          this.data = (null != (n = this.options.initialValues) ? n.slice(0) : void 0) || [];
                          this.data.sort(this.comparator).reverse()
                      }
                      g.prototype.queue = function(x) {
                          var n = l(this.data, x, this.comparator);
                          this.data.splice(n, 0, x)
                      }
                      ;
                      ...
                      g.prototype.find = function(x) {
                          var n = l(this.data, x, this.comparator) - 1;
                          return 0 <= n && !this.comparator(this.data[n], x) ? n : -1
                      }
                      ;
                      g.prototype.remove = function(x) {
                          x = this.find(x);
                          return 0 <= x ? (this.data.splice(x, 1),
                          !0) : !1
                      }
                      ;
                      g.prototype.removeAllMatching = function(x, n) {
                          for (var r = 0, y = this.data.length - 1; 0 <= y; --y)
                              if (x(this.data[y])) {
  ...
  , function(v, z, u) {
      (function(q) {
          ...
          var B = "undefined" !== typeof q && q || "undefined" !== typeof self && self || window
            , m = Function.prototype.apply;
          z.setTimeout = function() {
              return new t(m.call(setTimeout, B, arguments),clearTimeout)
          }
          ;
          z.setInterval = function() {
              return new t(m.call(setInterval, B, arguments),clearInterval)
          }
          ;
          ...
          z._unrefActive = z.active = function(d) {
              ...
              0 <= k && (d._idleTimeoutId = setTimeout(function() {
                  d._onTimeout && d._onTimeout()
              }, k))
          }
          ;
          u(23);
          z.setImmediate = "undefined" !== typeof self && self.setImmediate || "undefined" !== typeof q && q.setImmediate || this && this.setImmediate;
          z.clearImmediate = "undefined" !== typeof self && self.clearImmediate || "undefined" !== typeof q && q.clearImmediate || this && this.clearImmediate
      }
      ).call(this, u(10))
  }
  , function(v, z, u) {
      function q(B, m, d) {
          return new Promise(function(k) {
              ...
              ;
              p.src = B;
              d.document.getElementsByTagName("head")[0].appendChild(p)
          }
          )
      }
      u.d(z, "a", function() {
  ...
  , function(v, z, u) {
      function q(d, k, p) {
          function f(x) {
              g = g || Date.now();
              return x ? (Object(t.a)("load", "Try instantiateStreaming"),
              fetch(Object(B.a)(d)).then(function(n) {
                  return WebAssembly.instantiateStreaming(n, k)
              }).catch(function(n) {
                  Object(t.a)("load", "instantiateStreaming Failed " + d + " message " + n.message);
                  return f(!1)
              })) : Object(B.b)(d, p, !0, !0).then(function(n) {
                  l = Date.now();
                  Object(t.a)("load", "Request took " + (l - g) + " ms");
                  return WebAssembly.instantiate(n, k)
              })
          }
          var l, g;
          return f(!!WebAssembly.instantiateStreaming).then(function(x) {
              Object(t.a)("load", "WASM compilation took " + (Date.now() - (l || g)) + " ms");
              return x
          })
      }
      u.d(z, "a", function() {
  ...
  , function(v, z, u) {
      function q(B, m, d, k) {
          function p(f) {
              return f instanceof d ? f : new d(function(l) {
                  l(f)
              }
              )
          }
          return new (d || (d = Promise))(function(f, l) {
              ...
              function n(r) {
                  r.done ? f(r.value) : p(r.value).then(g, x)
              }
              n((k = k.apply(B, m || [])).next())
          }
          )
      }
      function t(B, m) {
          ...
          function k(n) {
              ...
              for (; p; )
                  try {
                      if (f = 1,
                      l && (g = n[0] & 2 ? l["return"] : n[0] ? l["throw"] || ((g = l["return"]) && g.call(l),
                      0) : l.next) && !(g = g.call(l, n[1])).done)
                          return g;
                      if (l = 0,
                      g)
                          n = [n[0] & 2, g.value];
                      ...
                      default:
                          if (!(g = p.trys,
                          g = 0 < g.length && g[g.length - 1]) && (6 === n[0] || 2 === n[0])) {
                              p = 0;
                              continue
                          }
                          if (3 === n[0] && (!g || n[1] > g[0] && n[1] < g[3]))
                              p.label = n[1];
                          else if (6 === n[0] && p.label < g[1])
                              p.label = g[1],
                              g = n;
          ...
          "function" === typeof Symbol && (x[Symbol.iterator] = function() {
              return this
          }
          ),
          x
  ...
  , function(v, z) {
      ...
      try {
          var l = "function" === typeof clearTimeout ? clearTimeout : q
      } catch (y) {
          l = q
      }
      var g = [], x = !1, n, r = -1;
      ...
      v.off = p;
      v.removeListener = p;
      v.removeAllListeners = p;
      v.emit = p;
      v.prependListener = p;
      v.prependOnceListener = p;
  ...
  , function(v, z, u) {
      z.a = function() {
          ArrayBuffer.prototype.slice || (ArrayBuffer.prototype.slice = function(q, t) {
              void 0 === q && (q = 0);
              void 0 === t && (t = this.byteLength);
              q = Math.floor(q);
              t = Math.floor(t);
              0 > q && (q += this.byteLength);
              0 > t && (t += this.byteLength);
              q = Math.min(Math.max(0, q), this.byteLength);
              t = Math.min(Math.max(0, t), this.byteLength);
              if (0 >= t - q)
                  return new ArrayBuffer(0);
              var B = new ArrayBuffer(t - q)
                , m = new Uint8Array(B);
              q = new Uint8Array(this,q,t - q);
              m.set(q);
              return B
          }
          )
  ...
  , function(v, z, u) {
      z.a = function(q) {
          var t = {};
          decodeURIComponent(q.slice(1)).split("&").forEach(function(B) {
              B = B.split("=", 2);
              t[B[0]] = B[1]
          });
          return t
      ...
      (function(q) {
          ...
          function p() {
              var H = "setImmediate$" + Math.random() + "$"
                , G = function(I) {
                  I.source !== g && I.source !== g.parent || "string" !== typeof I.data || 0 !== I.data.indexOf(H) || m(+I.data.slice(H.length))
              };
              g.addEventListener ? g.addEventListener("message", G, !1) : g.attachEvent("onmessage", G);
              E = function(I) {
                  g.postMessage(H + I, "*")
              }
          }
          ...
          var g = "undefined" === typeof window ? self : window, x = 1, n = {}, r = !1, y = g.document, E, C = Object.getPrototypeOf && Object.getPrototypeOf(g);
          C = C && C.setTimeout ? C : g;
          "[object process]" === {}.toString.call(g.process) ? d() : k() ? p() : y && "onreadystatechange"in y.createElement("script") ? f() : l();
          C.setImmediate = t;
          C.clearImmediate = B;
          z.a = {
              setImmediate: t,
  ...
  , function(v, z, u) {
      ...
      v = function() {
          function B(m, d) {
              ...
              this.actionHandler.console_log = [function(k) {
                  Object(q.d)(k)
              }
              ];
              this.actionHandler.console_error = [function(k) {
                  Object(q.c)(k)
              }
              ];
          ...
          B.prototype.on = function(m, d, k) {
              var p = this.actionHandler;
              p[m] && Object(q.c)('There is already an actionName called "' + m + '"');
              p[m] = [d, k]
          }
          ;
          ...
          B.prototype.sendWithPromise = function(m, d, k) {
              ...
              this.callbacksCapabilities[p] = d;
              try {
                  this.postMessage(m)
              } catch (f) {
                  d.reject(f)
          ...
          B.prototype.sendWithPromiseWithId = function(m, d, k) {
              d > this.callbackIndex && Object(q.c)("Can't reuse callbackId " + d + " lesser than callbackIndex " + this.callbackIndex);
              d in this.callbacksCapabilities && Object(q.c)("Can't reuse callbackId " + d + ". There is a capability waiting to be resolved. ");
              m = {
                  action: m,
                  data: k,
                  callbackId: d
          ...
          B.prototype.getPromise = function(m) {
              ...
              Object(q.c)("Cannot get promise for callback " + m)
          }
          ;
          B.prototype.cancelPromise = function(m) {
              if (m in this.callbacksCapabilities) {
                  ...
                  this.pdfnetActiveCommands.has(m) && this.pdfnetActiveCommands.delete(m);
                  d.reject({
                      type: "Cancelled",
                  ...
                  Object(q.b)("Cannot cancel callback " + m)
          }
          ;
          B.prototype.postMessage = function(m) {
              Object(t.a)("enableWorkerLogs") && Object(q.d)("PDFWorker", "Sent " + JSON.stringify(m));
              if (this.postMessageTransfers) {
                  var d = this.getTransfersArray(m);
                  this.comObj.postMessage(m, d)
              } else
                  this.comObj.postMessage(m)
          }
          ;
          B.prototype.getObjectTransfers = function(m, d) {
              var k = this;
              null !== m && "object" === typeof m && (m instanceof Uint8Array ? d.push(m.buffer) : m instanceof ArrayBuffer ? d.push(m) : Object.keys(m).forEach(function(p) {
                  m.hasOwnProperty(p) && k.getObjectTransfers(m[p], d)
              }))
          }
          ;
          ...
          B.prototype.handleMessage = function(m) {
              var d = this
                , k = m.data;
              Object(t.a)("enableWorkerLogs") && Object(q.d)("PDFWorker", "Received " + JSON.stringify(k));
              var p = this.actionHandler
              ...
              if (k.isReply)
                  ...
                  delete m[p],
                  l.has(p) && l.delete(p),
                  "error"in k ? f.reject(k.error) : f.resolve(k.data)) : Object(q.a)("Cannot resolve callback " + p);
              else if (k.action in p) {
                  var g = p[k.action];
                  k.callbackId ? Promise.resolve().then(function() {
                  ...
                  k.action in f ? (g = f[k.action],
                  k.callbackId ? g[0].call(g[1], k).then(function(x) {
                      d.postMessage({
                          isReply: !0,
                          callbackId: k.callbackId,
                          data: x
                      ...
                      d.sendError(x, k.callbackId);
                      d.nextAsync()
                  }) : g[0].call(g[1], k).then(function() {
                      d.nextAsync()
                  }, function() {
                      d.nextAsync()
                  })) : Object(q.c)("Unknown action from worker: " + k.action)
          }
          ;
          return B
      }();
  ...
  , function(v, z, u) {
      ...
      var q = u(3)
        ...
        , m = function() {
          function k(p) {
              var f = this;
              this.promise = p.then(function(l) {
                  f.response = l;
                  f.status = 200
              })
          }
          k.prototype.addEventListener = function(p, f) {
              this.promise.then(f)
          }
          ;
          return k
          ...
          if (Object(B.a)() && !f) {
            console.log("Validating license")
              ...
              self.Module.instantiateWasm = function(g, x) {
                ...
                console.log("Inside instantiateWasm:");
                console.log("g:", g);
                console.log("x:", x);

                  return Object(t.a)(k + "Wasm.wasm", g, p["Wasm.wasm"]).then(function(n) {
                      x(n.instance)
                  })
              ...
              f = Object(q.b)(k + "Wasm.js.mem", p["Wasm.js.mem"], !1, !1)
          } else {
              if (p.disableObjectURLBlobs) {
                  importScripts((self.Module.asmjsPrefix ? self.Module.asmjsPrefix : "") + k + ".js");
                  return
              }
              f = Object(q.b)((self.Module.asmjsPrefix ? self.Module.asmjsPrefix : "") + k + ".js.mem", p[".js.mem"], !1);
              var l = Object(q.c)((self.Module.memoryInitializerPrefixURL ? self.Module.memoryInitializerPrefixURL : "") + k + ".mem", p[".mem"], !0, !0);
  ...
  , function(v, z, u) {
      (function(q) {
          "undefined" === typeof q.crypto && (q.crypto = {
  ...
  , function(v, z, u) {
      (function(q, t) {
          ...
          (function(m) {
              ...
              ;
              var H = m.Promise
                , G = H && "resolve"in H && "reject"in H && "all"in H && "race"in H && function() {
                  var A;
                  new H(function(F) {
                      A = F
                  }
              ...
              "undefined" !== typeof exports && exports ? (exports.Promise = G ? H : C,
              exports.Polyfill = C) : "function" === typeof define && u(24) ? define(function() {
                  return G ? H : C
              }) : G || (m.Promise = C);
              var I = "pending", a = "sealed", b = "fulfilled", c = "rejected", h = function() {}, e = "undefined" !== typeof t ? t : setTimeout, w = [], D;
              C.prototype = {
                  constructor: C,
                  state_: I,
                  then_: null,
                  ...
                  then: function(A, F) {
                      ...
                      this.state_ === b || this.state_ === c ? k(f, A) : this.then_.push(A);
                      return A.then
                  },
                  "catch": function(A) {
              ...
              C.all = function(A) {
                  ...
                  return new this(function(F, J) {
                      ...
                      for (var K = [], P = 0, M = 0, O; M < A.length; M++)
                          (O = A[M]) && "function" === typeof O.then ? O.then(L(M), J) : K[M] = O;
                      P || F(K)
                  }
                  )
              }
              ...
              C.race = function(A) {
                  ...
                  return new this(function(F, J) {
                      for (var L = 0, K; L < A.length; L++)
                          (K = A[L]) && "function" === typeof K.then ? K.then(F, J) : F(K)
                  }
                  )
              }
              ;
              C.resolve = function(A) {
                  return A && "object" === B(A) && A.constructor === this ? A : new this(function(F) {
                      F(A)
                  }
                  )
              }
          ...
          )("undefined" !== typeof window ? window : "undefined" !== typeof q ? q : "undefined" !== typeof self ? self : void 0)
      }
  ...
  , function(v, z, u) {
      (function(q, t) {
          (function(B, m) {
              ...
              function l() {
                  var I = "setImmediate$" + Math.random() + "$"
                    , a = function(b) {
                      b.source === B && "string" === typeof b.data && 0 === b.data.indexOf(I) && k(+b.data.slice(I.length))
                  };
              ...
              if (!B.setImmediate) {
                  var r = 1, y = {}, E = !1, C = B.document, H, G = Object.getPrototypeOf && Object.getPrototypeOf(B);
                  G = G && G.setTimeout ? G : B;
                  "[object process]" === {}.toString.call(B.process) ? p() : f() ? l() : B.MessageChannel ? g() : C && "onreadystatechange"in C.createElement("script") ? x() : n();
                  G.setImmediate = function(I) {
                      "function" !== typeof I && (I = new Function("" + I));
                      for (var a = Array(arguments.length - 1), b = 0; b < a.length; b++)
                          a[b] = arguments[b + 1];
                      y[r] = {
                          callback: I,
                          args: a
          ...
          )("undefined" === typeof self ? "undefined" === typeof q ? this : q : self)
      }
      ).call(this, u(10), u(12))
  }
  , function(v, z) {
  ...
  , function(v, z, u) {
      (function(q) {
          ...
          q.CancellablePromise = function(B, m) {
              var d = !1, k, p = new Promise(function(f, l) {
                  k = function() {
                      d || (m(),
                      l("cancelled"))
                  }
                  ;
                  (new Promise(B)).then(function(g) {
                      d = !0;
                      f(g)
                  }, function(g) {
                      d = !0;
          ...
          ;
          q.CancellablePromise.all = function(B) {
              var m = Promise.all(B);
              return t(m, function() {
  ...
  , function(v, z, u) {
      (function(q, t) {
          function B(p) {
              "@babel/helpers - typeof";
              return B = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function(f) {
                  return typeof f
              }
              : function(f) {
          ...
          function d(p) {
              for (var f = 1; f < arguments.length; f++) {
                  ...
                  f % 2 ? m(Object(l), !0).forEach(function(g) {
                      var x = l[g];
                  ...
                  }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(p, Object.getOwnPropertyDescriptors(l)) : m(Object(l)).forEach(function(g) {
                      Object.defineProperty(p, g, Object.getOwnPropertyDescriptor(l, g))
                  })
              }
              return p
          }
          ...
          (function(p) {
              p.Module = {
                  ...
                  postProgressiveRenderingStartEvent: function(f, l) {
                      Module.postEvent(f, "progressiveRenderingStart", {
                          pageNum: l
                      })
                  },
                  postPagesUpdatedEvent: function(f, l, g, x) {
                      ...
                      if (g)
                          for (var n = 0; n < g.length; ++n)
                              g[n]in f.pageDimensions ? (f.pageDimensions[g[n]].contentChanged = !0,
                              x && (f.pageDimensions[g[n]].annotationsUnchanged = !0)) : console.warn("Invalid Page Number ".concat(g[n]));
                  ...
                  postPagesRenamedEvent: function(f, l) {
                      ...
                      for (var x = 1; Module.IteratorHasNext(f); ++x) {
                          var n = Module.stackSave()
                            , r = Module.IteratorCurrent(f);
                          g[x] = Module.PageGetId(r);
                          Module.IteratorNext(f);
                          Module.stackRestore(n)
                      }
                      Module.postEvent(l, "pagesRenamed", {
                          pageNumToId: g
                      })
                  },
                  ...
                  GetPageDimensionsRange: function(f, l, g) {
                      for (var x = {}, n = Module.PDFDocGetPageIterator(f, l); l < g && Module.IteratorHasNext(n); ++l) {
                          var r = Module.stackSave()
                            , y = Module.IteratorCurrent(n);
                  ...
                  GetPageDimensionsContentChangedList: function(f, l) {
                      ...
                      for (var g = {}, x = l[0], n = l[l.length - 1], r = 0, y = Module.PDFDocGetPageIterator(f, x); x <= n && Module.IteratorHasNext(y); ++x) {
                          if (l[r] == x) {
                              for (++r; l[r] == x; )
                                  ++r;
                  ...
                  GetPageDimensions: function(f) {
                      try {
                          ...
                          if (0 === g)
                              throw "This document has no pages.";
                  ...
                  loadDoc: function(f, l) {
                      ...
                      try {
                          ...
                          f.customHandlerId && Module._TRN_PDFNetAddPDFTronCustomHandler(f.customHandlerId);
                          l = Module.CreateDoc(f, l);
                          var n = Module.GetDoc(l);
                          if (Module.PDFDocInitSecurityHandler(n))
                              return {
                                  docId: l,
                                  pageDimensions: Module.GetPageDimensions(n)
                              };
                          g = {
                              type: "NeedsPassword",
                              errorData: {
                  ...
                  loadCanvas: function(f, l, g, x, n, r, y, E) {
                      return new Promise(function(C, H) {
                          var G = Module.GetDoc(f)
                            , I = l + 1
                            , a = function() {
                              C(Module.RasterizePage(G, I, g, x, r, n, y, E, f))
                          }
                          ...
                          if (b) {
                              ...
                              c = function() {
                                  ...
                                  Module.loadPromise = e.then(function() {
                  ...
                  onRuntimeInitialized: function() {
                      ...
                      (function(f) {
                          f.PDFDocExportXFDF = function(l, g) {
                              ...
                              var x = Module.stackSave();
                              try {
                                  var n = g ? Module.PDFDocFDFExtract(l, g) : Module.PDFDocFDFExtract(l);
                                  var r = Module.FDFDocSaveAsXFDF(n);
                                  Module.stackRestore(x)
                              } catch (y) {
                                  throw Module.stackRestore(x),
                                  y;
                              }
                              return r
                          }
                          ...
                          f.PageArrayToPageSet = function(l) {
                              ...
                              try {
                                  ...
                                  for (var n = 0; n < l.length; ++n)
                                      Module.PageSetAddPage(x, l[n]);
                                  Module.stackRestore(g)
                              } catch (r) {
                                  throw Module.stackRestore(g),
                                  r;
                              }
                              return x
                          }
                          ...
                          f.cancelCurrent = function() {
                              ...
                              return l ? (l.cancel(),
                              l.cancelled = !0) : (l = Module.cleanupState) ? (q(l.timeout),
                          ...
                          f.XFDFMerge = function(l, g, x) {
                              if (g) {
                                  var n = Module.GetDoc(l)
                                    , r = [];
                                  try {
                                      Object(k.b)("worker", "Merge XFDF of length ".concat(g.length));
                                      ...
                                      var H = Module.PDFDocFDFUpdate(n, C, x);
                                      H && H.length && Module.postEvent(l, "apRefChanged", {
                                          apRefChanges: H
                                      })
                                  } finally {
                                      r.reverse().forEach(function(G) {
                                          G()
                                      })
                                  }
                              }
                          ...
                          f.ReadBufferFile = function(l, g) {
                              ...
                              g && (Module.docs[l].buffer = new Uint8Array(x.buffer.slice(0)));
                              return x
                          }
                          ;
                          ...
                          f.SaveHelper = function(l, g, x) {
                              ...
                              Module.MakeDev(g);
                              var n = Module._TRN_PDFDocSave(l, Module.GetUStringFromJSString(g), x, 0);
                          ...
                          ;
                          f.SaveDoc = function(l, g, x, n, r, y, E, C, H) {
                              return new Promise(function(G, I) {
                                  ...
                                  try {
                                      ...
                                      if (y) {
                                          h = function(N) {
                                              N = new Uint8Array(N);
                                              p.FS.writeFile("watermarkFile", N);
                                              N = Module.ImageCreateFromFile(b, Module.GetUStringFromJSString("watermarkFile"));
                                              p.FS.unlink("watermarkFile");
                                              return N
                                          }
                                          ;
                                              ...
                                              for (e = -1; Module.IteratorHasNext(F); ) {
                                                  ...
                                                  try {
                                                      ...
                                                      var M = Module.PageGetPageInfo(J)
                                                        , O = Module.ElementBuilderCreateImage(w, K, 0, 0, M.width, M.height);
                                                      Module.ElementWriterBegin(D, J);
                                                      Module.ElementWriterWritePlacedElement(D, O);
                                                      Module.ElementWriterEnd(D)
                                                  } catch (N) {
                                                      console.warn("Watermark for page " + L + "can not be added due to error: " + N)
                                                  }
                                              }
                                          } catch (N) {
                                      ...
                                      if (C) {
                                          ...
                                          R && (Module.SecurityHandlerChangeUserPasswordUString(R, C),
                                          Module.PDFDocSetSecurityHandler(b, R))
                                      }
                                      A = 0;
                                      if (n) {
                                          var Q = Module.PDFDocGetRoot(b);
                                          (A = Module.ObjFindObj(Q, "OpenAction")) && Module.ObjPut(Q, "__OpenActionBackup__", A);
                                          var S = Module.ObjPutDict(Q, "OpenAction");
                                          Module.ObjPutName(S, "Type", "Action");
                                          Module.ObjPutName(S, "S", "JavaScript");
                                          Module.ObjPutString(S, "JS", "this.print()")
                                      }
                                      var T = Module.SaveHelper(b, l, r);
                                      n && (A ? Module.ObjPut(Q, "OpenAction", Module.ObjFindObj(Q, "__OpenActionBackup__")) : Module.ObjErase(Q, "OpenAction"));
                          ...
                          ;
                          f.SaveDocFromFixedElements = function(l, g, x, n, r, y) {
                              l = Module.PDFDocCreateFromLayoutEls(l);
                              l = Module.CreateDoc({
                                  type: "ptr",
                                  value: l
                              });
                              return Module.SaveDoc(l, g, !0, !1, x, n, r, y)
                          }
                          ;
                          f.GetCurrentCanvasData = function(l) {
                              ...
                              if (g.bufPtr) {
                                  ...
                                  for (var n = 0, r = 0; r < g.out_height; ++r)
                                      for (var y = g.bufPtr + g.stride * r, E = 0; E < g.out_width; ++E)
                                          l[n++] = Module.HEAPU8[y + 2],
                                          l[n++] = Module.HEAPU8[y + 1],
                                          l[n++] = Module.HEAPU8[y],
                                          l[n++] = Module.HEAPU8[y + 3],
                                          y += 4
                              } else
                                  l = Module.ReadBufferFile("b", l);
                              Object(k.b)("bufferTiming", "Copy took ".concat(Date.now() - x));
                              return {
                                  pageBuf: l.buffer,
                              ...
                              return new Promise(function(G, I) {
                                  ...
                                  try {
                                      ...
                                      if (E) {
                                          ...
                                          0 !== D && (REX(Module._TRN_PDFRasterizerSetOCGContext(a.rast, D)),
                                          b.push(function() {
                                              Module._TRN_OCGContextDestroy(D)
                                          }))
                                      }
                                      var A = !1;
                                      C.hasOwnProperty("renderAnnots") ? (C.renderAnnots && (A = !0),
                                      REX(Module._TRN_PDFRasterizerSetDrawAnnotations(a.rast, C.renderAnnots ? 1 : 0))) : REX(Module._TRN_PDFRasterizerSetDrawAnnotations(a.rast, 0));
                                      C.hasOwnProperty("highlightFields") && (C.highlightFields && (A = !0),
                                      REX(Module._TRN_PDFRasterizerSetHighlightFields(a.rast, C.highlightFields)));
                                      C.hasOwnProperty("antiAliasing") && REX(Module._TRN_PDFRasterizerSetAntiAliasing(a.rast, C.antiAliasing));
                                      C.hasOwnProperty("pathHinting") && REX(Module._TRN_PDFRasterizerSetPathHinting(a.rast, C.pathHinting));
                                      if (C.hasOwnProperty("thinLinePixelGridFit")) {
                                          var F = !0;
                                          C.hasOwnProperty("thinLineStrokeAdjust") && (F = C.thinLineStrokeAdjust);
                                          REX(Module._TRN_PDFRasterizerSetThinLineAdjustment(a.rast, C.thinLinePixelGridFit, F))
                                      } else
                                          C.hasOwnProperty("thinLineStrokeAdjust") && REX(Module._TRN_PDFRasterizerSetThinLineAdjustment(a.rast, !1, C.thinLineStrokeAdjust));
                                      C.hasOwnProperty("thinLineScaling") && REX(Module._TRN_PDFRasterizerSetThinLineScaling(a.rast, C.thinLineScaling));
                                      C.hasOwnProperty("imageSmoothing") ? (F = !1,
                                      C.hasOwnProperty("hqImageResampling") && (F = C.hqImageResampling),
                                      REX(Module._TRN_PDFRasterizerSetImageSmoothing(a.rast, C.imageSmoothing, F))) : C.hasOwnProperty("hqImageResampling") && REX(Module._TRN_PDFRasterizerSetImageSmoothing(a.rast, !0, C.hqImageResampling));
                                      C.hasOwnProperty("caching") && REX(Module._TRN_PDFRasterizerSetCaching(a.rast, C.caching));
                                      C.hasOwnProperty("expGamma") && REX(Module._TRN_PDFRasterizerSetGamma(a.rast, C.expGamma));
                                      C.hasOwnProperty("isPrinting") && (C.isPrinting && (A = !0),
                                      REX(Module._TRN_PDFRasterizerSetPrintMode(a.rast, C.isPrinting)));
                                      C.hasOwnProperty("colorPostProcessMode") && (C.colorPostProcessMode && (A = !0),
                                      REX(Module._TRN_PDFRasterizerSetColorPostProcessMode(a.rast, C.colorPostProcessMode)));
                                      var J = Module.PageGetRotation(h);
                                      F = 1 === y || 3 === y;
                                      J = (1 === J || 3 === J) !== F;
                                      var L = Module.allocate(48, "i8", Module.ALLOC_STACK);
                                      if (r) {
                                          r.x1 = r[0];
                                          r.y1 = r[1];
                                          r.x2 = r[2];
                                          r.y2 = r[3];
                                          var K = Module.PageGetDefaultMatrix(h, 0)
                                            , P = Module.Matrix2DInverse(K);
                                          r = Module.Matrix2DMultBBox(P, r);
                                          if (r.x2 < r.x1) {
                                              var M = r.x1;
                                              r.x1 = r.x2;
                                              r.x2 = M
                                          ...
                                          r.y1 = r.y2,
                                          r.y2 = M);
                                          var O = a.out_width / (J ? r.y2 - r.y1 : r.x2 - r.x1);
                                          var R = Module.GetDefaultMatrixBox(h, r, y)
                                      } else
                                          R = Module.PageGetDefaultMatrix(h, y),
                                          O = a.out_width / (F ? w : e);
                                      Module.Matrix2DSet(L, O, 0, 0, O, 0, 0);
                                      Module.Matrix2DConcat(L, R);
                                      var Q = Module.allocate(4, "i8", Module.ALLOC_STACK)
                                        , S = Module.allocate(4, "i8", Module.ALLOC_STACK);
                                      A ? (a.bufPtr = Module._malloc(a.buf_size),
                                      Module._memset(a.bufPtr, C.pageTransparent ? 0 : 255, a.buf_size),
                                      b.push(function() {
                                      ...
                                      var T = C.overprintMode;
                                      if (10 === T) {
                                          REX(Module._TRN_PDFRasterizerSetOverprint(a.rast, 1));
                                          var U = Module.PDFRasterizerRasterizeSeparations(a.rast, h, a.out_width, a.out_height, L, 0, 0);
                                          G({
                                              pageBuf: U,
                                          ...
                                          REX(Module._TRN_PDFRasterizerSetOverprint(a.rast, T));
                                          A ? REX(Module._TRN_PDFRasterizerGetChunkRenderer(a.rast, h, a.bufPtr, a.out_width, a.out_height, a.stride, 4, !0, L, 0, 0, 0, Q)) : REX(Module._TRN_PDFRasterizerGetChunkRendererPath(a.rast, h, Module.GetUStringFromJSString("b"), a.out_width, a.out_height, !0, L, 0, 0, 0, Q));
                                          var N = Module.getValue(Q, "i8*");
                                          b.push(function() {
                                              REX(Module._TRN_ChunkRendererDestroy(N))
                                          })
                                      }
                                      var V = (new Date).getTime();
                                      C.useProgress && Module.postProgressiveRenderingStartEvent(H, g);
                                      var aa = t(function W() {
                                          try {
                                              if (REX(Module._TRN_ChunkRendererRenderForTimePeriod(N, 200, S)),
                                              Module.getValue(S, "i8"))
                                                  Module.cleanupState.timeout = t(W);
                                              else {
                                                  var Y = Module.GetCurrentCanvasData(!1);
                                                  Object(k.b)("worker", "Total Page Time ".concat((new Date).getTime() - V));
                          ...
                          f.UpdatePassword = function(l, g) {
                              try {
                                  var x = Module.stackSave();
                                  var n = Module.GetDoc(l);
                                  return Module.PDFDocInitStdSecurityHandler(n, g) ? (n in downloadDataMap && REX(Module._TRN_PDFDocDownloaderInitialize(n, downloadDataMap[n].downloader)),
                                  {
                                      success: !0,
                                      pageDimensions: Module.GetPageDimensions(n)
                                  }) : {
                          ...
                          f.UpdateCustomHeader = function(l, g) {
                              Module.customHeadersMap[l] = l in Module.customHeadersMap ? d(d({}, Module.customHeadersMap[l]), g) : g
                          }
                          ;
                          f.TriggerFullDownload = function(l) {
                              return new Promise(function(g, x) {
                                  var n = Module.GetDoc(l);
                                  try {
                                      n in downloadDataMap && REX(Module.PDFDocDownloaderTriggerFullDownload(n, downloadDataMap[n].downloader)),
                                      g({})
                                  } catch (r) {
                                      x(r)
                                  }
                          ...
                          ;
                          f.InsertBlankPages = function(l, g, x, n) {
                                  ...
                                  try {
                                      ...
                                      for (var G = g.length - 1; 0 <= G; --G) {
                                          var I = Module.PDFDocGetPageIterator(C, g[G])
                                            , a = Module.PDFDocPageCreate(C, x, n);
                          ...
                          ;
                          f.InsertPages = function(l, g, x, n, r, y) {
                              return new Promise(function(E, C) {
                                  ...
                                  try {
                                      ...
                                      if (g instanceof ArrayBuffer) {
                                          ...
                                          b = Module.GetDoc(g);
                                      for (var c = x.length, h = Module.PageSetCreate(), e = 0; e < c; ++e)
                                          Module.PageSetAddPage(h, x[e]);
                                      y ? Module.PDFDocInsertPages2(G, n, b, h, r) : Module.PDFDocInsertPages(G, n, b, h, r);
                                      var w;
                          ...
                          f.MovePages = function(l, g, x) {
                              return new Promise(function(n, r) {
                                  ...
                                  try {
                                      ...
                                      ;
                                      for (var H = g.length, G = Module.PageSetCreate(), I = 0; I < H; ++I)
                              ...
                              return new Promise(function(n, r) {
                                  ...
                                  try {
                                      ...
                                      for (var H = g.length - 1; 0 <= H; --H) {
                                          ...
                                          Module.IteratorHasNext(G) && (x ? Module.PDFDocPageRemove2(y, G) : Module.PDFDocPageRemove(y, G))
                                      }
                                      var I;
                          ...
                          f.RotatePages = function(l, g, x) {
                              return new Promise(function(n, r) {
                                  ...
                                  try {
                                      ...
                                      for (var b = g[0]; Module.IteratorHasNext(I) && G < g[H - 1]; ++b) {
                                          if (b === g[G]) {
                          ...
                          ;
                          f.ExtractPages = function(l, g, x, n, r, y) {
                              return new Promise(function(E, C) {
                                  var H = [];
                                  try {
                                      var G = Module.stackSave();
                                      ...
                                      Module.XFDFMerge(l, x, r);
                                      var a = Module.CreateEmptyDoc();
                                      H[H.length] = function() {
                                          Module.DeleteDoc(a)
                                      }
                                      ;
                                      var b = Module.InsertPages(a, l, g, 1, !0, y).then(function() {
                                          return Module.SaveDoc(a, void 0, !0, !1, void 0, n)
                                      }).then(function(c) {
                                          H.reverse().forEach(function(h) {
                                              h()
                                          });
                          ...
                          ;
                          f.CropPages = function(l, g, x, n, r, y) {
                              return new Promise(function(E, C) {
                                  ...
                                  try {
                                      ...
                                      for (var h = [], e = g[0]; Module.IteratorHasNext(c) && b < g[a - 1]; ++e) {
                                          if (e === g[b]) {
                                              ...
                                              0 === A % 4 ? (Module.setValue(D, F + r, "double"),
                                              Module.setValue(D + 8, J + n, "double"),
                                              Module.setValue(D + 16, L - y, "double"),
                                              Module.setValue(D + 24, K - x, "double")) : 1 === A % 4 ? (Module.setValue(D, F + x, "double"),
                                              Module.setValue(D + 8, J + r, "double"),
                                              Module.setValue(D + 16, L - n, "double"),
                                              Module.setValue(D + 24, K - y, "double")) : 2 === A % 4 ? (Module.setValue(D, F + y, "double"),
                                              Module.setValue(D + 8, J + x, "double"),
                                              Module.setValue(D + 16, L - r, "double"),
                                              Module.setValue(D + 24, K - n, "double")) : 3 === A % 4 && (Module.setValue(D, F + n, "double"),
                                              Module.setValue(D + 8, J + y, "double"),
                                              Module.setValue(D + 16, L - x, "double"),
                                              Module.setValue(D + 24, K - r, "double"));
                                      ...
                                      var P = Module.postPagesUpdatedEvent(H, l, h, !0);
  ...
  , function(v, z, u) {
      (function(q) {
          function t(d) {
              "@babel/helpers - typeof";
              return t = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function(k) {
                  return typeof k
              }
              : function(k) {
                  return k && "function" == typeof Symbol && k.constructor === Symbol && k !== Symbol.prototype ? "symbol" : typeof k
          ...
          (function(d) {
              ...
              var g = function(a, b, c, h, e) {
                  ...
                  return CancellablePromise(function(D, A) {
                      w.open("GET", a, !0);
                      ...
                      h && Object.keys(h).forEach(function(J) {
              ...
              x.prototype = {
                  ...
                  insert: function(a, b) {
                      this.lruList.length >= this.maxChunkNum && (delete this.chunkMap[this.lruList[0]],
                      this.lruList.shift());
                      this.lruList.push(b);
                      this.chunkMap[b] = a
                  },
              ...
              n.prototype = {
                  read: function(a, b, c) {
                      ...
                      a = a.subarray(b, b + c);
                      b = c;
                      for (var h = this.filePosition % this.chunkSize, e = this.filePosition - h, w = 0; 0 < c; ) {
                          if (this.chunkCache.has(e))
                              var D = this.chunkCache.get(e);
                          else
                              D = new Int8Array(this.reader.readAsArrayBuffer(this.file.slice(e, e + this.chunkSize))),
                              this.chunkCache.insert(D, e);
                          var A = D.length
                            , F = h + c;
                          F <= A ? (a.set(D.subarray(h, F), w),
                          this.filePosition += c,
                          c = 0) : (a.set(D.subarray(h), w),
              ...
              var y = function(a, b, c, h, e) {
                  "object" === t(a) ? (this.lruList = a.lruList,
                  this.chunkMap = a.chunkMap,
                  this.length = a.length,
                  this.url = a.url,
                  this.customHeaders = a.customHeaders,
                  this.withCredentials = a.withCredentials) : (this.lruList = [],
                  this.chunkMap = {},
                  this.chunkMap[b] = e,
                  this.length = b,
                  this.url = a,
              ...
              y.prototype = {
                  ...
                  getChunk: function(a) {
                      ...
                      if (this.chunkMap[a])
                          ...
                          this.customHeaders && Object.keys(this.customHeaders).forEach(function(e) {
                          ...
                          if (200 === h.status || 206 === h.status)
                              ...
                              throw Error("Failed to load data from");
                      }
                      return this.chunkMap[a]
                  },
                  hadChunk: function(a) {
                      ...
                      try {
                          ...
                          if (w) {
                              ...
                              for (a = 0; a < w; ++a) {
                                  ...
                                  this.hasChunk(A) ? c.have.push(A) : this.hadChunk(A) ? c.missing.push(A) : c.downloading.push(A)
                              }
                          }
                      } finally {
                          D && Module._free(D),
                  ...
                  keepVisibleChunks: function(a, b) {
                      for (var c = b.length, h = Module.chunkMax / 2, e = 0, w = 0; w < c; ++w) {
                  ...
                  getChunkAsync: function(a) {
                      ...
                      return g(this.url, a, h, this.customHeaders, this.withCredentials).then(function(e) {
                          b.writeChunk(e, a)
                      })
                  },
                  ...
                  writeChunk: function(a, b, c) {
                      ...
                      1048576 !== e || a.buffer.byteLength !== e ? (w ? (h = this.lruList.shift(),
                      w = this.chunkMap[h],
                      1048576 > w.length && (w = new Int8Array(1048576)),
                      this.chunkMap[h] = null) : w = h ? this.chunkMap[b] : new Int8Array(1048576),
                      w.subarray(c, c + e).set(a),
                      a = w) : w && (h = this.lruList.shift(),
              ...
              E.prototype = {
                  ...
                  write: function(a, b, c) {
                      var h = this.position + c <= this.length
                        , e = this.position + c <= this.length ? c : this.length - this.position
                        , w = a.subarray(b, b + e)
              ...
              var H = {
                  ...
                  open: function(a) {
                      ...
                      this.IsSink(a) ? (a.provider = new C(b),
                      Module.docs[b].sink = a.provider) : a.provider = Module.docs[b].sink ? new r(Module.docs[b].sink.data) : Module.docs[b].chunkStorage ? new E(Module.docs[b].chunkStorage) : Module.docs[b].buffer ? new r(Module.docs[b].buffer) : new n(Module.docs[b].file)
                  },
                  close: function(a) {
                      a.provider.close()
                  },
                  ...
                  llseek: function(a, b, c) {
                      ...
                      if (0 > b)
                          throw new FS.ErrnoError(m.ERRNO_CODES.EINVAL);
                      a.seek(b);
                      return b
                  },
              ...
              d.clearDocBackend = function() {
                  ...
                  Module.cachePtr = null) : Module.docs[d.currentFileString] && delete Module.docs[d.currentFileString]
              }
              ;
              ...
              var I = function(a, b, c) {
                  "object" === t(a) ? (this.m_pages = a.m_pages,
                  ...
                  this.requirePageCallbacks = a.requirePageCallbacks) : (this.m_pages = [],
              ...
              d.DownloaderHint = function(a, b) {
                  ...
                  if (b.visiblePages) {
                      ...
                      Object.keys(h.requirePageCallbacks).forEach(function(D) {
                          h.requirePageCallbacks.hasOwnProperty(D) && e.push(parseInt(D, 10))
                      });
                      (b = Module.docs[a].chunkStorage) && b.keepVisibleChunks(h.downloader, e);
                      a = e.length;
                      var w = Module.allocate(4 * a, "i8", Module.ALLOC_STACK);
                      for (b = 0; b < a; ++b)
                          Module.setValue(w + 4 * b, e[b], "i32");
              ...
              d.RequirePage = function(a, b) {
                  return new Promise(function(c, h) {
                      ...
                      !e || e.m_finished_download || e.m_pages[b] ? c() : (b in e.requirePageCallbacks ? e.requirePageCallbacks[b].push(c) : e.requirePageCallbacks[b] = [c],
              ...
              d.createCallbacksStruct = function(a) {
                  if (!l) {
                      var b = function(c) {
                          return function(h) {
                              var e = arguments;
                              h in downloadDataMap ? c.apply(this, e) : q(function() {
                      ...
                      l = {
                          downloadProc: Module.addFunction(function(c, h, e, w, D) {
                              ...
                              var A = w.docId;
                              g(w.url, h, e, Module.customHeadersMap[A], Module.withCredentials[A]).then(function(F) {
                                  A in Module.docs && Module.docs[A].chunkStorage && Module.docs[A].chunkStorage.writeChunk(F, h);
                                  Module._TRN_DownloadComplete(0, h, e, c)
                              })
                          }, "viiiii"),
                          notifyUpdatePage: Module.addFunction(b(function(c, h, e, w) {
                              var D = downloadDataMap[c];
                              D.m_pages[h] = !0;
                              var A = D.eventPageArray;
                              if (h in D.requirePageCallbacks)
                                  for (e = D.requirePageCallbacks[h],
                                  w = 0; w < e.length; ++w)
                                      e[w]();
                              D.timeout ? A.push(h) : (A = D.eventPageArray = [h],
                              D.timeout = setTimeout(function() {
                                  Module.postPagesDownloadedEvent(c, D.m_id, A);
                                  D.timeout = null
                              }, 100))
                          }), "viiii"),
                          notifyUpdateOutline: Module.addFunction(b(function(c, h) {
                              c = downloadDataMap[c];
                              c.m_has_outline || (c.m_has_outline = !0,
                              Module.postEvent(c.m_id, "bookmarksUpdated", {}))
                          }), "vii"),
                          notifyUpdateNamedDests: Module.addFunction(b(function(c, h) {
                              c = downloadDataMap[c];
                              c.m_has_named_dests || (c.m_has_named_dests = !0)
                          }), "vii"),
                          notifyUpdateThumb: Module.addFunction(b(function(c, h) {}), "viiii"),
                          notifyFinishedDownload: Module.addFunction(b(function(c, h) {
                              c = downloadDataMap[c];
                              c.m_finished_download || (c.m_finished_download = !0,
              ...
              d.CreateDocDownloaderBackend = function(a, b, c) {
                  ...
                  var F = a.downloadData ? new I(a.downloadData,h,c) : new I(a.size,h,c);
                  var J = Module.createCallbacksStruct(F.downloadUserData)
                    , L = Module.allocate(4, "i8", Module.ALLOC_STACK);
                  Module.MakeDev(c);
                  a.chunkStorage ? h = new y(a.chunkStorage) : (a = new Int8Array(new ArrayBuffer(Math.ceil((a.size + 1048576 - 1) / 1048576 / 8))),
                  h = new y(h,e,w,D,a));
                  Module.docs[c] = {
                      chunkStorage: h
                  };
                  REX(Module._TRN_DownloaderCreate(J, e, Module.GetUStringFromJSString(c), A, L));
                  F.downloader = Module.getValue(L, "i8*");
                  if (e = Module._TRN_PDFDocCreateFromFilter(F.downloader, b))
                      Module._TRN_FilterDestroy(F.downloader),
                      REX(e);
                  b = Module.getValue(b, "i8*");
                  Module.docs[c].ptr = b;
                  Module.PDFDocInitSecurityHandler(b) && REX(Module._TRN_PDFDocDownloaderInitialize(b, F.downloader));
                  downloadDataMap[b] = F
              }
              ;
                  ...
                  try {
                      if (c)
                          if ("ptr" === e)
                              ...
                              var A = "object" === t(c) && c.url;
                              e = h && "pdf" !== h;
                              if (A)
                                  d.CreateDocDownloaderBackend(c, w, b);
                              else {
                                  var F = c instanceof ArrayBuffer;
                                  A = F ? "buffer" : "file";
                                  if (F && (c = new Uint8Array(c),
                                  10485760 > c.length + k && !e)) {
                                      k += c.length;
                                      var J = c.length
                                  ...
                                  if (e) {
                                      if (a.pageSizes && a.pageSizes.length)
                                          ...
                                          a.defaultPageSize && (P = a.defaultPageSize);
                                      var M = Module.GetUStringFromJSString(b);
                                      REX(Module._TRN_PDFDocCreate(w));
                                      K = Module.getValue(w, "i8*");
                                      var O = Module.ImageCreateFromFile(K, M);
                                      Module.InsertImageIntoDoc(K, O, P)
                                  } else {
                                      var R = Module.allocate(Module.intArrayFromString(b), "i8", Module.ALLOC_STACK);
              ...
              d.ChangeDocBackend = function(a, b) {
                  var c = Module.docs[a];
                  c ? (c.bufPtr && c.ownership && (Module._free(c.bufPtr),
                  k -= c.bufPtrSize),
                  delete Module.docs[a]) : Object(B.d)("Trying to delete document ".concat(a, " that does not exist."));
                  Module.docs[a] = b
              }
              ;
              d.DeleteDoc = function(a) {
                  var b = Module.docs[a];
                  b ? (b.ptr && (b.ptr in downloadDataMap && (clearTimeout(downloadDataMap[b.ptr].timeout),
                  downloadDataMap[b.ptr].destroyUserData(),
                  delete downloadDataMap[b.ptr]),
                  Module.PDFDocDestroy(b.ptr)),
                  b.bufPtr && b.ownership && (Module._free(b.bufPtr),
                  k -= b.bufPtrSize),
                  delete Module.docs[a]) : Object(B.d)("Trying to delete document ".concat(a, " that does not exist."))
              }
              ;
              ...
              d.GetUStringFromJSString = function(a, b) {
                  var c = Module.allocate(4, "i8", Module.ALLOC_STACK)
                    , h = 2 * (a.length + 1)
                    , e = Module.allocate(h, "i8", b ? Module.ALLOC_NORMAL : Module.ALLOC_STACK);
              ...
              d.PDFRasterizerRasterizeSeparations = function(a, b, c, h, e, w, D) {
                  ...
                  REX(Module._TRN_PDFRasterizerRasterizeSeparations(a, b, c, h, e, w, D, A));
              ...
              d.GetDefaultMatrixBox = function(a, b, c) {
                  ...
                  switch (a) {
                  case 0:
                      return REX(Module._TRN_Matrix2DSet(c, 1, 0, 0, -1, -b.x1, b.y2)),
                      c;
                  case 1:
                      return REX(Module._TRN_Matrix2DSet(c, 0, 1, 1, 0, -b.y1, -b.x1)),
                      c;
                  case 2:
                      return REX(Module._TRN_Matrix2DSet(c, -1, 0, 0, 1, b.x2, -b.y1)),
                      c;
                  case 3:
                      return REX(Module._TRN_Matrix2DSet(c, 0, -1, -1, 0, b.y2, b.x2)),
                      c
                  }
              ...
              d.ElementBuilderCreateImage = function(a, b, c, h, e, w) {
                  ...
                  REX(Module._TRN_ElementBuilderCreateImageScaled(a, b, c, h, e, w, D));
              ...
              d.PDFDocFDFUpdate = function(a, b, c) {
                  if (c) {
                      for (var h = Object.keys(c), e = h.length, w = Module._malloc(8 * e), D = 0; D < e; ++D) {
                          var A = 8 * D
                            , F = h[D]
                            , J = Module.GetDoc(c[F]);
                      ...
                      REX(Module._TRN_PDFDocFDFUpdate(a, b))
              }
              ;
  ...
  , function(v, z, u) {
      function q(t) {
          "@babel/helpers - typeof";
          return q = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function(B) {
              return typeof B
          }
          : function(B) {
      ...
      (function(t) {
          t.SetupPDFNetFunctions = function(B) {
              Module._IB_ = [];
              for (var m = function E(y) {
                  if ("object" === q(y) && null !== y)
                  ...
                  "object" === q(E) && null !== E && (E.buffer ? E = E.buffer.slice(E.byteOffset, E.byteOffset + E.length) : E.isArrayBufferRef ? E = Module._IB_[E.handle].buffer : Object.keys(E).forEach(function(H) {
                      E.hasOwnProperty(H) && (E[H] = C(E[H]))
                  }));
                  return E
              }, k = Module._TRN_EMSCreateSharedWorkerInstance(), p, f = Module._TRN_EMSWorkerInstanceGetFunctionIterator(k), l = function(E, C) {
                  return new Promise(function(H, G) {
                      E = m(E);
                      var I = E.docId;
                      I = I ? Module.GetDoc(I) : 0;
                      (I = Module.EMSCallSharedFunction(k, C, I)) ? G({
                          type: "PDFWorkerError",
                          message: Module.GetErrToString(I)
                      }) : (G = Module.EMSGetLastResponse(k),
                      G = d(G),
                      H(G))
                  }
                  )
              }; p = Module._TRN_EMSFunctionIteratorGetNextCommandName(f); )
                  p = Module.GetJSStringFromCString(p),
                  t.queue.onAsync(p, l);
              ...
              if (Module._TRN_EMSCreatePDFNetWorkerInstance) {
                  ...
                  var x = function(r) {
                      if (r in Module.docPtrStringToIdMap)
                          return Module.docPtrStringToIdMap[r];
                      throw Error("Couldn't find document ".concat(r));
                  };
                  t.queue.onAsync("PDFDoc.RequirePage", function(r) {
                      return Module.RequirePage(x(r.docId), r.pageNum)
                  });
                  f("pdfDocCreateFromBuffer", function(r) {
                      r = Module.CreateDoc({
                          type: "array",
                          value: r.buf
                      });
                      var y = Module.GetDoc(r).toString(16);
                      Module.docPtrStringToIdMap[y] = r;
                      return y
                  });
                  f("PDFDoc.destroy", function(r) {
                      r = x(r.auto_dealloc_obj);
                      Module.DeleteDoc(r)
                  });
                  f("PDFDoc.saveMemoryBuffer", function(r) {
                      var y = x(r.doc);
                      return Module.SaveHelper(Module.GetDoc(y), y, r.flags).slice(0)
                  });
                  f("pdfDocCreate", function() {
                      var r = Module.CreateDoc({
                          type: "new"
                      })
                        , y = Module.GetDoc(r).toString(16);
                      Module.docPtrStringToIdMap[y] = r;
                      return y
                  });
                  f("GetPDFDoc", function(r) {
                      r = r.docId;
                      var y = Module.GetDoc(r).toString(16);
                      Module.docPtrStringToIdMap[y] = r;
                      return y
                  });
                  f("ExtractPDFNetLayersContext", function(r) {
                      var y = r.layers;
                      r = Module.GetDoc(r.docId);
                      var E = 0;
                      y ? E = Module.EMSCreateUpdatedLayersContext(r, y) : Module.PDFDocHasOC(r) && (y = Module.PDFDocGetOCGConfig(r),
                      E = Module.OCGContextCreate(y));
                      return E.toString(16)
                  });
                  var n = Module._TRN_EMSCreatePDFNetWorkerInstance();
                  f = Module._TRN_EMSWorkerInstanceGetFunctionIterator(n);
                  for (l = function(r) {
                      return new Promise(function(y, E) {
                          r = m(r);
                          var C = Module.EMSCallPDFNetFunction(n, r);
                          C ? E(Module.GetErrToString(C)) : (E = Module.EMSGetLastResponse(n),
                          E = d(E),
                          y(E))
                      }
                      )
                  ...
                  ; p = Module._TRN_EMSFunctionIteratorGetNextCommandName(f); )
                      if (p = Module.GetJSStringFromCString(p),
                      !g[p])
                          B.onAsync(p, l);
                  Module._TRN_EMSFunctionIteratorDestroy(f)
              }
  ...
  , function(v, z, u) {
      ...
      (function(f) {
          ...
          f.basePath = "../";
          var g = function() {
              var n = f.pdfWorkerPath || "";
              f.workerBasePath && (f.basePath = f.workerBasePath);
              console.log('Value for IsFUll: ', f.isFull);
              var r = f.isFull
                , y = r ? "full/" : "lean/";
                console.log('Value for full: ', r);
                // console.log('Value for lean: ', y);
              f.useOptimizedWorker && (y += p.a);


              var E = f.wasmDisabled
                , C = f.disableObjectURLBlobs;
              Object(k.c)();
              f.overriddenPdfWorkerPath && (n = f.overriddenPdfWorkerPath,
              f.basePath = "../",
              !Object(m.a)() || E) && (n = "");
              f.basePath = f.externalPath ? f.externalPath : f.basePath + "external/";
              Object(d.a)("".concat(n + y, "PDFNetC"), {
                  "Wasm.wasm": r ? 1E7 : 4E6,
                  "Wasm.js.mem": 1E5,
                  ".js.mem": 12E6,
                  ".mem": r ? 2E6 : 6E5,
          ...
          f.EmscriptenPDFManager.prototype = {
              OnInitialized: function(n) {
                  Module.loaded ? n() : (Module.initCb = function() {
                      n()
                  }
                  ,
              ...
              Initialize: function(n, r, y, E) {
                  n && (Module.TOTAL_MEMORY = n);
                  Module.memoryInitializerPrefixURL = r;
                  Module.asmjsPrefix = y;
                  f.basePath = E;
                  g()
              },
              shouldRunRender: function(n) {
                  return Module.ShouldRunRender(n.docId, n.pageIndex + 1)
              }
          };
          var x = {
              setup: function(n) {
                  function r(e) {
                      var w = e.data
                        , D = e.action;
                      var A = "GetCanvas" === D || "GetCanvasPartial" === D ? H.shouldRunRender(w) : !0;
                      if (A) {
                          l = e;
                          var F = e.asyncCallCapability;
                          Object(k.b)("Memory", "Worker running command: ".concat(D));
                          G.actionMap[D](w, e).then(function(J) {
                          ...
                          f.deferredQueue.queue(e),
                          C()
                  }
                  function y(e) {
                      e.asyncCallCapability = createPromiseCapability();
                      l || G.length ? G.queue(e) : r(e);
                      return e.asyncCallCapability.promise
                  }
                  function E(e) {
                      self.shouldResize && H.Initialize(e.options.workerHeapSize, e.options.pdfResourcePath, e.options.pdfAsmPath, e.options.parentUrl);
                      Module.chunkMax = e.options.chunkMax;
                      if (e.array instanceof Uint8Array) {
                          var w = 255 === e.array[0];
                          n.postMessageTransfers = w;
                          "response"in new XMLHttpRequest ? H.OnInitialized(function() {
                              f.SetupPDFNetFunctions(n);
                              b();
                              n.send("test", {
                                  supportTypedArray: !0,
                                  supportTransfers: w
                  ...
                  var H = new f.EmscriptenPDFManager, G, I = !1, a = !1;
                  Module.workerMessageHandler = n;
                  var b = function() {
                      I ? a || (n.send("workerLoaded", {}),
                      a = !0) : I = !0
                  };
                  H.OnInitialized(b);
                  (function() {
                      f.queue = G = new q.a({
                          strategy: q.a.ArrayStrategy,
                          comparator: function(e, w) {
                              return e.priority === w.priority ? e.callbackId - w.callbackId : w.priority - e.priority
                          }
                      });
                      f.deferredQueue = new q.a({
                          strategy: q.a.ArrayStrategy,
                          comparator: function(e, w) {
                              return e.priority === w.priority ? e.callbackId - w.callbackId : w.priority - e.priority
                          }
                  ...
                  G.onAsync("GetCanvas", function(e) {
                      Object(k.b)("workerdetails", "Run GetCanvas PageIdx: ".concat(e.pageIndex, " Width: ").concat(e.width));
                      Object(k.b)("Memory", "loadCanvas with potential memory usage ".concat(e.width * e.height * 8));
                      return Module.loadCanvas(e.docId, e.pageIndex, e.width, e.height, e.rotation, null, e.layers, e.renderOptions)
                  });
                  G.onAsync("GetCanvasPartial", function(e) {
                      Object(k.b)("Memory", "GetCanvasPartial with potential memory usage ".concat(e.width * e.height * 8));
                      return Module.loadCanvas(e.docId, e.pageIndex, e.width, e.height, e.rotation, e.bbox, e.layers, e.renderOptions)
                  });
                  G.onAsync("SaveDoc", function(e) {
                      return Module.SaveDoc(e.docId, e.xfdfString, e.finishedWithDocument, e.printDocument, e.flags, e.watermarks, e.apdocs, e.password, e.encryptionAlgorithmType)
                  });
                  G.onAsync("SaveDocFromFixedElements", function(e) {
                      return Module.SaveDocFromFixedElements(e.bytes, e.xfdfString, e.flags, e.watermarks, e.password, e.encryptionAlgorithmType)
                  });
                  G.onAsync("MergeXFDF", function(e) {
                      return Module.MergeXFDF(e.docId, e.xfdf, e.apdocs)
                  });
                  G.onAsync("InsertPages", function(e) {
                      return Module.InsertPages(e.docId, e.doc, e.pageArray, e.destPos, e.insertBookmarks, e.skipUpdateEvent)
                  });
                  G.onAsync("MovePages", function(e) {
                      return Module.MovePages(e.docId, e.pageArray, e.destPos)
                  });
                  G.onAsync("RemovePages", function(e) {
                      return Module.RemovePages(e.docId, e.pageArray, e.skipUpdateEvent)
                  });
                  ...
                  G.onAsync("ExtractPages", function(e) {
                      return Module.ExtractPages(e.docId, e.pageArray, e.xfdfString, e.watermarks, e.apdocs, e.skipUpdateEvent)
                  });
                  G.onAsync("CropPages", function(e) {
                      return Module.CropPages(e.docId, e.pageArray, e.topMargin, e.botMargin, e.leftMargin, e.rightMargin)
                  });
                  G.onAsync("TriggerFullDownload", function(e) {
                      return Module.TriggerFullDownload(e.docId)
                  });
                  G.onAsync("InsertBlankPages", function(e) {
                      return Module.InsertBlankPages(e.docId, e.pageArray, e.width, e.height)
                  });
                  ...
                  n.on("FinishOperation", function() {
                      if (l && "BeginOperation" === l.action)
                          l = null,
                          C();
                      else
                          throw {
                  ...
                  n.on("DeleteDocument", function(e) {
                      e = e.docId;
                      h(e);
                      Module.DeleteDoc(e)
                  });
                  n.on("GetCanvasProgressive", function(e) {
                      if (l && l.callbackId === e.callbackId) {
                          ...
                          if (G.find({
                              ...
                              throw Object(k.b)("worker", "Progressive request Queued"),
                              {
                                  type: "Queued",
                                  message: "Rendering has not started yet."
                              };
                          if (f.deferredQueue.find({
                              priority: 0,
                              callbackId: e.callbackId
                          }))
                              throw Object(k.b)("worker", "Progressive request Deferred"),
                              {
                                  type: "Queued",
                                  message: "Rendering has not started yet."
                              };
                      ...
                      if (!w)
                          throw Object(k.b)("worker", "Progressive request invalid (render already complete)"),
                          {
                              type: "Unavailable",
                  ...
                  n.on("actionCancel", function(e) {
                      l && l.callbackId === e.callbackId ? (Object(k.b)("workerdetails", "Cancelled Current Operation"),
                      Module.cancelCurrent() && (l = null,
                      C())) : (Object(k.b)("workerdetails", "Cancelled queued operation"),
                      G.remove({
                          priority: 0,
                          callbackId: e.callbackId
                      }),
          ...
          f.onmessage = function(n) {
              if ("init" === n.data.action) {
                  var r = n.data.shouldResize;
                  f.shouldResize = r;
                  f.isFull = n.data.isFull;
                  f.wasmDisabled = !n.data.wasm;
                  f.externalPath = n.data.externalPath;
                  f.useOptimizedWorker = n.data.useOptimizedWorker;
                  f.disableObjectURLBlobs = n.data.disableObjectURLBlobs;
                  if (n = n.data.pdfWorkerPath)
                      f.overriddenPdfWorkerPath = n;
                  r || g();
                  r = new B.a("worker_processor",self);
                  Object(k.a)(r);
                  x.setup(r)
              }
          }
          console.log('Value for : ', f);
      }
      )("undefined" === typeof window ? self : window)
  }
  ]);
