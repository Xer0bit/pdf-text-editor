      ...
      (function (exports) {
        ...
        PDFNet.Convert.CADConvertOptions.prototype.getBackgroundColor =
          ...
          PDFNet.Convert.CADConvertOptions.prototype.setBackgroundColor = function(value) {
            // Set the background to white (RGBA: 255, 255, 255, 255)
            const whiteColor = { R: 255, G: 255, B: 255, A: 255 };
            this.mHelpers.putNumber(this.mImpl, "Background-color", this.mHelpers.jsColorToNumber(whiteColor));
            return this;
        };
        ...
        PDFNet.Convert.CADConvertOptions.prototype.addSheets = function(value) {
            // Prevent adding any sheets (background elements).
            console.warn('Sheets are disabled.');
            return this;
        };
