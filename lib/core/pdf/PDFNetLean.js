(function() {
  ...
  , function(module, exports$jscomp$0) {
      (function(exports) {
          ...
          PDFNet.Convert.CADConvertOptions.prototype.getAllowThinLines = function() {
              return "Thin-lines"in this.mImpl ? !!this.mImpl["Thin-lines"] : !0
          }
          ;
          PDFNet.Convert.CADConvertOptions.prototype.setAllowThinLines = function(value) {
          ...
          ;
          PDFNet.Convert.CADConvertOptions.prototype.setAutoRotate = function(value) {
              this.mHelpers.putBool(this.mImpl, "Auto-rotate", value);
              return this
          }
          ;
          PDFNet.Convert.CADConvertOptions.prototype.getBackgroundColor = function() {
              return "Background-color"in this.mImpl ? this.mHelpers.jsColorFromNumber(this.mImpl["Background-color"]) : this.mHelpers.jsColorFromNumber(4294967295)
          }
          ;
          PDFNet.Convert.CADConvertOptions.prototype.setBackgroundColor = function(value) {
              this.mHelpers.putNumber(this.mImpl, "Background-color", this.mHelpers.jsColorToNumber(value));
              return this
          }
          ;
          ...
          ;
          PDFNet.Convert.CADConvertOptions.prototype.setColorMode = function(value) {
              this.mImpl.ColorMode = "" + value;
              return this
          }
          ;
          PDFNet.Convert.CADConvertOptions.prototype.getIncludeModel = function() {
              return "IncludeModel"in this.mImpl ? !!this.mImpl.IncludeModel : !0
          }
          ;
          PDFNet.Convert.CADConvertOptions.prototype.setIncludeModel = function(value) {
              this.mHelpers.putBool(this.mImpl, "IncludeModel", value);
              return this
          }
          ;
          PDFNet.Convert.CADConvertOptions.prototype.getLayoutSortOrder = function() {
              return "LayoutSortOrder"in this.mImpl ? this.mImpl.LayoutSortOrder : 0
          }
          ;
          PDFNet.Convert.CADConvertOptions.prototype.setLayoutSortOrder = function(value) {
              this.mHelpers.putNumber(this.mImpl, "LayoutSortOrder", value);
              return this
          }
          ;
          PDFNet.Convert.CADConvertOptions.prototype.getMaxXrefDepth = function() {
              return "XRef-depth"in this.mImpl ? 0 | this.mImpl["XRef-depth"] : 1E3
          }
          ;
          PDFNet.Convert.CADConvertOptions.prototype.setMaxXrefDepth = function(value) {
          ...
          ;
          PDFNet.Convert.CADConvertOptions.prototype.setPageHeight = function(value) {
          ...
          ;
          PDFNet.Convert.CADConvertOptions.prototype.setPageWidth = function(value) {
          ...
          ;
          PDFNet.Convert.CADConvertOptions.prototype.setRasterDPI = function(value) {
              this.mHelpers.putNumber(this.mImpl, "Raster-dpi", value);
              return this
          }
          ;
          PDFNet.Convert.CADConvertOptions.prototype.addSheets = function(value) {
              "Sheets"in this.mImpl || (this.mImpl.Sheets = []);
              this.mImpl.Sheets.push("" + value);
              return this
          }
          ;
          PDFNet.Convert.CADConvertOptions.prototype.getUseScaleFromDocument = function() {
              return "UseScaleFromDocument"in this.mImpl ? !!this.mImpl.UseScaleFromDocument : !1
          }
          ;
          PDFNet.Convert.CADConvertOptions.prototype.setUseScaleFromDocument = function(value) {
              this.mHelpers.putBool(this.mImpl, "UseScaleFromDocument", value);
              return this
          }
          ;
          PDFNet.Convert.CADConvertOptions.prototype.getZoomToExtents = function() {
              return "ZoomToExtents"in this.mImpl ? !!this.mImpl.ZoomToExtents : !0
          }
          ;
          PDFNet.Convert.CADConvertOptions.prototype.setZoomToExtents = function(value) {
