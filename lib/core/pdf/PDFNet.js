(function() {
  ...
  $jscomp.arrayIterator = function(array) {
      return {
          next: $jscomp.arrayIteratorImpl(array)
      }
  }
  ;
  ...
  $jscomp.getGlobal = function(passedInThis) {
      passedInThis = ["object" == typeof globalThis && globalThis, passedInThis, "object" == typeof window && window, "object" == typeof self && self, "object" == typeof global && global];
  ...
  $jscomp.polyfillIsolated = function(target, polyfill, fromLang, toLang) {
      ...
      toLang = split[0];
      toLang = !target && toLang in $jscomp.polyfills ? $jscomp.polyfills : $jscomp.global;
      ...
      fromLang = $jscomp.IS_SYMBOL_NATIVE && "es6" === fromLang ? toLang[split] : null;
      polyfill = polyfill(fromLang);
      null != polyfill && (target ? $jscomp.defineProperty($jscomp.polyfills, split, {
          configurable: !0,
          writable: !0,
          value: polyfill
      }) : polyfill !== fromLang && (void 0 === $jscomp.propertyToPolyfillSymbol[split] && (fromLang = 1E9 * Math.random() >>> 0,
      $jscomp.propertyToPolyfillSymbol[split] = $jscomp.IS_SYMBOL_NATIVE ? $jscomp.global.Symbol(split) : $jscomp.POLYFILL_PREFIX + fromLang + "$" + split),
      $jscomp.defineProperty(toLang, $jscomp.propertyToPolyfillSymbol[split], {
          configurable: !0,
          writable: !0,
          value: polyfill
      })))
  ...
  $jscomp.polyfill("Promise", function(NativePromise) {
      ...
      PolyfillPromise.prototype.notifyUnhandledRejection_ = function() {
          ...
          if ("undefined" === typeof nativeDispatchEvent)
              return !0;
          "function" === typeof NativeCustomEvent ? NativeCustomEvent = new NativeCustomEvent("unhandledrejection",{
              cancelable: !0
          }) : "function" === typeof NativeEvent ? NativeCustomEvent = new NativeEvent("unhandledrejection",{
              cancelable: !0
          }) : (NativeCustomEvent = $jscomp.global.document.createEvent("CustomEvent"),
          NativeCustomEvent.initCustomEvent("unhandledrejection", !1, !0, NativeCustomEvent));
  ...
  $jscomp.polyfill("String.prototype.startsWith", function(orig) {
      return orig ? orig : function(searchString, opt_position) {
          ...
          opt_position = Math.max(0, Math.min(opt_position | 0, string.length));
          for (var j = 0; j < searchLen && opt_position < strLen; )
              if (string[opt_position++] != searchString[j++])
                  return !1;
          return j >= searchLen
      }
  }, "es6", "es3");
      ...
      return orig ? orig : function(arrayLike, opt_mapFn, opt_thisArg) {
          ...
          if ("function" == typeof iteratorFunction) {
              ...
              for (var k = 0; !(iteratorFunction = arrayLike.next()).done; )
                  result.push(opt_mapFn.call(opt_thisArg, iteratorFunction.value, k++))
          } else
  ...
  , function(module, exports$jscomp$0) {
      ...
      (function(exports) {
          function optionsHelpers() {
              return {
                  ...
                  jsColorToNumber: function(jsColor) {
                      return 4278190080 + 65536 * Math.floor(jsColor.R) + 256 * Math.floor(jsColor.G) + Math.floor(jsColor.B)
                  },
          ...
          PDFNet.Convert = exports.Core.PDFNet && exports.Core.PDFNet.Convert ? exports.Core.PDFNet.Convert : {};
          PDFNet.Optimizer = {};
          ...
          PDFNet.ByteRange = function(m_offset, m_size) {
              ...
              if (m_offset && "undefined" === typeof m_size)
                  ...
                  return "undefined" === typeof m_offset && (m_offset = 0),
                  "undefined" === typeof m_size && (m_size = 0),
                  new PDFNet.ByteRange({
                      m_offset: m_offset,
                      m_size: m_size
                  })
          }
          ...
          PDFNet.ContentItem = function(o, p) {
              ...
              if (o && "undefined" === typeof p)
                  ...
                  return "undefined" === typeof o && (o = "0"),
                  "undefined" === typeof p && (p = "0"),
                  new PDFNet.ContentItem({
                      o: o,
                      p: p
                  })
          }
          ...
          PDFNet.Date = function(year, month, day, hour, minute, second, UT, UT_hour, UT_minutes, mp_obj) {
              ...
              if (year && "undefined" === typeof month)
                  ...
                  return "undefined" === typeof year && (year = 0),
          ...
          ;
          PDFNet.DictIterator.prototype = Object.create(PDFNet.Destroyable.prototype);
          ...
          ;
          PDFNet.DisallowedChange.prototype = Object.create(PDFNet.Destroyable.prototype);
          ...
          PDFNet.FDFField = function(mp_leaf_node, mp_root_array) {
              ...
              if (mp_leaf_node && "undefined" === typeof mp_root_array)
                  ...
                  return "undefined" === typeof mp_leaf_node && (mp_leaf_node = "0"),
          ...
          PDFNet.Field = function(leaf_node, builder) {
              ...
              if (leaf_node && "undefined" === typeof builder)
                  ...
                  return "undefined" === typeof leaf_node && (leaf_node = "0"),
          ...
          ;
          PDFNet.FlowDocument.prototype = Object.create(PDFNet.Destroyable.prototype);
          ...
          ;
          PDFNet.KeyStrokeActionResult.prototype = Object.create(PDFNet.Destroyable.prototype);
          ...
          PDFNet.Matrix2D = function(m_a, m_b, m_c, m_d, m_h, m_v) {
              ...
              if (m_a && "undefined" === typeof m_b)
                  ...
                  return "undefined" === typeof m_a && (m_a = 0),
          ...
          PDFNet.PDFAOptions = function(id) {
              this.name = "PDFAOptions";
              this.id = id
          }
          ;
          ...
          ;
          PDFNet.PDFRasterizer.prototype = Object.create(PDFNet.Destroyable.prototype);
          ...
          PDFNet.PageLabel = function(mp_obj, m_first_page, m_last_page) {
              ...
              if (mp_obj && "undefined" === typeof m_first_page)
                  ...
                  return "undefined" === typeof mp_obj && (mp_obj = "0"),
          ...
          ;
          PDFNet.RadioButtonGroup.prototype = Object.create(PDFNet.Destroyable.prototype);
          ...
          PDFNet.Rect = function(x1, y1, x2, y2, mp_rect) {
              ...
              if (x1 && "undefined" === typeof y1)
                  ...
                  return "undefined" === typeof x1 && (x1 = 0),
          ...
          ;
          PDFNet.ResultSnapshot.prototype = Object.create(PDFNet.Destroyable.prototype);
          ...
          PDFNet.SElement = function(obj, k) {
              ...
              if (obj && "undefined" === typeof k)
                  ...
                  return "undefined" === typeof obj && (obj = "0"),
          ...
          PDFNet.TextExtractorLine = function(line, uni, num, cur_num, m_direction, mp_bld) {
              ...
              if (line && "undefined" === typeof uni)
                  ...
                  return "undefined" === typeof line && (line = "0"),
          ...
          PDFNet.TextExtractorStyle = function(mp_imp) {
              ...
              if ("object" === _typeof(mp_imp))
                  copyFunc(mp_imp, this);
              else if ("undefined" !== typeof mp_imp)
                  return new PDFNet.TextExtractorStyle({
                      mp_imp: mp_imp
                  })
          }
          ;
          PDFNet.TextExtractorWord = function(line, word, uni, num, cur_num, mp_bld) {
          ...
          ;
          PDFNet.TimestampingResult.prototype = Object.create(PDFNet.Destroyable.prototype);
          ...
          ;
          PDFNet.PDFDoc.RefreshOptions.prototype.getDrawBackgroundOnly = function() {
              return "DrawBackgroundOnly"in this.mImpl ? !!this.mImpl.DrawBackgroundOnly : !0
          }
          ;
          PDFNet.PDFDoc.RefreshOptions.prototype.setDrawBackgroundOnly = function(value) {
              this.mHelpers.putBool(this.mImpl, "DrawBackgroundOnly", value);
              return this
          }
          ;
          PDFNet.PDFDoc.RefreshOptions.prototype.getRefreshExisting = function() {
              return "RefreshExisting"in this.mImpl ? !!this.mImpl.RefreshExisting : !0
          }
          ;
          PDFNet.PDFDoc.RefreshOptions.prototype.setRefreshExisting = function(value) {
              this.mHelpers.putBool(this.mImpl, "RefreshExisting", value);
              return this
          }
          ;
          PDFNet.PDFDoc.RefreshOptions.prototype.getUseNonStandardRotation = function() {
              return "UseNonStandardRotation"in this.mImpl ? !!this.mImpl.UseNonStandardRotation : !1
          }
          ;
          PDFNet.PDFDoc.RefreshOptions.prototype.setUseNonStandardRotation = function(value) {
              this.mHelpers.putBool(this.mImpl, "UseNonStandardRotation", value);
              return this
          }
          ;
          PDFNet.PDFDoc.RefreshOptions.prototype.getUseRoundedCorners = function() {
              return "UseRoundedCorners"in this.mImpl ? !!this.mImpl.UseRoundedCorners : !1
          }
          ;
          PDFNet.PDFDoc.RefreshOptions.prototype.setUseRoundedCorners = function(value) {
          ...
          ;
          PDFNet.PDFDoc.DiffOptions.prototype.setAddGroupAnnots = function(value) {
          ...
          ;
          PDFNet.PDFDoc.DiffOptions.prototype.getLuminosityCompression = function() {
              return "LuminosityCompression"in this.mImpl ? this.mImpl.LuminosityCompression : 10
          }
          ;
          PDFNet.PDFDoc.DiffOptions.prototype.setLuminosityCompression = function(value) {
          ...
          PDFNet.PDFDoc.TextDiffOptions.prototype.setColorA = function(color) {
              this.mHelpers.putNumber(this.mImpl, "ColorA", this.mHelpers.jsColorToNumber(color));
              return this
          }
          ;
          ...
          ;
          PDFNet.PDFDoc.TextDiffOptions.prototype.setOpacityA = function(opacity) {
          ...
          PDFNet.PDFDoc.TextDiffOptions.prototype.setColorB = function(color) {
              this.mHelpers.putNumber(this.mImpl, "ColorB", this.mHelpers.jsColorToNumber(color));
              return this
          }
          ;
          PDFNet.PDFDoc.TextDiffOptions.prototype.getCompareUsingZOrder = function() {
              return "CompareUsingZOrder"in this.mImpl ? !!this.mImpl.CompareUsingZOrder : !1
          }
          ;
          PDFNet.PDFDoc.TextDiffOptions.prototype.setCompareUsingZOrder = function(value) {
          ...
          ;
          PDFNet.PDFDoc.TextDiffOptions.prototype.setOpacityB = function(opacity) {
              this.mHelpers.putNumber(this.mImpl, "OpacityB", opacity);
              return this
          }
          ;
          PDFNet.PDFDoc.TextDiffOptions.prototype.addZonesForPage = function(zones, regions, page_num) {
          ...
          ;
          PDFNet.PDFDoc.TextDiffOptions.prototype.getExtraMoveColor = function() {
              return "ExtraMoveColor"in this.mImpl ? this.mHelpers.jsColorFromNumber(this.mImpl.ExtraMoveColor) : this.mHelpers.jsColorFromNumber(4294898256)
          }
          ;
          PDFNet.PDFDoc.TextDiffOptions.prototype.setExtraMoveColor = function(color) {
              this.mHelpers.putNumber(this.mImpl, "ExtraMoveColor", this.mHelpers.jsColorToNumber(color));
              return this
          }
          ;
          PDFNet.PDFDoc.TextDiffOptions.prototype.getExtraMoveOpacity = function() {
              return "ExtraMoveOpacity"in this.mImpl ? this.mImpl.ExtraMoveOpacity : .8
          }
          ;
          PDFNet.PDFDoc.TextDiffOptions.prototype.setExtraMoveOpacity = function(opacity) {
              this.mHelpers.putNumber(this.mImpl, "ExtraMoveOpacity", opacity);
              return this
          }
          ;
          PDFNet.PDFDoc.TextDiffOptions.prototype.getExtraMoveHighlight = function() {
              return "ExtraMoveHighlight"in this.mImpl ? !!this.mImpl.ExtraMoveHighlight : !1
          }
          ;
          PDFNet.PDFDoc.TextDiffOptions.prototype.setExtraMoveHighlight = function(value) {
              this.mHelpers.putBool(this.mImpl, "ExtraMoveHighlight", value);
              return this
          }
          ;
          PDFNet.PDFDoc.TextDiffOptions.prototype.getShowPlaceholders = function() {
              return "ShowPlaceholders"in this.mImpl ? !!this.mImpl.ShowPlaceholders : !1
          }
          ;
          PDFNet.PDFDoc.TextDiffOptions.prototype.setShowPlaceholders = function(value) {
              this.mHelpers.putBool(this.mImpl, "ShowPlaceholders", value);
              return this
          }
          ;
          PDFNet.PDFDoc.TextDiffOptions.prototype.getCompareStyles = function() {
              return "CompareStyles"in this.mImpl ? !!this.mImpl.CompareStyles : !1
          }
          ;
          PDFNet.PDFDoc.TextDiffOptions.prototype.setCompareStyles = function(value) {
              this.mHelpers.putBool(this.mImpl, "CompareStyles", value);
              return this
          }
          ;
          PDFNet.PDFDoc.TextDiffOptions.prototype.addIgnoreZonesForPage = function(regions, page_num) {
          ...
          ;
          PDFNet.FDFDoc.XFDFExportOptions.prototype.getWriteAnnotationAppearance = function() {
              return "WriteAnnotationAppearance"in this.mImpl ? !!this.mImpl.WriteAnnotationAppearance : !1
          }
          ;
          PDFNet.FDFDoc.XFDFExportOptions.prototype.setWriteAnnotationAppearance = function(value) {
              this.mHelpers.putBool(this.mImpl, "WriteAnnotationAppearance", value);
              return this
          }
          ;
          PDFNet.FDFDoc.XFDFExportOptions.prototype.getWriteImagedata = function() {
              return "WriteImagedata"in this.mImpl ? !!this.mImpl.WriteImagedata : !0
          }
          ;
          PDFNet.FDFDoc.XFDFExportOptions.prototype.setWriteImagedata = function(value) {
          ...
          ;
          PDFNet.PDFACompliance.createPDFAOptions = function(level) {
              return Promise.resolve(new PDFNet.PDFACompliance.PDFAOptions(level))
          }
          ;
          PDFNet.PDFACompliance.PDFAOptions = function(level) {
              this.name = "PDFNet.PDFACompliance.PDFAOptions";
              this.mImpl = {};
              this.mHelpers = optionsHelpers();
              this.setConformance(level)
          }
          ;
          PDFNet.PDFACompliance.PDFAOptions.prototype.getConformance = function() {
              return "Conformance"in this.mImpl ? this.mImpl.Conformance : PDFNet.PDFACompliance.Conformance.e_Level1B
          }
          ;
          PDFNet.PDFACompliance.PDFAOptions.prototype.setConformance = function(value) {
              this.mHelpers.putNumber(this.mImpl, "Conformance", value);
              return this
          }
          ;
          PDFNet.PDFACompliance.PDFAOptions.prototype.getDPI = function() {
              return "Dpi"in this.mImpl ? 0 | this.mImpl.Dpi : 300
          }
          ;
          PDFNet.PDFACompliance.PDFAOptions.prototype.setDPI = function(value) {
              this.mHelpers.putNumber(this.mImpl, "Dpi", value);
              return this
          }
          ;
          PDFNet.PDFACompliance.PDFAOptions.prototype.getFirstStop = function() {
              return "FirstStop"in this.mImpl ? !!this.mImpl.FirstStop : !1
          }
          ;
          PDFNet.PDFACompliance.PDFAOptions.prototype.setFirstStop = function(value) {
              this.mHelpers.putBool(this.mImpl, "FirstStop", value);
              return this
          }
          ;
          PDFNet.PDFACompliance.PDFAOptions.prototype.getFlattenTransparency = function() {
              return "Flatten"in this.mImpl ? !!this.mImpl.Flatten : !1
          }
          ;
          PDFNet.PDFACompliance.PDFAOptions.prototype.setFlattenTransparency = function(value) {
              this.mHelpers.putBool(this.mImpl, "Flatten", value);
              return this
          }
          ;
          PDFNet.PDFACompliance.PDFAOptions.prototype.getMaxRefObjs = function() {
              return "MaxRefObjs"in this.mImpl ? 0 | this.mImpl.MaxRefObjs : 10
          }
          ;
          PDFNet.PDFACompliance.PDFAOptions.prototype.setMaxRefObjs = function(value) {
              this.mHelpers.putNumber(this.mImpl, "MaxRefObjs", value);
              return this
          }
          ;
          PDFNet.PDFACompliance.PDFAOptions.prototype.getPassword = function() {
              return "Password"in this.mImpl ? this.mImpl.Password : ""
          }
          ;
          PDFNet.PDFACompliance.PDFAOptions.prototype.setPassword = function(value) {
              this.mHelpers.putString(this.mImpl, "Password", "" + value);
              return this
          }
          ;
          PDFNet.PDFACompliance.PDFAOptions.prototype.getJsonString = function() {
              return JSON.stringify(this.mImpl)
          }
          ;
          ...
          PDFNet.QuadPoint = function(p1x, p1y, p2x, p2y, p3x, p3y, p4x, p4y) {
              ...
              if (p1x && "undefined" === typeof p1y)
                  ...
                  return "undefined" === typeof p1x && (p1x = 0),
          ...
          ;
          PDFNet.Optimizer.ImageSettings.prototype.setCompressionMode = function(mode) {
          ...
          ;
          PDFNet.Optimizer.MonoImageSettings.prototype.setImageDPI = function(maximum, resampling) {
              this.m_max_dpi = maximum;
              this.m_resample_dpi = resampling;
              return this
          }
          ...
          ;
          PDFNet.Optimizer.MonoImageSettings.prototype.forceRecompression = function(force) {
              this.m_force_recompression = force;
              return this
          }
          ;
          ...
          ;
          PDFNet.Optimizer.OptimizerSettings.prototype.setColorImageSettings = function(settings) {
          ...
          ;
          PDFNet.Optimizer.OptimizerSettings.prototype.removeCustomEntries = function(should_remove) {
          ...
          ;
          PDFNet.Convert.ConversionOptions.prototype.setFileExtension = function(value) {
              this.FileExtension = value;
              return this
          }
          ;
          PDFNet.Convert.ConversionOptions.prototype.setEnableExternalMediaDownloads = function(value) {
          ...
          ;
          PDFNet.Convert.OfficeToPDFOptions.prototype.setApplyPageBreaksToSheet = function(value) {
              this.ApplyPageBreaksToSheet = value;
              return this
          }
          ;
          PDFNet.Convert.OfficeToPDFOptions.prototype.setDisplayChangeTracking = function(value) {
              this.DisplayChangeTracking = value;
              return this
          }
          ;
          PDFNet.Convert.OfficeToPDFOptions.prototype.setExcelDefaultCellBorderWidth = function(width) {
              this.ExcelDefaultCellBorderWidth = width;
              return this
          }
          ;
          PDFNet.Convert.OfficeToPDFOptions.prototype.setExcelMaxAllowedCellCount = function(value) {
              this.ExcelMaxAllowedCellCount = value;
              return this
          }
          ;
          PDFNet.Convert.OfficeToPDFOptions.prototype.setLocale = function(value) {
              this.Locale = value;
              return this
          }
          ;
          PDFNet.Convert.OfficeToPDFOptions.prototype.setTemplateParamsJson = function(value) {
          ...
          ;
          PDFNet.Convert.XPSOutputCommonOptions.prototype.setRenderPages = function(render) {
          ...
          ;
          PDFNet.Convert.XPSOutputCommonOptions.prototype.getJsonString = function() {
              return JSON.stringify(this.mImpl)
          }
          ;
          ...
          PDFNet.Convert.XODOutputOptions.prototype.setExtractUsingZorder = function(use_zorder) {
          ...
          ;
          PDFNet.Convert.XODOutputOptions.prototype.setFlattenContent = function(flatten) {
              switch (flatten) {
          ...
          ;
          PDFNet.Convert.XODOutputOptions.prototype.setPreferJPG = function(prefer_jpg) {
          ...
          ;
          PDFNet.Convert.TiffOutputOptions.prototype.setRotate = function(rotation) {
              switch (rotation) {
          ...
          ;
          PDFNet.Convert.TiffOutputOptions.prototype.setClip = function(x1, y1, x2, y2) {
          ...
          ;
          PDFNet.Convert.TiffOutputOptions.prototype.setPages = function(page_desc) {
              this.mImpl.PAGES = page_desc;
              return this
          }
          ;
          PDFNet.Convert.TiffOutputOptions.prototype.setOverprint = function(mode) {
              switch (mode) {
              ...
              case PDFNet.PDFRasterizer.OverprintPreviewMode.e_op_pdfx_on:
                  ...
                  break;
              default:
                  console.log("unrecognized PDFNet.PDFRasterizer.OverprintPreviewMode type: " + mode)
              }
              return this
          }
          ;
          ...
          ;
          PDFNet.Convert.TiffOutputOptions.prototype.setDither = function(enable) {
          ...
          ;
          PDFNet.Convert.TiffOutputOptions.prototype.setAnnots = function(enable) {
              this.mImpl.ANNOTS = enable;
              return this
          }
          ;
          PDFNet.Convert.TiffOutputOptions.prototype.setSmooth = function(enable) {
              this.mImpl.SMOOTH = enable;
              return this
          }
          ;
          PDFNet.Convert.TiffOutputOptions.prototype.setPrintmode = function(enable) {
              this.mImpl.PRINTMODE = enable;
              return this
          }
          ;
          PDFNet.Convert.TiffOutputOptions.prototype.setTransparentPage = function(enable) {
              this.mImpl.TRANSPARENT_PAGE = enable;
              return this
          }
          ;
          PDFNet.Convert.TiffOutputOptions.prototype.setPalettized = function(enable) {
          ...
          ;
          PDFNet.Convert.HTMLOutputOptions.prototype.setPreferJPG = function(prefer_jpg) {
              this.mImpl.PREFER_JPEG = prefer_jpg;
              return this
          }
          ;
          PDFNet.Convert.HTMLOutputOptions.prototype.setJPGQuality = function(quality) {
              this.mImpl.JPEG_QUALITY = quality;
              return this
          }
          ;
          ...
          ;
          PDFNet.Convert.HTMLOutputOptions.prototype.setMaximumImagePixels = function(max_pixels) {
              this.mImpl.MAX_IMAGE_PIXELS = max_pixels;
              return this
          }
          ;
          ...
          ;
          PDFNet.Convert.HTMLOutputOptions.prototype.setExternalLinks = function(enable) {
              this.mImpl.EXTERNAL_LINKS = enable;
              return this
          }
          ;
          PDFNet.Convert.HTMLOutputOptions.prototype.setInternalLinks = function(enable) {
              this.mImpl.INTERNAL_LINKS = enable;
              return this
          }
          ;
          PDFNet.Convert.HTMLOutputOptions.prototype.setSimplifyText = function(enable) {
          ...
          ;
          PDFNet.Convert.EPUBOutputOptions.prototype.setExpanded = function(expanded) {
              this.mImpl.EPUB_EXPANDED = expanded;
              return this
          }
          ;
          PDFNet.Convert.EPUBOutputOptions.prototype.setReuseCover = function(reuse) {
          ...
          ;
          PDFNet.Convert.SVGOutputOptions.prototype.setEmbedImages = function(embed_images) {
              this.mImpl.EMBEDIMAGES = embed_images;
              return this
          }
          ;
          PDFNet.Convert.SVGOutputOptions.prototype.setNoFonts = function(no_fonts) {
              this.mImpl.NOFONTS = no_fonts;
              return this
          }
          ;
          PDFNet.Convert.SVGOutputOptions.prototype.setSvgFonts = function(svg_fonts) {
              this.mImpl.SVGFONTS = svg_fonts;
              return this
          }
          ;
          PDFNet.Convert.SVGOutputOptions.prototype.setEmbedFonts = function(embed_fonts) {
              this.mImpl.EMBEDFONTS = embed_fonts;
              return this
          }
          ;
          PDFNet.Convert.SVGOutputOptions.prototype.setNoUnicode = function(no_unicode) {
              this.mImpl.NOUNICODE = no_unicode;
              return this
          }
          ;
          PDFNet.Convert.SVGOutputOptions.prototype.setIndividualCharPlacement = function(individual_char_placement) {
              this.mImpl.INDIVIDUALCHARPLACEMENT = individual_char_placement;
              return this
          }
          ;
          PDFNet.Convert.SVGOutputOptions.prototype.setRemoveCharPlacement = function(remove_char_placement) {
              this.mImpl.REMOVECHARPLACEMENT = remove_char_placement;
              return this
          }
          ;
          PDFNet.Convert.SVGOutputOptions.prototype.setFlattenContent = function(flatten) {
              switch (flatten) {
              case PDFNet.Convert.FlattenFlag.e_off:
                  this.mImpl.FLATTEN_CONTENT = "OFF";
                  break;
          ...
          ;
          PDFNet.Convert.SVGOutputOptions.prototype.setFlattenThreshold = function(threshold) {
              switch (threshold) {
              case PDFNet.Convert.FlattenThresholdFlag.e_very_strict:
                  this.mImpl.FLATTEN_THRESHOLD = "VERY_STRICT";
                  break;
          ...
          ;
          PDFNet.Convert.SVGOutputOptions.prototype.setFlattenDPI = function(dpi) {
              this.mImpl.DPI = dpi;
              return this
          }
          ;
          PDFNet.Convert.SVGOutputOptions.prototype.setFlattenMaximumImagePixels = function(max_pixels) {
              this.mImpl.MAX_IMAGE_PIXELS = max_pixels;
              return this
          }
          ;
          PDFNet.Convert.SVGOutputOptions.prototype.setCompress = function(svgz) {
              this.mImpl.SVGZ = svgz;
              return this
          }
          ;
          PDFNet.Convert.SVGOutputOptions.prototype.setOutputThumbnails = function(include_thumbs) {
              this.mImpl.NOTHUMBS = include_thumbs;
              return this
          }
          ;
          PDFNet.Convert.SVGOutputOptions.prototype.setThumbnailSize = function(size) {
              this.mImpl.THUMB_SIZE = size;
              return this
          }
          ;
          PDFNet.Convert.SVGOutputOptions.prototype.setCreateXmlWrapper = function(xml) {
          ...
          ;
          PDFNet.Convert.SVGOutputOptions.prototype.setAnnots = function(annots) {
          ...
          PDFNet.Convert.SVGOutputOptions.prototype.setOverprint = function(op) {
              ...
              case PDFNet.PDFRasterizer.OverprintPreviewMode.e_op_pdfx_on:
                  ...
                  break;
              default:
                  console.log("unrecognized PDFNet.PDFRasterizer.OverprintPreviewMode type: " + op)
              }
              return this
          }
          ;
          ...
          ;
          PDFNet.PDFDoc.ViewerOptimizedOptions.prototype.setThumbnailRenderingThreshold = function(threshold) {
              this.mImpl.COMPLEXITY_THRESHOLD = threshold;
              return this
          }
          ;
          PDFNet.PDFDoc.ViewerOptimizedOptions.prototype.setMinimumInitialThumbnails = function(initial_thumbs) {
              this.mImpl.MINIMUM_INITIAL_THUMBNAILS = initial_thumbs;
              return this
          }
          ;
          PDFNet.PDFDoc.ViewerOptimizedOptions.prototype.setThumbnailSize = function(size) {
              this.mImpl.THUMB_SIZE = size;
              return this
          }
          ;
          PDFNet.PDFDoc.ViewerOptimizedOptions.prototype.setOverprint = function(mode) {
              switch (mode) {
              case PDFNet.PDFRasterizer.OverprintPreviewMode.e_op_off:
                  this.mImpl.OVERPRINT_MODE = "OFF";
                  break;
          ...
          ;
          PDFNet.PDFDoc.ViewerOptimizedOptions.prototype.getJsonString = function() {
              return JSON.stringify(this.mImpl)
          }
          ;
          ...
          PDFNet.Iterator.prototype.hasNext = function() {
              return PDFNet.sendWithPromise("Iterator.hasNext", {
                  itr: this.id
              })
          }
          ;
          PDFNet.Iterator.prototype.next = function() {
              return PDFNet.sendWithPromise("Iterator.next", {
                  itr: this.id
              })
          }
          ;
          ...
          PDFNet.DictIterator.prototype.next = function() {
              return PDFNet.sendWithPromise("DictIterator.next", {
                  itr: this.id
              })
          }
          ;
          PDFNet.Matrix2D.prototype.copy = function() {
              ...
              return PDFNet.sendWithPromise("Matrix2D.copy", {
                  m: this
              }).then(function(id) {
          ...
          PDFNet.Matrix2D.prototype.set = function(a, b, c, d, h, v) {
              checkArguments(arguments.length, 6, "set", "(number, number, number, number, number, number)", [[a, "number"], [b, "number"], [c, "number"], [d, "number"], [h, "number"], [v, "number"]]);
          ...
          PDFNet.Matrix2D.prototype.concat = function(a, b, c, d, h, v) {
              checkArguments(arguments.length, 6, "concat", "(number, number, number, number, number, number)", [[a, "number"], [b, "number"], [c, "number"], [d, "number"], [h, "number"], [v, "number"]]);
          ...
          PDFNet.Matrix2D.prototype.equals = function(m2) {
              checkArguments(arguments.length, 1, "equals", "(PDFNet.Matrix2D)", [[m2, "Structure", PDFNet.Matrix2D, "Matrix2D"]]);
          ...
          PDFNet.Matrix2D.prototype.preTranslate = function(h, v) {
              checkArguments(arguments.length, 2, "preTranslate", "(number, number)", [[h, "number"], [v, "number"]]);
          ...
          PDFNet.Matrix2D.createZeroMatrix = function() {
              return PDFNet.sendWithPromise("matrix2DCreateZeroMatrix", {}).then(function(id) {
                  return new PDFNet.Matrix2D(id)
              })
          }
          ;
          PDFNet.Matrix2D.createIdentityMatrix = function() {
              return PDFNet.sendWithPromise("matrix2DCreateIdentityMatrix", {}).then(function(id) {
                  return new PDFNet.Matrix2D(id)
              })
          }
          ;
          ...
          PDFNet.Matrix2D.prototype.multiply = function(m) {
              checkArguments(arguments.length, 1, "multiply", "(PDFNet.Matrix2D)", [[m, "Structure", PDFNet.Matrix2D, "Matrix2D"]]);
          ...
          PDFNet.Field.prototype.getType = function() {
              ...
              return PDFNet.sendWithPromise("Field.getType", {
                  field: this
              })
          }
          ;
          ...
          PDFNet.Field.prototype.setValueAsString = function(value) {
              ...
              return PDFNet.sendWithPromise("Field.setValueAsString", {
                  ...
                  me.yieldFunction = void 0;
                  id.result = createDestroyableObj(PDFNet.ViewChangeCollection, id.result);
          ...
          PDFNet.Field.prototype.getName = function() {
              ...
              return PDFNet.sendWithPromise("Field.getName", {
                  field: this
              })
          }
          ;
          ...
          PDFNet.Field.prototype.rename = function(field_name) {
              checkArguments(arguments.length, 1, "rename", "(string)", [[field_name, "string"]]);
          ...
          PDFNet.Field.prototype.isAnnot = function() {
              ...
              return PDFNet.sendWithPromise("Field.isAnnot", {
                  field: this
              })
          }
          ;
          ...
          PDFNet.Field.prototype.setMaxLen = function(max_len) {
              checkArguments(arguments.length, 1, "setMaxLen", "(number)", [[max_len, "number"]]);
          ...
          PDFNet.Field.prototype.getMaxLen = function() {
              ...
              return PDFNet.sendWithPromise("Field.getMaxLen", {
                  field: this
              })
          }
          ;
          ...
          PDFNet.Field.prototype.getOptCount = function() {
              ...
              return PDFNet.sendWithPromise("Field.getOptCount", {
                  field: this
              })
          }
          ;
          ...
          PDFNet.FDFDoc.createFromMemoryBuffer = function(buf) {
              checkArguments(arguments.length, 1, "createFromMemoryBuffer", "(ArrayBuffer|TypedArray)", [[buf, "ArrayBuffer"]]);
          ...
          PDFNet.FDFDoc.prototype.isModified = function() {
              return PDFNet.sendWithPromise("FDFDoc.isModified", {
                  doc: this.id
              })
          }
          ;
          ...
          PDFNet.FDFDoc.prototype.getFDF = function() {
              return PDFNet.sendWithPromise("FDFDoc.getFDF", {
                  doc: this.id
              }).then(function(id) {
                  return createPDFNetObj(PDFNet.Obj, id)
              })
          ...
          PDFNet.FDFDoc.prototype.getID = function() {
              return PDFNet.sendWithPromise("FDFDoc.getID", {
                  doc: this.id
              }).then(function(id) {
                  return createPDFNetObj(PDFNet.Obj, id)
              })
          ...
          PDFNet.FDFDoc.prototype.fieldCreate = function(field_name, type, field_value) {
              ...
              checkArguments(arguments.length, 2, "fieldCreate", "(string, number, PDFNet.Obj)", [[field_name, "string"], [type, "number"], [field_value, "Object", PDFNet.Obj, "Obj"]]);
          ...
          PDFNet.FDFDoc.prototype.fieldCreateFromString = function(field_name, type, field_value) {
              checkArguments(arguments.length, 3, "fieldCreateFromString", "(string, number, string)", [[field_name, "string"], [type, "number"], [field_value, "string"]]);
          ...
          ;
          PDFNet.FDFDoc.prototype.saveAsXFDFWithOptions = function(filepath, opts) {
              "undefined" === typeof opts && (opts = null);
              checkArguments(arguments.length, 1, "saveAsXFDFWithOptions", "(string, PDFNet.OptionBase)", [[filepath, "string"], [opts, "OptionBase"]]);
          ...
          ;
          PDFNet.FDFDoc.prototype.saveAsXFDFAsStringWithOptions = function(opts) {
              "undefined" === typeof opts && (opts = null);
              checkArguments(arguments.length, 0, "saveAsXFDFAsStringWithOptions", "(PDFNet.OptionBase)", [[opts, "OptionBase"]]);
              checkParamsYieldFunction("saveAsXFDFAsStringWithOptions", [[opts, 0]]);
              opts = opts ? opts.getJsonString() : "{}";
              return PDFNet.sendWithPromise("FDFDoc.saveAsXFDFAsStringWithOptions", {
                  doc: this.id,
                  opts: opts
              })
          }
          ...
          PDFNet.Filter.prototype.createASCII85Encode = function(line_width, buf_sz) {
              checkArguments(arguments.length, 2, "createASCII85Encode", "(number, number)", [[line_width, "number"], [buf_sz, "number"]]);
          ...
          PDFNet.Filter.createImage2RGBA = function(img, premultiply) {
              checkArguments(arguments.length, 2, "createImage2RGBA", "(PDFNet.Image, boolean)", [[img, "Object", PDFNet.Image, "Image"], [premultiply, "boolean"]]);
          ...
          PDFNet.Filter.prototype.getName = function() {
              return PDFNet.sendWithPromise("Filter.getName", {
                  filter: this.id
              })
          }
          ;
          ...
          PDFNet.Filter.prototype.begin = function() {
              return PDFNet.sendWithPromise("Filter.begin", {
                  filter: this.id
              })
          }
          ;
          PDFNet.Filter.prototype.size = function() {
              return PDFNet.sendWithPromise("Filter.size", {
                  filter: this.id
              })
          }
          ;
          ...
          PDFNet.Filter.prototype.count = function() {
              return PDFNet.sendWithPromise("Filter.count", {
                  filter: this.id
              })
          }
          ;
          ...
          PDFNet.Filter.prototype.setStreamLength = function(bytes) {
              checkArguments(arguments.length, 1, "setStreamLength", "(number)", [[bytes, "number"]]);
          ...
          PDFNet.Filter.prototype.flush = function() {
              return PDFNet.sendWithPromise("Filter.flush", {
                  filter: this.id
              })
          }
          ;
          PDFNet.Filter.prototype.flushAll = function() {
              return PDFNet.sendWithPromise("Filter.flushAll", {
                  filter: this.id
              })
          }
          ;
          ...
          PDFNet.Filter.prototype.canSeek = function() {
              return PDFNet.sendWithPromise("Filter.canSeek", {
                  filter: this.id
              })
          }
          ;
          ...
          PDFNet.Filter.prototype.tell = function() {
              return PDFNet.sendWithPromise("Filter.tell", {
                  filter: this.id
              })
          }
          ;
          PDFNet.Filter.prototype.truncate = function(new_size) {
              checkArguments(arguments.length, 1, "truncate", "(number)", [[new_size, "number"]]);
          ...
          PDFNet.FilterReader.create = function(filter) {
              checkArguments(arguments.length, 1, "create", "(PDFNet.Filter)", [[filter, "Object", PDFNet.Filter, "Filter"]]);
          ...
          PDFNet.FilterWriter.prototype.writeLine = function(line, eol) {
              ...
              checkArguments(arguments.length, 1, "writeLine", "(string, number)", [[line, "const char* = 0"], [eol, "number"]]);
          ...
          PDFNet.OCG.create = function(pdfdoc, name) {
              checkArguments(arguments.length, 2, "create", "(PDFNet.PDFDoc, string)", [[pdfdoc, "PDFDoc"], [name, "string"]]);
          ...
          PDFNet.OCG.prototype.copy = function() {
              return PDFNet.sendWithPromise("OCG.copy", {
                  ocg: this.id
              }).then(function(id) {
                  return createPDFNetObj(PDFNet.OCG, id)
              })
          ...
          PDFNet.OCG.prototype.isValid = function() {
              return PDFNet.sendWithPromise("OCG.isValid", {
                  ocg: this.id
              })
          }
          ;
          PDFNet.OCG.prototype.getName = function() {
              return PDFNet.sendWithPromise("OCG.getName", {
                  c: this.id
              })
          }
          ;
          ...
          PDFNet.OCG.prototype.getIntent = function() {
              return PDFNet.sendWithPromise("OCG.getIntent", {
                  c: this.id
              }).then(function(id) {
                  return createPDFNetObj(PDFNet.Obj, id)
              })
          ...
          PDFNet.OCG.prototype.hasUsage = function() {
              return PDFNet.sendWithPromise("OCG.hasUsage", {
                  c: this.id
              })
          }
          ;
          ...
          PDFNet.OCG.prototype.setCurrentState = function(ctx, state) {
              checkArguments(arguments.length, 2, "setCurrentState", "(PDFNet.OCGContext, boolean)", [[ctx, "Object", PDFNet.OCGContext, "OCGContext"], [state, "boolean"]]);
          ...
          PDFNet.OCGConfig.createFromObj = function(dict) {
              checkArguments(arguments.length, 1, "createFromObj", "(PDFNet.Obj)", [[dict, "Object", PDFNet.Obj, "Obj"]]);
          ...
          PDFNet.OCGConfig.prototype.copy = function() {
              return PDFNet.sendWithPromise("OCGConfig.copy", {
                  c: this.id
              }).then(function(id) {
                  return createPDFNetObj(PDFNet.OCGConfig, id)
              })
          ...
          PDFNet.OCGConfig.prototype.getName = function() {
              return PDFNet.sendWithPromise("OCGConfig.getName", {
                  c: this.id
              })
          }
          ;
          ...
          PDFNet.OCGConfig.prototype.getCreator = function() {
              return PDFNet.sendWithPromise("OCGConfig.getCreator", {
                  c: this.id
              })
          }
          ;
          PDFNet.OCGConfig.prototype.setCreator = function(value) {
              checkArguments(arguments.length, 1, "setCreator", "(string)", [[value, "string"]]);
          ...
          PDFNet.OCGContext.prototype.copy = function() {
              return PDFNet.sendWithPromise("OCGContext.copy", {
                  c: this.id
              }).then(function(id) {
                  return createDestroyableObj(PDFNet.OCGContext, id)
              })
          ...
          PDFNet.OCGContext.prototype.getOCMode = function() {
              return PDFNet.sendWithPromise("OCGContext.getOCMode", {
                  c: this.id
              })
          }
          ;
          ...
          PDFNet.OCMD.create = function(pdfdoc, ocgs, vis_policy) {
              checkArguments(arguments.length, 3, "create", "(PDFNet.PDFDoc, PDFNet.Obj, number)", [[pdfdoc, "PDFDoc"], [ocgs, "Object", PDFNet.Obj, "Obj"], [vis_policy, "number"]]);
          ...
          PDFNet.OCMD.prototype.getOCGs = function() {
              return PDFNet.sendWithPromise("OCMD.getOCGs", {
                  ocmd: this.id
              }).then(function(id) {
                  return createPDFNetObj(PDFNet.Obj, id)
              })
          ...
          PDFNet.OCMD.prototype.isValid = function() {
              return PDFNet.sendWithPromise("OCMD.isValid", {
                  ocmd: this.id
              })
          }
          ;
          ...
          ;
          PDFNet.PDFACompliance.createFromFileWithOptions = function(convert, file_path, in_options) {
              "undefined" === typeof in_options && (in_options = null);
              checkArguments(arguments.length, 2, "createFromFileWithOptions", "(boolean, string, PDFNet.OptionBase)", [[convert, "boolean"], [file_path, "string"], [in_options, "OptionBase"]]);
              checkParamsYieldFunction("createFromFileWithOptions", [[in_options, 2]]);
              in_options = in_options ? in_options.getJsonString() : "{}";
              return PDFNet.sendWithPromise("pdfaComplianceCreateFromFileWithOptions", {
                  convert: convert,
                  file_path: file_path,
                  in_options: in_options
              }).then(function(id) {
                  return createDestroyableObj(PDFNet.PDFACompliance, id)
              })
          }
          ;
          PDFNet.PDFACompliance.createFromBufferWithOptions = function(convert, buf, in_options) {
              "undefined" === typeof in_options && (in_options = null);
              checkArguments(arguments.length, 2, "createFromBufferWithOptions", "(boolean, ArrayBuffer|TypedArray, PDFNet.OptionBase)", [[convert, "boolean"], [buf, "ArrayBuffer"], [in_options, "OptionBase"]]);
              checkParamsYieldFunction("createFromBufferWithOptions", [[in_options, 2]]);
              var bufArrayBuffer = getArrayBuffer(buf, !1);
              in_options = in_options ? in_options.getJsonString() : "{}";
              return PDFNet.sendWithPromise("pdfaComplianceCreateFromBufferWithOptions", {
                  convert: convert,
                  buf: bufArrayBuffer,
                  in_options: in_options
              }).then(function(id) {
          ...
          PDFNet.PDFACompliance.getPDFAErrorMessage = function(id) {
              checkArguments(arguments.length, 1, "getPDFAErrorMessage", "(number)", [[id, "number"]]);
          ...
          PDFNet.PDFACompliance.getDeclaredConformance = function(doc) {
              ...
              return PDFNet.sendWithPromise("pdfaComplianceGetDeclaredConformance", {
                  doc: doc.id
              })
          }
          ;
          PDFNet.PDFACompliance.prototype.saveAsFromBuffer = function(linearized) {
              ...
              checkArguments(arguments.length, 0, "saveAsFromBuffer", "(boolean)", [[linearized, "boolean"]]);
          ...
          PDFNet.AttrObj.prototype.copy = function() {
              return PDFNet.sendWithPromise("AttrObj.copy", {
                  a: this.id
              }).then(function(id) {
                  return createPDFNetObj(PDFNet.AttrObj, id)
              })
          ...
          PDFNet.AttrObj.prototype.getOwner = function() {
              return PDFNet.sendWithPromise("AttrObj.getOwner", {
                  obj: this.id
              })
          }
          ;
          ...
          PDFNet.ClassMap.prototype.copy = function() {
              return PDFNet.sendWithPromise("ClassMap.copy", {
                  p: this.id
              }).then(function(id) {
                  return createPDFNetObj(PDFNet.ClassMap, id)
              })
          ...
          PDFNet.ClassMap.prototype.isValid = function() {
              return PDFNet.sendWithPromise("ClassMap.isValid", {
                  map: this.id
              })
          }
          ;
          ...
          PDFNet.ContentItem.prototype.copy = function() {
              checkThisYieldFunction("copy", this.yieldFunction);
              return PDFNet.sendWithPromise("ContentItem.copy", {
                  c: this
              }).then(function(id) {
          ...
          PDFNet.ContentItem.prototype.getMCID = function() {
              ...
              return PDFNet.sendWithPromise("ContentItem.getMCID", {
                  item: this
              })
          }
          ;
          ...
          PDFNet.RoleMap.prototype.copy = function() {
              return PDFNet.sendWithPromise("RoleMap.copy", {
                  p: this.id
              }).then(function(id) {
                  return createPDFNetObj(PDFNet.RoleMap, id)
              })
          ...
          PDFNet.RoleMap.prototype.isValid = function() {
              return PDFNet.sendWithPromise("RoleMap.isValid", {
                  map: this.id
              })
          }
          ;
          ...
          PDFNet.SElement.prototype.getType = function() {
              checkThisYieldFunction("getType", this.yieldFunction);
              return PDFNet.sendWithPromise("SElement.getType", {
                  e: this
              })
          }
          ;
          PDFNet.SElement.prototype.getNumKids = function() {
              ...
              return PDFNet.sendWithPromise("SElement.getNumKids", {
                  e: this
              })
          }
          ;
          ...
          PDFNet.SElement.prototype.getAsStructElem = function(index) {
              checkArguments(arguments.length, 1, "getAsStructElem", "(number)", [[index, "number"]]);
          ...
          PDFNet.SElement.prototype.getParent = function() {
              checkThisYieldFunction("getParent", this.yieldFunction);
              return PDFNet.sendWithPromise("SElement.getParent", {
                  e: this
              }).then(function(id) {
                  return new PDFNet.SElement(id)
              })
          ...
          PDFNet.SElement.prototype.hasTitle = function() {
              ...
              return PDFNet.sendWithPromise("SElement.hasTitle", {
                  e: this
              })
          }
          ;
          ...
          PDFNet.SElement.prototype.getID = function() {
              ...
              return PDFNet.sendWithPromise("SElement.getID", {
                  e: this
              }).then(function(id) {
                  return createPDFNetObj(PDFNet.Obj, id)
              })
          ...
          PDFNet.SElement.prototype.hasActualText = function() {
              ...
              return PDFNet.sendWithPromise("SElement.hasActualText", {
                  e: this
              })
          }
          ;
          PDFNet.SElement.prototype.getActualText = function() {
              ...
              return PDFNet.sendWithPromise("SElement.getActualText", {
                  e: this
              })
          }
          ;
          ...
          PDFNet.SElement.prototype.getAlt = function() {
              ...
              return PDFNet.sendWithPromise("SElement.getAlt", {
                  e: this
              })
          }
          ;
          ...
          PDFNet.STree.create = function(struct_dict) {
              checkArguments(arguments.length, 1, "create", "(PDFNet.Obj)", [[struct_dict, "Object", PDFNet.Obj, "Obj"]]);
          ...
          PDFNet.STree.prototype.copy = function() {
              return PDFNet.sendWithPromise("STree.copy", {
                  c: this.id
              }).then(function(id) {
                  return createPDFNetObj(PDFNet.STree, id)
              })
          ...
          PDFNet.STree.prototype.isValid = function() {
              return PDFNet.sendWithPromise("STree.isValid", {
                  tree: this.id
              })
          }
          ;
          PDFNet.STree.prototype.getNumKids = function() {
              return PDFNet.sendWithPromise("STree.getNumKids", {
                  tree: this.id
              })
          }
          ;
          PDFNet.STree.prototype.getKid = function(index) {
              checkArguments(arguments.length, 1, "getKid", "(number)", [[index, "number"]]);
          ...
          PDFNet.Action.createGotoRemoteSetNewWindow = function(file, page_num, new_window) {
              checkArguments(arguments.length, 3, "createGotoRemoteSetNewWindow", "(PDFNet.FileSpec, number, boolean)", [[file, "Object", PDFNet.FileSpec, "FileSpec"], [page_num, "number"], [new_window, "boolean"]]);
          ...
          PDFNet.Action.createURIWithUString = function(sdfdoc, uri) {
              checkArguments(arguments.length, 2, "createURIWithUString", "(PDFNet.SDFDoc, string)", [[sdfdoc, "SDFDoc"], [uri, "string"]]);
          ...
          PDFNet.Action.prototype.isValid = function() {
              return PDFNet.sendWithPromise("Action.isValid", {
                  action: this.id
              })
          }
          ;
          PDFNet.Action.prototype.getXFDF = function() {
              return PDFNet.sendWithPromise("Action.getXFDF", {
                  action: this.id
              })
          }
          ;
          PDFNet.Action.prototype.getType = function() {
              return PDFNet.sendWithPromise("Action.getType", {
                  action: this.id
              })
          }
          ;
          ...
          PDFNet.Action.prototype.setFormActionFlag = function(flag, value) {
              checkArguments(arguments.length, 2, "setFormActionFlag", "(number, boolean)", [[flag, "number"], [value, "boolean"]]);
          ...
          PDFNet.Action.prototype.execute = function() {
              return PDFNet.sendWithPromise("Action.execute", {
                  action: this.id
              })
          }
          ;
          PDFNet.Action.prototype.executeKeyStrokeAction = function(data) {
              checkArguments(arguments.length, 1, "executeKeyStrokeAction", "(PDFNet.KeyStrokeEventData)", [[data, "Object", PDFNet.KeyStrokeEventData, "KeyStrokeEventData"]]);
          ...
          ;
          PDFNet.KeyStrokeEventData.create = function(field_name, current, change, selection_start, selection_end) {
          ...
          PDFNet.Page.prototype.isValid = function() {
              return PDFNet.sendWithPromise("Page.isValid", {
                  page: this.id
              })
          }
          ;
          PDFNet.Page.prototype.getIndex = function() {
              return PDFNet.sendWithPromise("Page.getIndex", {
                  page: this.id
              })
          }
          ;
          ...
          PDFNet.Page.addRotations = function(r0, r1) {
              ...
              return PDFNet.sendWithPromise("pageAddRotations", {
                  r0: r0,
                  r1: r1
              })
          }
          ...
          PDFNet.Page.rotationToDegree = function(r) {
              ...
              return PDFNet.sendWithPromise("pageRotationToDegree", {
                  r: r
              })
          }
          ;
          PDFNet.Page.degreeToRotation = function(r) {
              ...
              return PDFNet.sendWithPromise("pageDegreeToRotation", {
                  r: r
              })
          }
          ;
          ...
          PDFNet.Page.prototype.getNumAnnots = function() {
              return PDFNet.sendWithPromise("Page.getNumAnnots", {
                  page: this.id
              })
          }
          ;
          ...
          PDFNet.Annot.createFromObj = function(d) {
              ...
              return PDFNet.sendWithPromise("annotCreateFromObj", {
                  d: d.id
              }).then(function(id) {
                  return createPDFNetObj(PDFNet.Annot, id)
              })
          ...
          PDFNet.Annot.prototype.copy = function() {
              return PDFNet.sendWithPromise("Annot.copy", {
                  d: this.id
              }).then(function(id) {
                  return createPDFNetObj(PDFNet.Annot, id)
              })
          ...
          PDFNet.Annot.prototype.isValid = function() {
              return PDFNet.sendWithPromise("Annot.isValid", {
                  annot: this.id
              })
          }
          ;
          ...
          PDFNet.Annot.prototype.getType = function() {
              return PDFNet.sendWithPromise("Annot.getType", {
                  annot: this.id
              })
          }
          ;
          PDFNet.Annot.prototype.isMarkup = function() {
              return PDFNet.sendWithPromise("Annot.isMarkup", {
                  annot: this.id
              })
          }
          ;
          ...
          PDFNet.Annot.prototype.setUniqueID = function(id) {
              checkArguments(arguments.length, 1, "setUniqueID", "(ArrayBuffer|TypedArray)", [[id, "ArrayBuffer"]]);
          ...
          PDFNet.AnnotBorderStyle.create = function(s, b_width, b_hr, b_vr) {
              ...
              checkArguments(arguments.length, 2, "create", "(number, number, number, number)", [[s, "number"], [b_width, "number"], [b_hr, "number"], [b_vr, "number"]]);
          ...
          ;
          PDFNet.AnnotBorderStyle.createWithDashPattern = function(s, b_width, b_hr, b_vr, b_dash) {
              checkArguments(arguments.length, 5, "createWithDashPattern", "(number, number, number, number, Array<number>)", [[s, "number"], [b_width, "number"], [b_hr, "number"], [b_vr, "number"], [b_dash, "Array"]]);
              return PDFNet.sendWithPromise("annotBorderStyleCreateWithDashPattern", {
                  s: s,
                  b_width: b_width,
                  b_hr: b_hr,
                  b_vr: b_vr,
          ...
          PDFNet.Annot.prototype.getAppearance = function(annot_state, app_state) {
              ...
              checkArguments(arguments.length, 0, "getAppearance", "(number, string)", [[annot_state, "number"], [app_state, "const char* = 0"]]);
          ...
          PDFNet.Annot.prototype.refreshAppearanceRefreshOptions = function(options) {
              ...
              return PDFNet.sendWithPromise("Annot.refreshAppearanceRefreshOptions", {
                  annot: this.id,
                  options: options
              })
          }
          ...
          PDFNet.AnnotBorderStyle.prototype.setHR = function(horizontal_radius) {
              checkArguments(arguments.length, 1, "setHR", "(number)", [[horizontal_radius, "number"]]);
          ...
          PDFNet.Annot.getBorderStyleStyle = function(bs) {
              checkArguments(arguments.length, 1, "getBorderStyleStyle", "(PDFNet.AnnotBorderStyle)", [[bs, "Object", PDFNet.AnnotBorderStyle, "AnnotBorderStyle"]]);
          ...
          PDFNet.LineAnnot.prototype.setStartPoint = function(sp) {
              checkArguments(arguments.length, 1, "setStartPoint", "(PDFNet.Point)", [[sp, "Structure", PDFNet.Point, "Point"]]);
          ...
          PDFNet.LineAnnot.prototype.setEndPoint = function(ep) {
              checkArguments(arguments.length, 1, "setEndPoint", "(PDFNet.Point)", [[ep, "Structure", PDFNet.Point, "Point"]]);
          ...
          PDFNet.LineAnnot.prototype.getLeaderLineExtensionLength = function() {
              return PDFNet.sendWithPromise("LineAnnot.getLeaderLineExtensionLength", {
                  line: this.id
              })
          }
          ;
          PDFNet.LineAnnot.prototype.setLeaderLineExtensionLength = function(length) {
              ...
              return PDFNet.sendWithPromise("LineAnnot.setLeaderLineExtensionLength", {
                  line: this.id,
                  length: length
              })
          }
          ...
          PDFNet.LineAnnot.prototype.setIntentType = function(it) {
              checkArguments(arguments.length, 1, "setIntentType", "(number)", [[it, "number"]]);
          ...
          PDFNet.FileAttachmentAnnot.createWithFileSpec = function(doc, pos, fs, icon_name) {
              ...
              checkArguments(arguments.length, 3, "createWithFileSpec", "(PDFNet.SDFDoc, PDFNet.Rect, PDFNet.FileSpec, number)", [[doc, "SDFDoc"], [pos, "Structure", PDFNet.Rect, "Rect"], [fs, "Object", PDFNet.FileSpec, "FileSpec"], [icon_name, "number"]]);
              checkParamsYieldFunction("createWithFileSpec", [[pos, 1]]);
              return PDFNet.sendWithPromise("fileAttachmentAnnotCreateWithFileSpec", {
                  doc: doc.id,
                  pos: pos,
                  fs: fs.id,
                  icon_name: icon_name
          ...
          PDFNet.FileAttachmentAnnot.createDefault = function(doc, pos, path) {
              checkArguments(arguments.length, 3, "createDefault", "(PDFNet.SDFDoc, PDFNet.Rect, string)", [[doc, "SDFDoc"], [pos, "Structure", PDFNet.Rect, "Rect"], [path, "string"]]);
          ...
          PDFNet.FreeTextAnnot.prototype.setCalloutLinePoints = function(p1, p2, p3) {
              checkArguments(arguments.length, 3, "setCalloutLinePoints", "(PDFNet.Point, PDFNet.Point, PDFNet.Point)", [[p1, "Structure", PDFNet.Point, "Point"], [p2, "Structure", PDFNet.Point, "Point"], [p3, "Structure", PDFNet.Point, "Point"]]);
          ...
          PDFNet.FreeTextAnnot.prototype.setCalloutLinePointsTwo = function(p1, p2) {
              checkArguments(arguments.length, 2, "setCalloutLinePointsTwo", "(PDFNet.Point, PDFNet.Point)", [[p1, "Structure", PDFNet.Point, "Point"], [p2, "Structure", PDFNet.Point, "Point"]]);
              checkParamsYieldFunction("setCalloutLinePointsTwo", [[p1, 0], [p2, 1]]);
              return PDFNet.sendWithPromise("FreeTextAnnot.setCalloutLinePointsTwo", {
                  ft: this.id,
                  p1: p1,
                  p2: p2
              })
          ...
          PDFNet.FreeTextAnnot.prototype.setEndingStyleName = function(est) {
              checkArguments(arguments.length, 1, "setEndingStyleName", "(string)", [[est, "string"]]);
          ...
          PDFNet.FreeTextAnnot.prototype.setFontName = function(fontName) {
              checkArguments(arguments.length, 1, "setFontName", "(string)", [[fontName, "string"]]);
          ...
          PDFNet.InkAnnot.prototype.setPoint = function(pathindex, pointindex, pt) {
              checkArguments(arguments.length, 3, "setPoint", "(number, number, PDFNet.Point)", [[pathindex, "number"], [pointindex, "number"], [pt, "Structure", PDFNet.Point, "Point"]]);
          ...
          PDFNet.LinkAnnot.prototype.setHighlightingMode = function(value) {
              checkArguments(arguments.length, 1, "setHighlightingMode", "(number)", [[value, "number"]]);
          ...
          PDFNet.getNormalizedUrl = function(url) {
              checkArguments(arguments.length, 1, "getNormalizedUrl", "(string)", [[url, "string"]]);
              return PDFNet.sendWithPromise("getNormalizedUrl", {
                  url: url
              })
          }
          ;
          ...
          PDFNet.MarkupAnnot.prototype.setSubject = function(contents) {
              checkArguments(arguments.length, 1, "setSubject", "(string)", [[contents, "string"]]);
          ...
          PDFNet.MarkupAnnot.prototype.getBorderEffectIntensity = function() {
              return PDFNet.sendWithPromise("MarkupAnnot.getBorderEffectIntensity", {
                  markup: this.id
              })
          }
          ;
          PDFNet.MarkupAnnot.prototype.setBorderEffectIntensity = function(intensity) {
              ...
              return PDFNet.sendWithPromise("MarkupAnnot.setBorderEffectIntensity", {
                  markup: this.id,
                  intensity: intensity
              })
          }
          ...
          PDFNet.MarkupAnnot.prototype.setCreationDates = function(dt) {
              checkArguments(arguments.length, 1, "setCreationDates", "(PDFNet.Date)", [[dt, "Structure", PDFNet.Date, "Date"]]);
          ...
          PDFNet.MarkupAnnot.prototype.setInteriorColor = function(c, CompNum) {
              checkArguments(arguments.length, 2, "setInteriorColor", "(PDFNet.ColorPt, number)", [[c, "Object", PDFNet.ColorPt, "ColorPt"], [CompNum, "number"]]);
          ...
          PDFNet.PolyLineAnnot.prototype.setVertex = function(idx, pt) {
              checkArguments(arguments.length, 2, "setVertex", "(number, PDFNet.Point)", [[idx, "number"], [pt, "Structure", PDFNet.Point, "Point"]]);
          ...
          PDFNet.PolyLineAnnot.prototype.setStartStyle = function(style) {
              checkArguments(arguments.length, 1, "setStartStyle", "(number)", [[style, "number"]]);
          ...
          ;
          PDFNet.RedactionAnnot.prototype.setOverlayTextAppearance = function(app) {
              checkArguments(arguments.length, 1, "setOverlayTextAppearance", "(string)", [[app, "string"]]);
              return PDFNet.sendWithPromise("RedactionAnnot.setOverlayTextAppearance", {
                  redaction: this.id,
                  app: app
              })
          }
          ...
          ;
          PDFNet.RubberStampAnnot.createCustom = function(doc, pos, form_xobject) {
              checkArguments(arguments.length, 3, "createCustom", "(PDFNet.SDFDoc, PDFNet.Rect, PDFNet.Obj)", [[doc, "SDFDoc"], [pos, "Structure", PDFNet.Rect, "Rect"], [form_xobject, "Object", PDFNet.Obj, "Obj"]]);
          ...
          PDFNet.rubberStampAnnotSetOpacity = function(stamp, opacity) {
              checkArguments(arguments.length, 2, "rubberStampAnnotSetOpacity", "(PDFNet.Annot, number)", [[stamp, "Object", PDFNet.Annot, "Annot"], [opacity, "number"]]);
          ...
          PDFNet.ScreenAnnot.prototype.getBackgroundColorCompNum = function() {
              return PDFNet.sendWithPromise("ScreenAnnot.getBackgroundColorCompNum", {
                  s: this.id
              })
          }
          ;
          ...
          PDFNet.ScreenAnnot.prototype.setMouseDownCaptionText = function(contents) {
              checkArguments(arguments.length, 1, "setMouseDownCaptionText", "(string)", [[contents, "string"]]);
          ...
          PDFNet.ScreenAnnot.prototype.setStaticIcon = function(icon) {
              checkArguments(arguments.length, 1, "setStaticIcon", "(PDFNet.Obj)", [[icon, "Object", PDFNet.Obj, "Obj"]]);
          ...
          PDFNet.ScreenAnnot.prototype.setRolloverIcon = function(icon) {
              checkArguments(arguments.length, 1, "setRolloverIcon", "(PDFNet.Obj)", [[icon, "Object", PDFNet.Obj, "Obj"]]);
          ...
          PDFNet.ScreenAnnot.prototype.setMouseDownIcon = function(icon) {
              checkArguments(arguments.length, 1, "setMouseDownIcon", "(PDFNet.Obj)", [[icon, "Object", PDFNet.Obj, "Obj"]]);
          ...
          PDFNet.ScreenAnnot.prototype.setHIconLeftOver = function(hl) {
              checkArguments(arguments.length, 1, "setHIconLeftOver", "(number)", [[hl, "number"]]);
          ...
          PDFNet.SoundAnnot.createAtPoint = function(doc, pos) {
              checkArguments(arguments.length, 2, "createAtPoint", "(PDFNet.SDFDoc, PDFNet.Point)", [[doc, "SDFDoc"], [pos, "Structure", PDFNet.Point, "Point"]]);
          ...
          PDFNet.TextAnnot.prototype.isOpen = function() {
              return PDFNet.sendWithPromise("TextAnnot.isOpen", {
                  text: this.id
              })
          }
          ;
          ...
          PDFNet.TextAnnot.prototype.getIcon = function() {
              return PDFNet.sendWithPromise("TextAnnot.getIcon", {
                  text: this.id
              })
          }
          ;
          ...
          PDFNet.TextAnnot.prototype.getAnchorPosition = function(anchor) {
              checkArguments(arguments.length, 1, "getAnchorPosition", "(PDFNet.Point)", [[anchor, "Structure", PDFNet.Point, "Point"]]);
          ...
          PDFNet.TextAnnot.prototype.setAnchorPosition = function(anchor) {
              checkArguments(arguments.length, 1, "setAnchorPosition", "(PDFNet.Point)", [[anchor, "Structure", PDFNet.Point, "Point"]]);
          ...
          PDFNet.WidgetAnnot.create = function(doc, pos, field) {
              checkArguments(arguments.length, 3, "create", "(PDFNet.SDFDoc, PDFNet.Rect, PDFNet.Field)", [[doc, "SDFDoc"], [pos, "Structure", PDFNet.Rect, "Rect"], [field, "Structure", PDFNet.Field, "Field"]]);
          ...
          PDFNet.WidgetAnnot.prototype.getBackgroundColorCompNum = function() {
              return PDFNet.sendWithPromise("WidgetAnnot.getBackgroundColorCompNum", {
                  widget: this.id
              })
          }
          ;
          ...
          ;
          PDFNet.WidgetAnnot.prototype.setBackgroundColor = function(col, compnum) {
          ...
          ;
          PDFNet.SignatureWidget.createWithDigitalSignatureField = function(doc, pos, field) {
              ...
              return PDFNet.sendWithPromise("signatureWidgetCreateWithDigitalSignatureField", {
                  doc: doc.id,
                  pos: pos,
                  field: field
              }).then(function(id) {
          ...
          PDFNet.SignatureWidget.prototype.createSignatureAppearance = function(img) {
              ...
              return PDFNet.sendWithPromise("SignatureWidget.createSignatureAppearance", {
                  self: this.id,
                  img: img.id
              })
          }
          ...
          PDFNet.SignatureWidget.prototype.getDigitalSignatureField = function() {
              return PDFNet.sendWithPromise("SignatureWidget.getDigitalSignatureField", {
                  self: this.id
              }).then(function(id) {
          ...
          PDFNet.ComboBoxWidget.prototype.addOptions = function(opts) {
              checkArguments(arguments.length, 1, "addOptions", "(Array<string>)", [[opts, "Array"]]);
          ...
          PDFNet.ComboBoxWidget.prototype.replaceOptions = function(new_opts) {
              checkArguments(arguments.length, 1, "replaceOptions", "(Array<string>)", [[new_opts, "Array"]]);
          ...
          ;
          PDFNet.ListBoxWidget.prototype.setSelectedOptions = function(selected_opts) {
              checkArguments(arguments.length, 1, "setSelectedOptions", "(Array<string>)", [[selected_opts, "Array"]]);
          ...
          PDFNet.CheckBoxWidget.prototype.setChecked = function(checked) {
              checkArguments(arguments.length, 1, "setChecked", "(boolean)", [[checked, "boolean"]]);
          ...
          PDFNet.Bookmark.createFromObj = function(in_bookmark_dict) {
              checkArguments(arguments.length, 1, "createFromObj", "(PDFNet.Obj)", [[in_bookmark_dict, "Object", PDFNet.Obj, "Obj"]]);
          ...
          PDFNet.Bookmark.prototype.isValid = function() {
              return PDFNet.sendWithPromise("Bookmark.isValid", {
                  bm: this.id
              })
          }
          ;
          ...
          PDFNet.Bookmark.prototype.addNewNext = function(in_title) {
              checkArguments(arguments.length, 1, "addNewNext", "(string)", [[in_title, "string"]]);
          ...
          PDFNet.Bookmark.prototype["delete"] = function() {
              return PDFNet.sendWithPromise("Bookmark.delete", {
                  bm: this.id
              })
          }
          ;
          PDFNet.Bookmark.prototype.unlink = function() {
              return PDFNet.sendWithPromise("Bookmark.unlink", {
                  bm: this.id
              })
          }
          ;
          PDFNet.Bookmark.prototype.getIndent = function() {
              return PDFNet.sendWithPromise("Bookmark.getIndent", {
                  bm: this.id
              })
          }
          ;
          PDFNet.Bookmark.prototype.isOpen = function() {
              return PDFNet.sendWithPromise("Bookmark.isOpen", {
                  bm: this.id
              })
          }
          ;
          ...
          PDFNet.Bookmark.prototype.getFlags = function() {
              return PDFNet.sendWithPromise("Bookmark.getFlags", {
                  bm: this.id
              })
          }
          ;
          ...
          PDFNet.ColorPt.init = function(x, y, z, w) {
              ...
              checkArguments(arguments.length, 0, "init", "(number, number, number, number)", [[x, "number"], [y, "number"], [z, "number"], [w, "number"]]);
          ...
          PDFNet.ColorPt.prototype.setByIndex = function(colorant_index, colorant_value) {
              checkArguments(arguments.length, 2, "setByIndex", "(number, number)", [[colorant_index, "number"], [colorant_value, "number"]]);
          ...
          PDFNet.ColorSpace.createDeviceGray = function() {
              return PDFNet.sendWithPromise("colorSpaceCreateDeviceGray", {}).then(function(id) {
                  return createDestroyableObj(PDFNet.ColorSpace, id)
              })
          }
          ;
          PDFNet.ColorSpace.createDeviceRGB = function() {
              return PDFNet.sendWithPromise("colorSpaceCreateDeviceRGB", {}).then(function(id) {
                  return createDestroyableObj(PDFNet.ColorSpace, id)
              })
          }
          ;
          PDFNet.ColorSpace.createDeviceCMYK = function() {
              return PDFNet.sendWithPromise("colorSpaceCreateDeviceCMYK", {}).then(function(id) {
                  return createDestroyableObj(PDFNet.ColorSpace, id)
              })
          }
          ;
          PDFNet.ColorSpace.createPattern = function() {
              return PDFNet.sendWithPromise("colorSpaceCreatePattern", {}).then(function(id) {
                  return createDestroyableObj(PDFNet.ColorSpace, id)
              })
          }
          ;
          ...
          PDFNet.ColorSpace.createICCFromFilter = function(doc, filter) {
              checkArguments(arguments.length, 2, "createICCFromFilter", "(PDFNet.SDFDoc, PDFNet.Filter)", [[doc, "SDFDoc"], [filter, "Object", PDFNet.Filter, "Filter"]]);
          ...
          PDFNet.ColorSpace.createICCFromBuffer = function(doc, buf) {
              checkArguments(arguments.length, 2, "createICCFromBuffer", "(PDFNet.SDFDoc, ArrayBuffer|TypedArray)", [[doc, "SDFDoc"], [buf, "ArrayBuffer"]]);
              var bufArrayBuffer = getArrayBuffer(buf, !1);
          ...
          PDFNet.ColorSpace.prototype.isAll = function() {
              return PDFNet.sendWithPromise("ColorSpace.isAll", {
                  cs: this.id
              })
          }
          ;
          PDFNet.ColorSpace.prototype.isNone = function() {
              return PDFNet.sendWithPromise("ColorSpace.isNone", {
                  cs: this.id
              })
          }
          ;
          PDFNet.ContentReplacer.create = function() {
              return PDFNet.sendWithPromise("contentReplacerCreate", {}).then(function(id) {
          ...
          PDFNet.ContentReplacer.prototype.addString = function(template_text, replacement_text) {
              checkArguments(arguments.length, 2, "addString", "(string, string)", [[template_text, "string"], [replacement_text, "string"]]);
          ...
          PDFNet.Reflow.prototype.getHtml = function() {
              return PDFNet.sendWithPromise("Reflow.getHtml", {
                  self: this.id
              })
          }
          ;
          PDFNet.Reflow.prototype.getAnnot = function(in_id) {
              checkArguments(arguments.length, 1, "getAnnot", "(string)", [[in_id, "string"]]);
          ...
          PDFNet.Reflow.prototype.setAnnot = function(in_json) {
              checkArguments(arguments.length, 1, "setAnnot", "(string)", [[in_json, "string"]]);
          ...
          PDFNet.Reflow.prototype.setIncludeImages = function(include) {
              checkArguments(arguments.length, 1, "setIncludeImages", "(boolean)", [[include, "boolean"]]);
          ...
          PDFNet.Reflow.prototype.setHTMLOutputTextMarkup = function(include) {
              checkArguments(arguments.length, 1, "setHTMLOutputTextMarkup", "(boolean)", [[include, "boolean"]]);
          ...
          ;
          PDFNet.Reflow.prototype.setMessageWhenNoReflowContent = function(content) {
              checkArguments(arguments.length, 1, "setMessageWhenNoReflowContent", "(string)", [[content, "string"]]);
              return PDFNet.sendWithPromise("Reflow.setMessageWhenNoReflowContent", {
                  self: this.id,
                  content: content
              })
          }
          ;
          PDFNet.Reflow.prototype.setMessageWhenReflowFailed = function(content) {
              checkArguments(arguments.length, 1, "setMessageWhenReflowFailed", "(string)", [[content, "string"]]);
          ...
          ;
          PDFNet.Reflow.prototype.setHideBackgroundImages = function(hide_background_images) {
              checkArguments(arguments.length, 1, "setHideBackgroundImages", "(boolean)", [[hide_background_images, "boolean"]]);
          ...
          ;
          PDFNet.Reflow.prototype.setHideImagesUnderText = function(hide_images_under_text) {
              checkArguments(arguments.length, 1, "setHideImagesUnderText", "(boolean)", [[hide_images_under_text, "boolean"]]);
          ...
          ;
          PDFNet.Reflow.prototype.setHideImagesUnderInvisibleText = function(hide_images_under_invisible_text) {
              checkArguments(arguments.length, 1, "setHideImagesUnderInvisibleText", "(boolean)", [[hide_images_under_invisible_text, "boolean"]]);
              return PDFNet.sendWithPromise("Reflow.setHideImagesUnderInvisibleText", {
                  self: this.id,
                  hide_images_under_invisible_text: hide_images_under_invisible_text
              })
          }
          ;
          PDFNet.Reflow.prototype.setDoNotReflowTextOverImages = function(do_not_reflow_text_over_images) {
              checkArguments(arguments.length, 1, "setDoNotReflowTextOverImages", "(boolean)", [[do_not_reflow_text_over_images, "boolean"]]);
          ...
          PDFNet.Reflow.prototype.setFontOverrideName = function(font_family) {
              checkArguments(arguments.length, 1, "setFontOverrideName", "(string)", [[font_family, "string"]]);
          ...
          PDFNet.Reflow.prototype.setCustomStyles = function(styles) {
              checkArguments(arguments.length, 1, "setCustomStyles", "(string)", [[styles, "string"]]);
          ...
          ;
          PDFNet.Reflow.prototype.setIncludeBBoxForRecognizedZones = function(include) {
              checkArguments(arguments.length, 1, "setIncludeBBoxForRecognizedZones", "(boolean)", [[include, "boolean"]]);
              return PDFNet.sendWithPromise("Reflow.setIncludeBBoxForRecognizedZones", {
                  self: this.id,
                  include: include
              })
          }
          ...
          PDFNet.Convert.fromXpsMem = function(in_pdfdoc, buf) {
              checkArguments(arguments.length, 2, "fromXpsMem", "(PDFNet.PDFDoc, ArrayBuffer|TypedArray)", [[in_pdfdoc, "PDFDoc"], [buf, "ArrayBuffer"]]);
              var bufArrayBuffer = getArrayBuffer(buf, !1);
          ...
          PDFNet.Convert.createReflow = function(in_page, json_zones) {
              checkArguments(arguments.length, 2, "createReflow", "(PDFNet.Page, string)", [[in_page, "Object", PDFNet.Page, "Page"], [json_zones, "string"]]);
          ...
          ;
          PDFNet.Convert.fromTextWithBuffer = function(in_pdfdoc, fileData, options) {
              "undefined" === typeof options && (options = new PDFNet.Obj("0"));
              checkArguments(arguments.length, 2, "fromTextWithBuffer", "(PDFNet.PDFDoc, ArrayBuffer|TypedArray, PDFNet.Obj)", [[in_pdfdoc, "PDFDoc"], [fileData, "ArrayBuffer"], [options, "Object", PDFNet.Obj, "Obj"]]);
          ...
          PDFNet.Convert.toXpsBuffer = function(in_pdfdoc, options$jscomp$0) {
              ...
              checkArguments(arguments.length, 1, "toXpsBuffer", "(PDFNet.PDFDoc, PDFNet.Obj)", [[in_pdfdoc, "PDFDoc"], [options$jscomp$0, "OptionObject", PDFNet.Obj, "Obj", "PDFNet.Convert.XPSOutputOptions"]]);
              options$jscomp$0 = getOptsObjPromise(options$jscomp$0, "PDFNet.Convert.XPSOutputOptions");
          ...
          ;
          PDFNet.Convert.fileToXpsWithBuffer = function(fileData, fileType, options$jscomp$0) {
              "undefined" === typeof options$jscomp$0 && (options$jscomp$0 = new PDFNet.Obj("0"));
              checkArguments(arguments.length, 2, "fileToXpsWithBuffer", "(ArrayBuffer|TypedArray, string, PDFNet.Obj)", [[fileData, "ArrayBuffer"], [fileType, "string"], [options$jscomp$0, "OptionObject", PDFNet.Obj, "Obj", "PDFNet.Convert.XPSOutputOptions"]]);
          ...
          ;
          PDFNet.Convert.fileToXodWithBuffer = function(fileData, fileType, options$jscomp$0) {
              "undefined" === typeof options$jscomp$0 && (options$jscomp$0 = new PDFNet.Obj("0"));
              checkArguments(arguments.length, 2, "fileToXodWithBuffer", "(ArrayBuffer|TypedArray, string, PDFNet.Obj)", [[fileData, "ArrayBuffer"], [fileType, "string"], [options$jscomp$0, "OptionObject", PDFNet.Obj, "Obj", "PDFNet.Convert.XODOutputOptions"]]);
              fileType.startsWith(".") || (fileType = "." + fileType);
              fileData = getArrayBuffer(fileData, !1);
              options$jscomp$0 = getOptsObjPromise(options$jscomp$0, "PDFNet.Convert.XODOutputOptions");
              return options$jscomp$0.then(function(options) {
          ...
          PDFNet.Convert.toXodBuffer = function(in_pdfdoc, options$jscomp$0) {
              "undefined" === typeof options$jscomp$0 && (options$jscomp$0 = new PDFNet.Obj("0"));
              checkArguments(arguments.length, 1, "toXodBuffer", "(PDFNet.PDFDoc, PDFNet.Obj)", [[in_pdfdoc, "PDFDoc"], [options$jscomp$0, "OptionObject", PDFNet.Obj, "Obj", "PDFNet.Convert.XODOutputOptions"]]);
              options$jscomp$0 = getOptsObjPromise(options$jscomp$0, "PDFNet.Convert.XODOutputOptions");
              return options$jscomp$0.then(function(options) {
          ...
          PDFNet.Convert.officeToPdfWithFilter = function(in_pdfdoc, in_stream, options$jscomp$0) {
              "undefined" === typeof options$jscomp$0 && (options$jscomp$0 = new PDFNet.Obj("0"));
              checkArguments(arguments.length, 2, "officeToPdfWithFilter", "(PDFNet.PDFDoc, PDFNet.Filter, PDFNet.Obj)", [[in_pdfdoc, "PDFDoc"], [in_stream, "Object", PDFNet.Filter, "Filter"], [options$jscomp$0, "OptionObject", PDFNet.Obj, "Obj", "PDFNet.Convert.ConversionOptions"]]);
              0 != in_stream.id && avoidCleanup(in_stream.id);
              options$jscomp$0 = getOptsObjPromise(options$jscomp$0, "PDFNet.Convert.ConversionOptions");
              return options$jscomp$0.then(function(options) {
          ...
          ;
          PDFNet.Convert.toPdfWithBuffer = function(in_pdfdoc, fileData, fileType) {
              checkArguments(arguments.length, 3, "toPdfWithBuffer", "(PDFNet.PDFDoc, ArrayBuffer|TypedArray, string)", [[in_pdfdoc, "PDFDoc"], [fileData, "ArrayBuffer"], [fileType, "string"]]);
              fileType.startsWith(".") || (fileType = "." + fileType);
              fileData = getArrayBuffer(fileData, !1);
          ...
          PDFNet.Convert.fromTiff = function(in_pdfdoc, in_data) {
              checkArguments(arguments.length, 2, "fromTiff", "(PDFNet.PDFDoc, PDFNet.Filter)", [[in_pdfdoc, "PDFDoc"], [in_data, "Object", PDFNet.Filter, "Filter"]]);
          ...
          PDFNet.Convert.pageToHtml = function(page) {
              ...
              return PDFNet.sendWithPromise("convertPageToHtml", {
                  page: page.id
              })
          }
          ;
          PDFNet.Convert.pageToHtmlZoned = function(page, json_zones) {
              checkArguments(arguments.length, 2, "pageToHtmlZoned", "(PDFNet.Page, string)", [[page, "Object", PDFNet.Page, "Page"], [json_zones, "string"]]);
          ...
          ;
          PDFNet.Convert.fileToTiffWithBuffer = function(fileData, fileType, options$jscomp$0) {
              "undefined" === typeof options$jscomp$0 && (options$jscomp$0 = new PDFNet.Obj("0"));
              checkArguments(arguments.length, 2, "fileToTiffWithBuffer", "(ArrayBuffer|TypedArray, string, PDFNet.Obj)", [[fileData, "ArrayBuffer"], [fileType, "string"], [options$jscomp$0, "OptionObject", PDFNet.Obj, "Obj", "PDFNet.Convert.TiffOutputOptions"]]);
              fileType.startsWith(".") || (fileType = "." + fileType);
              fileData = getArrayBuffer(fileData, !1);
              options$jscomp$0 = getOptsObjPromise(options$jscomp$0, "PDFNet.Convert.TiffOutputOptions");
              return options$jscomp$0.then(function(options) {
          ...
          PDFNet.Convert.toTiffBuffer = function(in_pdfdoc, options$jscomp$0) {
              "undefined" === typeof options$jscomp$0 && (options$jscomp$0 = new PDFNet.Obj("0"));
              checkArguments(arguments.length, 1, "toTiffBuffer", "(PDFNet.PDFDoc, PDFNet.Obj)", [[in_pdfdoc, "PDFDoc"], [options$jscomp$0, "OptionObject", PDFNet.Obj, "Obj", "PDFNet.Convert.TiffOutputOptions"]]);
              options$jscomp$0 = getOptsObjPromise(options$jscomp$0, "PDFNet.Convert.TiffOutputOptions");
              return options$jscomp$0.then(function(options) {
          ...
          PDFNet.Date.prototype.isValid = function() {
              checkThisYieldFunction("isValid", this.yieldFunction);
              return PDFNet.sendWithPromise("Date.isValid", {
                  date: this
              })
          }
          ;
          ...
          PDFNet.Destination.createXYZ = function(page, left, top, zoom) {
              checkArguments(arguments.length, 4, "createXYZ", "(PDFNet.Page, number, number, number)", [[page, "Object", PDFNet.Page, "Page"], [left, "number"], [top, "number"], [zoom, "number"]]);
          ...
          PDFNet.Destination.createFitV = function(page, left) {
              checkArguments(arguments.length, 2, "createFitV", "(PDFNet.Page, number)", [[page, "Object", PDFNet.Page, "Page"], [left, "number"]]);
          ...
          PDFNet.Destination.createFitR = function(page, left, bottom, right, top) {
              checkArguments(arguments.length, 5, "createFitR", "(PDFNet.Page, number, number, number, number)", [[page, "Object", PDFNet.Page, "Page"], [left, "number"], [bottom, "number"], [right, "number"], [top, "number"]]);
          ...
          PDFNet.Destination.createFitBV = function(page, left) {
              checkArguments(arguments.length, 2, "createFitBV", "(PDFNet.Page, number)", [[page, "Object", PDFNet.Page, "Page"], [left, "number"]]);
          ...
          PDFNet.GState.prototype.getFlatness = function() {
              return PDFNet.sendWithPromise("GState.getFlatness", {
                  gs: this.id
              })
          }
          ;
          PDFNet.GState.prototype.getLineCap = function() {
              return PDFNet.sendWithPromise("GState.getLineCap", {
                  gs: this.id
              })
          }
          ;
          PDFNet.GState.prototype.getLineJoin = function() {
              return PDFNet.sendWithPromise("GState.getLineJoin", {
                  gs: this.id
              })
          }
          ;
          PDFNet.GState.prototype.getLineWidth = function() {
              return PDFNet.sendWithPromise("GState.getLineWidth", {
                  gs: this.id
              })
          }
          ;
          ...
          PDFNet.GState.prototype.getPhase = function() {
              return PDFNet.sendWithPromise("GState.getPhase", {
                  gs: this.id
              })
          }
          ;
          ...
          PDFNet.GState.prototype.getLeading = function() {
              return PDFNet.sendWithPromise("GState.getLeading", {
                  gs: this.id
              })
          }
          ;
          PDFNet.GState.prototype.getFont = function() {
              return PDFNet.sendWithPromise("GState.getFont", {
                  gs: this.id
              }).then(function(id) {
                  return createDestroyableObj(PDFNet.Font, id)
              })
          ...
          PDFNet.GState.prototype.getFontSize = function() {
              return PDFNet.sendWithPromise("GState.getFontSize", {
                  gs: this.id
              })
          }
          ;
          ...
          PDFNet.GState.prototype.getTextRise = function() {
              return PDFNet.sendWithPromise("GState.getTextRise", {
                  gs: this.id
              })
          }
          ;
          ...
          PDFNet.GState.prototype.getBlendMode = function() {
              return PDFNet.sendWithPromise("GState.getBlendMode", {
                  gs: this.id
              })
          }
          ;
          ...
          PDFNet.GState.prototype.getAISFlag = function() {
              return PDFNet.sendWithPromise("GState.getAISFlag", {
                  gs: this.id
              })
          }
          ;
          ...
          PDFNet.GState.prototype.setFillColorSpace = function(cs) {
              checkArguments(arguments.length, 1, "setFillColorSpace", "(PDFNet.ColorSpace)", [[cs, "Object", PDFNet.ColorSpace, "ColorSpace"]]);
          ...
          PDFNet.GState.prototype.setStrokeColor = function(pattern, c) {
              checkArguments(arguments.length, 2, "setStrokeColor", "(PDFNet.PatternColor, PDFNet.ColorPt)", [[pattern, "Object", PDFNet.PatternColor, "PatternColor"], [c, "Object", PDFNet.ColorPt, "ColorPt"]]);
          ...
          PDFNet.GState.prototype.setFillColor = function(pattern, c) {
              checkArguments(arguments.length, 2, "setFillColor", "(PDFNet.PatternColor, PDFNet.ColorPt)", [[pattern, "Object", PDFNet.PatternColor, "PatternColor"], [c, "Object", PDFNet.ColorPt, "ColorPt"]]);
          ...
          PDFNet.GState.prototype.setLineCap = function(cap) {
              checkArguments(arguments.length, 1, "setLineCap", "(number)", [[cap, "number"]]);
          ...
          PDFNet.GState.prototype.setLineWidth = function(width) {
              checkArguments(arguments.length, 1, "setLineWidth", "(number)", [[width, "number"]]);
          ...
          PDFNet.GState.prototype.setDashPattern = function(dash_array, phase) {
              checkArguments(arguments.length, 2, "setDashPattern", "(Array<number>, number)", [[dash_array, "Array"], [phase, "number"]]);
          ...
          PDFNet.GState.prototype.setAutoStrokeAdjust = function(SA) {
              checkArguments(arguments.length, 1, "setAutoStrokeAdjust", "(boolean)", [[SA, "boolean"]]);
          ...
          PDFNet.GState.prototype.setBlackGenFunct = function(BG) {
              checkArguments(arguments.length, 1, "setBlackGenFunct", "(PDFNet.Obj)", [[BG, "Object", PDFNet.Obj, "Obj"]]);
          ...
          PDFNet.GState.prototype.setTransferFunct = function(TR) {
              checkArguments(arguments.length, 1, "setTransferFunct", "(PDFNet.Obj)", [[TR, "Object", PDFNet.Obj, "Obj"]]);
          ...
          PDFNet.Element.prototype.getType = function() {
              return PDFNet.sendWithPromise("Element.getType", {
                  e: this.id
              })
          }
          ;
          ...
          PDFNet.Element.prototype.getCTM = function() {
              return PDFNet.sendWithPromise("Element.getCTM", {
                  e: this.id
              }).then(function(id) {
                  return new PDFNet.Matrix2D(id)
              })
          ...
          PDFNet.Element.prototype.isOCVisible = function() {
              return PDFNet.sendWithPromise("Element.isOCVisible", {
                  e: this.id
              })
          }
          ;
          ...
          PDFNet.Element.prototype.isStroked = function() {
              return PDFNet.sendWithPromise("Element.isStroked", {
                  e: this.id
              })
          }
          ;
          PDFNet.Element.prototype.isFilled = function() {
              return PDFNet.sendWithPromise("Element.isFilled", {
                  e: this.id
              })
          }
          ;
          ...
          PDFNet.Element.prototype.setPathTypes = function(in_seg_types, count) {
              checkArguments(arguments.length, 2, "setPathTypes", "(string, number)", [[in_seg_types, "string"], [count, "number"]]);
          ...
          PDFNet.Element.prototype.isImageMask = function() {
              return PDFNet.sendWithPromise("Element.isImageMask", {
                  e: this.id
              })
          }
          ;
          ...
          PDFNet.Element.prototype.getMask = function() {
              return PDFNet.sendWithPromise("Element.getMask", {
                  e: this.id
              }).then(function(id) {
                  return createPDFNetObj(PDFNet.Obj, id)
              })
          ...
          PDFNet.Element.prototype.setTextMatrix = function(mtx) {
              checkArguments(arguments.length, 1, "setTextMatrix", "(PDFNet.Matrix2D)", [[mtx, "Structure", PDFNet.Matrix2D, "Matrix2D"]]);
          ...
          PDFNet.ElementBuilder.create = function() {
              return PDFNet.sendWithPromise("elementBuilderCreate", {}).then(function(id) {
          ...
          PDFNet.ElementBuilder.prototype.createImageFromMatrix = function(img, mtx) {
              ...
              return PDFNet.sendWithPromise("ElementBuilder.createImageFromMatrix", {
                  b: this.id,
                  img: img.id,
                  mtx: mtx
              }).then(function(id) {
          ...
          PDFNet.ElementBuilder.prototype.createTextBeginWithFont = function(font, font_sz) {
              checkArguments(arguments.length, 2, "createTextBeginWithFont", "(PDFNet.Font, number)", [[font, "Object", PDFNet.Font, "Font"], [font_sz, "number"]]);
              return PDFNet.sendWithPromise("ElementBuilder.createTextBeginWithFont", {
                  b: this.id,
                  font: font.id,
                  font_sz: font_sz
              }).then(function(id) {
          ...
          PDFNet.ElementBuilder.prototype.createTextRunUnsigned = function(text_data, font, font_sz) {
              ...
              return PDFNet.sendWithPromise("ElementBuilder.createTextRunUnsigned", {
                  b: this.id,
                  text_data: text_data,
                  font: font.id,
                  font_sz: font_sz
          ...
          PDFNet.ElementBuilder.prototype.createNewTextRunUnsigned = function(text_data) {
              checkArguments(arguments.length, 1, "createNewTextRunUnsigned", "(string)", [[text_data, "string"]]);
          ...
          PDFNet.ElementBuilder.prototype.createTextNewLineWithOffset = function(dx, dy) {
              ...
              return PDFNet.sendWithPromise("ElementBuilder.createTextNewLineWithOffset", {
                  b: this.id,
                  dx: dx,
                  dy: dy
              }).then(function(id) {
          ...
          ;
          PDFNet.ElementBuilder.prototype.createPath = function(points, buf_seg_types) {
              checkArguments(arguments.length, 2, "createPath", "(Array<number>, ArrayBuffer|TypedArray)", [[points, "Array"], [buf_seg_types, "ArrayBuffer"]]);
          ...
          PDFNet.ElementBuilder.prototype.createRect = function(x, y, width, height) {
              checkArguments(arguments.length, 4, "createRect", "(number, number, number, number)", [[x, "number"], [y, "number"], [width, "number"], [height, "number"]]);
          ...
          PDFNet.ElementBuilder.prototype.lineTo = function(x, y) {
              checkArguments(arguments.length, 2, "lineTo", "(number, number)", [[x, "number"], [y, "number"]]);
          ...
          ;
          PDFNet.ElementBuilder.prototype.createMarkedContentBeginInlineProperties = function(tag) {
              checkArguments(arguments.length, 1, "createMarkedContentBeginInlineProperties", "(string)", [[tag, "string"]]);
              return PDFNet.sendWithPromise("ElementBuilder.createMarkedContentBeginInlineProperties", {
                  b: this.id,
                  tag: tag
              }).then(function(id) {
                  return createPDFNetObj(PDFNet.Element, id)
          ...
          ;
          PDFNet.ElementBuilder.prototype.createMarkedContentBegin = function(tag, property_dict) {
              checkArguments(arguments.length, 2, "createMarkedContentBegin", "(string, PDFNet.Obj)", [[tag, "string"], [property_dict, "Object", PDFNet.Obj, "Obj"]]);
              return PDFNet.sendWithPromise("ElementBuilder.createMarkedContentBegin", {
                  b: this.id,
                  tag: tag,
                  property_dict: property_dict.id
              }).then(function(id) {
                  return createPDFNetObj(PDFNet.Element, id)
              })
          }
          ...
          PDFNet.ElementBuilder.prototype.createMarkedContentEnd = function() {
              return PDFNet.sendWithPromise("ElementBuilder.createMarkedContentEnd", {
                  b: this.id
              }).then(function(id) {
                  return createPDFNetObj(PDFNet.Element, id)
              })
          ...
          ;
          PDFNet.ElementBuilder.prototype.createMarkedContentPointInlineProperties = function(tag) {
              checkArguments(arguments.length, 1, "createMarkedContentPointInlineProperties", "(string)", [[tag, "string"]]);
              return PDFNet.sendWithPromise("ElementBuilder.createMarkedContentPointInlineProperties", {
                  b: this.id,
                  tag: tag
              }).then(function(id) {
                  return createPDFNetObj(PDFNet.Element, id)
          ...
          ;
          PDFNet.ElementBuilder.prototype.createMarkedContentPoint = function(tag, property_dict) {
              checkArguments(arguments.length, 2, "createMarkedContentPoint", "(string, PDFNet.Obj)", [[tag, "string"], [property_dict, "Object", PDFNet.Obj, "Obj"]]);
              return PDFNet.sendWithPromise("ElementBuilder.createMarkedContentPoint", {
                  b: this.id,
                  tag: tag,
                  property_dict: property_dict.id
              }).then(function(id) {
          ...
          PDFNet.ElementReader.create = function() {
              return PDFNet.sendWithPromise("elementReaderCreate", {}).then(function(id) {
          ...
          PDFNet.ElementReader.prototype.beginOnPage = function(page, ctx) {
              ...
              checkArguments(arguments.length, 1, "beginOnPage", "(PDFNet.Page, PDFNet.OCGContext)", [[page, "Object", PDFNet.Page, "Page"], [ctx, "Object", PDFNet.OCGContext, "OCGContext"]]);
          ...
          PDFNet.ElementReader.prototype.begin = function(content_stream, resource_dict, ctx) {
              ...
              "undefined" === typeof ctx && (ctx = new PDFNet.OCGContext("0"));
              checkArguments(arguments.length, 1, "begin", "(PDFNet.Obj, PDFNet.Obj, PDFNet.OCGContext)", [[content_stream, "Object", PDFNet.Obj, "Obj"], [resource_dict, "Object", PDFNet.Obj, "Obj"], [ctx, "Object", PDFNet.OCGContext, "OCGContext"]]);
          ...
          PDFNet.ElementReader.prototype.type3FontBegin = function(char_data, resource_dict) {
              "undefined" === typeof resource_dict && (resource_dict = new PDFNet.Obj("0"));
              checkArguments(arguments.length, 1, "type3FontBegin", "(PDFNet.CharData, PDFNet.Obj)", [[char_data, "Structure", PDFNet.CharData, "CharData"], [resource_dict, "Object", PDFNet.Obj, "Obj"]]);
          ...
          PDFNet.ElementReader.prototype.end = function() {
              return PDFNet.sendWithPromise("ElementReader.end", {
                  r: this.id
              })
          }
          ;
          ...
          PDFNet.ElementWriter.create = function() {
              return PDFNet.sendWithPromise("elementWriterCreate", {}).then(function(id) {
          ...
          PDFNet.ElementWriter.prototype.beginOnPage = function(page, placement, page_coord_sys, compress, resources) {
              ...
              checkArguments(arguments.length, 1, "beginOnPage", "(PDFNet.Page, number, boolean, boolean, PDFNet.Obj)", [[page, "Object", PDFNet.Page, "Page"], [placement, "number"], [page_coord_sys, "boolean"], [compress, "boolean"], [resources, "Object", PDFNet.Obj, "Obj"]]);
          ...
          PDFNet.ElementWriter.prototype.begin = function(doc, compress) {
              "undefined" === typeof compress && (compress = !0);
              checkArguments(arguments.length, 1, "begin", "(PDFNet.SDFDoc, boolean)", [[doc, "SDFDoc"], [compress, "boolean"]]);
          ...
          PDFNet.ElementWriter.prototype.beginOnObj = function(stream_obj_to_update, compress, resources) {
              "undefined" === typeof compress && (compress = !0);
              "undefined" === typeof resources && (resources = new PDFNet.Obj("0"));
              checkArguments(arguments.length, 1, "beginOnObj", "(PDFNet.Obj, boolean, PDFNet.Obj)", [[stream_obj_to_update, "Object", PDFNet.Obj, "Obj"], [compress, "boolean"], [resources, "Object", PDFNet.Obj, "Obj"]]);
          ...
          PDFNet.ElementWriter.prototype.flush = function() {
              return PDFNet.sendWithPromise("ElementWriter.flush", {
                  w: this.id
              })
          }
          ;
          PDFNet.ElementWriter.prototype.writeBuffer = function(data_buf) {
              checkArguments(arguments.length, 1, "writeBuffer", "(ArrayBuffer|TypedArray)", [[data_buf, "ArrayBuffer"]]);
          ...
          PDFNet.ElementWriter.prototype.setDefaultGState = function(reader) {
              checkArguments(arguments.length, 1, "setDefaultGState", "(PDFNet.ElementReader)", [[reader, "Object", PDFNet.ElementReader, "ElementReader"]]);
          ...
          PDFNet.FileSpec.create = function(doc, path, embed) {
              ...
              checkArguments(arguments.length, 2, "create", "(PDFNet.SDFDoc, string, boolean)", [[doc, "SDFDoc"], [path, "string"], [embed, "boolean"]]);
          ...
          PDFNet.FileSpec.prototype.isValid = function() {
              return PDFNet.sendWithPromise("FileSpec.isValid", {
                  fs: this.id
              })
          }
          ;
          ...
          PDFNet.Flattener.create = function() {
              return PDFNet.sendWithPromise("flattenerCreate", {}).then(function(id) {
          ...
          PDFNet.Flattener.prototype.processPage = function(page, mode) {
              checkArguments(arguments.length, 2, "processPage", "(PDFNet.Page, number)", [[page, "Object", PDFNet.Page, "Page"], [mode, "number"]]);
          ...
          PDFNet.Font.createFromFontDescriptor = function(doc, from, char_set) {
              checkArguments(arguments.length, 3, "createFromFontDescriptor", "(PDFNet.SDFDoc, PDFNet.Font, string)", [[doc, "SDFDoc"], [from, "Object", PDFNet.Font, "Font"], [char_set, "string"]]);
          ...
          ;
          PDFNet.Font.createTrueTypeFontWithBuffer = function(doc, font_buffer, embed, subset) {
              "undefined" === typeof embed && (embed = !0);
              "undefined" === typeof subset && (subset = !0);
              checkArguments(arguments.length, 2, "createTrueTypeFontWithBuffer", "(PDFNet.SDFDoc, ArrayBuffer|TypedArray, boolean, boolean)", [[doc, "SDFDoc"], [font_buffer, "ArrayBuffer"], [embed, "boolean"], [subset, "boolean"]]);
          ...
          ;
          PDFNet.Font.createCIDTrueTypeFontWithBuffer = function(doc, font_buffer, embed, subset, encoding, ttc_font_index) {
              "undefined" === typeof embed && (embed = !0);
              "undefined" === typeof subset && (subset = !0);
              "undefined" === typeof encoding && (encoding = PDFNet.Font.Encoding.e_IdentityH);
              "undefined" === typeof ttc_font_index && (ttc_font_index = 0);
              checkArguments(arguments.length, 2, "createCIDTrueTypeFontWithBuffer", "(PDFNet.SDFDoc, ArrayBuffer|TypedArray, boolean, boolean, number, number)", [[doc, "SDFDoc"], [font_buffer, "ArrayBuffer"], [embed, "boolean"], [subset, "boolean"], [encoding, "number"], [ttc_font_index, "number"]]);
              font_buffer = getArrayBuffer(font_buffer, !1);
          ...
          ;
          PDFNet.Font.createType1FontWithBuffer = function(doc, font_buffer, embed) {
              "undefined" === typeof embed && (embed = !0);
              checkArguments(arguments.length, 2, "createType1FontWithBuffer", "(PDFNet.SDFDoc, ArrayBuffer|TypedArray, boolean)", [[doc, "SDFDoc"], [font_buffer, "ArrayBuffer"], [embed, "boolean"]]);
              font_buffer = getArrayBuffer(font_buffer, !1);
          ...
          PDFNet.Font.prototype.getType = function() {
              return PDFNet.sendWithPromise("Font.getType", {
                  font: this.id
              })
          }
          ;
          PDFNet.Font.prototype.isSimple = function() {
              return PDFNet.sendWithPromise("Font.isSimple", {
                  font: this.id
              })
          }
          ;
          ...
          PDFNet.Font.prototype.getName = function() {
              return PDFNet.sendWithPromise("Font.getName", {
                  font: this.id
              })
          }
          ;
          ...
          PDFNet.Font.prototype.isSerif = function() {
              return PDFNet.sendWithPromise("Font.isSerif", {
                  font: this.id
              })
          }
          ;
          PDFNet.Font.prototype.isSymbolic = function() {
              return PDFNet.sendWithPromise("Font.isSymbolic", {
                  font: this.id
              })
          }
          ;
          PDFNet.Font.prototype.isItalic = function() {
              return PDFNet.sendWithPromise("Font.isItalic", {
                  font: this.id
              })
          }
          ;
          PDFNet.Font.prototype.isAllCap = function() {
              return PDFNet.sendWithPromise("Font.isAllCap", {
                  font: this.id
              })
          }
          ;
          ...
          PDFNet.Font.prototype.getEncoding = function() {
              return PDFNet.sendWithPromise("Font.getEncoding", {
                  font: this.id
              })
          }
          ;
          PDFNet.Font.prototype.isEmbedded = function() {
              return PDFNet.sendWithPromise("Font.isEmbedded", {
                  font: this.id
              })
          }
          ;
          ...
          PDFNet.Font.prototype.getBBox = function() {
              return PDFNet.sendWithPromise("Font.getBBox", {
                  font: this.id
              }).then(function(id) {
                  return new PDFNet.Rect(id)
              })
          ...
          PDFNet.Font.prototype.getAscent = function() {
              return PDFNet.sendWithPromise("Font.getAscent", {
                  font: this.id
              })
          }
          ;
          PDFNet.Font.prototype.getDescent = function() {
              return PDFNet.sendWithPromise("Font.getDescent", {
                  font: this.id
              })
          }
          ;
          ...
          PDFNet.Font.prototype.isCFF = function() {
              return PDFNet.sendWithPromise("Font.isCFF", {
                  font: this.id
              })
          }
          ;
          ...
          PDFNet.Font.prototype.getType3GlyphStream = function(char_code) {
              checkArguments(arguments.length, 1, "getType3GlyphStream", "(number)", [[char_code, "number"]]);
          ...
          PDFNet.Function.create = function(funct_dict) {
              "undefined" === typeof funct_dict && (funct_dict = new PDFNet.Obj("0"));
          ...
          PDFNet.Function.prototype.getType = function() {
              return PDFNet.sendWithPromise("Function.getType", {
                  f: this.id
              })
          }
          ;
          ...
          PDFNet.Highlights.create = function() {
              return PDFNet.sendWithPromise("highlightsCreate", {}).then(function(id) {
          ...
          PDFNet.Highlights.prototype.clear = function() {
              return PDFNet.sendWithPromise("Highlights.clear", {
                  hlts: this.id
              })
          }
          ;
          PDFNet.Highlights.prototype.begin = function(doc) {
              checkArguments(arguments.length, 1, "begin", "(PDFNet.PDFDoc)", [[doc, "PDFDoc"]]);
          ...
          PDFNet.Highlights.prototype.next = function() {
              return PDFNet.sendWithPromise("Highlights.next", {
                  hlts: this.id
              })
          }
          ;
          ...
          PDFNet.Image.createFromMemory = function(doc, buf, width, height, bpc, color_space, encoder_hints) {
              ...
              checkArguments(arguments.length, 6, "createFromMemory", "(PDFNet.SDFDoc, ArrayBuffer|TypedArray, number, number, number, PDFNet.ColorSpace, PDFNet.Obj)", [[doc, "SDFDoc"], [buf, "ArrayBuffer"], [width, "number"], [height, "number"], [bpc, "number"], [color_space, "Object", PDFNet.ColorSpace, "ColorSpace"], [encoder_hints, "Object", PDFNet.Obj, "Obj"]]);
              var bufArrayBuffer = getArrayBuffer(buf, !1);
          ...
          PDFNet.Image.createFromMemory2 = function(doc, buf, encoder_hints) {
              "undefined" === typeof encoder_hints && (encoder_hints = new PDFNet.Obj("0"));
              checkArguments(arguments.length, 2, "createFromMemory2", "(PDFNet.SDFDoc, ArrayBuffer|TypedArray, PDFNet.Obj)", [[doc, "SDFDoc"], [buf, "ArrayBuffer"], [encoder_hints, "Object", PDFNet.Obj, "Obj"]]);
              var bufArrayBuffer = getArrayBuffer(buf, !1);
          ...
          PDFNet.Image.createFromStream2 = function(doc, image_data, encoder_hints) {
              "undefined" === typeof encoder_hints && (encoder_hints = new PDFNet.Obj("0"));
              checkArguments(arguments.length, 2, "createFromStream2", "(PDFNet.SDFDoc, PDFNet.Filter, PDFNet.Obj)", [[doc, "SDFDoc"], [image_data, "Object", PDFNet.Filter, "Filter"], [encoder_hints, "Object", PDFNet.Obj, "Obj"]]);
          ...
          PDFNet.Image.createImageMask = function(doc, buf, width, height, encoder_hints) {
              "undefined" === typeof encoder_hints && (encoder_hints = new PDFNet.Obj("0"));
              checkArguments(arguments.length, 4, "createImageMask", "(PDFNet.SDFDoc, ArrayBuffer|TypedArray, number, number, PDFNet.Obj)", [[doc, "SDFDoc"], [buf, "ArrayBuffer"], [width, "number"], [height, "number"], [encoder_hints, "Object", PDFNet.Obj, "Obj"]]);
              var bufArrayBuffer = getArrayBuffer(buf, !1);
          ...
          PDFNet.Image.createSoftMaskFromStream = function(doc, image_data, width, height, bpc, encoder_hints) {
              "undefined" === typeof encoder_hints && (encoder_hints = new PDFNet.Obj("0"));
              checkArguments(arguments.length, 5, "createSoftMaskFromStream", "(PDFNet.SDFDoc, PDFNet.FilterReader, number, number, number, PDFNet.Obj)", [[doc, "SDFDoc"], [image_data, "Object", PDFNet.FilterReader, "FilterReader"], [width, "number"], [height, "number"], [bpc, "number"], [encoder_hints, "Object", PDFNet.Obj, "Obj"]]);
          ...
          PDFNet.Image.createDirectFromMemory = function(doc, buf, width, height, bpc, color_space, input_format) {
              checkArguments(arguments.length, 7, "createDirectFromMemory", "(PDFNet.SDFDoc, ArrayBuffer|TypedArray, number, number, number, PDFNet.ColorSpace, number)", [[doc, "SDFDoc"], [buf, "ArrayBuffer"], [width, "number"], [height, "number"], [bpc, "number"], [color_space, "Object", PDFNet.ColorSpace, "ColorSpace"], [input_format, "number"]]);
              var bufArrayBuffer = getArrayBuffer(buf, !1);
          ...
          PDFNet.Image.createDirectFromStream = function(doc, image_data, width, height, bpc, color_space, input_format) {
              checkArguments(arguments.length, 7, "createDirectFromStream", "(PDFNet.SDFDoc, PDFNet.FilterReader, number, number, number, PDFNet.ColorSpace, number)", [[doc, "SDFDoc"], [image_data, "Object", PDFNet.FilterReader, "FilterReader"], [width, "number"], [height, "number"], [bpc, "number"], [color_space, "Object", PDFNet.ColorSpace, "ColorSpace"], [input_format, "number"]]);
          ...
          PDFNet.Image.createFromObj = function(image_xobject) {
              ...
              checkArguments(arguments.length, 0, "createFromObj", "(PDFNet.Obj)", [[image_xobject, "Object", PDFNet.Obj, "Obj"]]);
          ...
          PDFNet.Image.prototype.copy = function() {
              return PDFNet.sendWithPromise("Image.copy", {
                  c: this.id
              }).then(function(id) {
                  return createPDFNetObj(PDFNet.Image, id)
              })
          ...
          PDFNet.Image.prototype.isValid = function() {
              return PDFNet.sendWithPromise("Image.isValid", {
                  img: this.id
              })
          }
          ;
          ...
          PDFNet.Image.prototype.isImageMask = function() {
              return PDFNet.sendWithPromise("Image.isImageMask", {
                  img: this.id
              })
          }
          ;
          ...
          PDFNet.Image.prototype.getMask = function() {
              return PDFNet.sendWithPromise("Image.getMask", {
                  img: this.id
              }).then(function(id) {
                  return createPDFNetObj(PDFNet.Obj, id)
              })
          ...
          PDFNet.PageLabel.prototype.isValid = function() {
              checkThisYieldFunction("isValid", this.yieldFunction);
              return PDFNet.sendWithPromise("PageLabel.isValid", {
                  l: this
              })
          }
          ;
          ...
          PDFNet.PageLabel.prototype.getStyle = function() {
              ...
              return PDFNet.sendWithPromise("PageLabel.getStyle", {
                  l: this
              })
          }
          ;
          PDFNet.PageLabel.prototype.getPrefix = function() {
              ...
              return PDFNet.sendWithPromise("PageLabel.getPrefix", {
                  l: this
              })
          }
          ;
          ...
          PDFNet.PageLabel.prototype.getStart = function() {
              ...
              return PDFNet.sendWithPromise("PageLabel.getStart", {
                  l: this
              })
          }
          ;
          PDFNet.PageLabel.prototype.setStart = function(start_at) {
              checkArguments(arguments.length, 1, "setStart", "(number)", [[start_at, "number"]]);
          ...
          PDFNet.PageSet.create = function() {
              return PDFNet.sendWithPromise("pageSetCreate", {}).then(function(id) {
          ...
          PDFNet.PatternColor.getTypeFromObj = function(pattern) {
              checkArguments(arguments.length, 1, "getTypeFromObj", "(PDFNet.Obj)", [[pattern, "Object", PDFNet.Obj, "Obj"]]);
          ...
          PDFNet.GeometryCollection.prototype.snapToNearestPixel = function(x, y, dpi, mode) {
              checkArguments(arguments.length, 4, "snapToNearestPixel", "(number, number, number, number)", [[x, "number"], [y, "number"], [dpi, "number"], [mode, "number"]]);
              return PDFNet.sendWithPromise("GeometryCollection.snapToNearestPixel", {
                  self: this.id,
                  x: x,
                  y: y,
                  dpi: dpi,
          ...
          ;
          PDFNet.DigestAlgorithm.calculateDigest = function(in_algorithm, in_buffer) {
              checkArguments(arguments.length, 2, "calculateDigest", "(number, ArrayBuffer|TypedArray)", [[in_algorithm, "number"], [in_buffer, "ArrayBuffer"]]);
          ...
          PDFNet.ObjectIdentifier.createFromPredefined = function(in_oid_enum) {
              ...
              return PDFNet.sendWithPromise("objectIdentifierCreateFromPredefined", {
          ...
          ;
          PDFNet.ObjectIdentifier.createFromDigestAlgorithm = function(in_algorithm) {
              checkArguments(arguments.length, 1, "createFromDigestAlgorithm", "(number)", [[in_algorithm, "number"]]);
              return PDFNet.sendWithPromise("objectIdentifierCreateFromDigestAlgorithm", {
                  in_algorithm: in_algorithm
              }).then(function(id) {
                  return createDestroyableObj(PDFNet.ObjectIdentifier, id)
              })
          ...
          ;
          PDFNet.X501DistinguishedName.prototype.getStringValuesForAttribute = function(in_oid) {
              checkArguments(arguments.length, 1, "getStringValuesForAttribute", "(PDFNet.ObjectIdentifier)", [[in_oid, "Object", PDFNet.ObjectIdentifier, "ObjectIdentifier"]]);
              return PDFNet.sendWithPromise("X501DistinguishedName.getStringValuesForAttribute", {
                  self: this.id,
                  in_oid: in_oid.id
              })
          }
          ...
          PDFNet.X509Certificate.createFromBuffer = function(in_cert_buf) {
              checkArguments(arguments.length, 1, "createFromBuffer", "(ArrayBuffer|TypedArray)", [[in_cert_buf, "ArrayBuffer"]]);
          ...
          PDFNet.X509Certificate.prototype.getNotBeforeEpochTime = function() {
              return PDFNet.sendWithPromise("X509Certificate.getNotBeforeEpochTime", {
                  self: this.id
              })
          }
          ;
          PDFNet.X509Certificate.prototype.getNotAfterEpochTime = function() {
              return PDFNet.sendWithPromise("X509Certificate.getNotAfterEpochTime", {
                  self: this.id
              })
          }
          ;
          ...
          PDFNet.X509Certificate.prototype.getFingerprint = function(in_digest_algorithm) {
              ...
              checkArguments(arguments.length, 0, "getFingerprint", "(number)", [[in_digest_algorithm, "number"]]);
          ...
          PDFNet.TimestampingConfiguration.createFromURL = function(in_url) {
              ...
              return PDFNet.sendWithPromise("timestampingConfigurationCreateFromURL", {
                  in_url: in_url
              }).then(function(id) {
          ...
          PDFNet.TimestampingConfiguration.prototype.setTimestampAuthorityServerURL = function(in_url) {
              ...
              return PDFNet.sendWithPromise("TimestampingConfiguration.setTimestampAuthorityServerURL", {
                  self: this.id,
                  in_url: in_url
              })
          }
          ...
          PDFNet.TimestampingConfiguration.prototype.setTimestampAuthorityServerUsername = function(in_username) {
              ...
              return PDFNet.sendWithPromise("TimestampingConfiguration.setTimestampAuthorityServerUsername", {
                  self: this.id,
                  in_username: in_username
              })
          }
          ;
          PDFNet.TimestampingConfiguration.prototype.setTimestampAuthorityServerPassword = function(in_password) {
              checkArguments(arguments.length, 1, "setTimestampAuthorityServerPassword", "(string)", [[in_password, "string"]]);
              return PDFNet.sendWithPromise("TimestampingConfiguration.setTimestampAuthorityServerPassword", {
                  self: this.id,
          ...
          PDFNet.TimestampingConfiguration.prototype.setUseNonce = function(in_use_nonce) {
              ...
              return PDFNet.sendWithPromise("TimestampingConfiguration.setUseNonce", {
                  self: this.id,
                  in_use_nonce: in_use_nonce
              })
          }
          ;
          PDFNet.TimestampingConfiguration.prototype.testConfiguration = function(in_opts) {
              ...
              return PDFNet.sendWithPromise("TimestampingConfiguration.testConfiguration", {
                  self: this.id,
                  in_opts: in_opts.id
              }).then(function(id) {
          ...
          PDFNet.DigitalSignatureField.prototype.hasCryptographicSignature = function() {
              ...
              return PDFNet.sendWithPromise("DigitalSignatureField.hasCryptographicSignature", {
                  self: this
              })
          }
          ;
          ...
          PDFNet.DigitalSignatureField.prototype.getSignatureName = function() {
              ...
              return PDFNet.sendWithPromise("DigitalSignatureField.getSignatureName", {
                  self: this
              })
          }
          ;
          ...
          PDFNet.DigitalSignatureField.prototype.getContactInfo = function() {
              ...
              return PDFNet.sendWithPromise("DigitalSignatureField.getContactInfo", {
                  self: this
              })
          }
          ;
          ...
          PDFNet.DigitalSignatureField.prototype.hasVisibleAppearance = function() {
              ...
              return PDFNet.sendWithPromise("DigitalSignatureField.hasVisibleAppearance", {
                  self: this
              })
          }
          ;
          PDFNet.DigitalSignatureField.prototype.setContactInfo = function(in_contact_info) {
              checkArguments(arguments.length, 1, "setContactInfo", "(string)", [[in_contact_info, "string"]]);
              checkThisYieldFunction("setContactInfo", this.yieldFunction);
              var me = this;
              this.yieldFunction = "DigitalSignatureField.setContactInfo";
              return PDFNet.sendWithPromise("DigitalSignatureField.setContactInfo", {
                  self: this,
          ...
          PDFNet.DigitalSignatureField.prototype.setLocation = function(in_location) {
              checkArguments(arguments.length, 1, "setLocation", "(string)", [[in_location, "string"]]);
          ...
          PDFNet.DigitalSignatureField.prototype.setReason = function(in_reason) {
              checkArguments(arguments.length, 1, "setReason", "(string)", [[in_reason, "string"]]);
          ...
          PDFNet.DigitalSignatureField.prototype.setDocumentPermissions = function(in_perms) {
              ...
              checkThisYieldFunction("setDocumentPermissions", this.yieldFunction);
              var me = this;
              this.yieldFunction = "DigitalSignatureField.setDocumentPermissions";
              return PDFNet.sendWithPromise("DigitalSignatureField.setDocumentPermissions", {
                  self: this,
                  in_perms: in_perms
              }).then(function(id) {
                  me.yieldFunction = void 0;
          ...
          PDFNet.DigitalSignatureField.prototype.signOnNextSave = function(in_pkcs12_keyfile_path, in_password) {
              checkArguments(arguments.length, 2, "signOnNextSave", "(string, string)", [[in_pkcs12_keyfile_path, "string"], [in_password, "string"]]);
              checkThisYieldFunction("signOnNextSave", this.yieldFunction);
              var me = this;
              this.yieldFunction = "DigitalSignatureField.signOnNextSave";
              return PDFNet.sendWithPromise("DigitalSignatureField.signOnNextSave", {
                  self: this,
          ...
          PDFNet.DigitalSignatureField.prototype.certifyOnNextSave = function(in_pkcs12_keyfile_path, in_password) {
              checkArguments(arguments.length, 2, "certifyOnNextSave", "(string, string)", [[in_pkcs12_keyfile_path, "string"], [in_password, "string"]]);
              checkThisYieldFunction("certifyOnNextSave", this.yieldFunction);
              var me = this;
              this.yieldFunction = "DigitalSignatureField.certifyOnNextSave";
              return PDFNet.sendWithPromise("DigitalSignatureField.certifyOnNextSave", {
                  self: this,
                  in_pkcs12_keyfile_path: in_pkcs12_keyfile_path,
                  in_password: in_password
              }).then(function(id) {
          ...
          ;
          PDFNet.DigitalSignatureField.prototype.isLockedByDigitalSignature = function() {
              checkThisYieldFunction("isLockedByDigitalSignature", this.yieldFunction);
              return PDFNet.sendWithPromise("DigitalSignatureField.isLockedByDigitalSignature", {
                  self: this
              })
          }
          ;
          PDFNet.DigitalSignatureField.prototype.getDocumentPermissions = function() {
              ...
              return PDFNet.sendWithPromise("DigitalSignatureField.getDocumentPermissions", {
                  self: this
              })
          }
          ;
          PDFNet.DigitalSignatureField.prototype.clearSignature = function() {
              ...
              return PDFNet.sendWithPromise("DigitalSignatureField.clearSignature", {
                  self: this
              }).then(function(id) {
                  me.yieldFunction = void 0;
                  copyFunc(id, me)
          ...
          PDFNet.DigitalSignatureField.createFromField = function(in_field) {
              checkArguments(arguments.length, 1, "createFromField", "(PDFNet.Field)", [[in_field, "Structure", PDFNet.Field, "Field"]]);
              checkParamsYieldFunction("createFromField", [[in_field, 0]]);
              return PDFNet.sendWithPromise("digitalSignatureFieldCreateFromField", {
                  in_field: in_field
              }).then(function(id) {
                  return new PDFNet.DigitalSignatureField(id)
              })
          ...
          PDFNet.DigitalSignatureField.prototype.getSigningTime = function() {
              ...
              return PDFNet.sendWithPromise("DigitalSignatureField.getSigningTime", {
                  self: this
              }).then(function(id) {
                  return new PDFNet.Date(id)
              })
          ...
          PDFNet.DigitalSignatureField.prototype.setFieldPermissions = function(in_action, in_field_names_list) {
              ...
              checkArguments(arguments.length, 1, "setFieldPermissions", "(number, Array<string>)", [[in_action, "number"], [in_field_names_list, "Array"]]);
              ...
              return PDFNet.sendWithPromise("DigitalSignatureField.setFieldPermissions", {
                  self: this,
                  in_action: in_action,
          ...
          ;
          PDFNet.DigitalSignatureField.prototype.signOnNextSaveFromBuffer = function(in_pkcs12_buffer, in_password) {
              ...
              return PDFNet.sendWithPromise("DigitalSignatureField.signOnNextSaveFromBuffer", {
                  self: this,
          ...
          PDFNet.DigitalSignatureField.prototype.signOnNextSaveWithCustomHandler = function(in_signature_handler_id) {
              ...
              return PDFNet.sendWithPromise("DigitalSignatureField.signOnNextSaveWithCustomHandler", {
                  self: this,
          ...
          PDFNet.DigitalSignatureField.prototype.certifyOnNextSaveFromBuffer = function(in_pkcs12_buffer, in_password) {
              ...
              var in_pkcs12_bufferArrayBuffer = getArrayBuffer(in_pkcs12_buffer, !1);
              return PDFNet.sendWithPromise("DigitalSignatureField.certifyOnNextSaveFromBuffer", {
                  self: this,
                  in_pkcs12_buffer: in_pkcs12_bufferArrayBuffer,
                  in_password: in_password
              }).then(function(id) {
          ...
          ;
          PDFNet.DigitalSignatureField.prototype.certifyOnNextSaveWithCustomHandler = function(in_signature_handler_id) {
              ...
              return PDFNet.sendWithPromise("DigitalSignatureField.certifyOnNextSaveWithCustomHandler", {
                  self: this,
                  in_signature_handler_id: in_signature_handler_id
              }).then(function(id) {
                  me.yieldFunction = void 0;
          ...
          PDFNet.DigitalSignatureField.prototype.getLockedFields = function() {
              ...
              return PDFNet.sendWithPromise("DigitalSignatureField.getLockedFields", {
                  self: this
              })
          }
          ;
          ...
          PDFNet.DigitalSignatureField.prototype.isCertification = function() {
              ...
              return PDFNet.sendWithPromise("DigitalSignatureField.isCertification", {
                  self: this
              })
          }
          ;
          PDFNet.DigitalSignatureField.prototype.getSignerCertFromCMS = function() {
              ...
              return PDFNet.sendWithPromise("DigitalSignatureField.getSignerCertFromCMS", {
                  self: this
              }).then(function(id) {
                  return createDestroyableObj(PDFNet.X509Certificate, id)
              })
          ...
          ;
          PDFNet.DigitalSignatureField.prototype.enableLTVOfflineVerification = function(in_verification_result) {
              checkArguments(arguments.length, 1, "enableLTVOfflineVerification", "(PDFNet.VerificationResult)", [[in_verification_result, "Object", PDFNet.VerificationResult, "VerificationResult"]]);
              checkThisYieldFunction("enableLTVOfflineVerification", this.yieldFunction);
              return PDFNet.sendWithPromise("DigitalSignatureField.enableLTVOfflineVerification", {
                  self: this,
                  in_verification_result: in_verification_result.id
              })
          }
          ;
          PDFNet.DigitalSignatureField.prototype.timestampOnNextSave = function(in_timestamping_config, in_timestamp_response_verification_options) {
              ...
              return PDFNet.sendWithPromise("DigitalSignatureField.timestampOnNextSave", {
                  self: this,
          ...
          ;
          PDFNet.DigitalSignatureField.prototype.generateContentsWithEmbeddedTimestamp = function(in_timestamping_config, in_timestamp_response_verification_options) {
              checkArguments(arguments.length, 2, "generateContentsWithEmbeddedTimestamp", "(PDFNet.TimestampingConfiguration, PDFNet.VerificationOptions)", [[in_timestamping_config, "Object", PDFNet.TimestampingConfiguration, "TimestampingConfiguration"], [in_timestamp_response_verification_options, "Object", PDFNet.VerificationOptions, "VerificationOptions"]]);
              checkThisYieldFunction("generateContentsWithEmbeddedTimestamp", this.yieldFunction);
              return PDFNet.sendWithPromise("DigitalSignatureField.generateContentsWithEmbeddedTimestamp", {
                  self: this,
                  in_timestamping_config: in_timestamping_config.id,
                  in_timestamp_response_verification_options: in_timestamp_response_verification_options.id
              }).then(function(id) {
          ...
          PDFNet.DigitalSignatureField.prototype.useSubFilter = function(in_subfilter_type, in_make_mandatory) {
              ...
              checkArguments(arguments.length, 1, "useSubFilter", "(number, boolean)", [[in_subfilter_type, "number"], [in_make_mandatory, "boolean"]]);
          ...
          ;
          PDFNet.DigitalSignatureField.prototype.calculateDigest = function(in_digest_algorithm_type) {
              "undefined" === typeof in_digest_algorithm_type && (in_digest_algorithm_type = PDFNet.DigestAlgorithm.Type.e_SHA256);
              checkArguments(arguments.length, 0, "calculateDigest", "(number)", [[in_digest_algorithm_type, "number"]]);
              checkThisYieldFunction("calculateDigest", this.yieldFunction);
              var me = this;
              this.yieldFunction = "DigitalSignatureField.calculateDigest";
              return PDFNet.sendWithPromise("DigitalSignatureField.calculateDigest", {
                  self: this,
          ...
          ;
          PDFNet.DigitalSignatureField.prototype.setPreferredDigestAlgorithm = function(in_digest_algorithm_type, in_make_mandatory) {
              "undefined" === typeof in_make_mandatory && (in_make_mandatory = !0);
              checkArguments(arguments.length, 1, "setPreferredDigestAlgorithm", "(number, boolean)", [[in_digest_algorithm_type, "number"], [in_make_mandatory, "boolean"]]);
              checkThisYieldFunction("setPreferredDigestAlgorithm", this.yieldFunction);
              var me = this;
              this.yieldFunction = "DigitalSignatureField.setPreferredDigestAlgorithm";
              return PDFNet.sendWithPromise("DigitalSignatureField.setPreferredDigestAlgorithm", {
                  self: this,
                  in_digest_algorithm_type: in_digest_algorithm_type,
                  in_make_mandatory: in_make_mandatory
              }).then(function(id) {
          ...
          ;
          PDFNet.DigitalSignatureField.prototype.createSigDictForCustomCertification = function(in_filter_name, in_subfilter_type, in_contents_size_to_reserve) {
              checkArguments(arguments.length, 3, "createSigDictForCustomCertification", "(string, number, number)", [[in_filter_name, "string"], [in_subfilter_type, "number"], [in_contents_size_to_reserve, "number"]]);
              checkThisYieldFunction("createSigDictForCustomCertification", this.yieldFunction);
              var me = this;
              this.yieldFunction = "DigitalSignatureField.createSigDictForCustomCertification";
              return PDFNet.sendWithPromise("DigitalSignatureField.createSigDictForCustomCertification", {
                  self: this,
          ...
          ;
          PDFNet.DigitalSignatureField.prototype.createSigDictForCustomSigning = function(in_filter_name, in_subfilter_type, in_contents_size_to_reserve) {
              checkArguments(arguments.length, 3, "createSigDictForCustomSigning", "(string, number, number)", [[in_filter_name, "string"], [in_subfilter_type, "number"], [in_contents_size_to_reserve, "number"]]);
              checkThisYieldFunction("createSigDictForCustomSigning", this.yieldFunction);
              var me = this;
              this.yieldFunction = "DigitalSignatureField.createSigDictForCustomSigning";
              return PDFNet.sendWithPromise("DigitalSignatureField.createSigDictForCustomSigning", {
                  self: this,
                  in_filter_name: in_filter_name,
                  in_subfilter_type: in_subfilter_type,
                  in_contents_size_to_reserve: in_contents_size_to_reserve
          ...
          ;
          PDFNet.DigitalSignatureField.prototype.setSigDictTimeOfSigning = function(in_date) {
              checkArguments(arguments.length, 1, "setSigDictTimeOfSigning", "(PDFNet.Date)", [[in_date, "Structure", PDFNet.Date, "Date"]]);
              checkThisYieldFunction("setSigDictTimeOfSigning", this.yieldFunction);
              ...
              return PDFNet.sendWithPromise("DigitalSignatureField.setSigDictTimeOfSigning", {
                  self: this,
                  in_date: in_date
              }).then(function(id) {
                  me.yieldFunction = void 0;
          ...
          ;
          PDFNet.DigitalSignatureField.signDigestBuffer = function(in_digest, in_pkcs12_buffer, in_keyfile_password, in_pades_mode, in_digest_algorithm_type) {
              checkArguments(arguments.length, 5, "signDigestBuffer", "(ArrayBuffer|TypedArray, ArrayBuffer|TypedArray, string, boolean, number)", [[in_digest, "ArrayBuffer"], [in_pkcs12_buffer, "ArrayBuffer"], [in_keyfile_password, "string"], [in_pades_mode, "boolean"], [in_digest_algorithm_type, "number"]]);
              var in_digestArrayBuffer = getArrayBuffer(in_digest, !1)
                , in_pkcs12_bufferArrayBuffer = getArrayBuffer(in_pkcs12_buffer, !1);
              return PDFNet.sendWithPromise("digitalSignatureFieldSignDigestBuffer", {
          ...
          ;
          PDFNet.DigitalSignatureField.generateESSSigningCertPAdESAttribute = function(in_signer_cert, in_digest_algorithm_type) {
              checkArguments(arguments.length, 2, "generateESSSigningCertPAdESAttribute", "(PDFNet.X509Certificate, number)", [[in_signer_cert, "Object", PDFNet.X509Certificate, "X509Certificate"], [in_digest_algorithm_type, "number"]]);
              return PDFNet.sendWithPromise("digitalSignatureFieldGenerateESSSigningCertPAdESAttribute", {
          ...
          ;
          PDFNet.DigitalSignatureField.generateCMSSignedAttributes = function(in_digest_buf, in_custom_signedattributes_buf) {
              "undefined" === typeof in_custom_signedattributes_buf && (in_custom_signedattributes_buf = new ArrayBuffer(0));
              checkArguments(arguments.length, 1, "generateCMSSignedAttributes", "(ArrayBuffer|TypedArray, ArrayBuffer|TypedArray)", [[in_digest_buf, "ArrayBuffer"], [in_custom_signedattributes_buf, "ArrayBuffer"]]);
              var in_digest_bufArrayBuffer = getArrayBuffer(in_digest_buf, !1)
                , in_custom_signedattributes_bufArrayBuffer = getArrayBuffer(in_custom_signedattributes_buf, !1);
              return PDFNet.sendWithPromise("digitalSignatureFieldGenerateCMSSignedAttributes", {
                  in_digest_buf: in_digest_bufArrayBuffer,
                  in_custom_signedattributes_buf: in_custom_signedattributes_bufArrayBuffer
              }).then(function(id) {
                  return new Uint8Array(id)
              })
          }
          ;
          PDFNet.DigitalSignatureField.generateCMSSignature = function(in_signer_cert, in_chain_certs_list, in_digest_algorithm_oid, in_signature_algorithm_oid, in_signature_value_buf, in_signedattributes_buf) {
              checkArguments(arguments.length, 6, "generateCMSSignature", "(PDFNet.X509Certificate, Array<Core.PDFNet.X509Certificate>, PDFNet.ObjectIdentifier, PDFNet.ObjectIdentifier, ArrayBuffer|TypedArray, ArrayBuffer|TypedArray)", [[in_signer_cert, "Object", PDFNet.X509Certificate, "X509Certificate"], [in_chain_certs_list, "Array"], [in_digest_algorithm_oid, "Object", PDFNet.ObjectIdentifier, "ObjectIdentifier"], [in_signature_algorithm_oid, "Object", PDFNet.ObjectIdentifier, "ObjectIdentifier"], [in_signature_value_buf, "ArrayBuffer"], [in_signedattributes_buf, "ArrayBuffer"]]);
              var in_signature_value_bufArrayBuffer = getArrayBuffer(in_signature_value_buf, !1)
                , in_signedattributes_bufArrayBuffer = getArrayBuffer(in_signedattributes_buf, !1);
              in_chain_certs_list = Array.from(in_chain_certs_list, function(x) {
                  return x.id
              });
              return PDFNet.sendWithPromise("digitalSignatureFieldGenerateCMSSignature", {
                  in_signer_cert: in_signer_cert.id,
          ...
          PDFNet.PDFDoc.prototype.isXFA = function() {
              return PDFNet.sendWithPromise("PDFDoc.isXFA", {
                  doc: this.id
              })
          }
          ;
          ...
          PDFNet.PDFDoc.createFromFilter = function(stream) {
              checkArguments(arguments.length, 1, "createFromFilter", "(PDFNet.Filter)", [[stream, "Object", PDFNet.Filter, "Filter"]]);
              0 != stream.id && avoidCleanup(stream.id);
          ...
          PDFNet.PDFDoc.prototype.isEncrypted = function() {
              return PDFNet.sendWithPromise("PDFDoc.isEncrypted", {
                  doc: this.id
              })
          }
          ;
          PDFNet.PDFDoc.prototype.initStdSecurityHandlerUString = function(password) {
              ...
              return PDFNet.sendWithPromise("PDFDoc.initStdSecurityHandlerUString", {
                  doc: this.id,
                  password: password
              })
          }
          ;
          PDFNet.PDFDoc.prototype.initStdSecurityHandlerBuffer = function(password_buf) {
          ...
          PDFNet.PDFDoc.prototype.isModified = function() {
              return PDFNet.sendWithPromise("PDFDoc.isModified", {
                  doc: this.id
              })
          }
          ;
          ...
          PDFNet.PDFDoc.prototype.saveMemoryBuffer = function(flags) {
              checkArguments(arguments.length, 1, "saveMemoryBuffer", "(number)", [[flags, "number"]]);
          ...
          ;
          PDFNet.PDFDoc.prototype.saveCustomSignatureBuffer = function(in_signature, in_field) {
              checkArguments(arguments.length, 2, "saveCustomSignatureBuffer", "(ArrayBuffer|TypedArray, PDFNet.DigitalSignatureField)", [[in_signature, "ArrayBuffer"], [in_field, "Structure", PDFNet.DigitalSignatureField, "DigitalSignatureField"]]);
              checkParamsYieldFunction("saveCustomSignatureBuffer", [[in_field, 1]]);
          ...
          ;
          PDFNet.PDFDoc.prototype.saveCustomSignatureStream = function(in_signature, in_field) {
              checkArguments(arguments.length, 2, "saveCustomSignatureStream", "(ArrayBuffer|TypedArray, PDFNet.DigitalSignatureField)", [[in_signature, "ArrayBuffer"], [in_field, "Structure", PDFNet.DigitalSignatureField, "DigitalSignatureField"]]);
              checkParamsYieldFunction("saveCustomSignatureStream", [[in_field, 1]]);
              var in_signatureArrayBuffer = getArrayBuffer(in_signature, !1);
          ...
          PDFNet.PDFDoc.prototype.getPage = function(page_number) {
              checkArguments(arguments.length, 1, "getPage", "(number)", [[page_number, "number"]]);
          ...
          PDFNet.PDFDoc.prototype.insertPages = function(insert_before_page_number, src_doc, start_page, end_page, flag) {
              checkArguments(arguments.length, 5, "insertPages", "(number, PDFNet.PDFDoc, number, number, number)", [[insert_before_page_number, "number"], [src_doc, "PDFDoc"], [start_page, "number"], [end_page, "number"], [flag, "number"]]);
          ...
          PDFNet.PDFDoc.prototype.insertPageSet = function(insert_before_page_number, src_doc, source_page_set, flag) {
              checkArguments(arguments.length, 4, "insertPageSet", "(number, PDFNet.PDFDoc, PDFNet.PageSet, number)", [[insert_before_page_number, "number"], [src_doc, "PDFDoc"], [source_page_set, "Object", PDFNet.PageSet, "PageSet"], [flag, "number"]]);
          ...
          PDFNet.PDFDoc.prototype.movePages = function(move_before_page_number, src_doc, start_page, end_page, flag) {
              checkArguments(arguments.length, 5, "movePages", "(number, PDFNet.PDFDoc, number, number, number)", [[move_before_page_number, "number"], [src_doc, "PDFDoc"], [start_page, "number"], [end_page, "number"], [flag, "number"]]);
          ...
          PDFNet.PDFDoc.prototype.movePageSet = function(move_before_page_number, src_doc, source_page_set, flag) {
              checkArguments(arguments.length, 4, "movePageSet", "(number, PDFNet.PDFDoc, PDFNet.PageSet, number)", [[move_before_page_number, "number"], [src_doc, "PDFDoc"], [source_page_set, "Object", PDFNet.PageSet, "PageSet"], [flag, "number"]]);
          ...
          PDFNet.PDFDoc.prototype.pageCreate = function(media_box) {
              ...
              checkArguments(arguments.length, 0, "pageCreate", "(PDFNet.Rect)", [[media_box, "Structure", PDFNet.Rect, "Rect"]]);
          ...
          PDFNet.PDFDoc.prototype.appendTextDiffPage = function(page1, page2) {
              checkArguments(arguments.length, 2, "appendTextDiffPage", "(PDFNet.Page, PDFNet.Page)", [[page1, "Object", PDFNet.Page, "Page"], [page2, "Object", PDFNet.Page, "Page"]]);
          ...
          ;
          PDFNet.PDFDoc.prototype.appendTextDiffDoc = function(doc1, doc2, options) {
              "undefined" === typeof options && (options = null);
              checkArguments(arguments.length, 2, "appendTextDiffDoc", "(PDFNet.PDFDoc, PDFNet.PDFDoc, PDFNet.OptionBase)", [[doc1, "PDFDoc"], [doc2, "PDFDoc"], [options, "OptionBase"]]);
          ...
          PDFNet.PDFDoc.highlightTextDiff = function(doc1, doc2, options) {
              "undefined" === typeof options && (options = null);
              checkArguments(arguments.length, 2, "highlightTextDiff", "(PDFNet.PDFDoc, PDFNet.PDFDoc, PDFNet.OptionBase)", [[doc1, "PDFDoc"], [doc2, "PDFDoc"], [options, "OptionBase"]]);
          ...
          PDFNet.PDFDoc.prototype.fieldCreate = function(field_name, type, field_value, def_field_value) {
              "undefined" === typeof field_value && (field_value = new PDFNet.Obj("0"));
              "undefined" === typeof def_field_value && (def_field_value = new PDFNet.Obj("0"));
          ...
          PDFNet.PDFDoc.prototype.fdfExtractPageSet = function(pages_to_extract, flag) {
              "undefined" === typeof flag && (flag = PDFNet.PDFDoc.ExtractFlag.e_forms_only);
              checkArguments(arguments.length, 1, "fdfExtractPageSet", "(PDFNet.PageSet, number)", [[pages_to_extract, "Object", PDFNet.PageSet, "PageSet"], [flag, "number"]]);
          ...
          PDFNet.PDFDoc.prototype.addFileAttachment = function(file_key, embedded_file) {
              checkArguments(arguments.length, 2, "addFileAttachment", "(string, PDFNet.FileSpec)", [[file_key, "string"], [embedded_file, "Object", PDFNet.FileSpec, "FileSpec"]]);
          ...
          PDFNet.PDFDoc.prototype.hasOC = function() {
              return PDFNet.sendWithPromise("PDFDoc.hasOC", {
                  doc: this.id
              })
          }
          ;
          ...
          PDFNet.PDFDoc.prototype.createIndirectString = function(value, buf_size) {
              checkArguments(arguments.length, 2, "createIndirectString", "(number, number)", [[value, "number"], [buf_size, "number"]]);
          ...
          PDFNet.PDFDoc.prototype.createIndirectStringFromUString = function(str) {
              ...
              return PDFNet.sendWithPromise("PDFDoc.createIndirectStringFromUString", {
                  doc: this.id,
                  str: str
              }).then(function(id) {
                  return createPDFNetObj(PDFNet.Obj, id)
          ...
          PDFNet.PDFDoc.prototype.createIndirectStreamFromFilter = function(data, filter_chain) {
              ...
              return PDFNet.sendWithPromise("PDFDoc.createIndirectStreamFromFilter", {
                  doc: this.id,
                  data: data.id,
          ...
          ;
          PDFNet.PDFDoc.prototype.createIndirectStream = function(data, filter_chain) {
              checkArguments(arguments.length, 2, "createIndirectStream", "(ArrayBuffer|TypedArray, PDFNet.Filter)", [[data, "ArrayBuffer"], [filter_chain, "Object", PDFNet.Filter, "Filter"]]);
          ...
          PDFNet.PDFDoc.prototype.unlock = function() {
              var me = this;
              return PDFNet.sendWithPromise("PDFDoc.unlock", {
                  doc: this.id
              }).then(function() {
          ...
          PDFNet.PDFDoc.prototype.isTagged = function() {
              return PDFNet.sendWithPromise("PDFDoc.isTagged", {
                  doc: this.id
              })
          }
          ;
          ...
          PDFNet.PDFDoc.prototype.addSignatureHandler = function(signature_handler) {
              checkArguments(arguments.length, 1, "addSignatureHandler", "(PDFNet.SignatureHandler)", [[signature_handler, "Object", PDFNet.SignatureHandler, "SignatureHandler"]]);
          ...
          PDFNet.PDFDoc.prototype.generateThumbnails = function(size) {
              checkArguments(arguments.length, 1, "generateThumbnails", "(number)", [[size, "number"]]);
          ...
          ;
          PDFNet.PDFDoc.prototype.getGeometryCollectionForPageWithOptions = function(page_num, options) {
              "undefined" === typeof options && (options = null);
              checkArguments(arguments.length, 1, "getGeometryCollectionForPageWithOptions", "(number, PDFNet.OptionBase)", [[page_num, "number"], [options, "OptionBase"]]);
              checkParamsYieldFunction("getGeometryCollectionForPageWithOptions", [[options, 1]]);
              options = options ? options.getJsonString() : "{}";
              return PDFNet.sendWithPromise("PDFDoc.getGeometryCollectionForPageWithOptions", {
                  in_pdfdoc: this.id,
                  page_num: page_num,
                  options: options
              }).then(function(id) {
          ...
          ;
          PDFNet.PDFDoc.prototype.getDigitalSignatureFieldIteratorBegin = function() {
              return PDFNet.sendWithPromise("PDFDoc.getDigitalSignatureFieldIteratorBegin", {
                  doc: this.id
              }).then(function(id) {
          ...
          PDFNet.PDFDoc.prototype.getDigitalSignaturePermissions = function() {
              return PDFNet.sendWithPromise("PDFDoc.getDigitalSignaturePermissions", {
                  doc: this.id
              })
          }
          ;
          PDFNet.PDFDoc.prototype.saveViewerOptimizedBuffer = function(opts$jscomp$0) {
              checkArguments(arguments.length, 1, "saveViewerOptimizedBuffer", "(PDFNet.Obj)", [[opts$jscomp$0, "OptionObject", PDFNet.Obj, "Obj", "PDFNet.PDFDoc.ViewerOptimizedOptions"]]);
              opts$jscomp$0 = getOptsObjPromise(opts$jscomp$0, "PDFNet.PDFDoc.ViewerOptimizedOptions");
              var me = this;
          ...
          PDFNet.PDFDoc.prototype.verifySignedDigitalSignatures = function(opts) {
              checkArguments(arguments.length, 1, "verifySignedDigitalSignatures", "(PDFNet.VerificationOptions)", [[opts, "Object", PDFNet.VerificationOptions, "VerificationOptions"]]);
              return PDFNet.sendWithPromise("PDFDoc.verifySignedDigitalSignatures", {
                  doc: this.id,
                  opts: opts.id
              })
          }
          ;
          PDFNet.convertPageToAnnotAppearance = function(docWithAppearance, objNum, annot_state, appearance_state) {
              checkArguments(arguments.length, 4, "convertPageToAnnotAppearance", "(PDFNet.PDFDoc, number, number, string)", [[docWithAppearance, "PDFDoc"], [objNum, "number"], [annot_state, "number"], [appearance_state, "string"]]);
          ...
          PDFNet.PDFDoc.prototype.mergeXFDF = function(stream, options) {
              "undefined" === typeof options && (options = null);
              checkArguments(arguments.length, 1, "mergeXFDF", "(PDFNet.Filter, PDFNet.OptionBase)", [[stream, "Object", PDFNet.Filter, "Filter"], [options, "OptionBase"]]);
          ...
          PDFNet.PDFDoc.prototype.mergeXFDFString = function(xfdf, options) {
              "undefined" === typeof options && (options = null);
              checkArguments(arguments.length, 1, "mergeXFDFString", "(string, PDFNet.OptionBase)", [[xfdf, "string"], [options, "OptionBase"]]);
          ...
          PDFNet.PDFDocInfo.prototype.setKeywords = function(keywords) {
              checkArguments(arguments.length, 1, "setKeywords", "(string)", [[keywords, "string"]]);
          ...
          PDFNet.PDFDocInfo.create = function(tr) {
              ...
              return PDFNet.sendWithPromise("pdfDocInfoCreate", {
                  tr: tr.id
              }).then(function(id) {
                  return createPDFNetObj(PDFNet.PDFDocInfo, id)
              })
          ...
          PDFNet.PDFDocViewPrefs.prototype.setPageMode = function(mode) {
              checkArguments(arguments.length, 1, "setPageMode", "(number)", [[mode, "number"]]);
          ...
          PDFNet.PDFDocViewPrefs.prototype.getNonFullScreenPageMode = function() {
              return PDFNet.sendWithPromise("PDFDocViewPrefs.getNonFullScreenPageMode", {
                  p: this.id
              })
          }
          ;
          ...
          PDFNet.PDFDocViewPrefs.prototype.setViewClip = function(box) {
              checkArguments(arguments.length, 1, "setViewClip", "(number)", [[box, "number"]]);
          ...
          ;
          PDFNet.PDFRasterizer.prototype.setDrawUIElements = function(draw_ui_elements) {
              checkArguments(arguments.length, 1, "setDrawUIElements", "(boolean)", [[draw_ui_elements, "boolean"]]);
          ...
          ;
          PDFNet.PDFRasterizer.prototype.setThinLineScaling = function(scaling) {
              checkArguments(arguments.length, 1, "setThinLineScaling", "(number)", [[scaling, "number"]]);
              return PDFNet.sendWithPromise("PDFRasterizer.setThinLineScaling", {
                  r: this.id,
                  scaling: scaling
              })
          }
          ...
          PDFNet.PDFRasterizer.prototype.setAnnotationState = function(annot, new_view_state) {
              checkArguments(arguments.length, 2, "setAnnotationState", "(PDFNet.Annot, number)", [[annot, "Object", PDFNet.Annot, "Annot"], [new_view_state, "number"]]);
          ...
          PDFNet.PDFRasterizer.prototype.setColorPostProcessMode = function(mode) {
              ...
              return PDFNet.sendWithPromise("PDFRasterizer.setColorPostProcessMode", {
                  r: this.id,
                  mode: mode
              })
          }
          ...
          PDFNet.PDFRasterizer.prototype.getColorPostProcessMode = function() {
              return PDFNet.sendWithPromise("PDFRasterizer.getColorPostProcessMode", {
                  r: this.id
              })
          }
          ;
          PDFNet.PDFRasterizer.prototype.enableDisplayListCaching = function(enabled) {
              ...
              return PDFNet.sendWithPromise("PDFRasterizer.enableDisplayListCaching", {
                  r: this.id,
                  enabled: enabled
              })
          }
          ...
          ;
          PDFNet.PDFRasterizer.prototype.rasterizeAnnot = function(annot, page, device_mtx, demult, cancel) {
          ...
          ;
          PDFNet.PDFRasterizer.prototype.rasterizeSeparations = function(page, width, height, mtx, clip, cancel) {
              checkArguments(arguments.length, 6, "rasterizeSeparations", "(PDFNet.Page, number, number, PDFNet.Matrix2D, PDFNet.Rect, boolean)", [[page, "Object", PDFNet.Page, "Page"], [width, "number"], [height, "number"], [mtx, "Structure", PDFNet.Matrix2D, "Matrix2D"], [clip, "Structure", PDFNet.Rect, "Rect"], [cancel, "boolean"]]);
              checkParamsYieldFunction("rasterizeSeparations", [[mtx, 3], [clip, 4]]);
          ...
          PDFNet.PDFDraw.create = function(dpi) {
              ...
              return PDFNet.sendWithPromise("pdfDrawCreate", {
                  dpi: dpi
              }).then(function(id) {
          ...
          PDFNet.PDFDraw.prototype.setImageSize = function(width, height, preserve_aspect_ratio) {
              "undefined" === typeof preserve_aspect_ratio && (preserve_aspect_ratio = !0);
          ...
          PDFNet.PDFDraw.prototype.setRotate = function(r) {
              checkArguments(arguments.length, 1, "setRotate", "(number)", [[r, "number"]]);
          ...
          ;
          PDFNet.PDFDraw.prototype.setDrawUIElements = function(draw_ui_elements) {
              checkArguments(arguments.length, 1, "setDrawUIElements", "(boolean)", [[draw_ui_elements, "boolean"]]);
          ...
          ;
          PDFNet.PDFDraw.prototype.setThinLineScaling = function(scaling) {
              checkArguments(arguments.length, 1, "setThinLineScaling", "(number)", [[scaling, "number"]]);
              return PDFNet.sendWithPromise("PDFDraw.setThinLineScaling", {
                  d: this.id,
                  scaling: scaling
              })
          }
          ...
          PDFNet.PDFDraw.prototype.getSeparationBitmaps = function(page) {
              checkArguments(arguments.length, 1, "getSeparationBitmaps", "(PDFNet.Page)", [[page, "Object", PDFNet.Page, "Page"]]);
          ...
          PDFNet.terminateEx = function(termination_level) {
              checkArguments(arguments.length, 1, "terminateEx", "(number)", [[termination_level, "number"]]);
          ...
          PDFNet.setColorManagement = function(t) {
              ...
              return PDFNet.sendWithPromise("pdfNetSetColorManagement", {
                  t: t
              })
          }
          ;
          PDFNet.setDefaultDeviceCMYKProfileFromFilter = function(stream) {
              ...
              return PDFNet.sendWithPromise("pdfNetSetDefaultDeviceCMYKProfileFromFilter", {
                  stream: stream.id
              })
          }
          ;
          PDFNet.setDefaultDeviceRGBProfileFromFilter = function(stream) {
              ...
              return PDFNet.sendWithPromise("pdfNetSetDefaultDeviceRGBProfileFromFilter", {
                  stream: stream.id
              })
          }
          ;
          PDFNet.setDefaultFlateCompressionLevel = function(level) {
              ...
              return PDFNet.sendWithPromise("pdfNetSetDefaultFlateCompressionLevel", {
                  level: level
              })
          }
          ;
          PDFNet.setViewerCache = function(max_cache_size, on_disk) {
              checkArguments(arguments.length, 2, "setViewerCache", "(number, boolean)", [[max_cache_size, "number"], [on_disk, "boolean"]]);
          ...
          PDFNet.setLogLevel = function(level) {
              ...
              return PDFNet.sendWithPromise("pdfNetSetLogLevel", {
                  level: level
              })
          }
          ;
          ...
          PDFNet.addPDFTronCustomHandler = function(custom_id) {
              checkArguments(arguments.length, 1, "addPDFTronCustomHandler", "(number)", [[custom_id, "number"]]);
          ...
          PDFNet.setConnectionErrorHandlingMode = function(mode) {
              checkArguments(arguments.length, 1, "setConnectionErrorHandlingMode", "(number)", [[mode, "number"]]);
              return PDFNet.sendWithPromise("pdfNetSetConnectionErrorHandlingMode", {
                  mode: mode
              })
          }
          ;
          ...
          PDFNet.Rect.prototype.get = function() {
              ...
              return PDFNet.sendWithPromise("Rect.get", {
                  rect: this
              })
          }
          ;
          ...
          PDFNet.Rect.prototype.width = function() {
              ...
              return PDFNet.sendWithPromise("Rect.width", {
                  rect: this
              })
          }
          ;
          PDFNet.Rect.prototype.height = function() {
              ...
              return PDFNet.sendWithPromise("Rect.height", {
                  rect: this
              })
          }
          ;
          PDFNet.Rect.prototype.contains = function(x, y) {
              checkArguments(arguments.length, 2, "contains", "(number, number)", [[x, "number"], [y, "number"]]);
          ...
          PDFNet.Rect.prototype.intersectRect = function(rect1, rect2) {
              ...
              checkParamsYieldFunction("intersectRect", [[rect1, 0], [rect2, 1]]);
              var me = this;
          ...
          PDFNet.Rect.prototype.normalize = function() {
              ...
              return PDFNet.sendWithPromise("Rect.normalize", {
                  rect: this
              }).then(function(id) {
                  me.yieldFunction = void 0;
                  copyFunc(id, me)
          ...
          PDFNet.Rect.prototype.inflate2 = function(x, y) {
              checkArguments(arguments.length, 2, "inflate2", "(number, number)", [[x, "number"], [y, "number"]]);
          ...
          PDFNet.Redactor.redactionCreate = function(page_num, bbox, negative, text) {
              checkArguments(arguments.length, 4, "redactionCreate", "(number, PDFNet.Rect, boolean, string)", [[page_num, "number"], [bbox, "Structure", PDFNet.Rect, "Rect"], [negative, "boolean"], [text, "string"]]);
          ...
          PDFNet.Shading.create = function(shading_dict) {
              "undefined" === typeof shading_dict && (shading_dict = new PDFNet.Obj("0"));
          ...
          PDFNet.Shading.prototype.getType = function() {
              return PDFNet.sendWithPromise("Shading.getType", {
                  s: this.id
              })
          }
          ;
          ...
          PDFNet.Shading.prototype.getBBox = function() {
              return PDFNet.sendWithPromise("Shading.getBBox", {
                  s: this.id
              }).then(function(id) {
                  return new PDFNet.Rect(id)
              })
          ...
          PDFNet.Shading.prototype.getAntialias = function() {
              return PDFNet.sendWithPromise("Shading.getAntialias", {
                  s: this.id
              })
          }
          ;
          ...
          PDFNet.Shading.prototype.isExtendEnd = function() {
              return PDFNet.sendWithPromise("Shading.isExtendEnd", {
                  s: this.id
              })
          }
          ;
          ...
          PDFNet.Shading.prototype.getCoords = function() {
              return PDFNet.sendWithPromise("Shading.getCoords", {
                  s: this.id
              })
          }
          ;
          ...
          PDFNet.Shading.prototype.getDomain = function() {
              return PDFNet.sendWithPromise("Shading.getDomain", {
                  s: this.id
              })
          }
          ;
          ...
          PDFNet.Shading.prototype.getColorForFunction = function(t1, t2) {
              checkArguments(arguments.length, 2, "getColorForFunction", "(number, number)", [[t1, "number"], [t2, "number"]]);
          ...
          PDFNet.Stamper.prototype.stampPage = function(dest_doc, page, dest_pages) {
              checkArguments(arguments.length, 3, "stampPage", "(PDFNet.PDFDoc, PDFNet.Page, PDFNet.PageSet)", [[dest_doc, "PDFDoc"], [page, "Object", PDFNet.Page, "Page"], [dest_pages, "Object", PDFNet.PageSet, "PageSet"]]);
          ...
          PDFNet.Stamper.prototype.stampText = function(dest_doc, txt, dest_pages) {
              checkArguments(arguments.length, 3, "stampText", "(PDFNet.PDFDoc, string, PDFNet.PageSet)", [[dest_doc, "PDFDoc"], [txt, "string"], [dest_pages, "Object", PDFNet.PageSet, "PageSet"]]);
          ...
          ;
          PDFNet.Stamper.prototype.setPosition = function(horizontal_distance, vertical_distance, use_percentage) {
              "undefined" === typeof use_percentage && (use_percentage = !1);
              checkArguments(arguments.length, 2, "setPosition", "(number, number, boolean)", [[horizontal_distance, "number"], [vertical_distance, "number"], [use_percentage, "boolean"]]);
          ...
          PDFNet.Stamper.prototype.setSize = function(size_type, a, b) {
              checkArguments(arguments.length, 3, "setSize", "(number, number, number)", [[size_type, "number"], [a, "number"], [b, "number"]]);
          ...
          PDFNet.TextExtractor.create = function() {
              return PDFNet.sendWithPromise("textExtractorCreate", {}).then(function(id) {
          ...
          PDFNet.TextExtractor.prototype.begin = function(page, clip_ptr, flags) {
              ...
              checkArguments(arguments.length, 1, "begin", "(PDFNet.Page, PDFNet.Rect, number)", [[page, "Object", PDFNet.Page, "Page"], [clip_ptr, "Structure", PDFNet.Rect, "Rect"], [flags, "number"]]);
          ...
          PDFNet.TextExtractor.prototype.setRightToLeftLanguage = function(rtl) {
              checkArguments(arguments.length, 1, "setRightToLeftLanguage", "(boolean)", [[rtl, "boolean"]]);
              return PDFNet.sendWithPromise("TextExtractor.setRightToLeftLanguage", {
                  te: this.id,
                  rtl: rtl
              })
          }
          ...
          PDFNet.TextExtractor.prototype.getRightToLeftLanguage = function() {
              return PDFNet.sendWithPromise("TextExtractor.getRightToLeftLanguage", {
                  te: this.id
              })
          }
          ;
          PDFNet.TextExtractor.prototype.getAsText = function(dehyphen) {
              ...
              checkArguments(arguments.length, 0, "getAsText", "(boolean)", [[dehyphen, "boolean"]]);
          ...
          PDFNet.TextExtractorStyle.prototype.compare = function(s) {
              checkArguments(arguments.length, 1, "compare", "(PDFNet.TextExtractorStyle)", [[s, "Structure", PDFNet.TextExtractorStyle, "TextExtractorStyle"]]);
              checkThisYieldFunction("compare", this.yieldFunction);
          ...
          PDFNet.TextExtractorStyle.create = function() {
              return PDFNet.sendWithPromise("textExtractorStyleCreate", {}).then(function(id) {
          ...
          PDFNet.TextExtractorWord.create = function() {
              return PDFNet.sendWithPromise("textExtractorWordCreate", {}).then(function(id) {
          ...
          PDFNet.TextExtractorLine.create = function() {
              return PDFNet.sendWithPromise("textExtractorLineCreate", {}).then(function(id) {
          ...
          PDFNet.TextSearch.create = function() {
              return PDFNet.sendWithPromise("textSearchCreate", {}).then(function(id) {
          ...
          PDFNet.TextSearch.prototype.getMode = function() {
              return PDFNet.sendWithPromise("TextSearch.getMode", {
                  ts: this.id
              })
          }
          ;
          ...
          ;
          PDFNet.TextSearch.prototype.setAmbientLettersBefore = function(ambient_letters_before) {
              checkArguments(arguments.length, 1, "setAmbientLettersBefore", "(number)", [[ambient_letters_before, "number"]]);
          ...
          ;
          PDFNet.TextSearch.prototype.setAmbientLettersAfter = function(ambient_letters_after) {
              checkArguments(arguments.length, 1, "setAmbientLettersAfter", "(number)", [[ambient_letters_after, "number"]]);
          ...
          ;
          PDFNet.TextSearch.prototype.setAmbientWordsBefore = function(ambient_words_before) {
              checkArguments(arguments.length, 1, "setAmbientWordsBefore", "(number)", [[ambient_words_before, "number"]]);
          ...
          ;
          PDFNet.TextSearch.prototype.setAmbientWordsAfter = function(ambient_words_after) {
              checkArguments(arguments.length, 1, "setAmbientWordsAfter", "(number)", [[ambient_words_after, "number"]]);
          ...
          PDFNet.NameTree.prototype.copy = function() {
              return PDFNet.sendWithPromise("NameTree.copy", {
                  d: this.id
              }).then(function(id) {
                  return createPDFNetObj(PDFNet.NameTree, id)
              })
          ...
          PDFNet.NameTree.prototype.isValid = function() {
              return PDFNet.sendWithPromise("NameTree.isValid", {
                  tree: this.id
              })
          }
          ;
          PDFNet.NameTree.prototype.getIterator = function(key) {
              checkArguments(arguments.length, 1, "getIterator", "(string)", [[key, "string"]]);
          ...
          PDFNet.NumberTree.prototype.eraseKey = function(key) {
              checkArguments(arguments.length, 1, "eraseKey", "(number)", [[key, "number"]]);
          ...
          PDFNet.Obj.prototype.getType = function() {
              return PDFNet.sendWithPromise("Obj.getType", {
                  o: this.id
              })
          }
          ;
          PDFNet.Obj.prototype.getDoc = function() {
              return PDFNet.sendWithPromise("Obj.getDoc", {
                  o: this.id
              }).then(function(id) {
                  return createPDFNetObj(PDFNet.SDFDoc, id)
              })
          ...
          PDFNet.Obj.prototype.write = function(stream) {
              checkArguments(arguments.length, 1, "write", "(PDFNet.FilterWriter)", [[stream, "Object", PDFNet.FilterWriter, "FilterWriter"]]);
          ...
          PDFNet.Obj.prototype.isBool = function() {
              return PDFNet.sendWithPromise("Obj.isBool", {
                  o: this.id
              })
          }
          ;
          PDFNet.Obj.prototype.getBool = function() {
              return PDFNet.sendWithPromise("Obj.getBool", {
                  o: this.id
              })
          }
          ;
          PDFNet.Obj.prototype.setBool = function(b) {
              ...
              return PDFNet.sendWithPromise("Obj.setBool", {
                  o: this.id,
                  b: b
              })
          }
          ...
          PDFNet.Obj.prototype.isNumber = function() {
              return PDFNet.sendWithPromise("Obj.isNumber", {
                  o: this.id
              })
          }
          ;
          PDFNet.Obj.prototype.getNumber = function() {
              return PDFNet.sendWithPromise("Obj.getNumber", {
                  o: this.id
              })
          }
          ;
          PDFNet.Obj.prototype.setNumber = function(n) {
              ...
              return PDFNet.sendWithPromise("Obj.setNumber", {
                  o: this.id,
                  n: n
              })
          }
          ...
          PDFNet.Obj.prototype.isNull = function() {
              return PDFNet.sendWithPromise("Obj.isNull", {
                  o: this.id
              })
          }
          ;
          PDFNet.Obj.prototype.isString = function() {
              return PDFNet.sendWithPromise("Obj.isString", {
                  o: this.id
              })
          }
          ;
          PDFNet.Obj.prototype.getBuffer = function() {
              return PDFNet.sendWithPromise("Obj.getBuffer", {
                  o: this.id
              })
          }
          ;
          ...
          PDFNet.Obj.prototype.setUString = function(value) {
              checkArguments(arguments.length, 1, "setUString", "(string)", [[value, "string"]]);
          ...
          PDFNet.Obj.prototype.isName = function() {
              return PDFNet.sendWithPromise("Obj.isName", {
                  o: this.id
              })
          }
          ;
          PDFNet.Obj.prototype.getName = function() {
              return PDFNet.sendWithPromise("Obj.getName", {
                  o: this.id
              })
          }
          ;
          ...
          PDFNet.Obj.prototype.isIndirect = function() {
              return PDFNet.sendWithPromise("Obj.isIndirect", {
                  o: this.id
              })
          }
          ;
          PDFNet.Obj.prototype.getObjNum = function() {
              return PDFNet.sendWithPromise("Obj.getObjNum", {
                  o: this.id
              })
          }
          ;
          PDFNet.Obj.prototype.getGenNum = function() {
              return PDFNet.sendWithPromise("Obj.getGenNum", {
                  o: this.id
              })
          }
          ;
          PDFNet.Obj.prototype.getOffset = function() {
              return PDFNet.sendWithPromise("Obj.getOffset", {
                  o: this.id
              })
          }
          ;
          PDFNet.Obj.prototype.isFree = function() {
              return PDFNet.sendWithPromise("Obj.isFree", {
                  o: this.id
              })
          }
          ;
          ...
          PDFNet.Obj.prototype.isMarked = function() {
              return PDFNet.sendWithPromise("Obj.isMarked", {
                  o: this.id
              })
          }
          ;
          PDFNet.Obj.prototype.isLoaded = function() {
              return PDFNet.sendWithPromise("Obj.isLoaded", {
                  o: this.id
              })
          }
          ;
          PDFNet.Obj.prototype.isContainer = function() {
              return PDFNet.sendWithPromise("Obj.isContainer", {
                  o: this.id
              })
          }
          ;
          PDFNet.Obj.prototype.size = function() {
              return PDFNet.sendWithPromise("Obj.size", {
                  o: this.id
              })
          }
          ;
          ...
          PDFNet.Obj.prototype.isDict = function() {
              return PDFNet.sendWithPromise("Obj.isDict", {
                  o: this.id
              })
          }
          ;
          ...
          PDFNet.Obj.prototype.putDict = function(key) {
              checkArguments(arguments.length, 1, "putDict", "(string)", [[key, "string"]]);
          ...
          PDFNet.Obj.prototype.putNull = function(key) {
              checkArguments(arguments.length, 1, "putNull", "(string)", [[key, "string"]]);
          ...
          PDFNet.Obj.prototype.putMatrix = function(key, mtx) {
              checkArguments(arguments.length, 2, "putMatrix", "(string, PDFNet.Matrix2D)", [[key, "string"], [mtx, "Structure", PDFNet.Matrix2D, "Matrix2D"]]);
          ...
          PDFNet.Obj.prototype.isArray = function() {
              return PDFNet.sendWithPromise("Obj.isArray", {
                  o: this.id
              })
          }
          ;
          ...
          PDFNet.Obj.prototype.insertName = function(pos, name) {
              checkArguments(arguments.length, 2, "insertName", "(number, string)", [[pos, "number"], [name, "string"]]);
          ...
          PDFNet.Obj.prototype.insertString = function(pos, value) {
              checkArguments(arguments.length, 2, "insertString", "(number, string)", [[pos, "number"], [value, "string"]]);
          ...
          PDFNet.Obj.prototype.insertNull = function(pos) {
              checkArguments(arguments.length, 1, "insertNull", "(number)", [[pos, "number"]]);
          ...
          PDFNet.Obj.prototype.insertMatrix = function(pos, mtx) {
              checkArguments(arguments.length, 2, "insertMatrix", "(number, PDFNet.Matrix2D)", [[pos, "number"], [mtx, "Structure", PDFNet.Matrix2D, "Matrix2D"]]);
          ...
          PDFNet.Obj.prototype.pushBackMatrix = function(mtx) {
              checkArguments(arguments.length, 1, "pushBackMatrix", "(PDFNet.Matrix2D)", [[mtx, "Structure", PDFNet.Matrix2D, "Matrix2D"]]);
          ...
          PDFNet.Obj.prototype.isStream = function() {
              return PDFNet.sendWithPromise("Obj.isStream", {
                  o: this.id
              })
          }
          ;
          ...
          PDFNet.Obj.prototype.setStreamData = function(data_buf) {
              checkArguments(arguments.length, 1, "setStreamData", "(ArrayBuffer|TypedArray)", [[data_buf, "ArrayBuffer"]]);
              var data_bufArrayBuffer = getArrayBuffer(data_buf, !1);
          ...
          ;
          PDFNet.Obj.prototype.setStreamDataWithFilter = function(data_buf, filter_chain) {
              checkArguments(arguments.length, 2, "setStreamDataWithFilter", "(ArrayBuffer|TypedArray, PDFNet.Filter)", [[data_buf, "ArrayBuffer"], [filter_chain, "Object", PDFNet.Filter, "Filter"]]);
              var data_bufArrayBuffer = getArrayBuffer(data_buf, !1);
              0 != filter_chain.id && avoidCleanup(filter_chain.id);
          ...
          PDFNet.ObjSet.prototype.createNumber = function(value) {
              checkArguments(arguments.length, 1, "createNumber", "(number)", [[value, "number"]]);
          ...
          PDFNet.SDFDoc.prototype.isEncrypted = function() {
              return PDFNet.sendWithPromise("SDFDoc.isEncrypted", {
                  doc: this.id
              })
          }
          ;
          PDFNet.SDFDoc.prototype.initStdSecurityHandlerUString = function(password) {
              checkArguments(arguments.length, 1, "initStdSecurityHandlerUString", "(string)", [[password, "string"]]);
              return PDFNet.sendWithPromise("SDFDoc.initStdSecurityHandlerUString", {
                  doc: this.id,
                  password: password
              })
          }
          ...
          PDFNet.SDFDoc.prototype.isModified = function() {
              return PDFNet.sendWithPromise("SDFDoc.isModified", {
                  doc: this.id
              })
          }
          ;
          ...
          PDFNet.SDFDoc.prototype.importObj = function(obj, deep_copy) {
              checkArguments(arguments.length, 2, "importObj", "(PDFNet.Obj, boolean)", [[obj, "Object", PDFNet.Obj, "Obj"], [deep_copy, "boolean"]]);
          ...
          PDFNet.SDFDoc.prototype.importObjsWithExcludeList = function(obj_list, exclude_list) {
              checkArguments(arguments.length, 2, "importObjsWithExcludeList", "(Array<Core.PDFNet.Obj>, Array<Core.PDFNet.Obj>)", [[obj_list, "Array"], [exclude_list, "Array"]]);
          ...
          PDFNet.SDFDoc.prototype.xRefSize = function() {
              return PDFNet.sendWithPromise("SDFDoc.xRefSize", {
                  doc: this.id
              })
          }
          ;
          ...
          PDFNet.SDFDoc.prototype.saveStream = function(stream, flags, header) {
              checkArguments(arguments.length, 3, "saveStream", "(PDFNet.Filter, number, string)", [[stream, "Object", PDFNet.Filter, "Filter"], [flags, "number"], [header, "string"]]);
          ...
          PDFNet.SDFDoc.prototype.getHeader = function() {
              return PDFNet.sendWithPromise("SDFDoc.getHeader", {
                  doc: this.id
              })
          }
          ;
          ...
          PDFNet.SDFDoc.prototype.lock = function() {
              var me = this;
              return PDFNet.sendWithPromise("SDFDoc.lock", {
                  doc: this.id
              }).then(function() {
                  lockedObjects.push({
                      name: "SDFDoc",
          ...
          PDFNet.SDFDoc.prototype.unlock = function() {
              var me = this;
              return PDFNet.sendWithPromise("SDFDoc.unlock", {
                  doc: this.id
              }).then(function() {
                  unregisterLockedObject(me)
              })
          ...
          PDFNet.SDFDoc.prototype.getFileName = function() {
              return PDFNet.sendWithPromise("SDFDoc.getFileName", {
                  doc: this.id
              })
          }
          ;
          ...
          PDFNet.SDFDoc.prototype.createIndirectStringFromUString = function(str) {
              checkArguments(arguments.length, 1, "createIndirectStringFromUString", "(string)", [[str, "string"]]);
              return PDFNet.sendWithPromise("SDFDoc.createIndirectStringFromUString", {
                  doc: this.id,
                  str: str
              }).then(function(id) {
                  return createPDFNetObj(PDFNet.Obj, id)
          ...
          ;
          PDFNet.SDFDoc.prototype.createIndirectStream = function(data_buf, filter_chain) {
              checkArguments(arguments.length, 2, "createIndirectStream", "(ArrayBuffer|TypedArray, PDFNet.Filter)", [[data_buf, "ArrayBuffer"], [filter_chain, "Object", PDFNet.Filter, "Filter"]]);
              var data_bufArrayBuffer = getArrayBuffer(data_buf, !1);
              0 != filter_chain.id && avoidCleanup(filter_chain.id);
          ...
          PDFNet.SecurityHandler.prototype.getPermission = function(p) {
              checkArguments(arguments.length, 1, "getPermission", "(number)", [[p, "number"]]);
          ...
          PDFNet.SecurityHandler.prototype.getEncryptionAlgorithmID = function() {
              return PDFNet.sendWithPromise("SecurityHandler.getEncryptionAlgorithmID", {
                  sh: this.id
              })
          }
          ;
          ...
          PDFNet.SecurityHandler.createFromEncCode = function(name, key_len, enc_code) {
              checkArguments(arguments.length, 3, "createFromEncCode", "(string, number, number)", [[name, "string"], [key_len, "number"], [enc_code, "number"]]);
          ...
          PDFNet.SecurityHandler.createDefault = function() {
              return PDFNet.sendWithPromise("securityHandlerCreateDefault", {}).then(function(id) {
                  return createDestroyableObj(PDFNet.SecurityHandler, id)
              })
          }
          ;
          ...
          PDFNet.SecurityHandler.prototype.changeRevisionNumber = function(rev_num) {
              ...
              return PDFNet.sendWithPromise("SecurityHandler.changeRevisionNumber", {
                  sh: this.id,
                  rev_num: rev_num
              })
          }
          ...
          PDFNet.SecurityHandler.prototype.isUserPasswordRequired = function() {
              return PDFNet.sendWithPromise("SecurityHandler.isUserPasswordRequired", {
                  sh: this.id
              })
          }
          ;
          PDFNet.SecurityHandler.prototype.isMasterPasswordRequired = function() {
              return PDFNet.sendWithPromise("SecurityHandler.isMasterPasswordRequired", {
                  sh: this.id
              })
          }
          ;
          ...
          ;
          PDFNet.SecurityHandler.prototype.changeUserPasswordUString = function(password) {
              checkArguments(arguments.length, 1, "changeUserPasswordUString", "(string)", [[password, "string"]]);
              return PDFNet.sendWithPromise("SecurityHandler.changeUserPasswordUString", {
                  sh: this.id,
                  password: password
              })
          }
          ...
          PDFNet.SecurityHandler.prototype.changeUserPasswordBuffer = function(password_buf) {
              ...
              var password_bufArrayBuffer = getArrayBuffer(password_buf, !1);
              return PDFNet.sendWithPromise("SecurityHandler.changeUserPasswordBuffer", {
                  sh: this.id,
                  password_buf: password_bufArrayBuffer
              })
          }
          ...
          PDFNet.SecurityHandler.prototype.changeMasterPasswordUString = function(password) {
              ...
              return PDFNet.sendWithPromise("SecurityHandler.changeMasterPasswordUString", {
                  sh: this.id,
                  password: password
              })
          }
          ;
          PDFNet.SecurityHandler.prototype.changeMasterPasswordBuffer = function(password_buf) {
              checkArguments(arguments.length, 1, "changeMasterPasswordBuffer", "(ArrayBuffer|TypedArray)", [[password_buf, "ArrayBuffer"]]);
              var password_bufArrayBuffer = getArrayBuffer(password_buf, !1);
              return PDFNet.sendWithPromise("SecurityHandler.changeMasterPasswordBuffer", {
                  sh: this.id,
                  password_buf: password_bufArrayBuffer
              })
          }
          ...
          PDFNet.SecurityHandler.prototype.initPasswordUString = function(password) {
              checkArguments(arguments.length, 1, "initPasswordUString", "(string)", [[password, "string"]]);
          ...
          PDFNet.OCRModule.applyOCRJsonToPDF = function(dst, json) {
              checkArguments(arguments.length, 2, "applyOCRJsonToPDF", "(PDFNet.PDFDoc, string)", [[dst, "PDFDoc"], [json, "string"]]);
          ...
          PDFNet.OCRModule.applyOCRXmlToPDF = function(dst, xml) {
              checkArguments(arguments.length, 2, "applyOCRXmlToPDF", "(PDFNet.PDFDoc, string)", [[dst, "PDFDoc"], [xml, "string"]]);
          ...
          ;
          PDFNet.VerificationOptions.prototype.addTrustedCertificate = function(in_certificate_buf, in_trust_flags) {
              "undefined" === typeof in_trust_flags && (in_trust_flags = PDFNet.VerificationOptions.CertificateTrustFlag.e_default_trust);
              checkArguments(arguments.length, 1, "addTrustedCertificate", "(ArrayBuffer|TypedArray, number)", [[in_certificate_buf, "ArrayBuffer"], [in_trust_flags, "number"]]);
              var in_certificate_bufArrayBuffer = getArrayBuffer(in_certificate_buf, !1);
              return PDFNet.sendWithPromise("VerificationOptions.addTrustedCertificate", {
                  self: this.id,
          ...
          ;
          PDFNet.VerificationOptions.prototype.addTrustedCertificates = function(in_P7C_binary_DER_certificates_file_data) {
              checkArguments(arguments.length, 1, "addTrustedCertificates", "(ArrayBuffer|TypedArray)", [[in_P7C_binary_DER_certificates_file_data, "ArrayBuffer"]]);
              var in_P7C_binary_DER_certificates_file_dataArrayBuffer = getArrayBuffer(in_P7C_binary_DER_certificates_file_data, !1);
              return PDFNet.sendWithPromise("VerificationOptions.addTrustedCertificates", {
                  self: this.id,
                  in_P7C_binary_DER_certificates_file_data_buf: in_P7C_binary_DER_certificates_file_dataArrayBuffer
              })
          }
          ;
          PDFNet.VerificationOptions.prototype.loadTrustList = function(in_fdf_cert_exchange_data) {
              checkArguments(arguments.length, 1, "loadTrustList", "(PDFNet.FDFDoc)", [[in_fdf_cert_exchange_data, "FDFDoc"]]);
          ...
          PDFNet.VerificationOptions.prototype.enableModificationVerification = function(in_on_or_off) {
              ...
              return PDFNet.sendWithPromise("VerificationOptions.enableModificationVerification", {
                  self: this.id,
                  in_on_or_off: in_on_or_off
              })
          }
          ;
          PDFNet.VerificationOptions.prototype.enableDigestVerification = function(in_on_or_off) {
              checkArguments(arguments.length, 1, "enableDigestVerification", "(boolean)", [[in_on_or_off, "boolean"]]);
              return PDFNet.sendWithPromise("VerificationOptions.enableDigestVerification", {
                  self: this.id,
                  in_on_or_off: in_on_or_off
              })
          }
          ...
          PDFNet.VerificationOptions.prototype.enableTrustVerification = function(in_on_or_off) {
              ...
              return PDFNet.sendWithPromise("VerificationOptions.enableTrustVerification", {
                  self: this.id,
                  in_on_or_off: in_on_or_off
              })
          }
          ...
          PDFNet.VerificationOptions.prototype.setRevocationProxyPrefix = function(in_str) {
              ...
              return PDFNet.sendWithPromise("VerificationOptions.setRevocationProxyPrefix", {
                  self: this.id,
                  in_str: in_str
              })
          }
          ;
          PDFNet.VerificationOptions.prototype.setRevocationTimeout = function(in_revocation_timeout_milliseconds) {
              checkArguments(arguments.length, 1, "setRevocationTimeout", "(number)", [[in_revocation_timeout_milliseconds, "number"]]);
              return PDFNet.sendWithPromise("VerificationOptions.setRevocationTimeout", {
                  self: this.id,
                  in_revocation_timeout_milliseconds: in_revocation_timeout_milliseconds
              })
          }
          ;
          PDFNet.VerificationOptions.prototype.enableOnlineCRLRevocationChecking = function(in_on_or_off) {
              checkArguments(arguments.length, 1, "enableOnlineCRLRevocationChecking", "(boolean)", [[in_on_or_off, "boolean"]]);
              return PDFNet.sendWithPromise("VerificationOptions.enableOnlineCRLRevocationChecking", {
                  self: this.id,
                  in_on_or_off: in_on_or_off
              })
          }
          ...
          PDFNet.VerificationOptions.prototype.enableOnlineOCSPRevocationChecking = function(in_on_or_off) {
              ...
              return PDFNet.sendWithPromise("VerificationOptions.enableOnlineOCSPRevocationChecking", {
                  self: this.id,
                  in_on_or_off: in_on_or_off
              })
          }
          ...
          PDFNet.VerificationOptions.prototype.enableOnlineRevocationChecking = function(in_on_or_off) {
              ...
              return PDFNet.sendWithPromise("VerificationOptions.enableOnlineRevocationChecking", {
                  self: this.id,
                  in_on_or_off: in_on_or_off
              })
          }
          ...
          PDFNet.VerificationResult.prototype.getDigitalSignatureField = function() {
              return PDFNet.sendWithPromise("VerificationResult.getDigitalSignatureField", {
                  self: this.id
              }).then(function(id) {
                  return new PDFNet.DigitalSignatureField(id)
              })
          ...
          PDFNet.VerificationResult.prototype.getVerificationStatus = function() {
              return PDFNet.sendWithPromise("VerificationResult.getVerificationStatus", {
                  self: this.id
              })
          }
          ;
          PDFNet.VerificationResult.prototype.getDocumentStatus = function() {
              return PDFNet.sendWithPromise("VerificationResult.getDocumentStatus", {
                  self: this.id
              })
          }
          ;
          ...
          PDFNet.VerificationResult.prototype.getPermissionsStatus = function() {
              return PDFNet.sendWithPromise("VerificationResult.getPermissionsStatus", {
                  self: this.id
              })
          }
          ;
          PDFNet.VerificationResult.prototype.getTrustVerificationResult = function() {
              return PDFNet.sendWithPromise("VerificationResult.getTrustVerificationResult", {
                  self: this.id
              }).then(function(id) {
          ...
          PDFNet.VerificationResult.prototype.hasTrustVerificationResult = function() {
              return PDFNet.sendWithPromise("VerificationResult.hasTrustVerificationResult", {
                  self: this.id
              })
          }
          ;
          ...
          PDFNet.VerificationResult.prototype.getDigestAlgorithm = function() {
              return PDFNet.sendWithPromise("VerificationResult.getDigestAlgorithm", {
                  self: this.id
              })
          }
          ;
          PDFNet.VerificationResult.prototype.getDocumentStatusAsString = function() {
              return PDFNet.sendWithPromise("VerificationResult.getDocumentStatusAsString", {
                  self: this.id
              })
          }
          ;
          PDFNet.VerificationResult.prototype.getDigestStatusAsString = function() {
              return PDFNet.sendWithPromise("VerificationResult.getDigestStatusAsString", {
                  self: this.id
              })
          }
          ;
          PDFNet.VerificationResult.prototype.getTrustStatusAsString = function() {
              return PDFNet.sendWithPromise("VerificationResult.getTrustStatusAsString", {
                  self: this.id
              })
          }
          ;
          PDFNet.VerificationResult.prototype.getPermissionsStatusAsString = function() {
              return PDFNet.sendWithPromise("VerificationResult.getPermissionsStatusAsString", {
                  self: this.id
              })
          }
          ;
          PDFNet.VerificationResult.prototype.getUnsupportedFeatures = function() {
              return PDFNet.sendWithPromise("VerificationResult.getUnsupportedFeatures", {
                  self: this.id
              })
          }
          ;
          PDFNet.EmbeddedTimestampVerificationResult.prototype.getVerificationStatus = function() {
              return PDFNet.sendWithPromise("EmbeddedTimestampVerificationResult.getVerificationStatus", {
                  self: this.id
              })
          }
          ;
          PDFNet.EmbeddedTimestampVerificationResult.prototype.getCMSDigestStatus = function() {
              return PDFNet.sendWithPromise("EmbeddedTimestampVerificationResult.getCMSDigestStatus", {
                  self: this.id
              })
          }
          ;
          PDFNet.EmbeddedTimestampVerificationResult.prototype.getMessageImprintDigestStatus = function() {
              return PDFNet.sendWithPromise("EmbeddedTimestampVerificationResult.getMessageImprintDigestStatus", {
                  self: this.id
              })
          }
          ;
          PDFNet.EmbeddedTimestampVerificationResult.prototype.getTrustStatus = function() {
              return PDFNet.sendWithPromise("EmbeddedTimestampVerificationResult.getTrustStatus", {
                  self: this.id
              })
          }
          ;
          PDFNet.EmbeddedTimestampVerificationResult.prototype.getCMSDigestStatusAsString = function() {
              return PDFNet.sendWithPromise("EmbeddedTimestampVerificationResult.getCMSDigestStatusAsString", {
                  self: this.id
              })
          }
          ;
          PDFNet.EmbeddedTimestampVerificationResult.prototype.getMessageImprintDigestStatusAsString = function() {
              return PDFNet.sendWithPromise("EmbeddedTimestampVerificationResult.getMessageImprintDigestStatusAsString", {
                  self: this.id
              })
          }
          ;
          PDFNet.EmbeddedTimestampVerificationResult.prototype.getTrustStatusAsString = function() {
              return PDFNet.sendWithPromise("EmbeddedTimestampVerificationResult.getTrustStatusAsString", {
                  self: this.id
              })
          }
          ;
          PDFNet.EmbeddedTimestampVerificationResult.prototype.hasTrustVerificationResult = function() {
              return PDFNet.sendWithPromise("EmbeddedTimestampVerificationResult.hasTrustVerificationResult", {
                  self: this.id
              })
          }
          ;
          PDFNet.EmbeddedTimestampVerificationResult.prototype.getTrustVerificationResult = function() {
              return PDFNet.sendWithPromise("EmbeddedTimestampVerificationResult.getTrustVerificationResult", {
                  self: this.id
              }).then(function(id) {
                  return createDestroyableObj(PDFNet.TrustVerificationResult, id)
              })
          ...
          PDFNet.EmbeddedTimestampVerificationResult.prototype.getCMSSignatureDigestAlgorithm = function() {
              return PDFNet.sendWithPromise("EmbeddedTimestampVerificationResult.getCMSSignatureDigestAlgorithm", {
                  self: this.id
              })
          }
          ;
          PDFNet.EmbeddedTimestampVerificationResult.prototype.getMessageImprintDigestAlgorithm = function() {
              return PDFNet.sendWithPromise("EmbeddedTimestampVerificationResult.getMessageImprintDigestAlgorithm", {
                  self: this.id
              })
          }
          ;
          PDFNet.EmbeddedTimestampVerificationResult.prototype.getUnsupportedFeatures = function() {
              return PDFNet.sendWithPromise("EmbeddedTimestampVerificationResult.getUnsupportedFeatures", {
                  self: this.id
              })
          }
          ;
          PDFNet.TrustVerificationResult.prototype.wasSuccessful = function() {
              return PDFNet.sendWithPromise("TrustVerificationResult.wasSuccessful", {
                  self: this.id
              })
          }
          ;
          PDFNet.TrustVerificationResult.prototype.getResultString = function() {
              return PDFNet.sendWithPromise("TrustVerificationResult.getResultString", {
                  self: this.id
              })
          }
          ;
          PDFNet.TrustVerificationResult.prototype.getTimeOfTrustVerification = function() {
              return PDFNet.sendWithPromise("TrustVerificationResult.getTimeOfTrustVerification", {
                  self: this.id
              })
          }
          ;
          PDFNet.TrustVerificationResult.prototype.getTimeOfTrustVerificationEnum = function() {
              return PDFNet.sendWithPromise("TrustVerificationResult.getTimeOfTrustVerificationEnum", {
                  self: this.id
              })
          }
          ;
          PDFNet.TrustVerificationResult.prototype.hasEmbeddedTimestampVerificationResult = function() {
              return PDFNet.sendWithPromise("TrustVerificationResult.hasEmbeddedTimestampVerificationResult", {
                  self: this.id
              })
          }
          ;
          PDFNet.TrustVerificationResult.prototype.getEmbeddedTimestampVerificationResult = function() {
              return PDFNet.sendWithPromise("TrustVerificationResult.getEmbeddedTimestampVerificationResult", {
                  self: this.id
              }).then(function(id) {
          ...
          PDFNet.X501AttributeTypeAndValue.prototype.getAttributeTypeOID = function() {
              return PDFNet.sendWithPromise("X501AttributeTypeAndValue.getAttributeTypeOID", {
                  self: this.id
              }).then(function(id) {
                  return createDestroyableObj(PDFNet.ObjectIdentifier, id)
              })
          ...
          PDFNet.X501AttributeTypeAndValue.prototype.getStringValue = function() {
              return PDFNet.sendWithPromise("X501AttributeTypeAndValue.getStringValue", {
                  self: this.id
              })
          }
          ;
          ...
          PDFNet.ByteRange.prototype.getSize = function() {
              ...
              return PDFNet.sendWithPromise("ByteRange.getSize", {
                  self: this
              })
          }
          ;
          ...
          ;
          PDFNet.TimestampingResult.prototype.hasResponseVerificationResult = function() {
              return PDFNet.sendWithPromise("TimestampingResult.hasResponseVerificationResult", {
                  self: this.id
              })
          }
          ;
          PDFNet.TimestampingResult.prototype.getResponseVerificationResult = function() {
              return PDFNet.sendWithPromise("TimestampingResult.getResponseVerificationResult", {
                  self: this.id
              }).then(function(id) {
                  return createDestroyableObj(PDFNet.EmbeddedTimestampVerificationResult, id)
              })
          ...
          PDFNet.Action.prototype.parameterCreateWithAnnot = function(annot) {
              checkArguments(arguments.length, 1, "parameterCreateWithAnnot", "(PDFNet.Annot)", [[annot, "Object", PDFNet.Annot, "Annot"]]);
          ...
          PDFNet.ViewChangeCollection.create = function() {
              return PDFNet.sendWithPromise("viewChangeCollectionCreate", {}).then(function(id) {
                  return createDestroyableObj(PDFNet.ViewChangeCollection, id)
              })
          }
          ;
          PDFNet.RadioButtonGroup.createFromField = function(field) {
              checkArguments(arguments.length, 1, "createFromField", "(PDFNet.Field)", [[field, "Structure", PDFNet.Field, "Field"]]);
          ...
          PDFNet.RadioButtonGroup.create = function(doc, field_name) {
              "undefined" === typeof field_name && (field_name = "");
              checkArguments(arguments.length, 1, "create", "(PDFNet.PDFDoc, string)", [[doc, "PDFDoc"], [field_name, "string"]]);
          ...
          PDFNet.RadioButtonGroup.prototype.add = function(pos, onstate) {
              ...
              checkArguments(arguments.length, 1, "add", "(PDFNet.Rect, string)", [[pos, "Structure", PDFNet.Rect, "Rect"], [onstate, "const char* = 0"]]);
          ...
          PDFNet.RadioButtonGroup.prototype.getButton = function(index) {
              checkArguments(arguments.length, 1, "getButton", "(number)", [[index, "number"]]);
          ...
          ;
          PDFNet.RadioButtonGroup.prototype.addGroupButtonsToPage = function(page) {
              checkArguments(arguments.length, 1, "addGroupButtonsToPage", "(PDFNet.Page)", [[page, "Object", PDFNet.Page, "Page"]]);
              return PDFNet.sendWithPromise("RadioButtonGroup.addGroupButtonsToPage", {
                  group: this.id,
                  page: page.id
              })
          }
          ...
          PDFNet.PDFTronCustomSecurityHandler.create = function(custom_id) {
              checkArguments(arguments.length, 1, "create", "(number)", [[custom_id, "number"]]);
          ...
          PDFNet.WebFontDownloader.disableDownloads = function() {
              return PDFNet.sendWithPromise("webFontDownloaderDisableDownloads", {})
          }
          ;
          ...
          PDFNet.WebFontDownloader.setCustomWebFontURL = function(url) {
              checkArguments(arguments.length, 1, "setCustomWebFontURL", "(string)", [[url, "string"]]);
              return PDFNet.sendWithPromise("webFontDownloaderSetCustomWebFontURL", {
                  url: url
              })
          }
          ;
          PDFNet.FlowDocument.create = function() {
              return PDFNet.sendWithPromise("flowDocumentCreate", {}).then(function(id) {
                  return createDestroyableObj(PDFNet.FlowDocument, id)
              })
          }
          ;
          PDFNet.FlowDocument.prototype.setDefaultPageSize = function(width, height) {
              checkArguments(arguments.length, 2, "setDefaultPageSize", "(number, number)", [[width, "number"], [height, "number"]]);
          ...
          ;
          PDFNet.FlowDocument.prototype.setDefaultMargins = function(left, top, right, bottom) {
              checkArguments(arguments.length, 4, "setDefaultMargins", "(number, number, number, number)", [[left, "number"], [top, "number"], [right, "number"], [bottom, "number"]]);
          ...
          PDFNet.FlowDocument.prototype.addParagraphWithText = function(text) {
              checkArguments(arguments.length, 1, "addParagraphWithText", "(string)", [[text, "string"]]);
          ...
          PDFNet.Paragraph.prototype.addText = function(text) {
              checkArguments(arguments.length, 1, "addText", "(string)", [[text, "string"]]);
          ...
          PDFNet.Paragraph.prototype.setSpaceBefore = function(val) {
              checkArguments(arguments.length, 1, "setSpaceBefore", "(number)", [[val, "number"]]);
          ...
          PDFNet.Paragraph.prototype.setSpaceAfter = function(val) {
              checkArguments(arguments.length, 1, "setSpaceAfter", "(number)", [[val, "number"]]);
          ...
          PDFNet.Paragraph.prototype.setJustificationMode = function(val) {
              checkArguments(arguments.length, 1, "setJustificationMode", "(number)", [[val, "number"]]);
          ...
          PDFNet.Paragraph.prototype.setStartIndent = function(val) {
              checkArguments(arguments.length, 1, "setStartIndent", "(number)", [[val, "number"]]);
          ...
          PDFNet.Paragraph.prototype.setEndIndent = function(val) {
              checkArguments(arguments.length, 1, "setEndIndent", "(number)", [[val, "number"]]);
          ...
          PDFNet.Paragraph.prototype.setTextIndent = function(val) {
              checkArguments(arguments.length, 1, "setTextIndent", "(number)", [[val, "number"]]);
          ...
          ;
          PDFNet.Paragraph.prototype.setBorder = function(thickness, red, green, blue) {
              checkArguments(arguments.length, 4, "setBorder", "(number, number, number, number)", [[thickness, "number"], [red, "number"], [green, "number"], [blue, "number"]]);
          ...
          PDFNet.Paragraph.prototype.addTabStop = function(val) {
              checkArguments(arguments.length, 1, "addTabStop", "(number)", [[val, "number"]]);
          ...
          PDFNet.Paragraph.prototype.getNextTabStop = function(val) {
              checkArguments(arguments.length, 1, "getNextTabStop", "(number)", [[val, "number"]]);
          ...
          PDFNet.Paragraph.prototype.setDefaultTabStop = function(val) {
              checkArguments(arguments.length, 1, "setDefaultTabStop", "(number)", [[val, "number"]]);
          ...
          PDFNet.Paragraph.prototype.setSpacesPerTab = function(val) {
              checkArguments(arguments.length, 1, "setSpacesPerTab", "(number)", [[val, "number"]]);
          ...
          PDFNet.Paragraph.prototype.setDisplayRtl = function(val) {
              checkArguments(arguments.length, 1, "setDisplayRtl", "(boolean)", [[val, "boolean"]]);
          ...
          PDFNet.Table.prototype.getTableCell = function(column, row) {
              checkArguments(arguments.length, 2, "getTableCell", "(number, number)", [[column, "number"], [row, "number"]]);
          ...
          PDFNet.Table.prototype.setDefaultColumnWidth = function(val) {
              checkArguments(arguments.length, 1, "setDefaultColumnWidth", "(number)", [[val, "number"]]);
          ...
          PDFNet.Table.prototype.setDefaultRowHeight = function(val) {
              checkArguments(arguments.length, 1, "setDefaultRowHeight", "(number)", [[val, "number"]]);
          ...
          PDFNet.Table.prototype.getNumRows = function() {
              return PDFNet.sendWithPromise("Table.getNumRows", {
                  self: this.id
              })
          }
          ;
          ...
          ;
          PDFNet.Table.prototype.setBorder = function(thickness, red, green, blue) {
              checkArguments(arguments.length, 4, "setBorder", "(number, number, number, number)", [[thickness, "number"], [red, "number"], [green, "number"], [blue, "number"]]);
          ...
          PDFNet.TableCell.prototype.mergeCellsRight = function(num) {
              checkArguments(arguments.length, 1, "mergeCellsRight", "(number)", [[num, "number"]]);
          ...
          PDFNet.TableCell.prototype.mergeCellsDown = function(num) {
              checkArguments(arguments.length, 1, "mergeCellsDown", "(number)", [[num, "number"]]);
          ...
          ;
          PDFNet.TableCell.prototype.setBackgroundColor = function(red, green, blue) {
              checkArguments(arguments.length, 3, "setBackgroundColor", "(number, number, number)", [[red, "number"], [green, "number"], [blue, "number"]]);
          ...
          ;
          PDFNet.TableCell.prototype.setBorder = function(thickness, red, green, blue) {
              checkArguments(arguments.length, 4, "setBorder", "(number, number, number, number)", [[thickness, "number"], [red, "number"], [green, "number"], [blue, "number"]]);
          ...
          PDFNet.TableCell.prototype.setVerticalAlignment = function(val) {
              checkArguments(arguments.length, 1, "setVerticalAlignment", "(number)", [[val, "number"]]);
          ...
          PDFNet.TableCell.prototype.setHorizontalAlignment = function(val) {
              checkArguments(arguments.length, 1, "setHorizontalAlignment", "(number)", [[val, "number"]]);
          ...
          PDFNet.TableCell.prototype.setHeight = function(val) {
              checkArguments(arguments.length, 1, "setHeight", "(number)", [[val, "number"]]);
          ...
          PDFNet.TableCell.prototype.setWidth = function(val) {
              checkArguments(arguments.length, 1, "setWidth", "(number)", [[val, "number"]]);
          ...
          PDFNet.TableRow.prototype.setRowHeight = function(val) {
              checkArguments(arguments.length, 1, "setRowHeight", "(number)", [[val, "number"]]);
          ...
          PDFNet.TextRun.prototype.getText = function() {
              return PDFNet.sendWithPromise("TextRun.getText", {
                  self: this.id
              })
          }
          ;
          PDFNet.TextStyledElement.prototype.setFontFace = function(font_name) {
              checkArguments(arguments.length, 1, "setFontFace", "(string)", [[font_name, "string"]]);
          ...
          PDFNet.TextStyledElement.prototype.setItalic = function(val) {
              checkArguments(arguments.length, 1, "setItalic", "(boolean)", [[val, "boolean"]]);
          ...
          PDFNet.TextStyledElement.prototype.setBold = function(val) {
              checkArguments(arguments.length, 1, "setBold", "(boolean)", [[val, "boolean"]]);
          ...
          ;
          PDFNet.TextStyledElement.prototype.setTextColor = function(red, green, blue) {
              checkArguments(arguments.length, 3, "setTextColor", "(number, number, number)", [[red, "number"], [green, "number"], [blue, "number"]]);
          ...
          ;
          PDFNet.TextStyledElement.prototype.setBackgroundColor = function(red, green, blue) {
              checkArguments(arguments.length, 3, "setBackgroundColor", "(number, number, number)", [[red, "number"], [green, "number"], [blue, "number"]]);
              return PDFNet.sendWithPromise("TextStyledElement.setBackgroundColor", {
                  impl: this.id,
                  red: red,
                  green: green,
                  blue: blue
          ...
          ;
          PDFNet.List.prototype.setNumberFormat = function(format, suffix, cascade) {
              checkArguments(arguments.length, 3, "setNumberFormat", "(number, string, boolean)", [[format, "number"], [suffix, "string"], [cascade, "boolean"]]);
          ...
          PDFNet.List.prototype.setStartIndex = function(idx) {
              checkArguments(arguments.length, 1, "setStartIndex", "(number)", [[idx, "number"]]);
          ...
          PDFNet.List.prototype.addItem = function() {
              return PDFNet.sendWithPromise("List.addItem", {
                  self: this.id
              }).then(function(id) {
                  return createPDFNetObj(PDFNet.ListItem, id)
              })
          ...
          PDFNet.List.prototype.continueList = function() {
              return PDFNet.sendWithPromise("List.continueList", {
                  self: this.id
              })
          }
          ;
          ...
          var getUrlAsBuffer = function(jsUrl, options) {
              ...
              return new Promise(function(resolve, reject) {
                  ...
                  xhr.onload = function(evt) {
                      200 == this.status ? (evt = new Uint8Array(xhr.response),
                      resolve(evt)) : reject(Error("Download Failed"))
                  }
                  ;
            ...
            , checkArguments = function(inputArgNum, minNum, funcName, funcParams, argInfoList) {
              ...
              if (minNum === maxNum) {
                  if (inputArgNum !== minNum)
                      throw new RangeError(inputArgNum + " arguments passed into function '" + funcName + "'. Expected " + minNum + " argument. Function Signature: " + funcName + funcParams);
              } else if (0 >= minNum) {
                  if (inputArgNum > maxNum)
                      throw new RangeError(inputArgNum + " arguments passed into function '" + funcName + "'. Expected at most " + maxNum + " arguments. Function Signature: " + funcName + funcParams);
              } else if (inputArgNum < minNum || inputArgNum > maxNum)
                  throw new RangeError(inputArgNum + " arguments passed into function '" + funcName + "'. Expected " + minNum + " to " + maxNum + " arguments. Function Signature: " + funcName + funcParams);
              var throwParaTypeError = function(argPos, argType, expectedType) {
                  throw new TypeError(positionString(argPos) + " input argument in function '" + funcName + "' is of type '" + argType + "'. Expected type '" + expectedType + "'. Function Signature: " + funcName + funcParams);
              };
              ...
              for (minNum = 0; minNum < maxNum; minNum++) {
                  ...
                  if (arg$jscomp$0 instanceof Promise)
                      throw new TypeError(positionString(minNum) + " input argument in function '" + funcName + "' is a Promise object. Promises require a 'yield' statement before being accessed.");
                  if ("OptionBase" === argType) {
                      if (arg$jscomp$0)
                          if ("object" === _typeof(arg$jscomp$0)) {
                              if ("function" !== typeof arg$jscomp$0.getJsonString)
                                  throw new TypeError(positionString(minNum) + " input argument in function '" + funcName + "' is an 'oject' which is expected to have the 'getJsonString' function");
                          } else
                              throwParaTypeError(minNum, arg$jscomp$0.name, "object")
                  } else
                      "Array" === argType ? Array.isArray(arg$jscomp$0) || inputArgNum(arg$jscomp$0, minNum, "Array") : "ArrayBuffer" === argType ? exports.isArrayBuffer(arg$jscomp$0) || exports.isArrayBuffer(arg$jscomp$0.buffer) || inputArgNum(arg$jscomp$0, minNum, "ArrayBuffer|TypedArray") : "ArrayAsBuffer" === argType ? Array.isArray(arg$jscomp$0) || exports.isArrayBuffer(arg$jscomp$0) || exports.isArrayBuffer(arg$jscomp$0.buffer) || inputArgNum(arg$jscomp$0, minNum, "ArrayBuffer|TypedArray") : "PDFDoc" === argType || "SDFDoc" === argType || "FDFDoc" === argType ? arg$jscomp$0 instanceof PDFNet.PDFDoc || arg$jscomp$0 instanceof PDFNet.SDFDoc || arg$jscomp$0 instanceof PDFNet.FDFDoc || inputArgNum(arg$jscomp$0, minNum, "PDFDoc|SDFDoc|FDFDoc") : "Structure" === argType ? arg$jscomp$0 instanceof argInfo[2] || !arg$jscomp$0 || arg$jscomp$0.name === argInfo[3] || inputArgNum(arg$jscomp$0, minNum, argInfo[3]) : "OptionObject" === argType ? arg$jscomp$0 instanceof argInfo[2] || ("object" === _typeof(arg$jscomp$0) && arg$jscomp$0.name ? arg$jscomp$0.name !== argInfo[4] && throwParaTypeError(minNum, arg$jscomp$0.name, argInfo[3]) : throwParaTypeError(minNum, _typeof(arg$jscomp$0), argInfo[3])) : "Object" === argType ? arg$jscomp$0 instanceof argInfo[2] || inputArgNum(arg$jscomp$0, minNum, argInfo[3]) : "const char* = 0" === argType ? "string" !== typeof arg$jscomp$0 && null !== arg$jscomp$0 && throwParaTypeError(minNum, _typeof(arg$jscomp$0), "string") : _typeof(arg$jscomp$0) !== argType && throwParaTypeError(minNum, _typeof(arg$jscomp$0), argType)
              }
          }
            , checkThisYieldFunction = function(funcName, yieldFunc) {
              if ("undefined" !== typeof yieldFunc)
                  throw Error("Function " + yieldFunc + " recently altered a struct object without yielding. That object is now being accessed by function '" + funcName + "'. Perhaps a yield statement is required for " + yieldFunc + "?");
          }
            , checkParamsYieldFunction = function(funcName, argInfoList) {
              for (var i = 0; i < argInfoList.length; i++) {
                  ...
                  if (arg && "undefined" !== typeof arg.yieldFunction)
                      throw Error("Function '" + arg.yieldFunction + "' recently altered a struct object without yielding. That object is now being accessed by the " + positionString(argInfo[1]) + " input argument in function '" + funcName + "'. Perhaps a yield statement is required for '" + arg.yieldFunction + "'?");
              }
          }
            , getArrayBuffer = function(buffer, arrayAsBuffer) {
              ...
              exports.isArrayBuffer(bufferArrayBuffer) || (bufferArrayBuffer = bufferArrayBuffer.buffer,
              buffer.byteLength < bufferArrayBuffer.byteLength && (bufferArrayBuffer = bufferArrayBuffer.slice(buffer.byteOffset, buffer.byteOffset + buffer.byteLength)));
              return bufferArrayBuffer
          }
            , getOptsObjPromise = function(options, optionClassName) {
              return options.name === optionClassName ? PDFNet.ObjSet.create().then(function(set) {
                  var optsJsonStr = "function" === typeof options.getJsonString ? options.getJsonString() : JSON.stringify(options);
          ...
          var createDestroyableObj = function(constructor, id, type) {
            ...
            , unregisterLockedObject = function(obj) {
              ...
              if (-1 != objIndex)
                  for (lockedObjects.splice(objIndex, 1),
                  i = unlockStackCounter.length - 1; 0 <= i; i--)
            ...
            , avoidCleanup = function(id) {
              ...
              if (-1 != objIndex)
                  for (createdObjects.splice(objIndex, 1),
                  i = deallocStackCounter.length - 1; 0 <= i; i--)
                      if (objIndex < deallocStackCounter[i])
                          --deallocStackCounter[i];
                      else
                          break;
              else
                  console.log("[WARNING], the object was not found in the deallocation list. Deallocating may cause errors.")
          };
          ...
          PDFNet.sendWithPromise = function(actionName, data) {
              var messageHandler = this.messageHandler
                , promiseAndId = messageHandler.sendWithPromiseReturnId(actionName, data, this.userPriority);
              messageHandler.pdfnetCommandChain = 0 == messageHandler.pdfnetActiveCommands.size ? promiseAndId.promise : messageHandler.pdfnetCommandChain.then(function() {
          ...
          PDFNet.runGeneratorWithoutCleanup = function(generator, license_key) {
              ...
              checkArguments(arguments.length, 1, "runGeneratorWithoutCleanup", "(object, string)", [[generator, "object"], [license_key, "string"]]);
          ...
          PDFNet.runGeneratorWithCleanup = function(generator, license_key) {
              "undefined" === typeof license_key && (license_key = "");
              checkArguments(arguments.length, 1, "runGeneratorWithCleanup", "(object, string)", [[generator, "object"], [license_key, "string"]]);
          ...
          PDFNet.endDeallocateStack = function() {
              if (0 === stackCallCounter)
                  return console.log("Warning, no startDeallocateStack() instances remain."),
                  Promise.resolve();
              ...
              if ("undefined" !== typeof unlockStackPos && 0 !== lockedObjects.length && lockedObjects.length !== unlockStackPos)
                  for (; lockedObjects.length > unlockStackPos; ) {
                      ...
                      objToUnlock = PDFNet.sendWithPromise(objToUnlock.name + "." + objToUnlock.unlocktype, {
                          doc: objToUnlock.id
                      });
              ...
              if ("undefined" !== typeof deallocStackPos && 0 !== createdObjects.length && createdObjects.length !== deallocStackPos)
                  for (; createdObjects.length > deallocStackPos; )
                      unlockStackPos = createdObjects.pop(),
                      unlockStackPos = PDFNet.sendWithPromise(unlockStackPos.name + ".destroy", {
          ...
          PDFNet.deallocateAllObjects = function() {
              ...
              for (deallocStackCounter = []; lockedObjects.length; )
                  ...
                  unlockPromise = PDFNet.sendWithPromise(objToUnlock.name + "." + objToUnlock.unlocktype, {
                      doc: objToUnlock.id
                  }),
              ...
              for (; createdObjects.length; ) {
                  ...
                  objToDealloc = PDFNet.sendWithPromise(objToDealloc.name + ".destroy", {
          ...
          PDFNet.Redactor.redact = function(doc, red_arr, appearance, ext_neg_mode, page_coord_sys) {
              ...
              "undefined" === typeof appearance.negative_overlay_color ? appearance.negative_overlay_color = void 0 : "undefined" !== typeof appearance.negative_overlay_color.id && (appearance.negative_overlay_color = appearance.negative_overlay_color.id);
              ...
              "undefined" === typeof appearance.max_font_size && (appearance.max_font_size = 24);
              ...
              "undefined" === typeof appearance.redacted_content_color ? appearance.redacted_content_color = void 0 : "undefined" !== typeof appearance.redacted_content_color.id && (appearance.redacted_content_color = appearance.redacted_content_color.id);
              "undefined" === typeof ext_neg_mode && (ext_neg_mode = !0);
              "undefined" === typeof page_coord_sys && (page_coord_sys = !0);
              checkArguments(arguments.length, 2, "redact", "(PDFNet.PDFDoc, Array<Core.PDFNet.Redaction>, object, boolean, boolean)", [[doc, "PDFDoc"], [red_arr, "Array"], [appearance, "object"], [ext_neg_mode, "boolean"], [page_coord_sys, "boolean"]]);
          ...
          PDFNet.Highlights.prototype.getCurrentQuads = function() {
              return PDFNet.sendWithPromise("Highlights.getCurrentQuads", {
                  ...
                  for (var retArray = [], currQuad, i = 0; i < id.length; i += 8)
                      currQuad = PDFNet.QuadPoint(id[i + 0], id[i + 1], id[i + 2], id[i + 3], id[i + 4], id[i + 5], id[i + 6], id[i + 7]),
          ...
          PDFNet.TextSearch.prototype.run = function() {
              ...
              return PDFNet.sendWithPromise("TextSearch.run", {
                  ts: this.id
              }).then(function(searchObj) {
                  searchObj.highlights = new PDFNet.Highlights(searchObj.highlights);
                  if ("0" == searchObj.highlights.id)
                      return searchObj;
                  createdObjects.push({
          ...
          PDFNet.Iterator.prototype.current = function() {
              if (0 != arguments.length)
                  throw new RangeError(arguments.length + " arguments passed into function 'fillEncryptDict'. Expected 0 argument.");
              var me = this;
          ...
          PDFNet.PDFDoc.createFromURL = function(url, options) {
              ...
              checkArguments(arguments.length, 1, "createFromURL", "(string, object)", [[url, "string"], [options, "object"]]);
              return getUrlAsBuffer(url, options).then(function(data) {
                  return PDFNet.PDFDoc.createFromBuffer(data)
              })
          }
          ;
          PDFNet.PDFDraw.prototype.exportBuffer = function(page, format, encoder_params) {
              "undefined" == typeof format && (format = "PNG");
              "undefined" == typeof encoder_params && (encoder_params = new PDFNet.Obj("0"));
              checkArguments(arguments.length, 1, "exportBuffer", "(PDFNet.Page, string, PDFNet.Obj)", [[page, "Object", PDFNet.Page, "Page"], [format, "string"], [encoder_params, "Object", PDFNet.Obj, "Obj"]]);
          ...
          PDFNet.Element.prototype.getTextData = function() {
              if (0 != arguments.length)
                  throw new RangeError(arguments.length + " arguments passed into function 'getTextData'. Expected 0 arguments. Function Signature: getTextData()");
              return PDFNet.sendWithPromise("Element.getTextData", {
                  e: this.id
              })
          }
          ;
          PDFNet.Element.prototype.getPathData = function() {
              if (0 != arguments.length)
                  throw new RangeError(arguments.length + " arguments passed into function 'getPathData'. Expected 0 arguments. Function Signature: getPathData()");
          ...
          PDFNet.PDFDoc.prototype.convertToXod = function(options) {
              "undefined" === typeof options && (options = new PDFNet.Obj("0"));
              checkArguments(arguments.length, 0, "convertToXod", "(PDFNet.Obj)", [[options, "OptionObject", PDFNet.Obj, "Obj", "PDFNet.Convert.XODOutputOptions"]]);
          ...
          PDFNet.FilterReader.prototype.read = function(buf_size) {
              checkArguments(arguments.length, 1, "read", "(number)", [[buf_size, "number"]]);
          ...
          PDFNet.FilterReader.prototype.readAllIntoBuffer = function() {
              if (0 != arguments.length)
                  throw new RangeError(arguments.length + " arguments passed into function 'readAllIntoBuffer'. Expected 0 arguments. Function Signature: readAllIntoBuffer()");
          ...
          PDFNet.PDFDraw.prototype.getBitmap = function(page, pix_fmt, demult) {
              checkArguments(arguments.length, 3, "getBitmap", "(PDFNet.Page, number, boolean)", [[page, "Object", PDFNet.Page, "Page"], [pix_fmt, "number"], [demult, "boolean"]]);
          ...
          PDFNet.Matrix2D.create = function(a, b, c, d, h, v) {
              ...
              void 0 == h && (h = 0);
              void 0 == v && (v = 0);
              checkArguments(arguments.length, 0, "create", "(number, number, number, number, number, number)", [[a, "number"], [b, "number"], [c, "number"], [d, "number"], [h, "number"], [v, "number"]]);
              var capability = createPromiseCapability()
          ...
          PDFNet.PDFDoc.prototype.getPDFDoc = function() {
              return PDFNet.sendWithPromise("GetPDFDoc", {
                  doc: this.id
              }).then(function(id) {
          ...
          PDFNet.TextExtractorWord.prototype.getGlyphQuad = function(glyph_idx) {
              checkArguments(arguments.length, 1, "getGlyphQuad", "(number)", [[glyph_idx, "number"]]);
          ...
          PDFNet.TextExtractor.prototype.getHighlights = function(char_ranges) {
              checkArguments(arguments.length, 1, "getHighlights", "(Array<object>)", [[char_ranges, "Array"]]);
          ...
          PDFNet.SecurityHandler.prototype.changeUserPasswordNonAscii = function(password) {
              checkArguments(arguments.length, 1, "changeUserPasswordNonAscii", "(string)", [[password, "string"]]);
              return PDFNet.sendWithPromise("SecurityHandler.changeUserPasswordNonAscii", {
                  sh: this.id,
                  password: password,
          ...
          PDFNet.SecurityHandler.prototype.changeMasterPasswordNonAscii = function(password) {
              checkArguments(arguments.length, 1, "changeMasterPasswordNonAscii", "(string)", [[password, "string"]]);
              return PDFNet.sendWithPromise("SecurityHandler.changeMasterPasswordNonAscii", {
                  sh: this.id,
                  password: password,
                  pwd_length: password.length
              })
          ...
          PDFNet.SecurityHandler.prototype.initPassword = function(password) {
              checkArguments(arguments.length, 1, "initPassword", "(string)", [[password, "string"]]);
          ...
          PDFNet.SecurityHandler.prototype.initPasswordNonAscii = function(password) {
              checkArguments(arguments.length, 1, "initPasswordNonAscii", "(string)", [[password, "string"]]);
              return PDFNet.sendWithPromise("SecurityHandler.initPasswordNonAscii", {
                  sh: this.id,
                  password: password,
                  pwd_length: password.length
              })
          ...
          PDFNet.Element.prototype.getBBox = function() {
              ...
              return PDFNet.sendWithPromise("Element.getBBox", {
                  e: this.id
              }).then(function(id) {
                  me.yieldFunction = void 0;
                  return new PDFNet.Rect(id)
          ...
          PDFNet.Matrix2D.prototype.mult = function(x, y) {
              checkArguments(arguments.length, 2, "create", "(number, number)", [[x, "number"], [y, "number"]]);
          ...
          PDFNet.Obj.prototype.getAsPDFText = function() {
              if (0 != arguments.length)
                  throw new RangeError(arguments.length + " arguments passed into function 'getAsPDFText'. Expected 0 arguments. Function Signature: getAsPDFText()");
              return PDFNet.sendWithPromise("Obj.getAsPDFText", {
                  o: this.id
              })
          }
          ;
          PDFNet.PDFDoc.prototype.initSecurityHandler = function(custom_data) {
              ...
              if (1 < arguments.length)
                  throw new RangeError(arguments.length + " arguments passed into function 'initSecurityHandler'. Expected at most 1 arguments. Function Signature: initSecurityHandler(void*)");
          ...
          ;
          PDFNet.PDFDoc.prototype.initStdSecurityHandler = PDFNet.PDFDoc.prototype.initStdSecurityHandlerUString;
          ...
          ;
          PDFNet.SDFDoc.prototype.initStdSecurityHandler = PDFNet.SDFDoc.prototype.initStdSecurityHandlerUString;
          PDFNet.Image.createFromURL = function(doc, url, encoder_hints, options) {
              "undefined" === typeof encoder_hints && (encoder_hints = new PDFNet.Obj("0"));
              "undefined" === typeof options && (options = {});
              checkArguments(arguments.length, 2, "createFromURL", "(PDFNet.PDFDoc, string, PDFNet.Obj, object)", [[doc, "PDFDoc"], [url, "string"], [encoder_hints, "Object", PDFNet.Obj, "Obj"], [options, "object"]]);
              return getUrlAsBuffer(url, options).then(function(data) {
          ...
          PDFNet.PDFDoc.prototype.addStdSignatureHandlerFromURL = function(pkcs12_file, pkcs12_pass) {
              checkArguments(arguments.length, 2, "addStdSignatureHandlerFromURL", "(string, string)", [[pkcs12_file, "string"], [pkcs12_pass, "string"]]);
              var me = this;
          ...
          ;
          PDFNet.PDFDoc.prototype.addStdSignatureHandlerFromBufferWithDoc = function(pkcs12_buffer, pkcs12_pass, doc) {
              checkArguments(arguments.length, 3, "addStdSignatureHandlerFromBufferWithDoc", "(ArrayBuffer|TypedArray, string, PDFNet.PDFDoc)", [[pkcs12_buffer, "ArrayBuffer"], [pkcs12_pass, "string"], [doc, "PDFDoc"]]);
              return PDFNet.sendWithPromise("PDFDoc.addStdSignatureHandlerFromBuffer", {
                  doc: doc.id,
          ...
          PDFNet.Filter.createFromMemory = function(buf) {
              checkArguments(arguments.length, 1, "createFromMemory", "(ArrayBuffer|TypedArray)", [[buf, "ArrayBuffer"]]);
              var bufArrayBuffer = getArrayBuffer(buf, !1);
          ...
          PDFNet.Filter.createURLFilter = function(url, options) {
              "undefined" === typeof options && (options = {});
              checkArguments(arguments.length, 1, "createURLFilter", "(string, object)", [[url, "string"], [options, "object"]]);
              return getUrlAsBuffer(url, options).then(function(data) {
          ...
          PDFNet.Filter.createFlateEncode = function(input_filter, compression_level, buf_sz) {
              ...
              checkArguments(arguments.length, 0, "createFlateEncode", "(PDFNet.Filter, number, number)", [[input_filter, "Object", PDFNet.Filter, "Filter"], [compression_level, "number"], [buf_sz, "number"]]);
          ...
          PDFNet.PDFDoc.prototype.importPages = function(page_arr, import_bookmarks) {
              ...
              checkArguments(arguments.length, 1, "importPages", "(Array<Core.PDFNet.Page>, boolean)", [[page_arr, "Array"], [import_bookmarks, "boolean"]]);
          ...
          PDFNet.SDFDoc.prototype.applyCustomQuery = function(query) {
              checkArguments(arguments.length, 1, "applyCustomQuery", "(object)", [[query, "object"]]);
          ...
          PDFNet.PDFACompliance.createFromUrl = function(convert, url, pwd, conform, excep, max_ref_objs, first_stop) {
              ...
              checkArguments(arguments.length, 2, "createFromUrl", "(boolean, string, string, number, ArrayBuffer|TypedArray, number, boolean)", [[convert, "boolean"], [url, "string"], [pwd, "string"], [conform, "number"], [excep, "ArrayBuffer"], [max_ref_objs, "number"], [first_stop, "boolean"]]);
              return getUrlAsBuffer(url).then(function(buf) {
                  return PDFNet.PDFACompliance.createFromBuffer(convert, buf, pwd, conform, excep, max_ref_objs, first_stop)
              })
          }
          ;
          PDFNet.PDFACompliance.createFromBuffer = function(convert, buf, pwd, conform, excep, max_ref_objs, first_stop) {
              ...
              "undefined" === typeof max_ref_objs && (max_ref_objs = 10);
              "undefined" === typeof first_stop && (first_stop = !1);
              checkArguments(arguments.length, 2, "createFromBuffer", "(boolean, ArrayBuffer|TypedArray, string, number, ArrayBuffer|TypedArray, number, boolean)", [[convert, "boolean"], [buf, "ArrayBuffer"], [pwd, "string"], [conform, "number"], [excep, "ArrayBuffer"], [max_ref_objs, "number"], [first_stop, "boolean"]]);
              var bufArrayBuffer = getArrayBuffer(buf, !1)
          ...
          PDFNet.PDFDoc.prototype.lock = function() {
              ...
              return PDFNet.sendWithPromise("PDFDoc.lock", {
                  doc: this.id
              })
          }
          ;
          PDFNet.PDFDoc.prototype.lockRead = function() {
              ...
              return PDFNet.sendWithPromise("PDFDoc.lockRead", {
                  doc: this.id
              })
          }
          ;
          ...
          PDFNet.PDFDoc.prototype.timedLock = function(milliseconds) {
              checkArguments(arguments.length, 1, "timedLock", "(number)", [[milliseconds, "number"]]);
              var index = lockedObjects.length;
              lockedObjects.push({
                  name: "PDFDoc",
                  id: this.id,
          ...
          PDFNet.PDFDoc.prototype.timedLockRead = function(milliseconds) {
              checkArguments(arguments.length, 1, "timedLockRead", "(number)", [[milliseconds, "number"]]);
              var index = lockedObjects.length;
              lockedObjects.push({
                  name: "PDFDoc",
                  id: this.id,
          ...
          PDFNet.Optimizer.optimize = function(doc, optimizerSettings) {
              "undefined" === typeof optimizerSettings && (optimizerSettings = new PDFNet.Optimizer.OptimizerSettings);
              checkArguments(arguments.length, 1, "optimize", "(PDFNet.PDFDoc, object)", [[doc, "PDFDoc"], [optimizerSettings, "object"]]);
          ...
          ;
          PDFNet.VerificationOptions.prototype.addTrustedCertificateFromURL = function(url, options, trust_flags) {
              "undefined" === typeof options && (options = {});
              "undefined" === typeof trust_flags && (trust_flags = PDFNet.VerificationOptions.CertificateTrustFlag.e_default_trust);
              checkArguments(arguments.length, 1, "addTrustedCertificateFromURL", "(string, object, number)", [[url, "string"], [options, "object"], [trust_flags, "number"]]);
              var me = this;
              return getUrlAsBuffer(url, options).then(function(data) {
          ...
          PDFNet.DigitalSignatureField.prototype.certifyOnNextSaveFromURL = function(url, in_password, options) {
              "undefined" === typeof options && (options = {});
              checkArguments(arguments.length, 2, "certifyOnNextSaveFromURL", "(string, string, object)", [[url, "string"], [in_password, "string"], [options, "object"]]);
              var me = this;
              return getUrlAsBuffer(url, options).then(function(data) {
          ...
          ;
          PDFNet.PDFRasterizer.prototype.rasterize = function(page, width, height, stride, num_comps, demult, device_mtx, clip, scrl_clp_regions) {
              "undefined" === typeof clip && (clip = null);
              "undefined" === typeof scrl_clp_regions && (scrl_clp_regions = null);
              checkArguments(arguments.length, 7, "rasterize", "(PDFNet.Page, number, number, number, number, boolean, PDFNet.Matrix2D, PDFNet.Rect, PDFNet.Rect)", [[page, "Object", PDFNet.Page, "Page"], [width, "number"], [height, "number"], [stride, "number"], [num_comps, "number"], [demult, "boolean"], [device_mtx, "Structure", PDFNet.Matrix2D, "Matrix2D"], [clip, "Structure", PDFNet.Rect, "Rect"], [scrl_clp_regions, "Structure", PDFNet.Rect, "Rect"]]);
              checkParamsYieldFunction("rasterize", [[device_mtx, 6], [clip, 7], [scrl_clp_regions, 8]]);
          ...
          ;
          PDFNet.ElementBuilder.prototype.createUnicodeTextRun = function(text_data) {
              checkArguments(arguments.length, 1, "createUnicodeTextRun", "(string)", [[text_data, "string"]]);
          ...
          ;
          PDFNet.DigitalSignatureField.prototype.getCertPathsFromCMS = function() {
              checkThisYieldFunction("getCertPathsFromCMS", this.yieldFunction);
              return PDFNet.sendWithPromise("DigitalSignatureField.getCertPathsFromCMS", {
                  self: this
              }).then(function(arrArray) {
                  for (var retArray = [], i = 0; i < arrArray.length; ++i) {
                      for (var idArray = arrArray[i], objArray = [], j = 0; j < idArray.length; ++j) {
                          var id = idArray[j];
                          if ("0" === id)
                              return null;
                          id = new PDFNet.X509Certificate(id);
          ...
          PDFNet.PDFDoc.prototype.requirePage = function(page_number) {
              checkArguments(arguments.length, 1, "requirePage", "(number)", [[page_number, "number"]]);
              if (0 >= page_number)
                  throw Error("1st input argument '" + page_number + "' in function 'requirePage' is invalid. Expected number between 1 and number of pages in the document.");
          ...
          PDFNet.beginOperation = function(optionsObj) {
              ...
              } : "undefined" === typeof optionsObj.allowMultipleInstances && console.log("Warning: passing in options object without value 'allowMultipleInstances'");
              if (0 < beginOperationCounter && !optionsObj.allowMultipleInstances)
                  throw Error("a previous instance of PDFNet.beginOperation() has been called without being terminated by PDFNet.finishOperation(). If this is intentional, pass in an options object with its parameter 'allowMultipleInstances' set to 'true' (ex. optObj={}; optObj.allowMultipleInstances=true; PDFNet.beginOperation(optObj));");
              beginOperationCounter += 1;
              if (1 < arguments.length)
                  throw new RangeError(arguments.length + " arguments passed into function 'beginOperation'. Expected 0 to 1 arguments. Function Signature: beginOperation(optObj = {})");
          ...
          PDFNet.finishOperation = function() {
              if (0 < beginOperationCounter) {
                  ...
                  if (0 != arguments.length)
                      throw new RangeError(arguments.length + " arguments passed into function 'finishOperation'. Expected 0 arguments. Function Signature: finishOperation()");
          ...
          PDFNet.runWithCleanup = function(callback, license_key) {
              "undefined" === typeof license_key && (license_key = "");
              checkArguments(arguments.length, 1, "runWithCleanup", "(function, string)", [[callback, "function"], [license_key, "string"]]);
              var result, shouldFinishOperation = !1, shouldDeallocateStack = !1;
              return previousRunPromise = previousRunPromise.then(function() {}, function() {}).then(function() {
                  ...
                  if (0 < stackCallCounter)
                      throw Error('Detected not yet deallocated stack. You may have called "PDFNet.startDeallocateStack()" somewhere without calling "PDFNet.endDeallocateStack()" afterwards.');
                  return result
              })["catch"](function(e) {
          ...
          PDFNet.initialize = function(licenseKey, pdfBackendType) {
              ...
              checkArguments(arguments.length, 0, "initialize", "(string, string)", [[licenseKey, "string"], [pdfBackendType, "string"]]);
              if (!finishedInitializeCapability) {
                  ...
                  var finishInit = function(pdfBackendType) {
                      ...
                      exports.Core.initPDFWorkerTransports(pdfBackendType, workerHandlers, licenseKey).then(function(transport) {
                  ...
                  pdfBackendType && "auto" !== pdfBackendType ? finishInit(pdfBackendType) : exports.Core.getDefaultBackendType().then(finishInit, function(e) {
                      finishedInitializeCapability.reject(e)
                  })
              }
