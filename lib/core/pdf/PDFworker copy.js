(function () {
  ...
  $jscomp.polyfill = function (v, z, u, q) {
    z &&
      ($jscomp.ISOLATE_POLYFILLS
        ? $jscomp.polyfillIsolated(v, z, u, q)
        : $jscomp.polyfillUnisolated(v, z, u, q));
  };
  ...
  $jscomp.polyfill(
    ...
    function (v) {
      ...
      for (
        ...
        "function" === typeof q &&
          "function" != typeof q.prototype[v] &&
          $jscomp.defineProperty(q.prototype, v, {
            configurable: !0,
            writable: !0,
            value: function () {
    ...
    function (v) {
      function z() {
        ...
        try {
          ...
          if (2 != l.get(p) || 3 != l.get(f)) return !1;
          l.delete(p);
          l.set(f, 4);
      ...
      function t(p) {
        if (!$jscomp.owns(p, m)) {
          var f = new u();
          $jscomp.defineProperty(p, m, { value: f });
        }
      }
      function B(p) {
      ...
      k.prototype.set = function (p, f) {
        ...
        t(p);
        if (!$jscomp.owns(p, m)) throw Error("WeakMap key fail: " + p);
        p[m][this.id_] = f;
        return this;
      };
    ...
    function (v) {
      ...
      q.prototype.forEach = function (k, p) {
        for (var f = this.entries(), l; !(l = f.next()).done; )
          (l = l.value), k.call(p, l[1], l[0], this);
      };
        ...
        B = function (k, p) {
          ...
          return $jscomp.iteratorPrototype(function () {
            if (f) {
              ...
              for (; f.next != f.head; )
                return (f = f.next), { done: !1, value: p(f) };
              f = null;
            }
  ...
  $jscomp.polyfill(
    ...
    function (v) {
      ...
      t.prototype.resolveTo_ = function (m) {
        ...
        else if (m instanceof t) this.settleSameAsPromise_(m);
        else {
          a: switch (typeof m) {
            case "object":
              var d = null != m;
      ...
      t.race = function (m) {
        return new t(function (d, k) {
          for (
            var p = $jscomp.makeIterator(m), f = p.next();
            !f.done;
            f = p.next()
          )
  ...
  $jscomp.findInternal = function (v, z, u) {
    ...
    for (var q = v.length, t = 0; t < q; t++) {
      var B = v[t];
      if (z.call(u, B, t, v)) return { i: t, v: B };
    }
    return { i: -1, v: void 0 };
  };
  $jscomp.polyfill(
    ...
    $jscomp.TRUST_ES6_POLYFILLS && "function" == typeof Object.assign
      ...
      : function (v, z) {
          for (var u = 1; u < arguments.length; u++) {
            var q = arguments[u];
            if (q) for (var t in q) $jscomp.owns(q, t) && (v[t] = q[t]);
          }
          return v;
        };
  $jscomp.polyfill(
    ...
    function (v) {
      function z() {
        ...
        try {
          ...
          var B = t.entries(),
            m = B.next();
          if (m.done || m.value[0] != q || m.value[1] != q) return !1;
          m = B.next();
          return m.done ||
            m.value[0] == q ||
            4 != m.value[0].x ||
      ...
      var u = function (q) {
        ...
        if (q) {
          ...
          for (var t; !(t = q.next()).done; ) this.add(t.value);
        }
  ...
  (function (v) {
    function z(q) {
      if (u[q]) return u[q].exports;
      var t = (u[q] = { i: q, l: !1, exports: {} });
    ...
    z.c = u;
    z.d = function (q, t, B) {
      z.o(q, t) || Object.defineProperty(q, t, { enumerable: !0, get: B });
    };
    z.r = function (q) {
    ...
    function (v, z, u) {
      ...
      var q = u(2),
        t = function (p, f) {
          Object(q.a)("disableLogs") ||
            (f ? console.warn(p + ": " + f) : console.warn(p));
        },
        B = function (p, f) {
          Object(q.a)("disableLogs") ||
            (f ? console.log(p + ": " + f) : console.log(p));
        },
        m = function (p) {
          if (!Object(q.a)("disableLogs")) throw (console.error(p), Error(p));
        },
        d = function (p, f) {},
        k = function (p, f) {};
    },
      ...
      var q = u(14),
        ...
        d = function (g) {
          ...
          g
            ...
            : ((console.log = t), (console.warn = B), (console.error = m));
        },
        k = function () {
    ...
    function (v, z, u) {
      ...
      var q = u(11),
        ...
        p = !1,
        f = function (c, h) {
          p || (k(d.basePath + "decode.min.js"), (p = !0));
      ...
      var g = !1,
        x = function (c) {
          g || (k(d.basePath + "pako_inflate.min.js"), (g = !0));
          var h = 10;
          if ("string" === typeof c) {
            if (c.charCodeAt(3) & 8) {
          ...
          var D = function () {
            ...
            J.length < c.compressedMaximum
              ? ((J = c.decompressFunction(J, c.shouldOutputArray)),
                ...
                k &&
                  Object(t.a)("worker", "Decompressed length is " + J.length))
              : h && (J = Object(m.a)(J));
            k &&
              Object(t.a)(
                "worker",
                c.url + " Decompression took " + (Date.now() - F)
              );
            return J;
          };
          if (c.isAsync)
    ...
    function (v, z, u) {
      ...
      var B =
        ...
        (navigator.userAgent.match(/Edg\/(.*?)/) &&
          q.navigator.userAgent.match(/Chrome\/(.*?) /));
      (function () {
        if (!B) return null;
      ...
      z =
        /iPad|iPhone|iPod/.test(q.navigator.platform) ||
        ("MacIntel" === navigator.platform && 1 < navigator.maxTouchPoints) ||
        /iPad|iPhone|iPod/.test(q.navigator.userAgent);
      var m = (function () {
          var n = q.navigator.userAgent.match(
            /.*\/([0-9\.]+)\s(Safari|Mobile).*/i
          );
          return n ? parseFloat(n[1]) : n;
        })(),
        d =
          /^((?!chrome|android).)*safari/i.test(q.navigator.userAgent) ||
          (/^((?!chrome|android).)*$/.test(q.navigator.userAgent) && z),
      ...
      var p = /Mac OS X 10_13_6.*\(KHTML, like Gecko\)$/.test(
        ...
        f = q.navigator.userAgent.match(/(iPad|iPhone).+\sOS\s((\d+)(_\d)*)/i)
          ? 14 <=
            parseInt(
        ...
        g =
          -1 < q.navigator.userAgent.indexOf("Edge/16") ||
          -1 < q.navigator.userAgent.indexOf("MSAppHost"),
        x = function () {
    ...
    function (v, z, u) {
      ...
      !(function (d) {
        ...
        return (function l(k, p, f) {
          ...
          for (var x = !1, n = 0; n < f.length; n++) g(f[n]);
          return g;
        })(
          {
            1: [
              function (k, p, f) {
                var l = {}.hasOwnProperty,
                  g = function (x, n) {
                    ...
                    for (var y in n) l.call(n, y) && (x[y] = n[y]);
              ...
              function (k, p, f) {
                ...
                p.exports = (function () {
                  function g(x) {
                    ...
                    this.data =
                      (null != (n = this.options.initialValues)
                        ? n.slice(0)
                        : void 0) || [];
    ...
    function (v, z, u) {
      (function (q) {
        ...
        z.setImmediate =
          ...
          ("undefined" !== typeof q && q.setImmediate) ||
          (this && this.setImmediate);
        z.clearImmediate =
          ("undefined" !== typeof self && self.clearImmediate) ||
          ("undefined" !== typeof q && q.clearImmediate) ||
    ...
    function (v, z, u) {
      function q(d, k, p) {
        function f(x) {
          g = g || Date.now();
          return x
            ? (Object(t.a)("load", "Try instantiateStreaming"),
              fetch(Object(B.a)(d))
                .then(function (n) {
                ...
                .catch(function (n) {
                  Object(t.a)(
                    "load",
                    "instantiateStreaming Failed " + d + " message " + n.message
                  );
                  return f(!1);
                }))
        ...
        return f(!!WebAssembly.instantiateStreaming).then(function (x) {
          Object(t.a)(
            "load",
            "WASM compilation took " + (Date.now() - (l || g)) + " ms"
          );
          return x;
        });
      }
          ...
          for (; p; )
            try {
              ...
              switch (n[0]) {
                ...
                default:
                  if (
                    !((g = p.trys), (g = 0 < g.length && g[g.length - 1])) &&
                    (6 === n[0] || 2 === n[0])
                  ) {
                    p = 0;
                    continue;
                  ...
                  if (3 === n[0] && (!g || (n[1] > g[0] && n[1] < g[3])))
                    ...
                    (p.label = g[1]), (g = n);
                  else if (g && p.label < g[2]) (p.label = g[2]), p.ops.push(n);
                  else {
                    g[2] && p.ops.pop();
                    p.trys.pop();
                    continue;
    ...
    function (v, z) {
      ...
      function m() {
        x &&
          n &&
          ((x = !1), n.length ? (g = n.concat(g)) : (r = -1), g.length && d());
      }
      function d() {
        if (!x) {
          var y = t(m);
    ...
    function (v, z, u) {
      z.a = function () {
        ArrayBuffer.prototype.slice ||
          (ArrayBuffer.prototype.slice = function (q, t) {
            void 0 === q && (q = 0);
            ...
            if (0 >= t - q) return new ArrayBuffer(0);
    ...
    function (v, z, u) {
      (function (q) {
        ...
        C.setImmediate = t;
        C.clearImmediate = B;
        z.a = { setImmediate: t, clearImmediate: B };
      }).call(this, u(12));
    },
    function (v, z, u) {
      var q = u(0),
      ...
      v = (function () {
        ...
        B.prototype.on = function (m, d, k) {
          ...
          p[m] &&
            Object(q.c)('There is already an actionName called "' + m + '"');
          p[m] = [d, k];
        };
        ...
        B.prototype.sendWithPromise = function (m, d, k) {
          ...
          m = { action: m, data: d, callbackId: p, priority: k };
        ...
        B.prototype.sendWithPromiseReturnId = function (m, d, k) {
          ...
          return { promise: d.promise, callbackId: p };
        };
        ...
        B.prototype.cancelPromise = function (m) {
          ...
          } else Object(q.b)("Cannot cancel callback " + m);
        };
        B.prototype.postMessage = function (m) {
          Object(t.a)("enableWorkerLogs") &&
            Object(q.d)("PDFWorker", "Sent " + JSON.stringify(m));
        ...
        B.prototype.handleMessage = function (m) {
          var d = this,
            k = m.data;
          Object(t.a)("enableWorkerLogs") &&
            Object(q.d)("PDFWorker", "Received " + JSON.stringify(k));
          var p = this.actionHandler,
          ...
          if (k.isReply)
            (p = k.callbackId),
              p in m
                ...
                : Object(q.a)("Cannot resolve callback " + p);
        ...
        d = function (k, p, f) {
          if (Object(B.a)() && !f) {
            self.Module.instantiateWasm = function (g, x) {
              return Object(t.a)(k + "Wasm.wasm", g, p["Wasm.wasm"]).then(
                function (n) {
                  x(n.instance);
                }
              );
    ...
    function (v, z, u) {
      (function (q) {
        "undefined" === typeof q.crypto &&
          (q.crypto = {
            getRandomValues: function (t) {
              for (var B = 0; B < t.length; B++) t[B] = 256 * Math.random();
            },
          });
      ...
      (function (q, t) {
        ...
        (function (m) {
          ...
          var I = "pending",
            ...
            c = "rejected",
            h = function () {},
            e = "undefined" !== typeof t ? t : setTimeout,
            w = [],
            D;
          C.prototype = {
            constructor: C,
        ...
        (function (p) {
          p.Module = {
            ...
            postPagesUpdatedEvent: function (f, l, g, x) {
              ...
              if (g)
                for (var n = 0; n < g.length; ++n)
                  g[n] in f.pageDimensions
                    ? ((f.pageDimensions[g[n]].contentChanged = !0),
                      x && (f.pageDimensions[g[n]].annotationsUnchanged = !0))
                    : console.warn("Invalid Page Number ".concat(g[n]));
            ...
            GetPageDimensionsRange: function (f, l, g) {
              for (
                var x = {}, n = Module.PDFDocGetPageIterator(f, l);
                l < g && Module.IteratorHasNext(n);
                ++l
              ) {
            ...
            onRuntimeInitialized: function () {
              ...
              (function (f) {
                ...
                f.CreateBufferFile = function (l, g, x) {
                  ...
                  n = new Uint8Array(n);
                  x = x ? 0 : 255;
                  for (var r = 0; r < g; ++r) n[r] = x;
                  Module.docs[l] = { buffer: n };
                };
                    ...
                    try {
                      ...
                      if (y) {
                        ...
                        try {
                          ...
                          for (e = -1; Module.IteratorHasNext(F); ) {
                            ...
                            try {
                              ...
                              var M = Module.PageGetPageInfo(J),
                                O = Module.ElementBuilderCreateImage(
                                  w,
                                  K,
                                  0,
                                  0,
                          ...
                          console.warn(
                            "Watermarks can not be added due to error: " + N
                          );
                        }
                      }
                      if (C) {
                      ...
                      if (n) {
                        ...
                        (A = Module.ObjFindObj(Q, "OpenAction")) &&
                          Module.ObjPut(Q, "__OpenActionBackup__", A);
                      ...
                      n &&
                        (A
                          ? Module.ObjPut(
                              Q,
                              "OpenAction",
                              Module.ObjFindObj(Q, "__OpenActionBackup__")
                            )
                          : Module.ObjErase(Q, "OpenAction"));
                  ...
                  return new Promise(function (G, I) {
                    ...
                    try {
                      ...
                      if (r) {
                        ...
                        r.y2 < r.y1 && ((M = r.y1), (r.y1 = r.y2), (r.y2 = M));
                        var O = a.out_width / (J ? r.y2 - r.y1 : r.x2 - r.x1);
                        var R = Module.GetDefaultMatrixBox(h, r, y);
                      } else (R = Module.PageGetDefaultMatrix(h, y)), (O = a.out_width / (F ? w : e));
                      ...
                      if (10 === T) {
                        ...
                        var U = Module.PDFRasterizerRasterizeSeparations(
                          a.rast,
                          h,
                          a.out_width,
                          a.out_height,
                      ...
                      Module.cleanupState = { cleanupArr: b, timeout: aa };
                      b.push(function () {
                        Module.cleanupState = null;
                      });
                    } catch (ba) {
                ...
                f.UpdatePassword = function (l, g) {
                  try {
                    var x = Module.stackSave();
                    var n = Module.GetDoc(l);
                    return Module.PDFDocInitStdSecurityHandler(n, g)
                      ? (n in downloadDataMap &&
                          REX(
                            Module._TRN_PDFDocDownloaderInitialize(
                              n,
                              downloadDataMap[n].downloader
                            )
                          ),
                        {
                          success: !0,
                ...
                f.InsertPages = function (l, g, x, n, r, y) {
                  return new Promise(function (E, C) {
                    ...
                    try {
                      ...
                      y
                        ? Module.PDFDocInsertPages2(G, n, b, h, r)
                        : Module.PDFDocInsertPages(G, n, b, h, r);
                      var w;
                        ...
                        if (e === g[b]) {
                          ...
                          0 === A % 4
                            ...
                            ? (Module.setValue(D, F + y, "double"),
                              ...
                              Module.setValue(D + 24, K - n, "double"))
                            : 3 === A % 4 &&
                              (Module.setValue(D, F + n, "double"),
            ...
            open: function (a) {
              ...
              this.IsSink(a)
                ...
                : (a.provider = Module.docs[b].sink
                    ? new r(Module.docs[b].sink.data)
                    : Module.docs[b].chunkStorage
                    ? new E(Module.docs[b].chunkStorage)
                    : Module.docs[b].buffer
                    ? new r(Module.docs[b].buffer)
                    : new n(Module.docs[b].file));
            },
            close: function (a) {
              a.provider.close();
            },
                  ...
                  if (A) d.CreateDocDownloaderBackend(c, w, b);
                    ...
                    if (e) {
                      if (a.pageSizes && a.pageSizes.length)
                        var P = a.pageSizes[0];
                      else a.defaultPageSize && (P = a.defaultPageSize);
      ...
      (function (t) {
        t.SetupPDFNetFunctions = function (B) {
          ...
          for (
            ...
            (p = Module.GetJSStringFromCString(p)), t.queue.onAsync(p, l);
          ...
          if (Module._TRN_EMSCreatePDFNetWorkerInstance) {
            ...
            f("pdfDocCreateFromBuffer", function (r) {
              r = Module.CreateDoc({ type: "array", value: r.buf });
            ...
            f("pdfDocCreate", function () {
              var r = Module.CreateDoc({ type: "new" }),
            ...
            f("ExtractPDFNetLayersContext", function (r) {
              ...
              var E = 0;
              y
                ? (E = Module.EMSCreateUpdatedLayersContext(r, y))
                : Module.PDFDocHasOC(r) &&
                  ((y = Module.PDFDocGetOCGConfig(r)),
              ...
              l = function (r) {
                return new Promise(function (y, E) {
                  ...
                  C
                    ...
                    : ((E = Module.EMSGetLastResponse(n)), (E = d(E)), y(E));
                });
              };
              (p = Module._TRN_EMSFunctionIteratorGetNextCommandName(f));

            )
              if (((p = Module.GetJSStringFromCString(p)), !g[p]))
                B.onAsync(p, l);
            Module._TRN_EMSFunctionIteratorDestroy(f);
          }
        };
      ...
      (function (f) {
        ...
        var x = {
          setup: function (n) {
            ...
            var b = function () {
              I ? a || (n.send("workerLoaded", {}), (a = !0)) : (I = !0);
            };
            H.OnInitialized(b);
            (function () {
              f.queue = G = new q.a({
        ...
        f.onmessage = function (n) {
          if ("init" === n.data.action) {
            ...
            if ((n = n.data.pdfWorkerPath)) f.overriddenPdfWorkerPath = n;
            r || g();
