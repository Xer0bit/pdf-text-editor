(function () {
  ...
  var $jscomp$lookupPolyfilledValue = function (u, p, q) {
    if (!q || null != u) {
      q = $jscomp.propertyToPolyfillSymbol[p];
      if (null == q) return u[p];
      q = u[q];
      return void 0 !== q ? q : u[p];
    }
  };
  $jscomp.polyfill = function (u, p, q, n) {
    p &&
      ($jscomp.ISOLATE_POLYFILLS
        ? $jscomp.polyfillIsolated(u, p, q, n)
        : $jscomp.polyfillUnisolated(u, p, q, n));
  };
  $jscomp.polyfillUnisolated = function (u, p, q, n) {
    q = $jscomp.global;
    u = u.split(".");
    ...
    p != n &&
      null != p &&
      $jscomp.defineProperty(q, u, {
        configurable: !0,
        writable: !0,
        value: p,
      });
  };
  $jscomp.polyfillIsolated = function (u, p, q, n) {
    var l = u.split(".");
    u = 1 === l.length;
    n = l[0];
    n = !u && n in $jscomp.polyfills ? $jscomp.polyfills : $jscomp.global;
    ...
    l = l[l.length - 1];
    q = $jscomp.IS_SYMBOL_NATIVE && "es6" === q ? n[l] : null;
    p = p(q);
    null != p &&
      (u
        ...
        : p !== q &&
          (void 0 === $jscomp.propertyToPolyfillSymbol[l] &&
            ...
            ($jscomp.propertyToPolyfillSymbol[l] = $jscomp.IS_SYMBOL_NATIVE
              ...
              : $jscomp.POLYFILL_PREFIX + q + "$" + l)),
          $jscomp.defineProperty(n, $jscomp.propertyToPolyfillSymbol[l], {
            configurable: !0,
            writable: !0,
            value: p,
          })));
  ...
  $jscomp.arrayIteratorImpl = function (u) {
    var p = 0;
    return function () {
      return p < u.length ? { done: !1, value: u[p++] } : { done: !0 };
    };
  };
  $jscomp.arrayIterator = function (u) {
    return { next: $jscomp.arrayIteratorImpl(u) };
  };
  $jscomp.makeIterator = function (u) {
    var p =
      "undefined" != typeof Symbol && Symbol.iterator && u[Symbol.iterator];
    if (p) return p.call(u);
  ...
  $jscomp.polyfill(
    ...
    function (u) {
      ...
      l.prototype.resolveTo_ = function (c) {
        if (c === this)
          this.reject_(new TypeError("A Promise cannot resolve to itself"));
        else if (c instanceof l) this.settleSameAsPromise_(c);
        else {
          a: switch (typeof c) {
            case "object":
              var e = null != c;
      ...
      l.prototype.resolveToNonPromiseObj_ = function (c) {
        var e = void 0;
        try {
          e = c.then;
        } catch (k) {
      ...
      l.prototype.reject_ = function (c) {
        this.settle_(2, c);
      };
      l.prototype.fulfill_ = function (c) {
        this.settle_(1, c);
      };
      l.prototype.settle_ = function (c, e) {
        if (0 != this.state_)
          throw Error(
            "Cannot settle(" +
              c +
      ...
      var h = new p();
      l.prototype.settleSameAsPromise_ = function (c) {
        var e = this.createResolveAndReject_();
        c.callWhenSettled_(e.resolve, e.reject);
      };
      l.prototype.settleSameAsThenable_ = function (c, e) {
      ...
      l.prototype.then = function (c, e) {
        ...
        var m,
          r,
          w = new l(function (y, E) {
            m = y;
            r = E;
          });
        this.callWhenSettled_(k(c, m), k(e, r));
        return w;
      };
      l.prototype.catch = function (c) {
        return this.then(void 0, c);
      };
      l.prototype.callWhenSettled_ = function (c, e) {
        function k() {
          switch (m.state_) {
            case 1:
              c(m.result_);
      ...
      l.race = function (c) {
        return new l(function (e, k) {
          for (
            var m = $jscomp.makeIterator(c), r = m.next();
            !r.done;
            r = m.next()
          )
            q(r.value).callWhenSettled_(e, k);
        });
      };
      l.all = function (c) {
        ...
        return k.done
          ...
          : new l(function (m, r) {
              ...
              do
                y.push(void 0),
                  E++,
                  q(k.value).callWhenSettled_(w(y.length - 1), r),
                  (k = e.next());
              while (!k.done);
            });
      };
  ...
  $jscomp.checkStringArgs = function (u, p, q) {
    if (null == u)
      throw new TypeError(
  ...
  $jscomp.polyfill(
    ...
    function (u) {
      ...
      for (
        ...
        "function" === typeof n &&
          "function" != typeof n.prototype[u] &&
          $jscomp.defineProperty(n.prototype, u, {
            configurable: !0,
            writable: !0,
            value: function () {
  ...
  $jscomp.setPrototypeOf =
    $jscomp.TRUST_ES6_POLYFILLS && "function" == typeof Object.setPrototypeOf
      ...
      ? function (u, p) {
          u.__proto__ = p;
          if (u.__proto__ !== p) throw new TypeError(u + " is not extensible");
          return u;
        }
      : null;
  $jscomp.assign =
    $jscomp.TRUST_ES6_POLYFILLS && "function" == typeof Object.assign
      ...
      : function (u, p) {
          for (var q = 1; q < arguments.length; q++) {
            var n = arguments[q];
            if (n) for (var l in n) $jscomp.owns(n, l) && (u[l] = n[l]);
          }
          return u;
        };
  $jscomp.polyfill(
    ...
    function (u) {
      return u
        ...
        : function (p, q, n) {
            var l = this.length || 0;
            0 > q && (q = Math.max(0, l + q));
            if (null == n || n > l) n = l;
            n = Number(n);
            0 > n && (n = Math.max(0, l + n));
  ...
  $jscomp.typedArrayFill = function (u) {
    return u ? u : Array.prototype.fill;
  };
  $jscomp.polyfill(
  ...
  (function (u) {
    function p(n) {
      ...
      var l = (q[n] = { i: n, l: !1, exports: {} });
      u[n].call(l.exports, l, l.exports, p);
      l.l = !0;
      return l.exports;
    }
    var q = {};
    ...
    p.c = q;
    p.d = function (n, l, h) {
      p.o(n, l) || Object.defineProperty(n, l, { enumerable: !0, get: h });
    };
    p.r = function (n) {
    ...
    p.t = function (n, l) {
      l & 1 && (n = p(n));
      if (l & 8 || (l & 4 && "object" === typeof n && n && n.__esModule))
        return n;
      var h = Object.create(null);
      p.r(h);
      Object.defineProperty(h, "default", { enumerable: !0, value: n });
      if (l & 2 && "string" != typeof n)
        for (var c in n)
          p.d(
            h,
            c,
    ...
    function (u, p, q) {
      ...
      u = (function () {
        function h() {}
        h.generateRenderXMLCommand = function (c, e, k, m, r) {
          var w =
        ...
        h.generateInsertUndoCommand = function (c, e, k) {
          var m = Number.isInteger(e) && Number.isInteger(k);
          return (
        ...
        h.generateInsertTextCommand = function (c, e, k, m) {
          var r =
            '\t<Command Name="Insert Text" OID="' + c + '" Pos="' + e + '">\n';
          k = Object(n.a)(k);
          r += "\t\t<Text>" + k + "</Text>\n";
          m &&
            ((k = m.fontSize && "" !== m.fontSize),
            m.fontName &&
              "" !== m.fontName &&
              !0 === m.fontNameHasChanged &&
              (r += "\t\t<FontName>" + m.fontName + "</FontName>\n"),
            k && (r += "\t\t<FontSize>" + m.fontSize + "</FontSize>\n"));
          r += "\t</Command>\n";
          m &&
            ((r +=
          ...
          m.fontColor &&
            (r +=
              ...
              e +
              '">\n                    <F>\n                      <RGB>' +
              Object(n.b)(m.fontColor) +
              "</RGB>\n                    </F>\n                  </Command>");
          return r;
        };
        h.generateInsertCharacterCommand = function (c, e, k, m) {
          e = Object(n.a)(e);
          var r = "" + this.generateInsertUndoCommand(c, k, e.length);
          return (r += this.generateInsertTextCommand(c, k, e, m));
        };
        h.generateChangeFontWeightOrDecorationCommand = function (c, e, k, m) {
          var r = m.startIndex,
            w = m.textLength;
          return (
            "<Commands>\n              " +
        ...
        h.generateTextAttributesCommand = function (c, e, k, m) {
          var r = m.restrictFontName,
            w = m.restrictFontSize;
          m =
            '<Commands><Command Name="Get Text Attributes" OID="' +
            (c + '" Pos="' + e + '" GlyphCount="' + k + '">');
          r || (m += '<Key Name="FontName" />');
          w || (m += '<Key Name="FontSize" />');
          return (m =
            m +
        ...
        h.generateTextColorCommand = function (c, e, k) {
          ...
          k =
            "<Commands>\n\t" + (this.generateCopyTextCommandBody(c, k) + "\n");
          k += this.generateInsertUndoCommand(c, m, r);
          k +=
            '\t<Command Name="Set Text Colour" OID="' +
            c +
            '" Pos="' +
        ...
        h.generateAlignParagraphXMLCommand = function (c, e, k, m) {
          var r = "<Commands>",
            w = k.startIndex;
          k = k.endIndex;
          r =
            (w || k
              ? r +
                ('\n\t<Command Name="Set Para Attribs" OID="' +
                  ...
                  (k - w) +
                  '">')
              : r + ('<Command Name="Set Para Attribs" OID="' + c + '">')) +
        ...
        h.generateColorContentBoxXMLCommand = function (c, e) {
          ...
          return (
            c +
            ("<F><RGB>" + k + " " + m + " " + e + " 1.000</RGB></F></Command>")
          );
        };
        ...
        h.generateUpdateImageCommand = function (c, e, k, m) {
          var r =
        ...
        h.generateEditXMLCommand = function (c, e, k) {
          for (var m, r = "<Commands>\n", w = 0; w < e.length; w++) {
            m = e[w];
            switch (m.name) {
              case "Delete":
                r += h.generateDeleteXMLCommand(c, m.index, m.len);
                break;
              case "Insert":
                r += h.generateInsertCharacterCommand(c, m.data, m.index, k);
            }
            m = m.newindex;
          }
          return { commandStr: r + "</Commands>", newIndex: m };
        };
        ...
        h.generateExportPageXMLCommand = function (c, e, k, m, r) {
          ...
          return (c +=
            "<Output>" + m + "</Output><ImagesOnly/></Command></Commands>");
        };
        ...
        h.genCommand = function (c, e, k, m, r) {
          var w = {};
          w.name = c;
          w.index = e;
          w.len = k;
        ...
        h.generateReplaceContentCommand = function (c, e, k) {
          return (
            '<Commands><Command Name="Delete Text" OID="' +
            c +
            '"></Command>' +
            (this.generateInsertTextWithDocFontCommand(c, null, e) +
              '<Command Name="SavePDF"><File>' +
              k +
              "</File></Command></Commands>")
          );
        };
        h.generateTextStyleUndoCommandBody = function (c, e, k, m, r, w) {
          var y = "";
          l[c] && !w
            ? (y +=
                '\t<Command Name="Delete Text" OID="' +
            ...
            : l[c] &&
              ...
              (y +=
                ...
                '">\n\t</Command>\n');
          return (y +=
            "\t" + this.generateInsertTextWithDocFontCommand(e, k, r) + "\n");
        };
        ...
        h.generateCheckPageModifiedCommand = function (c) {
          return (
            '<Commands><Command Name="Page Modified" PageNum="' +
            c +
            '"></Command></Commands>'
          );
        };
        h.generatePasteTextCommand = function (c, e, k) {
          ...
          k = k.chars;
          var w = "<Commands>\n";
          e && (w += this.generateDeleteXMLCommand(c, m, e));
          w += "" + this.generateInsertUndoCommand(c, m, k.length);
          w += "\t" + this.generateInsertTextWithDocFontCommand(c, m, r) + "\n";
          return w + "</Commands>";
        };
        ...
        h.generatePlaceImageCommand = function (c, e, k, m) {
          return (
    ...
    function (u, p, q) {
      ...
      var n = q(8),
        ...
        m = !1,
        r = function (v, x) {
          m || (k(e.basePath + "decode.min.js"), (m = !0));
          v = self.BrotliDecode(Object(c.b)(v));
          return x ? v : Object(c.a)(v);
        },
        w = function (v, x) {
          return Object(n.a)(void 0, void 0, Promise, function () {
            var B;
            return Object(n.b)(this, function (F) {
              switch (F.label) {
                case 0:
                  return m
                    ? [3, 2]
                ...
                case 1:
                  F.sent(), (m = !0), (F.label = 2);
                case 2:
                  return (
                    (B = self.BrotliDecode(Object(c.b)(v))),
                    [2, x ? B : Object(c.a)(B)]
                  );
              }
            });
      ...
      (function () {
        ...
        v.prototype.processRaw = function (x) {
          return x;
        };
        v.prototype.processBrotli = function (x) {
          this.remainingDataArrays.push(x);
          return null;
        };
        v.prototype.GetNextChunk = function (x) {
          this.decodeFunction ||
            (this.decodeFunction =
              0 === x[0] && 97 === x[1] && 115 === x[2] && 109 === x[3]
                ? this.processRaw
                : this.processBrotli);
          return this.decodeFunction(x);
        };
        v.prototype.End = function () {
          if (this.remainingDataArrays.length) {
            for (var x = this.arrays, B = 0, F = 0; F < x.length; ++F)
              B += x[F].length;
            B = new Uint8Array(B);
            var K = 0;
      ...
      var y = !1,
        E = function (v) {
          y || (k(e.basePath + "pako_inflate.min.js"), (y = !0));
          var x = 10;
          if ("string" === typeof v) {
            if (v.charCodeAt(3) & 8) {
              for (; 0 !== v.charCodeAt(x); ++x);
              ++x;
            }
          } else if (v[3] & 8) {
            for (; 0 !== v[x]; ++x);
          ...
          v = Object(c.b)(v);
          v = v.subarray(x, v.length - 8);
          return e.pako.inflate(v, { windowBits: -15 });
        },
        z = function (v, x) {
          return x ? v : Object(c.a)(v);
        },
        C = function (v) {
          var x = !v.shouldOutputArray,
            B = new XMLHttpRequest();
          B.open("GET", v.url, v.isAsync);
          var F = x && B.overrideMimeType;
          B.responseType = F ? "text" : "arraybuffer";
          F && B.overrideMimeType("text/plain; charset=x-user-defined");
          B.send();
          var K = function () {
            var Q = Date.now();
            var L = F ? B.responseText : new Uint8Array(B.response);
            Object(l.a)("worker", "Result length is " + L.length);
            L.length < v.compressedMaximum
              ? ((L = v.decompressFunction(L, v.shouldOutputArray)),
                Object(l.b)(
                ...
                k &&
                  Object(l.a)("worker", "Decompressed length is " + L.length))
              : x && (L = Object(c.a)(L));
            k &&
              Object(l.a)(
                "worker",
                v.url + " Decompression took " + (Date.now() - Q)
              );
            return L;
          };
          if (v.isAsync)
            var N = new Promise(function (Q, L) {
              B.onload = function () {
                200 === this.status || 0 === this.status
                  ? Q(K())
                  : L("Download Failed " + v.url);
              };
              B.onerror = function () {
                L("Network error occurred " + v.url);
              };
            });
          else {
            if (200 === B.status || 0 === B.status) return K();
            throw Error("Failed to load " + v.url);
          }
          return N;
        },
        O = function (v) {
          var x = v.lastIndexOf("/");
          -1 === x && (x = 0);
          var B = v.slice(x).replace(".", ".br.");
          k ||
            (B.endsWith(".js.mem")
              ? (B = B.replace(".js.mem", ".mem"))
              : B.endsWith(".js") && (B = B.concat(".mem")));
          return v.slice(0, x) + B;
        },
        T = function (v, x) {
          var B = v.lastIndexOf("/");
          -1 === B && (B = 0);
          var F = v.slice(B).replace(".", ".gz.");
          x.url = v.slice(0, B) + F;
          x.decompressFunction = E;
          return C(x);
        },
        R = function (v, x) {
          x.url = O(v);
          x.decompressFunction = k ? r : w;
          return C(x);
        },
        G = function (v, x) {
          v.endsWith(".js.mem")
            ? (v = v.slice(0, -4))
            : v.endsWith(".mem") && (v = v.slice(0, -4) + ".js.mem");
          x.url = v;
          x.decompressFunction = z;
          return C(x);
        },
        M = function (v, x, B, F) {
          return v.catch(function (K) {
            Object(l.b)(K);
            return F(x, B);
          });
        },
        A = function (v, x, B) {
          ...
          if (B.isAsync) {
            var K = x[0](v, B);
            for (F = 1; F < x.length; ++F) K = M(K, v, B, x[F]);
            return K;
          }
          for (F = 0; F < x.length; ++F)
            try {
    ...
    function (u, p, q) {
      ...
      var n = function (h) {
        ...
        l = function (h) {
          if ("string" !== typeof h) {
            for (var c = "", e = 0, k = h.length, m; e < k; )
              (m = h.subarray(e, e + 1024)),
                (e += 1024),
                (c += String.fromCharCode.apply(null, m));
            return c;
          }
          return h;
        };
    ...
    function (u, p, q) {
      function n(h, c, e) {
        return new Promise(function (k) {
          if (!h) return k();
          var m = e.document.createElement("script");
          ...
          m.src = h;
          e.document.getElementsByTagName("head")[0].appendChild(m);
        });
      }
      q.d(p, "a", function () {
        return n;
    ...
    function (u, p, q) {
      function n(e, k, m) {
        function r(E) {
          y = y || Date.now();
          return E
            ? (Object(l.a)("load", "Try instantiateStreaming"),
              fetch(Object(h.a)(e))
                .then(function (z) {
                  return WebAssembly.instantiateStreaming(z, k);
                })
                .catch(function (z) {
                  Object(l.a)(
                    "load",
                    "instantiateStreaming Failed " + e + " message " + z.message
                  );
                  return r(!1);
                }))
            : Object(h.b)(e, m, !0, !0).then(function (z) {
                w = Date.now();
                Object(l.a)("load", "Request took " + (w - y) + " ms");
                return WebAssembly.instantiate(z, k);
              });
        }
        var w, y;
        return r(!!WebAssembly.instantiateStreaming).then(function (E) {
          Object(l.a)(
            "load",
            "WASM compilation took " + (Date.now() - (w || y)) + " ms"
          );
          return E;
        });
      }
    ...
    function (u, p, q) {
      function n(h, c, e, k) {
        ...
        return new (e || (e = Promise))(function (r, w) {
          function y(C) {
            try {
              z(k.next(C));
            } catch (O) {
          ...
          function z(C) {
            C.done ? r(C.value) : m(C.value).then(y, E);
          }
          z((k = k.apply(h, c || [])).next());
        });
      }
      function l(h, c) {
        function e(z) {
                ...
                w &&
                  (y =
                    z[0] & 2
                      ? w["return"]
                      : z[0]
                      ? w["throw"] || ((y = w["return"]) && y.call(w), 0)
                      : w.next) &&
                  !(y = y.call(w, z[1])).done)
              )
                return y;
              if (((w = 0), y)) z = [z[0] & 2, y.value];
              switch (z[0]) {
                case 0:
                case 1:
                  y = z;
                ...
                default:
                  if (
                    !((y = m.trys), (y = 0 < y.length && y[y.length - 1])) &&
                    (6 === z[0] || 2 === z[0])
                  ) {
                    m = 0;
                    continue;
                  }
                  if (3 === z[0] && (!y || (z[1] > y[0] && z[1] < y[3])))
                    m.label = z[1];
                  else if (6 === z[0] && m.label < y[1])
                    (m.label = y[1]), (y = z);
                  else if (y && m.label < y[2]) (m.label = y[2]), m.ops.push(z);
                  else {
                    y[2] && m.ops.pop();
                    m.trys.pop();
                    continue;
        ...
        var m = {
          ...
          E;
        return (
          (E = { next: e(0), throw: e(1), return: e(2) }),
    ...
    function (u, p, q) {
      ...
      var n = q(2),
        ...
        c = (function () {
          ...
          k.prototype.addEventListener = function (m, r) {
            this.promise.then(r);
          };
          return k;
        })(),
        e = function (k, m, r) {
          if (Object(h.a)() && !r) {
            self.Module.instantiateWasm = function (y, E) {
              return Object(l.a)(k + "Wasm.wasm", y, m["Wasm.wasm"]).then(
                function (z) {
                  E(z.instance);
                }
              );
            ...
            r = Object(n.b)(k + "Wasm.js.mem", m["Wasm.js.mem"], !1, !1);
          } else {
            if (m.disableObjectURLBlobs) {
              importScripts(
            ...
            self.Module.memoryInitializerRequest = new c(w);
          }
    ...
    function (u, p, q) {
      ...
      u = (function () {
        ...
        return (z =
          /(msie) ([\w.]+)/.exec(z) || /(trident)(?:.*? rv:([\w.]+)|)/.exec(z))
          ? parseInt(z[2], 10)
          : z;
      })();
      var l = (function () {
        var z = n.navigator.userAgent.match(/OPR/),
          C = n.navigator.userAgent.match(/Maxthon/),
          O = n.navigator.userAgent.match(/Edge/);
        return n.navigator.userAgent.match(/Chrome\/(.*?) /) && !z && !C && !O;
      })();
      (function () {
        if (!l) return null;
        var z = n.navigator.userAgent.match(/Chrome\/([0-9]+)\./);
        return z ? parseInt(z[1], 10) : z;
      })();
      var h =
      ...
      (function () {
        if (!h) return null;
        var z = n.navigator.userAgent.match(/Edg\/([0-9]+)\./);
        return z ? parseInt(z[1], 10) : z;
      })();
      p =
      ...
      var c = (function () {
          var z = n.navigator.userAgent.match(
            /.*\/([0-9\.]+)\s(Safari|Mobile).*/i
          );
          return z ? parseFloat(z[1]) : z;
        })(),
        e =
      ...
      (function () {
        if (!k) return null;
        var z = n.navigator.userAgent.match(/Firefox\/([0-9]+)\./);
        return z ? parseInt(z[1], 10) : z;
      })();
      u || /Android|webOS|Touch|IEMobile|Silk/i.test(navigator.userAgent);
      navigator.userAgent.match(/(iPad|iPhone|iPod)/i);
      n.navigator.userAgent.indexOf("Android");
      var m = /Mac OS X 10_13_6.*\(KHTML, like Gecko\)$/.test(
          n.navigator.userAgent
        ),
        r = n.navigator.userAgent.match(/(iPad|iPhone).+\sOS\s((\d+)(_\d)*)/i)
          ? 14 <=
            parseInt(
    ...
    function (u, p, q) {
      ...
      (function (n) {
        function l(A, f, H) {
          ...
          null == v && (v = "importCommand" + H + ".xml");
          FS.writeFile(v, A);
          M.ccall("wasmRunXML", "number", ["string", "string"], [v, f]);
          FS.unlink(v);
        }
        function h(A) {
          var f =
        ...
        function c() {
          1 == T ? postMessage({ cmd: "isReady" }) : setTimeout(c, 300);
        }
        function e(A, f, H, v, x, B, F, K, N) {
          l(B, x, 0, F);
          x = h(x);
          0 == N && (B = null);
          postMessage(
        ...
        function m(A, f) {
          var H = A.galleyId,
            v = A.resultsFile,
            x = A.willTriggerTextContentUpdated,
            B = A.pageNumber;
          l(A.commandXML, v, 0, A.commandFile);
          A = h(v);
          postMessage(
            {
              pageNumber: B,
              ...
              galleyId: H,
              resultsXML: A,
              willTriggerTextContentUpdated: x,
            },
            [A]
          );
        }
        function r(A, f, H, v, x) {
          if (f) {
            H = new Uint8Array(H);
            f = "inputFile" + A + ".pdf";
            FS.writeFile(f, H);
            v = new Uint8Array(v);
            var B = new TextDecoder("utf-8").decode(v),
              F = "exported" + A + ".xml";
            H = "objects" + A + ".xml";
            v = "results" + A + ".xml";
            B = C.a.generateExportPageXMLCommand(f, 1, F, H, B);
            l(B, v, 1);
            G = A;
            x &&
              ((x = h(f, !1)),
        ...
        function w(A) {
          ...
          x !== G && r(x, !0, f, H, !1);
          var U = "results" + x + ".xml";
          f = K ? "transformTextBox" : "transformObject";
          l(B, U, x);
          H = h(A);
          U = h(U);
          postMessage(
        ...
        function y(A, f, H, v, x, B) {
          f != G && r(f, !0, A, v, !1);
          v = "outputFile" + f + ".pdf";
          A = "results" + f + ".xml";
          x = C.a.generateUpdateContentBoxXMLCommand(H, x, v);
          l(x, A, f);
          v = h(v);
          A = h(A);
          postMessage(
        ...
        var E = q(9),
          z = q(2),
          C = q(0),
          O = "undefined" === typeof window ? self : window;
        O.Core = O.Core || {};
        var T = !1,
          R = null,
          G = -1,
          M = {
            ...
            getPreloadedPackage: function (A, f) {
              ...
              return Object(z.b)("".concat(R || "").concat(A), f, !1, !0)
                .buffer;
            },
          };
        self.Module = M;
          ...
          switch (f.cmd) {
            ...
            case "initialiseInfixServer":
              ...
              M.ccall(
                ...
                ["infixcore.cfg", H, "results.xml"]
              );
              var v = h("results.xml");
              postMessage({ cmd: "initialiseInfixServer", resultsXML: v }, [v]);
              break;
            case "loadAvailableFonts":
              var x = C.a.generateGetWebFontsXMLCommand(f.webFontURL);
              l(x, "results0.xml", 0);
              var B = h("results0.xml");
              postMessage({ cmd: "loadAvailableFonts", resultsXML: B }, [B]);
              break;
            case "exportFile":
              r(f.pageNumber, f.performExport, f.pdfFile, f.tableData, !0);
              break;
            case "applyTransformMatrix":
              var F = f.transformMatrix,
                K = f.objectID,
                N = f.pageNumber,
                Q = F.m11,
                L = F.m12,
                ...
                ma = F.e,
                a = F.f,
                b = "<Commands><Command Name='Transform'><OID>"
                  .concat(K, "</OID><Matrix>")
                  .concat(Q, " ")
                  .concat(L, " ")
                  .concat(U, " ")
                  .concat(ha, " ")
                  .concat(ma, " ")
                  .concat(a, "</Matrix></Command></Commands>");
              l(b, "results" + N + ".xml", N);
              postMessage({
            ...
            case "deleteObject":
              var d = f.pageNumber,
                ...
                D = f.isUndoRedo,
                I = f.isPageDeleted;
              d != G && r(d, !0, f.pdfFile, f.tableData, !1);
              var J = "outputFile" + d + ".pdf",
                P = "results" + d + ".xml",
                S = '<Commands><Command Name="DeleteObject">';
              S =
                !0 === t
                  ? S + "<GID>".concat(g, "</GID></Command>")
                  : S + "<OID>".concat(g, "</OID></Command>");
              S += '<Command Name="SavePDF"><File>'.concat(J, "</File>");
              l(S + "</Command></Commands>", P, d);
              var ba = h(J),
                va = h(P);
              postMessage(
                {
            ...
            case "insertNewTextBox":
              var ac = f.pdfFile,
                ...
                ic = f.content,
                jc = f.canUndoRedo,
                kc = new TextEncoder().encode("").buffer;
              V != G && r(V, !0, ac, kc, !1);
              var wa = "results" + V + ".xml",
                xa = "exported" + V + ".xml",
                ya = "outputFile" + V + ".pdf";
              var W =
                '<Commands><Command Name="Insert Text Box">' +
                "<Rect><Top>".concat(bc, "</Top><Left>").concat(cc, "</Left>");
              W += "<Bottom>"
                .concat(dc, "</Bottom><Right>")
                .concat(ec, "</Right></Rect>");
              W += "<Size>"
                .concat(gc, "</Size><FontName>")
                .concat(fc, "</FontName>");
              var za = "editText" + V + ".xml";
              FS.writeFile(za, hc);
              W += "<File>".concat(
                za,
            ...
            case "AlignContentBox":
              var ca = f.pageNumber,
                na = f.galleyId,
                lc = f.alignment,
                mc = f.galleyNumericID;
              ca != G && r(ca, !0, f.pdfFile, f.tableData, !1);
              var Da = "results" + na + ".xml",
                Ea = "outputFile" + ca + ".pdf",
                Fa = C.a.generateAlignParagraphXMLCommand(na, lc, {}, Ea);
              l(Fa, Da, ca);
              var Ga = h(Da),
                Ha = h(Ea);
              postMessage(
            ...
            case "RenderContentBox":
              var X = f.pageNumber,
                nc = f.galleyId;
              X != G && r(X, !0, f.pdfFile, f.tableData, !1);
              var Ia = "outputFile" + X + ".pdf",
                Ja = "results" + X + ".xml",
                oc = C.a.generateRenderContentBox(Ia);
              l(oc, Ja, X);
              var Ka = h(Ia),
                La = h(Ja);
              postMessage(
            ...
            case "AlignParagraph":
              var ia = f.pageNumber,
                ...
                pc = f.alignment,
                pa = f.selection;
              ia != G && r(ia, !0, f.pdfFile, f.tableData, !1);
              var qa = "results" + oa + ".xml",
                Ma = C.a.generateAlignParagraphXMLCommand(
                  oa,
                  pc,
                  pa,
                  "outputFile" + ia + ".pdf"
              ...
              postMessage(
                {
                  ...
                  subCmd: "Set Para Attribs",
                  galleyId: oa,
                  caretStart: pa.startIndex,
                  caretEnd: pa.endIndex,
                  resultsFile: qa,
                  commandXML: Ma,
                  commandFile: "importCommand0.xml",
                  resultsXML: Na,
              ...
              switch (f.subCmd) {
                case "bold":
                  var qc = f.pdfFile,
                    ...
                    Oa = f.galleyId,
                    sc = f.tableData,
                    tc = C.a.generateBoldContentBoxXMLCommand(Oa, f.toApply);
                  y(qc, rc, Oa, sc, tc, C.b["Set Bold"]);
                  break;
                case "italic":
                  var uc = f.pdfFile,
                    vc = f.pageNumber,
                    Pa = f.galleyId,
                    wc = f.tableData,
                    xc = C.a.generateItalicContentBoxXMLCommand(Pa, f.toApply);
                  y(uc, vc, Pa, wc, xc, C.b["Set Italic"]);
                  break;
                case "underline":
                  var yc = f.pdfFile,
                    zc = f.pageNumber,
                    Qa = f.galleyId,
                    Ac = f.tableData,
                    Bc = C.a.generateUnderlineContentBoxXMLCommand(
                      Qa,
                      f.toApply
                    );
                  y(yc, zc, Qa, Ac, Bc, C.b["Set Underline"]);
                  break;
                case "strike":
                  var Cc = f.pdfFile,
                    Dc = f.pageNumber,
                    Ra = f.galleyId,
                    Ec = f.tableData,
                    Fc = C.a.generateStrikeContentBoxXMLCommand(Ra, f.toApply);
                  y(Cc, Dc, Ra, Ec, Fc, C.b["Set Strike"]);
                  break;
                case "colorContentBox":
                  var Gc = f.pdfFile,
                    ...
                    Sa = f.galleyId,
                    Ic = f.tableData,
                    Jc = C.a.generateColorContentBoxXMLCommand(Sa, f.newColor);
                  y(Gc, Hc, Sa, Ic, Jc, C.b["Set Text Color"]);
              }
              break;
            case "insertImage":
              var Kc = f.pdfFile,
                ...
                Pc = f.rightVal,
                Qc = f.canUndoRedo,
                Rc = new TextEncoder().encode("").buffer,
                Sc = { top: Mc, left: Nc, bottom: Oc, right: Pc };
              Y != G && r(Y, !0, Kc, Rc, !1);
              var Ta = "outputFile" + Y + ".pdf",
                Ua = "results" + Y + ".xml",
                Va = "imageFile" + String(new Date().getTime());
              FS.writeFile(Va, n.from(ra));
              var Wa = C.a.generatePlaceImageCommand(Va, Ta, Lc, Sc);
              l(Wa, Ua, Y);
              var Xa = h(Ta),
                Ya = h(Ua);
              postMessage(
            ...
            case "runCommand":
              var Tc = f.subCmd,
                Za = f.resultsFile;
              l(f.commandXML, Za, 0, f.commandFile);
              var $a = h(Za);
              postMessage({ cmd: "runCommand", subCmd: Tc, resultsXML: $a }, [
                $a,
              ]);
              break;
            case "renderGalleyArea":
              var ab = f.resultsFile;
              l(f.commandXML, ab, 0, f.commandFile);
              var bb = h(ab),
                cb = h(f.imageFName);
              postMessage(
                {
            ...
            case "renderEditGalley":
              var db = f.resultsFile;
              l(f.commandXML, db, 0, f.commandFile);
              var eb = h(db),
                fb = h(f.imageFName);
              postMessage(
                {
              ...
              break;
            case "renderFullPage":
              var gb = f.resultsFile;
              l(f.commandXML, gb, 0, f.commandFile);
              var hb = h(gb),
                ib = h(f.imageFName);
              postMessage(
                {
            ...
            case "textAttributes":
              var Uc = f.id,
                Vc = f.numChars,
                jb = f.resultsFile;
              l(f.commandXML, jb, 0, f.commandFile);
              var kb = h(jb);
              postMessage(
                { cmd: "textAttributes", id: Uc, numChars: Vc, resultsXML: kb },
                [kb]
              );
              break;
            case "loadSwatchColour":
              var lb = f.resultsFile;
              l(f.commandXML, lb, 0, f.commandFile);
              var mb = h(lb);
              postMessage({ cmd: "loadSwatchColour", resultsXML: mb }, [mb]);
              break;
            case "fittingAttributes":
              var nb = f.resultsFile;
              l(f.commandXML, nb, 0, f.commandFile);
              var ob = h(nb);
              postMessage({ cmd: "fittingAttributes", resultsXML: ob }, [ob]);
              break;
            case "spacingAttributes":
              var Wc = f.numChars,
                pb = f.resultsFile;
              l(f.commandXML, pb, 0, f.commandFile);
              var qb = h(pb);
              postMessage(
                { cmd: "spacingAttributes", numChars: Wc, resultsXML: qb },
                [qb]
              );
              break;
            case "indentAttributes":
              var Xc = f.numChars,
                rb = f.resultsFile;
              l(f.commandXML, rb, 0, f.commandFile);
              var sb = h(rb);
              postMessage(
                { cmd: "indentAttributes", numChars: Xc, resultsXML: sb },
                [sb]
              );
              break;
            case "editText":
              ...
              switch (f.subCmd) {
                ...
                case "insertImageRedo":
                  var Bb = f.commandXML,
                    ea = f.pageNumber,
                    Cb = f.newImage,
                    bd = "outputFile" + ea + ".pdf",
                    Db = "results" + ea + ".xml",
                    Eb = "imageFile" + ea + ".jpg";
                  FS.writeFile(Eb, n.from(Cb));
                  l(Bb, Db, ea);
                  var Fb = h(bd),
                    Gb = h(Db);
                  FS.unlink(Eb);
            ...
            case "dumpTextBox":
              var cd = f.galleyId,
                Hb = f.resultsFile;
              l(f.commandXML, Hb, 0, f.commandFile);
              var Ib = h(Hb);
              postMessage(
                { cmd: "dumpTextBox", galleyId: cd, resultsXML: Ib },
                [Ib]
              );
              break;
            case "transformTextBox":
              ...
              break;
            case "savePDF":
              var Jb = f.resultsFile,
                dd = f.pdfFileName,
                ed = new Uint8Array(f.pdfFile);
              FS.writeFile(f.pdfFileName, ed);
              l(f.commandXML, Jb, 0, f.commandFile);
              var Kb = h(dd),
                Lb = h(Jb);
              postMessage({ cmd: "savePDF", pdfBuffer: Kb, resultsXML: Lb }, [
                Kb,
                Lb,
              ]);
              break;
            case "loadPDF":
              var Mb = f.resultsFile,
                fd = new Uint8Array(f.pdfFile);
              FS.writeFile(f.pdfFileName, fd);
              l(f.commandXML, Mb, 0, f.commandFile);
              var Nb = h(Mb);
              postMessage({ cmd: "loadPDF", resultsXML: Nb }, [Nb]);
              break;
            case "loadHyperlinkURL":
              var gd = f.id,
                sa = f.resultsFile;
              l(f.commandXML, sa, 0, f.commandFile);
              var Ob = FS.readFile(sa).buffer;
              FS.unlink(sa);
              postMessage({ id: gd, cmd: "loadHyperlinkURL", resultsXML: Ob }, [
                Ob,
              ]);
              break;
            case "setTypographyContentBox":
              var Z = f.pageNumber,
                ja = f.galleyId,
                aa = f.value;
              Z != G && r(Z, !0, f.pdfFile, f.tableData, !1);
              var ta = "outputFile" + Z + ".pdf",
                Pb = "results" + Z + ".xml",
                ka = "";
              aa.style
                ? (ka = C.a.generateSetFontContentBoxCommand(ja, aa.style, ta))
                : aa.size &&
                  (ka = C.a.generateSetFontSizeContentBoxCommand(
                    ja,
                    aa.size,
                    ta
                  ));
            ...
            case "savePDFPage":
              var la = f.pageNumber,
                Sb = "outputFile" + la + ".pdf",
                Tb = "results" + la + ".xml",
                hd = '<Commands><Command Name="SavePDF"><File>'.concat(
                  Sb,
                  "</File></Command></Commands>"
                );
              l(hd, Tb, la);
            ...
            case "updateDocumentContent":
              var fa = f.pageNumber,
                ...
                kd = f.outputFileName,
                Vb = f.commandXML,
                ld = f.isSearchReplace,
                md = f.callbackMapId,
                nd = f.pdfPage,
                od = f.tableArray;
              fa != G && r(fa, !0, nd, od, !1);
              var Wb = "results" + fa + ".xml";
              l(Vb, Wb, fa);
              var Xb = h(kd),
                Yb = h(Wb);
              postMessage(
            ...
            case "getInfixVersion":
              var Zb = C.a.generateGetVersionCommand();
              l(Zb, "results1.xml", 1);
              var $b = h("results1.xml");
              postMessage(
                { cmd: "getInfixVersion", commandXML: Zb, resultsXML: $b },
                [$b]
              );
          }
        };
    ...
    function (u, p, q) {
      (function (n) {
        ...
        function r(a, b) {
          var d = 0 > b.length ? 0 : y(b.length) | 0;
          a = h(a, d);
        ...
        function w(a, b) {
          ...
          if (b) {
            ...
            if ("Buffer" === b.type && U(b.data)) return r(a, b.data);
          }
          throw new TypeError(
            ...
            switch (a) {
              ...
              case "base64":
                return (
                  (b =
                    0 === b && d === this.length
                      ? Q.fromByteArray(this)
                      : Q.fromByteArray(this.slice(b, d))),
                  b
                );
              case "ucs2":
              case "ucs-2":
        ...
        function O(a, b, d, g, t) {
          ...
          if (c.isBuffer(b)) return 0 === b.length ? -1 : T(a, b, d, g, t);
          if ("number" === typeof b)
            return (
              (b &= 255),
              c.TYPED_ARRAY_SUPPORT &&
        ...
        function T(a, b, d, g, t) {
          function D(S, ba) {
            return 1 === I ? S[ba] : S.readUInt16BE(ba * I);
          }
          var I = 1,
            J = a.length,
            P = b.length;
          ...
          if (t)
            for (g = -1; d < J; d++)
              if (D(a, d) === D(b, -1 === g ? 0 : d - g)) {
                if ((-1 === g && (g = d), d - g + 1 === P)) return g * I;
              } else -1 !== g && (d -= d - g), (g = -1);
          else
            for (d + P > J && (d = J - P); 0 <= d; d--) {
              J = !0;
              for (g = 0; g < P; g++)
                if (D(a, d + g) !== D(b, g)) {
                  J = !1;
            ...
            if (b + I <= d)
              switch (I) {
                ...
                case 3:
                  ...
                  128 === (J & 192) &&
                    128 === (P & 192) &&
                    ((t = ((t & 15) << 12) | ((J & 63) << 6) | (P & 63)),
                    2047 < t && (55296 > t || 57343 < t) && (D = t));
                  break;
                case 4:
                  J = a[b + 1];
                  P = a[b + 2];
                  ...
                  128 === (J & 192) &&
                    ...
                    ((t =
                      ...
                      ((P & 63) << 6) |
                      (S & 63)),
                    65535 < t && 1114112 > t && (D = t));
              }
            null === D
              ? ((D = 65533), (I = 1))
              : 65535 < D &&
                ((D -= 65536),
                g.push(((D >>> 10) & 1023) | 55296),
                (D = 56320 | (D & 1023)));
            g.push(D);
            b += I;
          }
          a = g.length;
          if (a <= ha) g = String.fromCharCode.apply(String, g);
          else {
            d = "";
            for (b = 0; b < a; )
              d += String.fromCharCode.apply(String, g.slice(b, (b += ha)));
            g = d;
          }
          return g;
        }
        ...
        function A(a, b, d, g) {
          0 > b && (b = 65535 + b + 1);
          for (var t = 0, D = Math.min(a.length - d, 2); t < D; ++t)
            a[d + t] =
              (b & (255 << (8 * (g ? t : 1 - t)))) >>> (8 * (g ? t : 1 - t));
        }
        function f(a, b, d, g) {
          0 > b && (b = 4294967295 + b + 1);
          for (var t = 0, D = Math.min(a.length - d, 4); t < D; ++t)
            a[d + t] = (b >>> (8 * (g ? t : 3 - t))) & 255;
        }
        function H(a, b, d, g, t, D) {
          if (d + g > a.length) throw new RangeError("Index out of range");
          if (0 > d) throw new RangeError("Index out of range");
        }
        function v(a, b, d, g, t) {
          t || H(a, b, d, 4, 3.4028234663852886e38, -3.4028234663852886e38);
          L.write(a, b, d, g, 23, 4);
          return d + 4;
        }
        function x(a, b, d, g, t) {
          t || H(a, b, d, 8, 1.7976931348623157e308, -1.7976931348623157e308);
          L.write(a, b, d, g, 52, 8);
          return d + 8;
        }
        function B(a, b) {
          b = b || Infinity;
          for (var d, g = a.length, t = null, D = [], I = 0; I < g; ++I) {
            d = a.charCodeAt(I);
            if (55295 < d && 57344 > d) {
              if (!t) {
                if (56319 < d) {
            ...
            } else t && -1 < (b -= 3) && D.push(239, 191, 189);
            t = null;
            if (128 > d) {
              if (0 > --b) break;
              D.push(d);
        ...
        function N(a, b, d, g) {
          for (var t = 0; t < g && !(t + d >= b.length || t >= a.length); ++t)
            b[t + d] = a[t];
          return t;
        }
        var Q = q(15),
        ...
        c.compare = function (a, b) {
          ...
          if (a === b) return 0;
          for (
            var d = a.length, g = b.length, t = 0, D = Math.min(d, g);
            t < D;
            ++t
          )
            if (a[t] !== b[t]) {
        ...
        c.prototype.compare = function (a, b, d, g, t) {
          if (!c.isBuffer(a)) throw new TypeError("Argument must be a Buffer");
          void 0 === b && (b = 0);
          void 0 === d && (d = a ? a.length : 0);
          void 0 === g && (g = 0);
          void 0 === t && (t = this.length);
          if (0 > b || d > a.length || 0 > g || t > this.length)
        ...
        c.prototype.write = function (a, b, d, g) {
          ...
          for (t = !1; ; )
            switch (g) {
              ...
              case "utf8":
              case "utf-8":
                return N(B(a, this.length - b), this, b, d);
              case "ascii":
                return N(F(a), this, b, d);
              case "latin1":
              case "binary":
                return N(F(a), this, b, d);
              case "base64":
                return N(K(a), this, b, d);
              case "ucs2":
              case "ucs-2":
              case "utf16le":
              case "utf-16le":
                g = a;
                t = this.length - b;
                for (var D = [], I = 0; I < g.length && !(0 > (t -= 2)); ++I) {
                  var J = g.charCodeAt(I);
                  a = J >> 8;
                  J %= 256;
                  D.push(J);
                  D.push(a);
        ...
        c.prototype.readUIntLE = function (a, b, d) {
          ...
          d || G(a, b, this.length);
          d = this[a];
          for (var g = 1, t = 0; ++t < b && (g *= 256); ) d += this[a + t] * g;
          return d;
        };
        ...
        c.prototype.readIntBE = function (a, b, d) {
          ...
          d || G(a, b, this.length);
          d = b;
          for (var g = 1, t = this[a + --d]; 0 < d && (g *= 256); )
            t += this[a + --d] * g;
          t >= 128 * g && (t -= Math.pow(2, 8 * b));
          return t;
        };
        ...
        c.prototype.readFloatLE = function (a, b) {
          b || G(a, 4, this.length);
          return L.read(this, a, !0, 23, 4);
        };
        c.prototype.readFloatBE = function (a, b) {
          b || G(a, 4, this.length);
          return L.read(this, a, !1, 23, 4);
        };
        c.prototype.readDoubleLE = function (a, b) {
          b || G(a, 8, this.length);
          return L.read(this, a, !0, 52, 8);
        };
        c.prototype.readDoubleBE = function (a, b) {
          b || G(a, 8, this.length);
          return L.read(this, a, !1, 52, 8);
        };
        c.prototype.writeUIntLE = function (a, b, d, g) {
          a = +a;
          b |= 0;
          d |= 0;
          g || M(this, a, b, d, Math.pow(2, 8 * d) - 1, 0);
          g = 1;
          var t = 0;
          for (this[b] = a & 255; ++t < d && (g *= 256); )
            this[b + t] = (a / g) & 255;
          return b + d;
        };
        ...
        c.prototype.writeIntLE = function (a, b, d, g) {
          a = +a;
          b |= 0;
          g || ((g = Math.pow(2, 8 * d - 1)), M(this, a, b, d, g - 1, -g));
          g = 0;
          var t = 1,
            D = 0;
          for (this[b] = a & 255; ++g < d && (t *= 256); )
            0 > a && 0 === D && 0 !== this[b + g - 1] && (D = 1),
              (this[b + g] = (((a / t) >> 0) - D) & 255);
          return b + d;
        };
        ...
        c.prototype.writeInt32LE = function (a, b, d) {
          a = +a;
          b |= 0;
          d || M(this, a, b, 4, 2147483647, -2147483648);
          c.TYPED_ARRAY_SUPPORT
            ? ((this[b] = a & 255),
              (this[b + 1] = a >>> 8),
              (this[b + 2] = a >>> 16),
        ...
        c.prototype.writeFloatLE = function (a, b, d) {
          return v(this, a, b, !0, d);
        };
        c.prototype.writeFloatBE = function (a, b, d) {
          return v(this, a, b, !1, d);
        };
        ...
        c.prototype.copy = function (a, b, d, g) {
          ...
          var t = g - d;
          if (this === a && d < b && b < g)
            for (g = t - 1; 0 <= g; --g) a[g + b] = this[g + d];
          else if (1e3 > t || !c.TYPED_ARRAY_SUPPORT)
            for (g = 0; g < t; ++g) a[g + b] = this[g + d];
          else Uint8Array.prototype.set.call(a, this.subarray(d, d + t), b);
          return t;
        };
    ...
    function (u, p, q) {
      ...
      p.toByteArray = function (e) {
        ...
        for (E = 0; E < y; E += 4)
          (m =
            (h[e.charCodeAt(E)] << 18) |
            (h[e.charCodeAt(E + 1)] << 12) |
            (h[e.charCodeAt(E + 2)] << 6) |
            h[e.charCodeAt(E + 3)]),
            (r[w++] = (m >> 16) & 255),
            (r[w++] = (m >> 8) & 255),
            (r[w++] = m & 255);
        2 === k &&
          ((m = (h[e.charCodeAt(E)] << 2) | (h[e.charCodeAt(E + 1)] >> 4)),
          (r[w++] = m & 255));
        1 === k &&
          ((m =
            (h[e.charCodeAt(E)] << 10) |
            (h[e.charCodeAt(E + 1)] << 4) |
            (h[e.charCodeAt(E + 2)] >> 2)),
          (r[w++] = (m >> 8) & 255),
          (r[w++] = m & 255));
        return r;
      };
      p.fromByteArray = function (e) {
        for (
          var k = e.length, m = k % 3, r = [], w = 0, y = k - m;
          w < y;
          w += 16383
        ) {
          for (
        ...
        1 === m
          ? ((e = e[k - 1]), r.push(l[e >> 2] + l[(e << 4) & 63] + "=="))
          : 2 === m &&
            ((e = (e[k - 2] << 8) + e[k - 1]),
            r.push(l[e >> 10] + l[(e >> 4) & 63] + l[(e << 2) & 63] + "="));
        return r.join("");
      };
      var l = [],
        h = [],
    ...
    function (u, p) {
      p.read = function (q, n, l, h, c) {
        ...
        l = y & ((1 << -r) - 1);
        y >>= -r;
        for (r += e; 0 < r; l = 256 * l + q[n + c], c += w, r -= 8);
        e = l & ((1 << -r) - 1);
        l >>= -r;
        for (r += h; 0 < r; e = 256 * e + q[n + c], c += w, r -= 8);
        if (0 === l) l = 1 - m;
        else {
          if (l === k) return e ? NaN : Infinity * (y ? -1 : 1);
          e += Math.pow(2, h);
          l -= m;
        }
        return (y ? -1 : 1) * e * Math.pow(2, l - h);
      };
      p.write = function (q, n, l, h, c, e) {
        var k,
          m = 8 * e - c - 1,
          r = (1 << m) - 1,
          w = r >> 1,
          y = 23 === c ? Math.pow(2, -24) - Math.pow(2, -77) : 0;
        e = h ? 0 : e - 1;
        var E = h ? 1 : -1,
          z = 0 > n || (0 === n && 0 > 1 / n) ? 1 : 0;
        n = Math.abs(n);
        isNaN(n) || Infinity === n
          ...
          : ((h = Math.floor(Math.log(n) / Math.LN2)),
            ...
            (n = 1 <= h + w ? n + y / k : n + y * Math.pow(2, 1 - w)),
            2 <= n * k && (h++, (k /= 2)),
            h + w >= r
              ? ((n = 0), (h = r))
              : 1 <= h + w
              ? ((n = (n * k - 1) * Math.pow(2, c)), (h += w))
              : ((n = n * Math.pow(2, w - 1) * Math.pow(2, c)), (h = 0)));
        for (; 8 <= c; q[l + e] = n & 255, e += E, n /= 256, c -= 8);
        h = (h << c) | n;
        for (m += c; 0 < m; q[l + e] = h & 255, e += E, h /= 256, m -= 8);
        q[l + e - E] |= 128 * z;
      };
    },
    function (u, p) {
