      ...
      577: function (xa, ta, h) {
        ...
        h = (function () {
          function fa(x, z) {
            ...
            z = z || {};
            this.url = x;
            this.filename = z.filename || x;
            this.Lf = z.customHeaders;
            this.yLa = !!z.useDownloader;
            this.withCredentials = !!z.withCredentials;
          }
          fa.prototype.rN = function (x) {
            this.Lf = x;
          };
          ...
          fa.prototype.getFileData = function (x) {
            ...
            n.responseType = f;
            this.Lf &&
              Object.keys(this.Lf).forEach(function (a) {
                n.setRequestHeader(a, z.Lf[a]);
              });
            ...
            n.addEventListener(
              ...
              function (a) {
                return Object(qa.b)(this, void 0, void 0, function () {
                  var e, w, y, ba, ha, aa;
                  return Object(qa.d)(this, function (ea) {
                    switch (ea.label) {
                      case 0:
                        ...
                        e = this.response;
                        return r.Y8(r.filename) ? [4, Object(ja.b)(e)] : [3, 2];
                      case 1:
                        return (
                          (w = ea.aa()),
                      ...
                      case 4:
                        ...
                        if (!r.Y8(r.filename)) return [3, 6];
                        e = new Blob([ba.buffer]);
                        return [4, Object(ja.b)(e)];
                      case 5:
                        return (
                          (w = ea.aa()),
                          (r.fileSize = w.byteLength),
                      ...
                      case 6:
                        (r.fileSize = ba.length), x(ba), (ea.label = 7);
                      case 7:
                        return [3, 9];
                      case 8:
                        return (
          ...
          fa.prototype.getFile = function () {
            ...
            return new Promise(function (z) {
              ka.da.isJSWorker && z(x.url);
              if (x.yLa) {
                var r = Object(qa.a)(
                  { url: x.url },
                  x.Lf ? { customHeaders: x.Lf } : {}
                );
                z(r);
              }
              z(null);
          ...
          fa.prototype.abort = function () {
            this.xG && (this.xG.abort(), (this.xG = null));
          };
          fa.Events = {
