  ...
  return (function (e) {
    ...
    function (e, t, n) {
            ...
            (i = [
              {
                ...
                value: function () {
                  ...
                  (window.isApryseWebViewerWebComponent = !0),
                    (window.webViewerPath = t),
                    (this.id =
                      ...
                      (function e() {
                        ...
                        return -1 ===
                          ...
                          ? (t.push(o),
                            localStorage.setItem("wv_instanceIds", t),
                            m++,
                            o)
                          : e();
                      })() ||
                      "default"),
                    fetch("".concat(t, "/ui/index-wc.html"))
                      .then(function (e) {
                        return e.text();
                      })
                      .then(function (n) {
      ...
      try {
        ...
        console.warn(
          "This environment does not allow for usage of the WebComponent version of WebViewer: ".concat(
            e
          )
        );
      }
      var v = function (e, t) {
        return new Promise(function (n, o) {
          ...
          s.setAttribute("id", "wc-".concat(t.id)),
            ...
            (e.azureWorkaround = e.azureWorkaround || e.enableAzureWorkaround),
            ...
            (e.useSharedWorker = e.workerTransportPromise ? "true" : "false"),
            (e.path = e.path || "/lib"),
            e.css &&
              ((i = t),
              (r = e.css),
              ...
              a.setAttribute("href", "".concat(r, "/ui/style.css")),
              i.appendChild(a)),
            e.workerTransportPromise &&
              (window.apryseWorkerTransportPromise = e.workerTransportPromise),
            e.l && (window.apryse_l = btoa(e.l));
          ...
          e))
            void 0 !== (null == e ? void 0 : e[l]) &&
              null !== (null == e ? void 0 : e[l]) &&
              (c.includes(l) && !1 === e[l]
                ? s.removeAttribute(l)
                : e.encryption
                ? s.setAttribute("auto_load", !1)
                : "licenseKey" !== l && "l" !== l && s.setAttribute(l, e[l]));
          s.setAttribute("webviewerjsversion", "10.12.0");
          var u = function (t) {
            "requestl" === t.data &&
              t.source &&
          ...
          t.appendChild(s),
            s.addEventListener("ready", function () {
              ...
              null !== (e = s.instance) &&
                ...
                e.UI &&
                (M(t, s.instance),
                (s.instance.UI.dispose = function () {
                  return new Promise(function (e) {
                    window.removeEventListener("message", u),
                      console.clear(),
                      s.instance.Core.documentViewer
                        .closeDocument()
                        .then(function () {
                          e();
                        });
      ...
      window.PDFNet &&
        !T.skipPDFNetWebViewerWarning &&
        console.warn(
          "PDFNet.js and WebViewer.js have been included in the same context. See https://community.apryse.com/t/what-is-the-best-location-to-call-pdfnet-apis-when-used-in-conjunction-with-webviewer/5210 for an explanation of why this could be an error in your application."
        );
      var I = new Map(),
        S = new Map();
      T.WebViewer = function (e, t) {
        ...
        t.addEventListener("ready", function e() {
          (I.get(t).instance = n.getCompleteInstance()),
        ...
        e.fullAPI &&
          ...
          (this.options = O({}, T.WebViewer.Options, e));
        ...
        i > 0 && "/" !== this.options.path[i] && (this.options.path += "/"),
          ...
          t ||
            console.error(
              "ViewerElement is not defined. This may be caused by calling the WebViewer constructor before the DOM is loaded, or an invalid selector. Please see https://docs.apryse.com/documentation/web/get-started/ for an example."
            ),
          (this.element = t),
      ...
      (T.WebViewer.prototype = {
        ...
        _validateOptions: function (e) {
          for (var t = Object.keys(e), n = 0; n < t.length; n++) {
            var o = t[n];
            o in O({}, E, T.WebViewer.Options) ||
              console.warn(
                "".concat(
                  o,
                  " is not a valid option name. See https://docs.apryse.com/api/web/global.html#WebViewerOptions for all available options."
                )
              );
          }
        ...
        _viewerLoaded: function (e) {
          ...
          try {
            ...
            console.warn(
              "Viewer is on a different domain, the promise from WebViewer function is rejected and API functions will not work because of cross domain permissions. See https://docs.apryse.com/documentation/web/guides/wv-inside/#loading-webviewer-from-another-domain for more information."
            );
          }
        },
        _getHTML5OptionsURL: function () {
          ...
          (void 0 === o.annotationAdmin && void 0 === o.isAdminUser) ||
            (r += "&admin=".concat(o.annotationAdmin || o.isAdminUser ? 1 : 0)),
          void 0 !== o.custom &&
            (r += "&custom=".concat(encodeURIComponent(o.custom))),
          (void 0 === o.showLocalFilePicker && void 0 === o.enableFilePicker) ||
            (r += "&filepicker=".concat(
              o.showLocalFilePicker || o.enableFilePicker ? 1 : 0
            )),
          void 0 !== o.fullAPI && (r += "&pdfnet=".concat(o.fullAPI ? 1 : 0)),
          ...
          void 0 !== o.hideDetachedReplies &&
            (r += "&hideDetachedReplies=".concat(
              o.hideDetachedReplies ? 1 : 0
            )),
          ...
          void 0 !== o.autoExpandOutlines &&
            (r += "&autoExpandOutlines=".concat(o.autoExpandOutlines ? 1 : 0)),
          void 0 !== o.enableAnnotationNumbering &&
            (r += "&enableAnnotationNumbering=".concat(
              o.enableAnnotationNumbering ? 1 : 0
            )),
          void 0 !== o.enableOfficeEditing &&
            (r += "&enableOfficeEditing=".concat(
              o.enableOfficeEditing ? 1 : 0
            )),
          ...
          return (
            ...
            void 0 !== o.webviewerServerRangeRequests &&
              (r += "&wvsRange=".concat(
                o.webviewerServerRangeRequests ? "true" : "false"
              )),
            ...
            o.disableIndexedDB && (r += "&disableIndexedDB=1"),
            o.disableMultiViewerComparison &&
              (r += "&disableMultiViewerComparison=1"),
            o.showInvalidBookmarks && (r += "&showInvalidBookmarks=1"),
            o.disableObjectURLBlobs &&
              (r += "&disableObjectURLBlobs=".concat(o.disableObjectURLBlobs)),
            (r += "&id=".concat(this.id)),
            (r += "&basePath=".concat(
            ...
            o.ui && !o.enableOfficeEditing && (r += "&ui=".concat(o.ui)),
            r
          );
        },
        ...
        dispose: function () {
          ...
          return new Promise(function (t) {
            I.delete(e.element),
              S.delete(e.element),
              window.removeEventListener("message", e.messageHandler),
              (e.iframe = null),
              console.clear(),
              e.instance.Core.documentViewer.unmount().then(function () {
                t();
              });
          });
        },
          ...
          return new Promise(function (n, o) {
            ...
            t.addEventListener("ready", function r() {
              ...
              try {
                ...
                var s = i.getInstance(),
                  c = { iframeWindow: a, dispose: i.dispose.bind(i) },
                  l = O(
                    {},
                    s,
                    g(
                ...
                if (
                  ...
                  l[s.UI_NAMESPACE_KEY].setTranslations(
                    d.language,
                    d.translations
                  );
                }
      ...
      (k.l = function (e) {
        ...
        (k.workerTransportPromise = function (e) {
          var t = C(e);
